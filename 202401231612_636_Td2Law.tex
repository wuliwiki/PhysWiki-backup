...
$$W'-W=Q_2-Q_2' ~.$$
当 $A$、$B$ 两热机按上述方式一起运行，$A$ 和 $B$ 都是循环过程，均恢复原状；高温热源 $\theta_1$ 也恢复原状；仅仅从低温热源 $\theta_2$ 吸收了 $Q_2-Q_2'$ 的热量并转化为了 $W'-W$ 的有用功，且 $W'-W=Q_2-Q_2'$，是完全转化了的，但没有产生其他影响。这违背开尔文表述：不可能从单一热源吸热做功而无环境影响。所以假设不成立，应当有 $\eta_A \ge \eta_B$。
