...
如果 $\ket{i_1},\ket{i_2},\dots,\ket{i_N}$ 中只有 $M < N$ 种不同的状态， 情况就要更复杂一些． 因为不同的组合减少至 $N!/(n_1! n_2! \dots n_M!)$ 种， 其中 $n_i$ 是第 $i$ 种状态重复的次数， $\sum_i n_i = N$． 我们仍然可以写出类似\autoref{symetr_eq1} 的表达式， 但求和只有 $N!/(n_1! n_2! \dots n_M!)$ 项， 归一化系数也随之变为 $\sqrt{n_1! n_2! \dots n_M!}/\sqrt{N!}$．
