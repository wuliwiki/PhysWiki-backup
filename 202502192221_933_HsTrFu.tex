...
首先来看关于 $x$ 轴对称，由于三角函数的角是以 $x$ 轴正方向为始边定义的，因此若两个角 $\alpha, \beta$ 对应的点 $P, Q$ 关于 $x$ 轴对称，则 $Q$ 的位置可以看作是 $P$ 沿 $x$ 轴翻转，即 $P$ 的终边逆时针旋转 $\beta$ 所在的角度，而 $Q$ 的终边则顺时针旋转相同的角度。这意味着，若 $P$ 对应的角为 $\beta$，则 $Q$ 对应的角为 $-\beta$。由于单位圆的周期性，相差 $2k\pi$ 的角等价，此时有：
