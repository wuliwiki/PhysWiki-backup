...
\begin{equation}
\pdv{\sigma}{\omega}{\Omega}(\omega) = \frac{\pi m\omega k q^2}{c\epsilon_0} \abs{\mel{i}{\uvec e \vdot\bvec r}{j}}^2
\end{equation}
速度规范下有（\autoref{HionCr_eq5} ）
\begin{equation}
\pdv{\sigma}{\omega}{\Omega}(\omega) = \frac{\pi k q^2}{c\epsilon_0 m \omega} \abs{\mel{i}{\uvec e \vdot \bvec p}{j}}^2
\end{equation}
