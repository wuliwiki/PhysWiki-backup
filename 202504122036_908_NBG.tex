...
情况2:\(\phi(x_1, \dots, x_n, Y_{\rightarrow}) = \psi_1(x_1, \dots, x_n, Y_{\rightarrow}) \land \psi_2(x_1, \dots, x_n, Y_{\rightarrow})\)。由于\(\psi_1\)和\(\psi_2\)都具有少于\(k\)个逻辑符号，归纳假设意味着存在唯一的\(n\)-元组类\(A_1\)和\(A_2\)，使得：
\[
(x_1, \dots, x_n) \in A_1 \iff \psi_1(x_1, \dots, x_n, Y_{\rightarrow}),~
\]
\[
(x_1, \dots, x_n) \in A_2 \iff \psi_2(x_1, \dots, x_n, Y_{\rightarrow}).~
\]
...
&\iff \psi_1(x_1, \dots, x_n, Y_{\rightarrow}) \land \psi_2(x_1, \dots, x_n, Y_{\rightarrow})\\
