...
然后，在 $\displaystyle{\int x^k (\ln x)^n\,\mathrm{d}x}$ 中：令 u=(\ln x)^n\,,\mathbb{d}v=x^k\,\mathbb{d}x\Rightarrow\,\mathbb{d}u=\frac{n(\ln x)^{n-1}\mathbb{d}x}{x}\,,v=\frac{x^{k+1}}{k+1} 
