...
\hline
$x\in\mathbb{R}$，$b^2-4ac\leq0$且$a<0$\footnote{大部分情况下也可以由$c<0$来代替$a<0$进行判定。}&$ax^2+bx+c\leq0$\\
\hline
$x\in\mathbb{R}$&$a^x>0\quad$&$a\in\mathbb{R}^+$\\
\hline
$x\in\mathbb{R}$&$0\leq|\sin x|\leq 1$&$0\leq|\cos x|\leq 1$\\
\hline
$x\in[-{3\pi\over4}+2k\pi,{\pi\over4}+2k\pi]\quad (k\in\mathbb{Z})$&$\sin x\leq\cos x$\\
\hline
$x\in[{\pi\over4}+2k\pi,{5\pi\over4}+2k\pi]\quad (k\in\mathbb{Z})$&$\sin x\geq\cos x$&x={\pi\over4}+k\pi\\
\hline
