...
在高中阶段\footnote{事实上，使用逻辑连接词来定义的“蕴含”为：$\lnot P\lor Q$，它与\aref{演绎推理}{sub_HsLogi_1}的三段论是完全等同的。但涉及这个定义的讨论，已超出高中的范畴，关于蕴含还有很多知识，可以参考\enref{命题的连接词}{Propos}。}，将“$P\Rightarrow Q$”理解为表示“如果命题$P$为真，那么命题$Q$也为真”就可以了。
