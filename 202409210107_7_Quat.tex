...
给定四元数$A=(a, \bvec{x})$和$B=(b, \bvec{y})$，如果将$\bvec{x}$和$\bvec{y}$的分别表示为$x_1\I+x_2\mathrm{j}+x_3\mathrm{k}$和$y_1\I+y_2\mathrm{j}+y_3\mathrm{k}$，使得$\I^2=\mathrm{j}^2=\mathrm{k}^2=\I\mathrm{j}\mathrm{k}=-1$，那么
\begin{equation}
\begin{aligned}
A\times B ={}& \qty(ab-x_1y_1-x_2y_2-x_3y_3)+\\
&\qty(x_2y_3-x_3y_2)\I+\qty(x_3y_1-x_1y_3)\mathrm{j}+\qty(x_1y_2-x_2y_1)\mathrm{k}. 
\end{aligned}~
\end{equation}
\end{lemma}
