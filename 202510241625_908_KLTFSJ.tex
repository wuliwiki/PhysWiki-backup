...
**[T1]** 它是幂集 (\wp(X)) 的一个有界子格，也就是说
(X, \varnothing \in {\mathfrak{S}}[\mathbf{c}])。

**[T2]** 它对任意交封闭：若
(\mathcal{I})
是任意指标集，且
({C_i}*{i \in \mathcal{I}} \subseteq {\mathfrak{S}}[\mathbf{c}])，
则
(\displaystyle \bigcap*{i \in \mathcal{I}} C_i \in {\mathfrak{S}}[\mathbf{c}])。
...
({C_i}*{i \in \mathcal{I}} \subseteq {\mathfrak{S}}[\mathbf{c}])，
则
(\displaystyle \bigcup*{i \in \mathcal{I}} C_i \in {\mathfrak{S}}[\mathbf{c}])。
