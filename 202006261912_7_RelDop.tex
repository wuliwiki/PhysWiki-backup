...
下面我们分别从严格的代数角度和利用直观的尺缩效应来推导光的多普勒效应．


\subsection{光的多普勒效应的代数推导}
...
在$K_2$中，“同一时间”条件为$t_1-vt_1\cos{\theta}=t_2-v(t_2+\lambda)\cos{\theta}$．类似一维情况，代入该条件并求两波峰的空间坐标之差，所得到的差是一个向量，该向量的模长就是$\lambda'$．因此，
\begin{equation}
