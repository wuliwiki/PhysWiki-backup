...
\end{figure}
如果在电路中加入一个电动势作周期性变化的电源，如\autoref{EleRes_fig1}所示，可以连续不断地供给能量，即可使电流振幅保持不变，这种在外加周期性电动势持续作用下产生的振荡，称为\textbf{受迫振荡}．设电源的电动势为$\mathscr{E}=\mathscr{E}_{0} \cos \omega_{\mathrm{d}} t$，则受迫振荡的微分方程可写成
\begin{equation}
...
由\autoref{EleRes_eq1}不难看出，当电路满足条件$\omega_{\mathrm{d}} L=\dfrac{1}{\omega_{\mathrm{d}} C}$时，电流将有最大的振幅．由上述条件可得
\begin{equation}
