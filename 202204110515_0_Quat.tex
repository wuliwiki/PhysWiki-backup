...
标量与四元数相乘也类似
\begin{equation}
\lambda (a_0, \bvec a) = (\lambda,\bvec 0) (a_0, \bvec a) = (\lambda a_0, \lambda\bvec a)
\end{equation}
...
\end{aligned}
\end{equation}
使用该形式， 可以求 $(a_0, \bvec a)$ 的逆——令 $(a_0,\bvec a)(a_0,\bvec b) = (1,0,0,0)$， 解线性方程组即可．
\addTODO{是否所有非零四元数都存在逆？}
