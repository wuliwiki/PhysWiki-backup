...
从$Q$的角度考虑：$Q$是$P$中信息的一部分，$Q$为真对$P$成立是必要的，也就是说$Q$不成立$P$就不可能成立（四条边不全相等的四边形一定不是正方形）。

又因为，$Q\Rightarrow P$是假命题（$Q$不能推出$P$）。

从$Q$的角度考虑：$Q$不能推出$P$，说明$Q$中提供的信息不够充分，不足以得到$P$，也就是说$Q$中欠缺了一些$P$所需要信息。

从$P$的角度考虑：$P$为真对$Q$成立并不是必要的。也就是说，必须$Q$为真$P$才可能成立，而$Q$不成立$P$就不可能成立（四条边不全相等的四边形一定不是正方形）。
\end{example}
