...
\subsection{电势能}
我们先来看电势能． 如果空间中存在某种分布的电场（关于位置的矢量函数） $\bvec E(\bvec r)$， 一个电荷为 $q$ 的点电荷在任意位置 $\bvec r$ 都会受到电场力
\begin{equation}
...
要讨论势能的概念， 我们首先需要确保这个力场是一个保守场， 即只有上式的结果只与初末位置有关而与路径无关时才可能存在一个势能函数． 以后我们会看到， 当空间中没有随时间变化的磁场时， 电场必定是一个保守场， % 链接未完成
所以我们接下来只讨论这种情况．
