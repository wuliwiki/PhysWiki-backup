...
同样地，我们假定等温等容系统发生了一个变化，并求这个系统能对外做的最多非体积功（功可以被分为体积功与非体积功，体积功指因为系统体积变化而导致的机械功  $w_\text{体}=p\Delta V$，而非体积功指其余类型的功，例如电功等。）。根据热一和热二，我们写出：
\begin{equation}
\left \{
    \begin{aligned}
    \Delta U &= q-w_\text{非体}\\
...
\right.~,
\end{equation}
显然由于等容，体积功为零。同时，根据状态量与路径无关的性质\upref{StaPro}，我们假定内能的变化$\Delta U$和熵的变化$\Delta S$是已知的。
