...
\end{figure}
其中阴影区域是任意可能的费曼图贡献之和。若有多条费米子链，由于光子 $k$ 可以接在任意一条费米子链上，所以Ward 等式为
\begin{equation}
k_\mu\mathcal{M}^\mu(k,p_1,\cdots,p_n;p'_1,\cdots,p'_m) 
&= e(\mathcal{M}(p_1,\cdots p_n;p'_1-k,\cdots p'_m)+\mathcal{M}(p_1,\cdots p_n;p'_1,\cdots p'_m-k)\\
&-\mathcal{M}(p_1+k,\cdots,p_n;p'_1,\cdots,p'_m)-\mathcal{M}(p_1,\cdots,p_n+k;p'_1,\cdots,p'_m)
)
\end{equation}
