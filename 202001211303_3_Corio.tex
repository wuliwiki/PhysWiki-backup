...
\qty(\dv{\bvec A}{t})_{xyz} = \qty(\dv{\bvec A}{t})_{abc} + \bvec\omega\cross\bvec A_{abc}
\end{equation}

\begin{example}{}
令 $abc$ 系 $t = 0$ 时与 $xyz$ 系重合并绕 $z$ 轴逆时针匀速转动， 又令 $\bvec A_{abc}(t) = \alpha t \uvec a$， 验证 $\bvec A(t)$ 满足\autoref{Corio_eq4}．
