...
% \caption{液体的模型} \label{NCLT_fig5}
% \end{figure}

% 引用自 https://chem.libretexts.org/Bookshelves/General_Chemistry/Map%3A_A_Molecular_Approach_(Tro)/11%3A_Liquids_Solids_and_Intermolecular_Forces/11.02%3A_Solids_Liquids_and_Gases-_A_Molecular_Comparison
%这个带%URL好像加在\href里会卡bug
\href{https://chem.libretexts.org/Bookshelves/General_Chemistry/Map \% 3A_A_Molecular_Approach_(Tro)/11 \% 3A_Liquids_Solids_and_Intermolecular_Forces/11.02 \% 3A_Solids_Liquids_and_Gases-_A_Molecular_Comparison}{1}
...
\text{https://chem.libretexts.org/Bookshelves/General_Chemistry/Map\%3A_A_Molecular_Approach_(Tro)/11\%3A_Liquids_Solids_and_Intermolecular_Forces/11.02\%3A_Solids_Liquids_and_Gases-_A_Molecular_Comparison}