...
角的度量值称为\textbf{角度（measure of angle）}。角的大小可以用\textbf{度分秒}表示，例如 $30^\circ45'35''$。这种表示角大小的单位制称为\textbf{角度制}。角度制要求一个\textbf{平角}的度数为 $180^\circ$，而\textbf{周角}的度数为 $360^\circ$。按角度的大小角可以分为：
\begin{itemize}
