...
拉扎尔·尼古拉·玛尔格里特·卡诺（\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/f960dff13a9d239e.png}
\caption{} \label{fig_Lazare_8}
\end{figure}法语：[lazaʁ nikɔla maʁɡəʁit kaʁno]；1753年5月13日 – 1823年8月2日）是法国数学家、物理学家、军官、政治家，并在法国大革命期间成为公共安全委员会的主要成员之一。他的军事改革，包括实施全民征兵（levée en masse），在将法国革命军转变为一支有效的战斗力量方面发挥了重要作用。
