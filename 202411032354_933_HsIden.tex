...
\hline
$x\in\mathbb{R}$&$x^{2n}\geq0\quad$&$n\in\mathbb{Z}$\\
\hline
$x\in[0,+\infty$&$x^{1\over2n}\geq0\quad$&$n\in\mathbb{Z}$\\
\hline
$x\in\mathbb{R}$&$ax^2+bx+c\geq0\quad(b^2-4ac\leq0\text{且}a>0$，大部分情况下也可以由$c>0$来代替$a>0$进行判定。\\
\hline
$x\in\mathbb{R}$，，大部分情况下也可以由$c<0$来代替$a<0$进行判定。&$ax^2+bx+c\leq0\quad(b^2-4ac\leq0$&$a<0$\\
\hline
$x\in\mathbb{R}$&$a^x>0\quad$&$a\in\mathbb{R}^+$\\
\hline
$x\in\mathbb{R}$&$0\leq|\sin x|\leq 1$&$0\leq|\cos x|\leq 1$\\
\hline
$x\in[-{3\pi\over4}+2k\pi$&${\pi\over4}+2k\pi]$&$\sin x\leq\cos x$&$\quad k\in\mathbb{Z}$\\
\hline
$x\in[{\pi\over4}+2k\pi$&${5\pi\over4}+2k\pi]$&$\sin x\geq\cos x$&$\quad k\in\mathbb{Z}$\\
\hline
$x\in[0$&${\pi\over2}$&$\sin x\leq x\leq\tan x$\\
\hline
\end{tabular}
\end{table}
