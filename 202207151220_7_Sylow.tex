...
设$P$的迷向子群为$F_P\subseteq G$．由共轭作用和迷向子群的定义，$F_P=\{g\in G\mid gPg^{-1}=P\}$，故可见$F_P$是$P$的\textbf{正规化子}（\autoref{NormSG_def2}~\upref{NormSG}）．

由\autoref{Group3_cor2}~\upref{Group3}，$n_p=\abs{G}/\abs{F_P}$
