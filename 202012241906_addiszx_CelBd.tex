...
\end{equation}
（其中 $k$ 为大于零的常数） 则该问题被称为\textbf{开普勒问题}． 对于万有引力， 有 $k = GMm$， 对于异种电荷间的库仑引力， 有\footnote{高中所学的库仑定律的系数 $k$ 在大学物理中通常记为 $1/(4\pi\epsilon_0)$， 其中 $\epsilon_0$ 为真空中的电介质常数．} $k = \abs{Qq}/(4\pi\epsilon_0)$．
...
对于\textbf{双曲线}， 偏近点角使用不同的定义， 可取任意实数， 使得
\begin{equation}
r = a(e\cosh\xi - 1)
\end{equation}
\begin{equation}
