...
若声明使用原子单位， 物理量的数值后面就不需要标记单位， 例如 “氢原子基态能量为 $E = 0.5$”． 有时候为了强调我们使用原子单位， 我们会在数值后面加上 “a.u.”， 如 $E = 0.5 \Si{a.u.}$． “a.u.” 可等效为 “单位 1”， 就像弧度单位 “Rad” 一样\footnote{例如在扇形面积公式 $S = \theta R^2/2$ 中的 $\theta$ 可以看作具有单位 “Rad”， 但面积的量纲却只是 “$\Si{m^2}$” 而无需记为 “$\Si{Rad\times m^2}$”．}．
