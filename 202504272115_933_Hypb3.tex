...
从图中可以非常明显地看出，这些双曲线拥有的一个共同性质就是共享渐近线\footnote{当然，还有一个共同性质就是它们的\aref{离心率}{def_HsCsFD_1}也相同。}。前面介绍过的\aref{共轭双曲线}{eq_Hypb3_14} 其实就同属与一个双曲线族。

\subsection{渐近线}
通过前面的介绍可以看出，渐近线是双曲线与tuo y
\begin{figure}[ht]
\centering
