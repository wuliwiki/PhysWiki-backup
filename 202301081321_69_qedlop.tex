...
&=-e^2\mu^{4-d} \int\frac{\dd[d]{k}}{(2\pi)^d} \frac{\gamma^\mu \not k \gamma_\mu + m\gamma^\mu\gamma_\mu}{(k^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}+i(\delta_2\not p -\delta_m)
\\
&=-e^2\mu^{4-d} \int\frac{\dd[d]{k}}{(2\pi)^d} \frac{(2-d)\not k + dm}{(k^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}+i(\delta_2\not p -\delta_m)
\end{aligned}
\end{equation}
...
计算以下 Feynman 积分
\begin{equation}
I^\mu = \mu^{4-d}\int\frac{\dd[d]{k}}{(2\pi)^d} \frac{k^\mu}{(k^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}
\end{equation}
\end{exercise}
...
\begin{equation}
\begin{aligned}
A(p^2) = I^\mu p_\mu/p^2 = \frac{\mu^{4-d}}{p^2} \int \frac{\dd[d]{k}}{(2\pi)^d} \frac{}{(k^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}
\end{aligned}
\end{equation}
