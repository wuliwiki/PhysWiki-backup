...
\item \verb|arf_t| 的数据结构， 看懂下面的代码就了解了． 基本就是小数部分 \verb|.d|（一个 GMP 整数，例如 0.100101110）， 指数部分 \verb|.exp|（一个 GMP 整数）， 和 \verb|.size| 部分．
...
#define ARF_SGNBIT(x) (ARF_XSIZE(x) & 1) // last bit, 1 for negative
