...
\begin{definition}
	...
	设
	\begin{equation}
		f_{n}(z)=\int_{0}^{n}\left(1-\frac{t}{n}\right)^{n}t^{z-1}\mathrm{d}t\qquad\operato{Re}(z)>0
	\end{equation}
	...
	\begin{equation}
		0\leqslant1-e^{t}\left(1-\frac{t}{n}\right)^{n}\leqslant\frac{et^2}{4n}\label{Gamma_eq7}
	\end{equation}
	事实上,由于
	\[
	...
	\]
	结合\eqref{Guass f_n(z)}式和 \autoref{Gamma_eq7} 式,可得
	\begin{equation}
