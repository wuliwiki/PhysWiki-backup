...
类似的，可以定义多元映射的连续性。
\begin{definition}{}
设 $(X,d),(X_i,d_i),i=1,\ldots,n$ 是度量空间，$f:X_1\times\cdots\times X_n\rightarrow X$ 是映射，$x=(x_1,\ldots,x_n)$。若对任意的 $\epsilon>0$，存在 $\delta_i>0,i=1,\cdots,n$ 满足
\begin{equation}
d_1(x_1,x_0)<\delta \Rightarrow d_2(f(x),f(x_0))<\epsilon,~
\end{equation}
则称 $f$ 在 $x_0$ 处\textbf{连续}。若 $f$ 在 $X_1$ 的每一点都连续，则称 $f$ 在 $X_1$ 上\textbf{连续}。
\end{definition}
