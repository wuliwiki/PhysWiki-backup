...
要求解该问题， 可以用 “一维自由粒子高斯波包\upref{GausWP}” 相似的思路，先把初始波函数拆解为无数平面波， 再分别把每个平面波在电场 $\bvec {\mathcal E}(t)$ 中演化到任意时间 $t$， 最后重新组合成为 $\Psi(x,t)$。

那么它在该电场中演化到某时刻的波函数称为 \textbf{Volkov 波函数}。
