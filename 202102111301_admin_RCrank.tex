...
\subsection{证明}
以下证明\autoref{RCrank_the1} 中 $Y_0$ 与 $Y_1$ 互为正交补， $X_0, X_1$ 同理． 令 $\mat A$ 为 $N_Y$ 行 $N_X$ 列的矩阵， 对应的线性算符为 $A: X\to Y$． $X, Y$ 空间的维数分别为 $N_X, N_Y$． $\mat A$ 的厄米共轭\upref{HerMat}记为 $\mat A\Her$， 对应算符记为 $A\Her$．
