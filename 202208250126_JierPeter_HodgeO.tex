...
设流形$M$上有内积定义，即对于余切向量$\alpha$和$\beta$，有内积$\langle \alpha, \beta \rangle$．

给定余切向量$\alpha_i$和$\beta_j$，构成两个$k$-向量$\omega_\alpha=\alpha_1\wedge\alpha_2\wedge\cdots\wedge\alpha_k$和$\omega_\beta=\beta_1\wedge\beta_2\wedge\cdots\wedge\beta_k$．则这两个$k$-向量的内积定义为
\begin{equation}
