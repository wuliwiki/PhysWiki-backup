...
\pdv{x} = \sin\theta\cos\phi\pdv{r} + \frac{\cos\phi\cos\theta}{r}\pdv{\theta} -\frac{\sin\phi}{r}\pdv{\phi}~,
\end{equation}
\begin{equation}\label{eq_SphNab_7}
\pdv{y} = \sin\theta\sin\phi\pdv{r} + \frac{\sin\phi\cos\theta}{r}\pdv{\theta} +\frac{\cos\phi}{r}\pdv{\phi}~.
\end{equation}
...
\end{equation}
\begin{equation}
\pdv{\theta}{x} = \sin\theta\cos\phi, \qquad
\pdv{\theta}{y} = \sin\theta\sin\phi, \qquad
\pdv{\theta}{z} = \cos\theta~,
\end{equation}
