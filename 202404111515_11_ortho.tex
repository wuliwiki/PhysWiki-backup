...
本文用“$(\bvec x,\bvec y)$”表示对任意两个向量作内积。本文的“内积”是狭义上的具有正定性的对称双线性函数。正交变换的定义可以拓展为把
\subsection{正交变换}
...
$\mathcal A$是正交变换$\Longleftrightarrow $对任意$\bvec x\in V$，线性变换$\mathcal A$满足$|\mathcal A\bvec x|=|\bvec x|$。
