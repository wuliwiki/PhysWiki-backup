...
我们现在考虑两个仅受相互作用的质点 $A$ 和 $B$， 它们的质量分别为 $m_A$ 和 $m_B$。 由于不受系统外力， 在任何\enref{惯性系}{New3}中它们的质心\upref{CM}都会做匀速直线运动（\autoref{eq_PLaw_2}~\upref{PLaw}）。 所以系统的质心参考系（\autoref{sub_CM_2}~\upref{CMfram}）是一个惯性系， 以下我们选取质心参考系， 系统的质心将一直处于原点。
