...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PhaSft_1.png}
\caption{内反射： r、t 作为入射角的函数} \label{PhaSft_fig1}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/PhaSft_2.png}
...
\includegraphics[width=\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/PhaSft_3.png}
\caption{请添加图片描述} \label{PhaSft_fig3}
\end{figure}cm]{./figures/PhaSft_3.png}
\caption{请添加图片描述} \label{PhaSft_fig3}
\end{figure}cm]{./figures/PhaSft_3.png}
\caption{请添加图片描述} \label{PhaSft_fig3}
\end{figure}cm]{./figures/PhaSft_2.png}
\caption{请添加图片描述} \label{PhaSft_fig2}
\end{figure}cm]{./figures/PhaSft_2.png}
\caption{请添加图片描述} \label{PhaSft_fig2}
\end{figure}cm]{./figures/PhaSft_1.png}
\caption{请添加图片描述} \label{PhaSft_fig1}
\end{figure}
\end{enumerate}
