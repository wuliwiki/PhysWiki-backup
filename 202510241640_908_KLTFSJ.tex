...
它对任意交封闭：若$\mathcal{I}$是任意指标集，且$\left\{ C_i \}*{i \in \mathcal{I}} \subseteq {\mathfrak{S}}[\mathbf{c}]$,则有$\bigcap*{i \in \mathcal{I}} C_i \in {\mathfrak{S}}[\mathbf{c}]$.

\textbf{[T3]}有限并封闭（Closure under Finite Unions）

它对有限并封闭：若$\mathcal{I}$是有限指标集，且${ C_i }*{i \in \mathcal{I}} \subseteq {\mathfrak{S}}[\mathbf{c}]$,则有$\bigcup*{i \in \mathcal{I}} C_i \in {\mathfrak{S}}[\mathbf{c}]$.
