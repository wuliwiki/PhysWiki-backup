...
\begin{lstlisting}[language=matlab, caption=hydrogen\_ioniz\_cross\_section\_z.m]
% hydrogen single ionization cross_section
% use <Coulomb plane wave|z|n,l,m> as transition matrix
% eq_SIcros_2
function ret = hydrogen_ioniz_cross_section_z(Z,n,l,m,k,r_max)
load constants.mat alpha; % 1/(speed of light) in a.u.
dipole_z = hydrogen_trans_dipole_plane(Z, k, 0, 0, n, l, m, r_max);
ret = (4*pi^2*(kz.^2/2+0.5*Z^2/n^2)*kz)*alpha * abs(dipole_z)^2;
end
\end{lstlisting}
