...
\hline
\enref{角动量定理}{AMLaw1} & $\bvec \tau = \dv{\bvec L}{t}$ & $\bvec L = \bvec r \times \bvec p$ 质点角动量是质点动量与位矢的叉乘 & $\bvec \tau = \sum \bvec \tau_i $是质点所受力矩和；$\bvec \tau_i= \bvec r \times \bvec F_i$ \enref{力矩是力与位矢的叉乘}{Torque}；& 力矩和为零时，质点角动量守恒\\
\hline
\enref{动能定理}{KELaw1}& $W = \Delta E_k$  & $E_k = \frac{1}{2} m v^2$ 质点动能=1/2*质点质量*速度的平方 & 
$W = \sum W_i$是各力做的功之和；
$W_i = \bvec F_i \cdot \Delta \bvec r$ \enref{功是力在质点位移上的“作用量”。}{Fwork} & 功之和为零时，质点动能守恒\\
\hline
