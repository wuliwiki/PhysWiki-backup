...
\item 要停止在非苹果文件系统的硬盘生成 \verb`._XXX` 文件（这是为了使 metadata 兼容），用 \verb`defaults write com.apple.desktopservices AppleDouble -bool false`
\item 要清除已经生成的 \verb`._XXX` 文件，用 \verb``
