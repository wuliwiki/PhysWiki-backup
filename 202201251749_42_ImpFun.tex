...
在 $n+1$ 维长方体 $(a_1,b_1;\cdots;a_n,b_n)$ 中，方程\autoref{ImpFun_eq2} $F(x_1,\cdots,x_n,y)=0$ 确定 $y$ 为 $x_1,\cdots,x_n$ 的\textbf{单值函数}，若在 $n$ 维长方体 $((a_1,b_1;\cdots;a_n,b_n))$ 中任一点 $（x_1,\cdots,x_n）$，方程\autoref{ImpFun_eq2} 有且仅有一个根 $y$．有且仅有一个根 $y$ 位于区间 
\end{definition}