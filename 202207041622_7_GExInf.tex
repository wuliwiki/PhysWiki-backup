...
且有：$\mathbb{M}/\mathbb{F}$是正规扩张 $\iff$ $\opn{Gal}(\mathbb{K}/\mathbb{M})\triangleleft \opn{Gal}(\mathbb{K}/\mathbb{F})$ ．
\end{lemma}


\textbf{证明}：

由\autoref{GExt_the6}~\upref{GExt}，$\mathbb{K}/\mathbb{M}$是Galois扩张，因此$\opn{Gal}(\mathbb{K}/\mathbb{M})$存在．
