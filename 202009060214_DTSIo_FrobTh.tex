...
$$
于是切丛的子丛$\text{ker}d\Pi$在原点的小邻域内与$\mathfrak{D}$互补， 故$(d\Pi)^{-1}$在丛$\text{span}(\partial_1,\cdots ,\partial_k)$上是良好定义的， 而且其像正是$\mathfrak{D}$。 命$V_i=(d\Pi)^{-1}\partial_i$， 则诸$V_i$都是$\mathfrak{D}$的截面， 根据对合性质， $[V_i,V_j]$也是$\mathfrak{D}$的截面， 而且
$$
