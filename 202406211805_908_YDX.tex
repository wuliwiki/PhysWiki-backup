...
\caption{角速度矢量ω按照右手定则的规定，向上指逆时针旋转，向下指顺时针旋转。角位置θ（t)以一定的速度随时间变化ω(t) = dθ/dt。} \label{fig_YDX_11}
\end{figure}
...
即M相对于F的角速度矩阵。参数$\\omega$是角$\\theta$的时间导数，即

$\omega = \\frac{d\\theta}{dt}.$

加速度

$\mathbf{F+P(t)$的加速度通过速度的时间导数获得，
