...
\begin{theorem}{}
设 $\{\dot p_0;\dot p_1,\cdots,\dot p_n\}$ 是空间 $V$ 的一个坐标系，$e_i:=\vec{\dot p_0 p_i},i=1,\cdots,n$．若 $\dot p,\dot q$ 在此坐标系中的坐标分别为 $x_1,\cdots,x_n$ 和 $y_1,\cdots,y_n$ ，那么矢量 $\vec{pq}$ 在此基底
\end{theorem} 