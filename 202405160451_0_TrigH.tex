...
\subsection{经典积分}
\begin{equation}
\int \frac{1}{\sqrt{2(k^2/2+Z/r)}} \dd{r} = \frac{k r \sqrt{k^2+\frac{2 Z}{r}}-2 Z \tanh ^{-1}(\frac{\sqrt{k^2+\frac{2 Z}{r}}}{k})}{k^3}
= = \frac{k r \sqrt{k^2+\frac{2 Z}{r}}-2 Z \tanh ^{-1}(\frac{\sqrt{k^2+\frac{2 Z}{r}}}{k})}{k^3}~.
\end{equation}
