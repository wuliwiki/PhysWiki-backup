...
\end{figure}
那么自然而然的，合振动的振幅取决于两个位移矢量合成后的模长，当两个位移矢量同向，也就是波源在该位置的相位差为$2n\pi(n\in \mathbb{N}_0)$时，合振动振幅最大，我们把质点所在位置称之为振动加强点；当位移矢量反向，即相位差为$(2n+1)\pi$时，合振动振幅最小，此时位置则是振动减弱点。读者可验证，该结论与两个波源在此处是
