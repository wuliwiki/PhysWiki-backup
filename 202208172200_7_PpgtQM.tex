...
\end{equation}
根据\textbf{高斯积分}\upref{GsInt}\autoref{PpgtQM_eq5} ，或者如果你对高斯积分向复数的拓展有疑虑的话，根据\textbf{留数定理}\upref{ResThe}\autoref{ResThe_ex3}~\upref{ResThe}，知$\int \E^{-\I b^2}\dd b = \sqrt{\frac{\pi}{2}}(1+\I)$．代入\autoref{PpgtQM_eq6} 得
\begin{equation}
\ali{
    \int\E^{-\I a^2t/2m}\E^{\I a(y-x)} \dd a &= \E^{\I\frac{B^2}{4A}}\cdot\frac{1}{\sqrt{A}}\cdot \sqrt{\frac{\pi}{2}}(1-\I)\\
    &= \exp\qty(\frac{m\I\qty(x-y)^2}{2t})\sqrt{\frac{\pi m}{t}}(1-\I)\\
    % &= \sqrt{\frac{\pi m}{t}}\exp\qty(\frac{2m\I\qty(x-y)^2}{t})\cdot \sqrt{2}\exp\qty(-\pi\I/4)
}
\end{equation}
