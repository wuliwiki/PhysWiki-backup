...
如果点A具有位置坐标$\mathbf{P}_{A}=\Big (X_{A},Y_{A},Z_{A}\Big )$

如果点B具有位置坐标$\mathbf{P}_{B}=\Big (X_{B},Y_{B},Z_{B}\Big )$
...
如果点A具有位置坐标$\mathbf{V}_{A}=\Big (V_{A_x},V_{A_y},V_{A_z}\Big )$

如果点B具有位置坐标$\mathbf{V}_{B}=\Big (V_{B_x},V_{B_y},V_{B_z}\Big )$
...
如果点C有加速度分量$\mathbf{P}_{A}=\Big (X_{A},Y_{A},Z_{A}\Big )$

指向B有加速度分量$\mathbf{P}_{B}=\Big (X_{B},Y_{B},Z_{B}\Big )$
