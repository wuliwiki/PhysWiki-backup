...
首先，我们假设碰撞前的平均速度为$\bvec v_0$，可得碰撞之后的平均速度的为$\bvec v=\bvec v_0 -\frac{e\bvec E \tau}{m}$,那么就有：
\begin{equation}
\Delta E = \frac{1}{2}m\left(\left(\bvec v_0 -\frac{e\bvec E \tau}{m}\right)^2-v_0\right)
\end{equation}
