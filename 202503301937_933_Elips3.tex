...
\begin{example}{对两定点 $F_1(-c, 0)$ 和 $F_2(c, 0)$，若点$P$满足$|PF_1| + |PF_2| = M,(M > 2c)$，求$P$方程。}\label{ex_Elips3_1}
解：
...
由于$M>2c$，也就是，可以看出，\autoref{ex_Elips3_1} 的结果的形式与\autoref{eq_Elips3_2} 相同，也就是说二者的结果对应着同一个。
