...
\begin{lstlisting}[language=none]
sudo zfs create -V 8G poolname/swap
sudo zfs set primarycache=none poolname/swap
sudo zfs set secondarycache=none poolname/swap
sudo zfs set com.sun:auto-snapshot=false poolname/swap
sudo mkswap -f /dev/zvol/poolname/swap
sudo swapon /dev/zvol/poolname/swap
/dev/zvol/poolname/swap none swap defaults 0 0
swapon --show
free -h
\end{lstlisting}
\end{itemize}
