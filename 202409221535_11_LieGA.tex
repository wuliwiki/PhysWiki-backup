...
\end{aligned}
\end{equation}
因此$\mathfrak so(n,\mathbb R)$由实反对称矩阵构成。对于三维实正交矩阵，常约定李代数的基为
\begin{equation}J_1=\pmat{0&0&0\\0&0&-1\\0&1&0},\quad J_2=\pmat{0&0&1\\0&0&0\\-1&0&0},\quad J_3=\pmat{0&-1&0\\1&0&0\\0&0&0}~,\end{equation}
读者可验证，上述基的线性组合确实能导出所有的反对称矩阵。$\{c_i(t)=\E^{tX_i}\mid t\in \mathbb R\}$为$SO(n,\mathbb R)$的光滑曲线，分别代表绕$x,y,z$轴的旋转，$t$为对应的旋转角，这可以通过指数函数的技术展开来验证。
