...
\end{figure}
我们把质点所受的力分为两类：施力与受力物体都在系统内的力叫内力，而施力、受力物体之一在系统外的叫外力\upref{PSys} 。同理，可区分内力矩与外力矩。
...
系统的“状态”可由一系列的物理量描述，包括“宏观量”（系统的机械能、系统的体积...）与“微观量”(各质点的位矢、动量...)等\upref{StaPro} 。在牛顿力学中这部分内容不是必须的，但在经典热力学中我们会大量涉及这类问题。

例如桌面上有一杯水，我们可以测量他的温度、体积、压力，甚至用某些\textsl{想象中的神奇工具}测出其中每一个水分子的位矢与动量。但是，我们还是不知道这杯水从na tiao
