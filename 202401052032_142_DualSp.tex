...
考虑一个域 $\mathbb{F}$ 上的线性空间 $V$ 及其对偶空间 $V^*$，那么对于任意 $\bvec{v}\in V$，$\bvec{v}$ 是 $V^*$ 上的线性函数。
