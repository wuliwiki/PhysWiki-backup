...
a_n=dn+(a_1-d)~.
\end{equation}
在\enref{数列}{HsSeFu}中曾介绍过数列与函数的关系，\autoref{eq_HsAmPg_9} 与\autoref{ex_HsAmPg_3} 都可以说明，等差数列实际上是一次函数的离散形式。换句话说，在直角坐标系中，如果将数列的项数 $n$ 作为横坐标，数列的值 $a_n$ 作为纵坐标，则点 $(n, a_n)$ 将分布在一条过$$$(1,a_1)$的指数函数的曲线上。
