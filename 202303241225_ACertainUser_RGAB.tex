...
事实上，除质心之外，我们可以选取任意一点作为基点，并将刚体的平面运动分解为 同该基点的平动 与 固连于基点的参考系中关于过该基点的转轴的定轴转动。有趣的是，不论如何如何选取基点，你都能观察到相同的角速度与角加速度（但不一定能得到相同的速度或加速度）！这为解决一些问题带来了极大的方便。比如，分析摆锤的运动。
