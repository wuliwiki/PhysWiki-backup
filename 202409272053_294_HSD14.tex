...
(B)$E \do ,C\uparrow ,U\uparrow ,W\uparrow$
(C)E↓,CTUTDI(D)ET,C↑U↓,W↓
19,在一半径为8的均匀圆柱体内充满磁感应强度为后的均句磁场，这磁场以速率些在减小,如图於4受的金属掉 ab(ab-1<2R)两端的感生电动势6为，
w-受無，a点电势高@安一8点电势高@到”受苦b点电势高四-安要b 点电势高
20.均匀磁场与导体回路法线。的夹角为0=m13，磁感强度8随时间技正比的规律增加，即B=k(k>0)，ab边长为!，且以速度u向右滑动(设t-0时，x=0)，则导体回路内任意时刻感应电动势的大小和方向为:(A)2kxd逆时针方向(B)顺时针方向
2kut
(C)kui! 顺时针方向
(D)hult 逆时针方向
\end{enumerate}