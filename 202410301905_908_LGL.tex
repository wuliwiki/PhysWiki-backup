...
这意味着
\[
dL(\mathbf {Q}, {\dot {\mathbf {Q}}}, t) = dL(\mathbf {q}, {\dot {\mathbf {q}}}, t),~
\]
并且
...
\]
这表明，对于每个 \(\mathbf {q}\)、\({\dot {\mathbf {q}}}\) 和 \(t\)，
\[
\sum_{i=1}^{n} {\frac {\partial L}{\partial {\dot {q}}_{i}}} d{\dot {q}}_{i}
\]
是一个定义良好的线性形式，其系数
\[
{\frac {\partial L}{\partial {\dot {q}}_{i}}}
\]
是共变1-张量。将方程的两边应用于 \({\dot {\mathbf {q}}}\) 并使用上面的公式，对于 \({\dot {\mathbf {Q}}}\) 产生：
