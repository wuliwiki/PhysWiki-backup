...
2．$\mathbb{F}_1=\mathbb{F}_2\mathbb{F}_3 \iff H_1=H_2\cap H_3$；

3．$\mathbb{F}_1=\mathbb{F}_2\cap\mathbb{F}_3 \iff H_1$是包含$H_2\cap H_3$的最小的群．

4．$\mathbb{F}_1$和$\mathbb{F}_2$为共轭域，当且仅当$H_1$和$H_2$在$\opn{Gal}(\mathbb{K}/\mathbb{F})$中共轭．
...
$\mathbb{F}_1=\mathbb{F}_2\mathbb{F}_3\implies \mathbb{F}_1\supseteq\mathbb{F}_2\mathbb{F}_3\implies$
