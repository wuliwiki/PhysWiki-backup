...
可证$S_1$是$R_1$的子群。设任意$a_1,a_2\in S_1$，则$f((a_1-a_2)r)=f(a_1r)-f(a_2r)=f(a_1-a_2)f(r)$，同理$S_2$也是$R_1$的子群。若$a_1\in S_1-S_2,a_2\in S_2-S_1$，则在$S_1$的视角里，$a_1-a_2\in$