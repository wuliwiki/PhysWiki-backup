...
\begin{equation}
\int_a^b M(x)\eta'(x)\dd x=\int_{x_0}^{x_0+\frac{\pi}{n}}M(x)\sin^2[n(x-x_0)]\dd x-\int_{x_1}^{x_1+\frac{\pi}{n}}M(x)\sin^2[n(x-x_1)]\dd x>(d_1-d_2)\int_0^{\frac{\pi}{n}}\sin^2nx\dd x>0
\end{equation}
