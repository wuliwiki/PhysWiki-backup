...
\begin{equation}
\int \pdv{(\rho \bvec u)}{t}\dd V+\int_S\rho \bvec u (\bvec u\cdot \hat{\bvec n})\dd S=\int \rho\bvec g\dd V+\int_S \overleftrightarrow {\bvec T} \cdot \hat n\dd S
\end{equation}
其中 $T$ 是流体的应力张量．可以证明，为了保证角动量守恒，应力张量是二阶对称的张量．
最终我们有矢量表达式
\begin{equation}
