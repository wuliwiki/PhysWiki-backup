...
若在一段时间内， 质点的加速度矢量 $\bvec a$ 不随时间变化（常矢量）， 那么我们说质点做\textbf{匀加速运动（constant acceleration motion）}。 由“\enref{速度、加速度}f{VnA}” 中的\autoref{eq_VnA_7} 和\autoref{eq_VnA_8}， 速度和位移函数分别为
