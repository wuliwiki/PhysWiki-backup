...
其中$\sigma$是应力\upref{STRESS}，$\varepsilon$是应变\upref{Strain}，$E$被称为\textbf{杨氏模量（Young's modulus）}，也叫\textbf{杨氏模数}或者\textbf{弹性模量}， 是用于衡量材料弹性的力学性质。杨氏模量具有压强的量纲（国际单位：帕斯卡\upref{SIunit}）
