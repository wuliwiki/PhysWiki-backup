...
在中心力场问题\upref{CenFrc} 中， 若 $F(r)$ 是平方反比的斥力或引力， 即
\begin{equation}
F(r) = \frac{k}{r^2}  \qquad V(r) = \frac{k}{r}
\end{equation}
则该问题被称为\textbf{开普勒问题}． 对于万有引力 $k = -GMm$， 对于电荷间的库仑引力\footnote{高中所学的库仑定律的系数 $k$ 在大学物理中通常记为 $1/(4\pi\epsilon_0)$， 其中 $\epsilon_0$ 为真空中的电介质常数．} $k = Qq/(4\pi\epsilon_0)$．

在开普勒问题中， 质点的轨道是圆锥曲线的一种， 能量 $E$（质点的动能加势能）和角动量 $L$ 可以唯一地确定轨道的形状和大小． 轨道的形状一般由离心率 $e$ 描述， 大小由半通径 $p$ 描述（\autoref{Cone_eq5}~\upref{Cone}）． $E < 0$ 对应椭圆轨道， $E = 0$ 对应抛物线轨道， $E > 0$ 对应双曲线轨道．
\begin{align}
...
对于\textbf{双曲线}， 偏近点角使用不同的定义， 可取任意实数， 有
\begin{equation}
r = a(e\cosh\xi - 1)
\end{equation}
\begin{equation}
t = \sqrt{\abs{a^3/k}} (e\sinh\xi - \xi)
\end{equation}
