...
\end{aligned}
\end{equation}
由假设，\autoref{eq_ODEUC_3} 的解 $\varphi(t)$存在唯一，且 $r$ 次连续可微的依赖于起始点 $(t_0,y_0)$（即解可写为 $\varphi(t_0,y,t)\equiv\varphi(t)$ 且 $\varphi(x_0,t_0,t_0)=x_0$），于是解也就 $r$ 阶连续可微的依赖于 $(t_0,x_0)$；
