...
由于$f$是反对称的，因此必然至少有两个向量其内积不为$0$，如$f(\bvec \bvec \varepsilon_1,\bvec x_2)=k\neq 0$，设$\bvec {\varepsilon_2}=\frac{\bvec x_2}{k}$并拓展至$V$上的一组基：
\begin{equation}
\varepsilon_1,\bvec \varepsilon_2,\eta_3,...\eta_n~,
\end{equation}
并设$\eta'_3$