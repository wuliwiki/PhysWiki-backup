...
简单来说，某元素 $x$ 在上极限 $U$ 中，当且仅当 $x$ 在\textbf{无穷多个}$A_n$ 中。其实也没那么简单，证明如下：

\begin{corollary}{元素 $ 在上极限 $ 中，当且仅当 $ 在\textbf{无穷多个}$ 中。}
假设$x\in\limsup A_{k}$。那么对于任意的$j$，都有$x\in\bigcup_{k\geqslant j}A_{k}$，即$x$至少属于从第$j$个集合开始的所有$A_{k}$的并集。
\end{corollary}
