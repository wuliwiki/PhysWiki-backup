...
&=\frac{i\lambda m^2}{16\pi^2}\left(\frac{1}{\epsilon}+\frac{1}{2}+\log\left(\frac{\mu}{m}\right) \right)+ i(p^2\delta_Z-\delta_m)
\end{aligned}
\end{equation}
这里我们定义了 $\mu^2=4\pi \tilde{\mu}^2 e^{-\gamma}$
...
(d\rightarrow 4)&=\frac{\lambda}{32\pi^2}\left(\frac{1}{\epsilon}+1-\gamma+\log\left(\frac{4\pi\tilde{\mu}^2}{m^2}\right)\right)
\end{aligned}
\end{equation}
...
&=\frac{i}{2} \cdot \tilde{\mu}^{4-d}\frac{i\Gamma(2-d/2)}{(4\pi)^{d/2}}\int_0^1 \dd x\frac{1}{(m^2-x(1-x)p^2)^{2-d/2}}\\
(d\rightarrow 4)&=-\frac{1}{2(4\pi)^2}\int_0^1 \dd x 
\left(
    \frac{1}{\epsilon}-\gamma+\log(4\pi\tilde{\mu}^2)-\log[m^2-x(1-x)p^2]
...
-3\gamma +3\log(4\pi\tilde{\mu}^2) - \log[m^2-x(1-x)4m^2]
-2\log[m^2]
\right)
\end{aligned}
\end{equation}
