...
我们还可以定义向量空间 $V$ 的 $k$ 次\textbf{张量幂}，$V^{\otimes k}: = V \otimes \dots \otimes V$
\end{definition}
...
设 $V_1,V_2$ 是域 $\mathbb F$ 上的向量空间，$V_1$ 的维数是 $k$，$e_1,\cdots,e_n$ 是 $V_1$ 的一组基。则对 $V_2$ 中任意 $k$ 个元素 $\alpha_1,\cdots,\alpha_n$ ，存在唯一的线性映射 $f:V_1\rightarrow V_2$ 使
\begin{equation}
