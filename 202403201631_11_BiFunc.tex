...
\begin{theorem}{}
设域$K$的特征不为$2$，$V$是域$K$的$n$维线性空间，$f$是$V$上的反对称双线性函数。则存在一组基$\varepsilon_i,\varepsilon_2,\eta_3...\eta_n$，使得$f$的度量矩阵具有如下形式：
\begin{equation}
...
\end{theorem}
\textbf{证明：}
由对称矩阵的性质可知，$n\neq 3$时定理自然成立。下面假设维度小于$n$时成立，需要证明维度为$n$时定理成立。
