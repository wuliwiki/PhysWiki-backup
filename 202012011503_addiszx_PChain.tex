...
\begin{equation}
f[u_1(x_1, \dots, x_N), \dots, u_M(x_1, \dots, x_N)]
\end{equation}
中的某个 $u_i$ 有 $\pdv*{f}{u_i}$ 不恒为零时， 我们说 $f$ \textbf{显含} $u_i$． 特殊地， 当某个 $u_i(x_1, \dots, x_N) = x_j$ 时， 我们就说函数 $f$ \textbf{显含} $x_j$， 否则就说 $f$ \textbf{不显含} $x_j$．
