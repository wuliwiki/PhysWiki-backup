...
\subsubsection{施密特正交化的部分证明}
假设对于给定的 $k$ 必定存在满足\autoref{ScaNrm_eq7} 的一对解， 解空间是 2 维的， 那么 $\psi'_{k,2}$ 必定可以表示为
\begin{equation}
