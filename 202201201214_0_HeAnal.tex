...
&= \frac{1}{r_2} \sum_{L,M,l_2,m_2} \bmat{l_1 & l_2 & L\\ M - m_2 & m_2 & M} \psi_{l_1, l_2}^{L,M}(r_1, r_2) Y_{l_2, m_2}(\uvec r_2)
}\end{equation}
这样\autoref{HeAnal_eq6} 就变为
\begin{equation}
\Psi(\bvec r_1, \bvec r_2) = \frac{1}{r_1} \sum_{l_1, m_1} \psi_{l_1, m_1}(r_1, \bvec r_2) Y_{l_2, m_2} (\uvec r_1)
\end{equation}
单电子概率为
\begin{equation}
\begin{aligned}
