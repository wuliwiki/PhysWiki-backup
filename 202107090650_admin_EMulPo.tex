...
其中常数 $C_{l,m}$ 为
\begin{equation}
C_{l,m} = \frac{1}{(2l+1)\epsilon_0} \int_{r<a} r^l \rho(\bvec r) Y_{l,m}^*(\uvec r) \dd[3]{r}
\end{equation}
...
D_{l,m} = \frac{1}{(2l+1)\epsilon_0} \int_{r>a} \frac{1}{r^{l+1}} \rho(\bvec r) Y_{l,m}^*(\uvec r) \dd[3]{r}
\end{equation}
...
反之， 若电荷分布 $r' > a$， 场点 $r < a$， 那么有 $r_> = r', r_< = r$． 代入\autoref{EMulPo_eq1} 再代入\autoref{EMulPo_eq5} 得\autoref{EMulPo_eq4}．
