...
\end{equation}
那么对于任意$a,b\neq 1$必有$f(a\,b)=(i_a\,i_b)$。因为$f(a\,b)$与$f(1\,a),f(1\,b)$都分别只包含一个相同元素。倘若包含的是$i_1$，即$f(a\,b)=(i_1\,i_k)$，则$f(a\,b)=f(1\,k)$，违背$f$的双射性。所以对于$S_n$，任意$f$实际上指定了一个双射$a\rightarrow i_a$，$i_a$是从1至$n$中指定一个元素。
