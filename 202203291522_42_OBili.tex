...
\end{equation}
而且 $f$ 在 $\langle\bvec e'_1,\bvec e'_2\rangle^{\perp}$ 上的限制是个非退化的斜对称型．事实上，若存在非零向量 $\bvec a\in \langle\bvec e'_1,\bvec e'_2\rangle^{\perp}$ ，使得对任意 $\bvec x_1\in\langle\bvec e'_1,\bvec e'_2\rangle^{\perp}$，都有
\begin{equation}
f(\bvec a,\bvec x_1)=\bvec 0
\end{equation}
那么 $\forall \bvec x=\bvec x_0+\bvec x_1\in V,\bvec x_0\in\langle\bvec e'_1,\bvec e'_2\rangle$，成立
\begin{equation}
f(\bvec a,\bvec x)=f(\bvec a,\bvec x_0+\bvec x_1)=f(\bvec a,\bvec x_0)+
\end{equation}
