...
由于概率振幅是个数字，这提醒我们应该考虑每条路径上的泛函．最直接的想法，当然是使用经典作用量：$\int_{\text{给定路径}}L\dd t$，其中拉格朗日函数$L=\frac{m\dot{x}^2}{2}-V(x)$．然而，折线段的作用量，是各直线段组分的作用量之\textbf{和}；而\autoref{PIntQM_eq2} 中，折线段的概率振幅，是各直线段组分的作用量之\textbf{积}．
