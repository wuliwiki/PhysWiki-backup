...
\begin{gather}
\sin\qty(\frac{x + y}{2})\cos\qty(\frac{x - y}{2}) = \frac12 [\sin x + \sin y]\\
\sin\qty(\frac{x - y}{2})\cos\qty(\frac{x + y}{2}) = \frac12 [\sin x - \sin y]\\
\cos\qty(\frac{x+y}{2})\cos\qty(\frac{x-y}{2}) = \frac12 [\cos x + \cos y]\\
\sin\qty(\frac{x+y}{2})\sin\qty(\frac{x-y}{2}) = \frac12 [\cos y - \cos x]
\end{gather}
