...
\end{equation}
对所有的 $i=0,\cdots,k$ 满足 $v_{i-1},v_{i}\in e_{i}$，则称 $W$ 是 $G$ 中的端点为 $v_0,v_n$ \textbf{链}（chain）或\textbf{途径}（walk）。$v_0,v_n$ 称作 $W$ 的端点（end vertex），其余的点称作 $W$ 的\textbf{内点}（internal vertex）。 
\end{definition}
