...
\footnote{参考 \cite{Goldstein} 第三章．}开普勒问题中若已知轨道形状\upref{Keple1}， 我们来计算质点在轨道上的位置如何关于时间变化． 直观上我们可以使用开普勒第二定律\upref{Keple}使用扫过的面积推导出从出发点到达任意位置所需的时间． 但这里介绍对半径做定积分的方法， 二者的结果是一样的．
