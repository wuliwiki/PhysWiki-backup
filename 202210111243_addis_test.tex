...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/test_2.png}
\caption{Winding Mountain Road} \label{test_fig2}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/test_3.png}
\caption{Individual Tree} \label{test_fig3}
\end{figure}
