...
在法拉第电磁感应定律\upref{FaraEB}中我们已经了解了“变化的磁场会产生电场”，那么反过来，“变化的电场也会产生磁场”吗？充满着简洁与对称美的电动力学给出了肯定的答案．
...
\end{equation}
为\textbf{位移电流（displacement current）}．这使得\autoref{DisCur_eq2} 还可写作
\begin{equation}
...
广义安培环路定律事实上是电动力学的基本假设之一， 所以以下并不是推导， 而是一种把安培环路定律拓展到非静电学情况的可能思路．我们可以从思想实验，或者电荷守恒与安培环路定律中得到一些启发．
