...
如之前所说，这个定义和椭圆的定义几乎没有什么区别。另外，关于 \autoref{ex_Hypb3_1} 还有几点需要特别注意：
...
\item 对于 \autoref{eq_Hypb3_3}，令 $y=0$ 时，得到图像与 $x$ 轴的两个交点，采用\autoref{eq_Hypb3_10} 的记法为：
\begin{equation}
x = \pm a~.
\end{equation}
...
y = \pm  b\I~.
\end{equation}
这与椭圆存在显著的区别：标准椭圆的图像与坐标轴有四个交点，而这里的双曲线仅在 ，与 $y$ 轴并没有交点。
\end{itemize}
