...
由于许多人有误解， 我们首先强调这个编辑器只是在 \href{https://www.mathjax.org/}{MathJax} 的基础上做了一个简单的拓展， MathJax 只支持公式环境， 我们另外实现了基本的 LaTeX 命令， 如标题， 粗体， 常用的环境（简单的表格， 定理， 例题， 习题等）， 以及对一些环境和公式的引用． 编辑器只支持唯一一种模板（见 main.tex），
