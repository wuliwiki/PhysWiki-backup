...
\subsection{线性方程组的几何含义}
可以分别从行与列的角度来理解线性方程组的几何含义．\footnote{本节参考了Gilbert Strang的《线性代数》课程．}更深刻、数学的表示可以见线性方程组的仿射解释\upref{AS2LF}．
...
\begin{corollary}{$\mat A \bvec x=\bvec 0$解的唯一性}
...
\begin{theorem}{}
若$\bvec y$是$\mat A$的列向量的线性组合($\bvec y \in Col(\mat A)$)，则$\mat A \bvec x=\bvec y$一定存在解．
\end{theorem}
...
\begin{theorem}{解的结构}
$\mat A \bvec x=\bvec y$的解等于$\mat A \bvec x=\bvec y$的一个特解加上$\mat A \bvec x=0$的各个线性无关的解的线性组合．
