...
\begin{equation}
\dd s^2=H_1\dd u^2+H_2\dd v^2+H_3\dd w^2
\end{equation}
其中
\begin{equation}
\begin{aligned}
&H_1^2=\qty(\pdv{\varphi_1}{u})^2+\qty(\pdv{\psi_1}{u})^2+\qty(\pdv{\omega_1}{u})^2\\
&H_2^2=\qty(\pdv{\varphi_1}{v})^2+\qty(\pdv{\psi_1}{v})^2+\qty(\pdv{\omega_1}{v})^2\\
&H_3^2=\qty(\pdv{\varphi_1}{w})^2+\qty(\pdv{\psi_1}{w})^2+\qty(\pdv{\omega_1}{q}\Big)^2
\end{aligned}
\end{equation}
\end{definition}
