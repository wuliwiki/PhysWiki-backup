...
利用这一约定，则可将\autoref{eq_OpSet_1} 翻译成下面定理
\begin{theorem}{}
\begin{equation}
\begin{aligned}
&\qty((x\in X)\land y\in Y)\lor z\in Z=(x\in X\lor z\in Z)\land(y\in Y\lor z\in Z),\\
&\qty((x\in X)\lor y\in Y)\land z\in Z=(x\in X\lor z\in Z)\land(y\in Y\lor z\in Z)~.
\end{aligned}
\end{equation}
