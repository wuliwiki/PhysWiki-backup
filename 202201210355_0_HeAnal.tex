...
\end{equation}
根据选择定则， $n_1 = 2$ 时共有 5 个分波 $(n_1,l_1,m_1,l_2,m_2) = (2, 0, 0, 1, 0)$， $(2,1,0,0,0)$， $(2,1,0,2,0)$， $(2,1,\pm 1, 2,\mp 1)$． 对于 $(n_1, l_1) = (2, 1)$ 以及 $z$ 方向， $m_1 = -m_2 \ne 0$ 时 $Y_{l_2,m_2}(\uvec z) \equiv 0$
