...
\subsection{吉布斯能判据}
可以与亥姆霍兹自由能\upref{HelmF}类比，亥姆霍兹自由能判据适用于等温等容系统，而吉布斯自由能适用于等温等压系统．

\textbf{对于一个恒温恒压过程，系统对外做的非体积功小于（不可逆过程）或等于（可逆过程）吉布斯自由能减小量}．\footnote{非体积功是除去 $p\dd V$ 外其余形式的做功，例如电场、磁场做功$-H\dd M$，$-E\dd P$ 等．}
\begin{equation}
\delta w \le -\Delta G
\end{equation}
