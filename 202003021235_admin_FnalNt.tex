...
\item 任何有限维赋范空间都是可分的的．

\item 令 $X$ 为可分的赋范空间． 存在一个序列 $\qty{X_n}$ of finite-dimensional linear subspaces $X_n$ of $X$ such that $X_1 \subseteq X_2 \subseteq \dots \subseteq X$ and $\bigcup_{n=1}^\infty X_n = X$
