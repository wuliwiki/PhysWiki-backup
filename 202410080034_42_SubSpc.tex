...
\begin{lemma}{}
设 $U,W$ 分别是 $k,l$ 维的子空间，$(a_1,\cdots,a_m)$ 是 $U$ 的基，$(b_1,\cdots,b_m)$ 是 $W$ 的基，那么
\begin{equation}
U+W=\langle a_1,\cdots,a_m;b_1,\cdots,b_m\rangle~.
\end{equation}
其中
\begin{equation}
\langle a_1,\cdots,a_m;b_1,\cdots,b_m\rangle:=\qty{\sum_{i=1}^m\alpha_i a_i+\sum_{i=1}^l\beta_i b_i\Bigg|\alpha_i,\beta_i\in \mathbb F}.~
\end{equation}
