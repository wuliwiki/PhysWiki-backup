...
$\mathbb{M}/\mathbb{F}$是正规扩张$\iff$对于任意$\sigma\in\opn{Gal}(\mathbb{K}/\mathbb{F})$，都有$\sigma\mathbb{M}=\mathbb{M}$ $\iff$ 对于任意$f\in\opn{Gal}(\mathbb{K}/\mathbb{M})$，都有$\sigma\circ f \circ \sigma^{-1}$
