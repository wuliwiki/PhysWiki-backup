...
不过，由于偏导数的对称性，结合求和约定，我们知道$X^aY^b\frac{\partial^2}{\partial a\partial b}=Y^bX^a\frac{\partial^2}{\partial b\partial a}$，因此：
\begin{equation}
\begin{aligned}
XY-YX&=X^a\frac{\partial}{\partial a}(Y^b\frac{\partial}{\partial b})-Y^b\frac{\partial}{\partial b}(X^a\frac{\partial}{\partial a})\\
&=X^a(\frac{\partial Y^b}{\partial a})\frac{\partial}{\partial b}+X^aY^b\frac{\partial^2}{\partial a\partial b}-
\end{aligned}
\end{equation}
