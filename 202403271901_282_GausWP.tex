...
\caption{根据\autoref{eq_GausWP_4} 画出的 $t > 0$ 的高斯波包， 蓝色为实部， 红色为虚部。 动画见\href{https://wuli.wiki/apps/free_gauss.html}{这里}， Matlab 代码见 “自由高斯波包（量子）的动画绘制（Matlab）\upref{FreeGs}”， 互动见\href{https://wuli.wiki/apps/gausWP.html}{这里}）， 注意从左到右频率逐渐变高， 这种现象叫做啁啾（chirp）。} \label{fig_GausWP_1}
\end{figure}
