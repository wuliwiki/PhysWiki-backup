...
另外有
\begin{equation}
\bvec a^{2n} = (0, \bvec a)^{2n} = ((-1)^n\abs{\bvec a}^{2n},\  \bvec 0) \qquad (n = 0,1,2\dots)
\end{equation}
\begin{equation}
\bvec a^{2n+1} = (0, \bvec a)^{2n+1} = (0,\ (-1)^n\abs{\bvec a}^{2n}\bvec a) \qquad (n = 0,1,2\dots)
\end{equation}
这里 $\bvec a^{n}$ 的记号可能会产生歧义（区分于例如 $\bvec a^2 = \bvec a\vdot\bvec a$）， 但从语境中不难区分．
