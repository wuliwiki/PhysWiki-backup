...
\end{align}
要证明\autoref{COrNoB_eq7}， 只需要使用狄拉克 $\delta$ 的性质（\autoref{Delta_eq7}~\upref{Delta}） $\int \delta(x - x_0) f(x) \dd{x} = f(x_0)$ 即可
要证明， 我们可以把\autoref{COrNoB_eq7} 看成定义， 来证明\autoref{COrNoB_eq9} ：
