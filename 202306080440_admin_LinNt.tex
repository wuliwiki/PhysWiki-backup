...
\item 所以作为系统管理员，要想让不同组的用户可以访问不同的文件夹，那就首先把这个文件夹本身的权限设为 \verb|2750|， owner 设为 \verb|root|， 组设为可以访问的组。 所有子文件夹和文件权限分别设为 \verb|2775| 和 \verb|664|， 组设为可以访问的组。 每个用户的 \verb|~/.bashrc| 中 \verb|umask| 设为 \verb|002| （默认为 022）。
