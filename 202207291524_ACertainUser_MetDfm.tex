...
如图所示，外力F在滑移方向上的分力\footnote{在材料科学中，往往更关注“一点处的力的大小”，类似于压强的概念，因此要除以力作用面的面积．常记为$\sigma=\frac{F}{A}$}为 
$$\tau=\frac{F \cos \lambda}{A/{\cos \phi}}=\frac{F}{A}{\cos \lambda}{\cos \phi}$$
如果临界切分应力为$\tau_k$，那么外力至少得达到 $F_k=\frac{\tau_k A}{\cos \lambda \cos \phi} $