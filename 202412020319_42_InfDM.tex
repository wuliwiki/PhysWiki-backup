...
&0,\quad j=m\\
&\frac{\pi}{2L}(-1)^{(j-m)}\cot[2\pi(j-m)/N],j\neq m
\end{aligned}\right.~
\end{equation}
...
\begin{equation}
\begin{aligned}
w_j=p'(x_j)=\frac{\pi}{2L}\sum_{m=1,m\neq j}^{N}(-1)^{(j-m)}\cot[2\pi(j-m)/N]u(x_m)
\end{aligned}~
\end{equation}
因此，差分矩阵为
\begin{equation}
\frac{\pi}{2L}
\begin{pmatrix}
0&\cot(2\pi/N)&-\cot(4\pi/N)&\cdots&\cot(2(N-1)\pi/N)\\
-\cot(2\pi/N)&\ddots&\ddots&\ddots&\ddots\\
\cot(4\pi/N)&\ddots&\ddots&\ddots&\ddots\\
\vdots&\ddots&\ddots&\ddots&\ddots\\
-\cot(2(N-1)\pi/N)&\ddots&\ddots&\ddots&\ddots\\
\end{pmatrix}.~
\end{equation}
