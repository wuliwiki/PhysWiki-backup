...
\end{equation}
另外，可以证明，对动量的变换等价与对坐标的变换$R = (r_1+r_2)/2,r=(r_1-r_2)/2$，或$r_1 = ()$
\begin{equation}
\frac{\partial \psi}{\partial r} = \frac{\partial \psi}{\partial r_1} \frac{\partial r_1}{\partial r} + \frac{\partial \psi}{\partial r_2} \frac{\partial r_2}{\partial r}
\end{equation}
