...
$Z = 1$ 时 $r R_{l,m}(r)$ 的函数图\footnote{我们以后会看到 $r R_{l,m}(r)$ 比 $R_{l,m}(r)$ 更常用}\footnote{我们以后会看到 $r R_{l,m}(r)$ 比 $R_{l,m}(r)$ 更常用}如\autoref{HWF_fig1}
\begin{figure}[ht]
\centering
...
\end{equation}
更多 $R_{n,l}$ 可以用 Mathematica 或者 Wolfram Alpha 生成， 如% 链接未完成
