...
给定四元数$A=a_0+a_1\I+a_2\J+a_3\K$、$B=b_0+b_1\I+b_2\J+b_3\K$和$C=c_0+c_1\I+c_2\J+c_3\K$，则
\begin{equation}
    A(BC) = (AB)C. ~
\end{equation}
...
\begin{equation}
    \begin{aligned}
        A(BC) ={}& (a_0+a_1\I+a_2\J+a_3\K)\times\\
        &\qty((b_0+b_1\I+b_2\J+b_3\K)(c_0+c_1\I+c_2\J+c_3\K))\\
        ={}& (a_0+a_1\I+a_2\J+a_3\K)\times\\
        (&(b_0c_0-b_1c_1-b_2c_2-b_3c_3)+\\
        &(b_0c_1+b_1c_0+b_2c_3-b_3c_2)\I+\\
        &(b_0c_2+b_2c_0+b_3c_1-b_1c_3)\J+\\
        &(b_0c_3+b_3c_0+b_1c_2-b_2c_1)\K)\\
        ={}& (a_0b_0c_0-a_0b_1c_1-a_0b_2c_2-a_0b_3c_3)
    \end{aligned}~
\end{equation}
\textbf{证毕}。
