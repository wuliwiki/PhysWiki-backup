...
\begin{equation}
\frac{1}{r_1}\sum_{l_1,m_1} \qty[\frac{1}{r_2}\sum_{l_2,m_2} \psi_{l_1,l_2}^{m_1,m_2}(r_1, r_2) Y_{l_2,m_2}(\uvec r_2)] Y_{l_1,m_1}(\uvec r_1)
\end{equation}

中括号中的内容逐项投影到库仑平面波上得 $\psi_{l_1,m_1}(r_1)$
\begin{equation}
\braket{\psi_{\bvec k_2}(\bvec r_2)}{\Psi(\bvec r_1, \bvec r_2)}
\end{equation}
