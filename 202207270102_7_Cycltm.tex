...
设素数$p$满足$p\mid k$，则$p\not\mid n$，因此$\alpha_0^p$是$n$次本原单位根．显然，$\Phi_n(\alpha_0^p)=0$，即$f(\alpha_0^p)$和$g(\alpha_0^p)$中至少一个为零．设$f(\alpha_0^p)=0$，那么$\beta_0=\alpha_0^k=(\alpha_0^p)^{k/p}$．由于$k/p<k$，故这违反了$$
