...
\end{equation}
由于只有 $m_1 + m_2 = M$ 时 CG 系数才不为零， 公式中令 $m_2 = M - m_1$， 求和就由双重求和变为了单个求和． $m_1$ 的上下限满足 $-l_1 \leqslant m_1 \leqslant l_1$， $-l_2 \leqslant M-m_1 \leqslant l_2$ 即
\begin{equation}
\max\{\}\leqslant m_1 \leqslant
\end{equation}
