...
假设线性无关组$\{\bvec{v}_i\}_{i\in\Gamma}$张成空间$V$．$V$中的每一个矢量都可以表示成$\{\bvec{v}_i\}_{i\in\Gamma}$中矢量的某个线性组合，并且由于线性无关，这种表示方法还是唯一的．这时，我们称这个线性无关组是$V$的一个\textbf{基}，基中的矢量都称为一个\textbf{基向量}．
