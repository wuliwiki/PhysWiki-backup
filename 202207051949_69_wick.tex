...
\pentry{标量场的量子化\upref{quanti}，标量场的谱\upref{spectr}，克莱因-戈登传播子\upref{Klein}}
...
对于四个场算符构成的格林函数，$\bra 0 T\phi(x)\phi(y)\phi(z)\phi(w)\ket 0$，用类似的推导，可以将每个场算符分解为正频率部分和负频率部分，