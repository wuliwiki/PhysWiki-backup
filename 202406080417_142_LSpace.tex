...
（二维、三维）欧几里得空间和列向量空间都是特别的向量空间，对应的向量为\enref{几何向量}{GVec}和列向量「\upref{colVec}
这里的“向量”是\enref{几何向量}{GVec}的抽象，反过来，几何向量是向量的具象（特例）。一个广义的向量，不一定具有长度和方向，例如下面会看到函数也可以看作向量。
