...
显然，他们分别是$\tan x,\cos x,\sin x$的倒数。需要注意的是，尽管余割的英文是Cosecant，也是加了co的前缀。但他的简写不是cos，因为已经用来表示余弦了。所以另外选取第1，3，5位的字母，用csc来表示余割。
...
首先研究的角$\alpha$如\autoref{fig_HsTrFu_5} 所示，称作正角，在之前学习过，两个角互余就是他们的角度之和为$90^\circ$，也就是说余角是垂角减去正角后剩余的角。
然后是弦、切、割的概念，对于圆而言\footnote{关于曲线的切线和割线可以参见\enref{切线与割线}{TanL}。}：
\begin{itemize}
\item 连接圆上两点的线段，称作弦。
\item 过圆外一点作直线，与圆交于相异两点，称作割线。
\item 过圆外一点作直线，与圆交于唯一一个点时，称作切线。
\end{itemize}


正余弦，正余切，正余割，分别对应特定的弦，切线，割线的长度。
如果把弦和弧的组合看做一把“弓”的话，矢的位置正好就是这把弓上的“箭”
