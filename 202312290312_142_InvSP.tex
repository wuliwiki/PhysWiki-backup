...
设 $U$ 的基底为 $(e_1,\cdots,e_m)$ ，$W$ 的基底为 $(e_{m+1},\cdots,e_n)$，则由\autoref{the_DirSum_1}~\upref{DirSum}，$(e_{1},\cdots,e_n)$ 是 $V$ 的基底。
...
\end{aligned}
\end{equation}
我们有 $\mathcal{A}|_U$ 在基底 $(e_1,\cdots,e_m)$ 下表示成 $A_U$，对 $W$ 也是类似，因此算子 $\mathcal{A}$ 的对应矩阵 $A$ 即为 
\begin{equation}
...
假设在基底 $(e_1,\cdots,e_n)$ 下，$\mathcal{A}$ 可以被表示成$A = \begin{pmatrix}
A_U & 0\\
0 & A_W
\end{pmatrix}$的形式，其中 $U=\langle e_1,\cdots,e_m\rangle$ 和 $W=\langle e_{m+1},\cdots,e_n\rangle$ 

任选 $V$ 的基底 $(e_1,\cdots,e_n)$，即得 $A$ 对应的算子 $\mathcal{A}$ 具有关系式\autoref{eq_InvSP_2} 。而这意味着由基底 $(e_1,\cdots,e_m)$ 和 $(e_{m+1},\cdots,e_n)$ 张成的空间  是算子 $\mathcal{A}$ 的不变子空间，而由基底 $(e_1,\cdots,e_n)$ 的线性无关性可知，$V=U\oplus W$。
