...
我们需要清楚广义能量函数的意义．首先，势能$V$是与广义速度无关的，因此$H$的定义式\autoref{motint_eq2}中的$\dfrac{\partial L}{\partial \dot{q_\alpha}}$．可代之以$\dfrac{\partial T}{\partial \dot{q_\alpha}}$．
...
例如，在匀速直线运动的汽车中有一谐振子在光滑水平槽中往返振动取q 轴沿振动
方向，原点在谐振子的平衡点选这汽车为参考系，可以认为这是惯性系于是，谐振子的
L = T - V = mc//2 - k沪/2 易见8L/况= 0, 所以H 守恒另一方面，由于动能
T = mc//2 是广义速度q 的二次单项式，所以H 就是机械能．诚然， H=pq-L=
(8L/8q)q - L = mq2 /2 + kq2 /2 = T + V
改取地面为参考系，这也可认为是惯性系如果谐振子的振动槽平行于汽车行进方向，则
谐振子的L=T — V = m(q + vo)2 /2 - kq2 /2 = mq2 /2 + mvoq + mvJ/2 - kq2 /2, 其中v．
是汽车的速度因8L/8t = 0, 所以H 守恒但动能T 不是q 的二次齐次式，所以H 并非
机械能事实上， H = pq- L = m(q + vo)<i- L = mq2 /2 - mvJ/2 + kq勹2-=JT+V
如果汽车并非匀速，而是匀加速，其速度为at 仍以地面为参考系，则谐振子的L=
m(q+at) 勹2 — kq2 /2 这时8L/8t =J 0, 所以H 不守恒另一方面T 不是q 的二次齐次
式所以H 也不是机械能事实上， H=m扩/2 - ma2们2 + kq2 /2 =/ T + V
\end{example}
