...
在量子力学中， 由于普朗克常数 $\hbar$ 大量出现， 我们希望它在原子单位下等于 $1$， 即 $\beta_L = \hbar$． 注意 $\hbar$ 具有角动量量纲． 令角动量公式 $\bvec L = m \bvec r \cross \bvec v$ 在原子单位下依然成立， 那么 
\begin{equation}
...
1 = \frac{\beta_m \beta_x^2}{\hbar \beta_t}
\end{equation}
