...
令$p: E\to X$是一个唯一地定义在空间$X$上的纤维丛\upref{Fibre}，纤维为$F^n$．取道路$\gamma: (0, 1)\to X$\footnote{译注：同样据该百科的\href{https://encyclopediaofmath.org/wiki/Path}{道路}，道路的定义应该是闭区间$[0, 1]$上的映射．}
