...
量子力学认为量子态构成一个\enref{希尔伯特空间}\upref{Hilber}，其中互为倍数的量子态是等价的（\autoref{def_QMPrcp_2}~\upref{QMPrcp}）。为了方便，我们可以限定只讨论模为$1$的那些量子态，也可以说我们讨论的不是矢量，而是\textbf{射线（ray）}。当然，如果觉得射线的语言不好理解，也可以只考虑归一化的态矢，不影响对定理的理解和表述。
