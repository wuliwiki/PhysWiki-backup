...
\item 11.4 $R^p$ 中的\textbf{区间（interval）}指的是满足 $a_i\leqslant x_i\leqslant b_i$（$i=1,\dots,p$） 的点 $x=(x_1,\dots,x_p)$ 的集合， 或者把任意或全部 $\leqslant$ 改为 $<$ 的集合． 若 $A$ 是有限个区间的并， 就说 $A$ 是\textbf{初等集（elementary set）}．
