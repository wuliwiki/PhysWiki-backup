...
\begin{equation}
\begin{aligned}
&T\dd(Nk(\ln Z_1-\beta\frac{\partial }{\partial \beta}\ln Z_1))=-\dd(N \frac{\partial \ln Z_1}{\partial \beta})+\frac{N}{\beta}\frac{\partial \ln Z_1}{\partial y}-\mu\dd N\\
&kT(\ln Z_1-\beta\frac{\partial }{\partial \beta}\ln Z_1)=\mu
\end{aligned}
\end{equation}
