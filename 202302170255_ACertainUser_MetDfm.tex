...
\end{figure}
原子\footnote{我们此处假设物体是直接由原子组成的。实际物体还可以由分子、离子组成，但这并不影响此处的定性结论}依靠原子间作用力（或者说，键\footnote{根据强度与具体机制等，键可以再细化为化学键（金属键、共价键、离子键）与分子间作用力等}）连接在一起。原子间作用力的具体机制非常复杂，但简化的来说，原子间作用力可以理解为一组电荷交互作用，包括电子间的排斥力与原子核对电子的吸引力。
...
这对吸引力与排斥力保持了一种微妙的平衡。当物体不受外力时，吸引力与斥力最终将相同并让合力为零，这使原子在不受外力的作用下保持一定的平衡间距。而当外力试图拉开原子时，吸引力大于斥力，合力倾向于吸引被拉开的原子；同样的，当外力试图压缩原子时，合力倾向于弹开被压缩的原子。这就是为什么物体体现出抵抗外力作用的“弹性”。

这也能解释为什么固体能保持形态，而液体、气体却相对松散：固体中粒子间的作用力远远强于气体、液体。
