...
\caption{不相交并集：\(\{(n,0) : n \in \mathbb{N}\} \ \cup \ \{(n,1) : n \in \mathbb{N}\}\)在最不重要位置优先的**字典序**下，其序型为 \(\omega \cdot 2\)。这个序型不同于\(\omega\)。} \label{fig_Ordina_1}
\end{figure}
\begin{figure}[ht]
\centering
...
不相交并集：\(\{(n,0) : n \in \mathbb{N}\} \ \cup \ \{(n,1) : n \in \mathbb{N}\}\)在最不重要位置优先的**字典序**下，其序型为 \(\omega \cdot 2\)。这个序型不同于\(\omega\)。