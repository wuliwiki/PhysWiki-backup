...
由于 $A,B$ 两粒子体系的量子态是自选单态，在对 $A$ 作测量时，根据正统量子力学，$B$ 粒子的状态“似乎也发生了坍缩”．例如当 $A$ 粒子测得的 $S_z=1/2$ 时，$B$ 粒子测得的 $S_z$ 就一定是 $-1/2$，这是两电子的总自旋为 $0$ 的必然要求．那么，似乎有一种鬼魅般的超距作用在起作用．这是否符合我们对因果律的认知呢？是否真的存在某种非定域的超距作用？又似乎如同爱因斯坦所说的那样存在某个超出量子力学之外的隐变量能够解释这一切？