...
$\mathbb{R}$有一个拓扑基$\mathcal{B}=\{(a,b):a,b\in \mathbb{R}\}$，也就是说，$\mathcal{B}$是全体开区间的集合．对于集合$(0,1)$，我们可以取开覆盖$\{(-1,1/3)\cup(2/3,2), (1/4, 3/4)\}$，这个开覆盖中包含了两个开集．但是这个覆盖也可以看成是三个开区间构成的，而这三个开区间都来自$\mathcal{B}$．
