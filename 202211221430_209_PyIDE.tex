...
Miniconda是一款python环境管理工具，其安装程序中包含conda软件包管理器和Python．

优点：占用内存小

缺点：

Miniconda 官方下载地址：https://docs.conda.io/en/latest/miniconda.html#．注意：Miniconda 和 Python 版本是一一对应关系，请根据实际情况（Python版本）选择 Miniconda 版本．
