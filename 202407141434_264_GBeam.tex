...
(\nabla^2+k^2)\bvec E=0~.
\end{equation}
这里的$\bvec E$是指电场的空间分量，即$\bvec E(x,y,z)$。完整的表达式是$\bvec E(x,y,z,t)=\bvec E(x,y,z)\E^{\I \omega t}$，但我们研究的是空间分布，所以不需要管电场随时间的变化，下文中的$\bvec E$均指得是不带时间分量的那个，即$\bvec E(x,y,z)$。此外，在我们的推导中，光线都是在均匀介质中的，没有色散，也没有非线性，所以\autoref{eq_HHeq}成立，并且适用于电场任何一个空间分量，下文中将用$E$来指代$\bvec$
