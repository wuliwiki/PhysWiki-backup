...
自由粒子的拉格朗日函数\upref{FPLSR}为$L(t, x^i, \dot{x}^i) = -mc^2\sqrt{1-\frac{1}{c^2}\dot{x}^i\dot{x}^jg_{ij}}$．如何添加一个“相互作用”的项呢？注意到和粒子有关的部分是$\sqrt{1-\frac{1}{c^2}\dot{x}^i\dot{x}^jg_{ij}}$，我们带着这部分，简单地把标量场$\phi$加进去试试：
