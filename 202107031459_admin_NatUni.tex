...
普朗克单位制并不规定电磁学常数， 但我们可以创造一套． 首先令库仑定律为
\begin{equation}
F = \frac{q_1q_2}{r^2}
\end{equation}
得
\begin{equation}
\beta_q = 2\sqrt{\pi\epsilon_0 c\hbar}
\end{equation}
令
\begin{equation}
F = Eq
...
\hline
\dfracH 电场强度 $\dfrac{c^4}{2G\sqrt{\pi\epsilon_0 c\hbar}}$ & $\dfrac{e}{4\pi \epsilon_0 a_0^2}$ & 基态轨道电场强度 & $5.1422067070\e{11}$ \\
\hline
