...
由于 $d \geq 0$，我们考虑 $d^2$，将 \autoref{eq_Hypb3_24} 和 $c^2 = a^2 + b^2$（即 \autoref{eq_Hypb3_12}）代入得：
...
\end{split}
\end{equation}
显然，\autoref{eq_Hypb3_25} 在$\displaystyle x_0=\frac{a^2}{c}$处取到极小值，但由于$c>a$，$\displaystyle x_0=a\frac{a}{c}<a$并不在双曲线上。由于\autoref{eq_Hypb3_25} 在$(\displaystyle\frac{a^2}{c},+\infty)$上单调递增，因此在$x_0=a$处取到最小值。
\end{example}
