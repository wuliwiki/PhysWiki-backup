...
\item 矢量的坐标表示为实数或复数的笛卡尔积\autoref{Set_eq1}~\upref{Set}（如 $\mathbb R^N, \mathbb C^N$ 或 $(c_1, c_2, c_3)$）， 也可以表示为列矩阵（如 $\bvec c, \bvec x$）以便和矩阵相乘（如线性方程组记为 $\bvec y = \mat A \bvec x$）．
