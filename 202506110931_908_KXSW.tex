...
\textbf{C*-代数上正泛函的柯西–施瓦茨不等式}[23][24]——若 $\varphi$ 是 C\*-代数 $A$ 上的正线性泛函，则对所有 $a, b \in A$，有：
$$
...
\textbf{Kadison–Schwarz 不等式}[25][26]（以理查德·卡迪森命名）——若 $\varphi$ 是一个单位正映射，则对于其定义域内的任意正规元 $a$，都有：$\varphi (a^{*}a)\geq \varphi \left(a^{*}\right)\varphi (a)
$$
