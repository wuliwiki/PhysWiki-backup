...
由\enref{数乘的连续性}{tvs}，任意零邻域 $U$，存在 $x$ 的邻域 $U_x$ 和 $\delta>0$，使得 $[-\delta,\delta]\cdot U_x\subset U$。由于 $\{x_n\}\rightarrow x,\{t_n\}\rightarrow0$，所以存在 $N_1,N_2>0$，使得只要 $n_1\geq N_1,n_2\geq N_2$，就有 $x_{n_1}\in U_x,t_{n_2}\in[-\delta,\delta]$。取 $N=\max\{N_1,N_2\}$，则 $n>N$，成立
