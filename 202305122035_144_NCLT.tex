...
形成晶胚的过程中，虽然液-固相变降低了体积自由能，但新产生的相界面又提高了表面自由能，二者间存在竞争。因此，形成晶胚前后，系统总自由能变化： 
...
那么，这一小晶胚能否顺利长大？这取决于晶胚长大的过程是否能继续降低系统的自由能。仔细分析 \autoref{eq_NCLT_1} ，或者观察\autoref{fig_NCLT_2} ，我们就会发现，只有当晶胚的初始半径r大于某个半径时，自由能减少的方向才是晶胚自发长大的方向，否则晶胚将自发衰亡。此半径称为\textbf{临界形核半径}。
\begin{figure}[ht]
\centering
