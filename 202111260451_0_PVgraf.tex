...
根据理想气体状态方程\upref{PVnRT}， 我们可以得知给定量的理想气体的宏观状态只有两个自由度\upref{DoF}． 在\autoref{StaPro_ex2}~\upref{StaPro} 中我们说到可以在压强 $P$， 体积 $V$， 温度 $T$ 等宏观量中任取两个来作为该系统的状态量， 完全确定系统的宏观状态． 而最常见的作法是取压强和体积 $P,V$． 于是自然地， 我们可以用一个二维直角坐标系 $P$-$V$ 中的一点来描绘理想气体的状态． 该平面就是理想气体的（宏观）状态空间．
