...
$\bvec k$可以取任意值吗？从直觉上这是不可能的，一方面无限大动能的电子不存在，另一方面如果电子动能很大，它早就跑出晶体了。所以我们需要考虑$\bvec k$ 满足的限制条件：周期平移不变性。实际晶体不是无穷大的，周期性平移电子总会跑出晶体之外，这该怎么办？物理学家常用的处理方法是将其“绕回去”：设晶格在三个方向上的原胞数量分别为 $N_1,N_2,N_3$，则平移$N_1$个原胞后得到的波函数与初态相同，又回去了：
\begin{equation}
...
\end{equation}
其中$\bvec b_1, \bvec b_2,\bvec b_3$ 是倒格基矢。利用倒格基矢与
