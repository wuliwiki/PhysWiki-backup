...
结合前面对实解与虚解的讨论，这里也引入“实轴”与“虚轴”的概念。双曲线与坐标轴的交点称为顶点，连接两顶点的线段称为实轴，长度为 $2a$，其中 $a$ 被称为半实轴。双曲线的两个焦点始终位于实轴上。

将复数解对应的虚数部分在另一条坐标轴上标记，得到虚顶点，两虚顶点之间的线段称为虚轴，长度为 $2b$，其中 $b$ 称为半虚轴。
