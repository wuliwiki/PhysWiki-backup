...
设三维空间中 $z=0$ 下方是导体，$z=0$ 上方是真空．在 $(0,0,a)(a>0)$ 处有一个电荷量为 $+q$ 的电荷．求 $z=0$ 处导体面的电荷密度分布．用 Dirichlet Green 函数、电像法都能解答此问题．这里我们举一个使用 Neumann 格林函数的例子．
...
\begin{equation}
\phi(\bvec r)=\frac{1}{4\pi\epsilon_0}\frac{q}{|\bvec r-\bvec r_1|}+\frac{1}{4\pi\epsilon_0}\frac{q}{|\bvec r-\bvec r_2|}+\frac{1}{2\pi}(\frac{1}{|\bvec r-\bvec r_1|})
\end{equation}
