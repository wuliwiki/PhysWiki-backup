...
由于Pauli 矩阵与单位矩阵$I$ 一起，构成了所有 $2 \times 2$ 复矩阵
$$
\mathcal{M}_{2,2}(\mathbb{C})~
$$
的Hilbert 空间的一个正交基，因此，任意一个$2 \times 2$复矩阵$M$都可以表示为：
$$
M = c I + \sum_k a_k \sigma^k,~
$$
其中：$c$ 是一个复数，$\vec{a} = (a_1,a_2,a_3)$ 是一个三维复向量。

利用Pauli矩阵的性质，可以很容易得出：
$$
