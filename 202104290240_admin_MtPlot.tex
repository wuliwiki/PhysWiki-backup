...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_9.png}
\caption{请添加图片描述} \label{MtPlot_fig9}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_10.png}
\caption{请添加图片描述} \label{MtPlot_fig10}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_11.png}
\caption{请添加图片描述} \label{MtPlot_fig11}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_12.png}
\caption{请添加图片描述} \label{MtPlot_fig12}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_13.png}
\caption{请添加图片描述} \label{MtPlot_fig13}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_14.png}
\caption{请添加图片描述} \label{MtPlot_fig14}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_15.png}
\caption{请添加图片描述} \label{MtPlot_fig15}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_16.png}
\caption{请添加图片描述} \label{MtPlot_fig16}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MtPlot_17.png}
