...
\item 弗雷德里克·萨吕斯（Frédéric Sarrus）**（1828年），*Mémoire sur les oscillations des corps flottans*（《漂浮物体振荡的备忘录》），*纯粹与应用数学年刊*（尼姆），第19卷，第185–211页。
\end{itemize}
...
\item 此外，可参考以下文献：
* **J.A. Wheeler；C. Misner；K.S. Thorne**（1973年），*Gravitation*（《引力论》），W\.H. Freeman & Co.，第85–86页，第3.5节，ISBN 978-0-7167-0344-0。
