...
\subsection{自然运算} 
序数的自然和（natural sum）和自然积（natural product）由Gerhard Hessenberg于1906年定义，有时也被称为Hessenberg和或Hessenberg积（Sierpiński 1958）。自然和通常记作\(\alpha \oplus \beta\)或\(\alpha \# \beta\)自然积通常记作\(\alpha \otimes \beta\)或\(\alpha \⨳\beta\)  