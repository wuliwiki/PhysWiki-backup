...
\end{equation}
\begin{equation}
\pdv{T}{\theta_1} = m_2l_1l_2\omega_1\omega_2\sin\alpha
\end{equation}
\begin{equation}
\pdv{T}{\theta_2} = -m_2l_1l_2\omega_1\omega_2\sin\alpha
\end{equation}
\begin{equation}
...
\begin{equation}
(m_1+m_2)l_1\dot\omega_1 + m_2l_2\cos\alpha\dot\omega_2 = m_2l_2\sin\alpha\cdot\omega_2^2 - (m_1+m_2)g\sin\theta_1
\end{equation}
\begin{equation}
l_1\cos\alpha\dot\omega_1 + l_2\dot\omega_2 = l_1\sin(\theta_1-\theta_2)\omega_1^2 - g\sin\theta_2
\end{equation}
解得
\begin{equation}
\dot\omega_1 = \frac{m_2l_2\sin\alpha\cdot\omega_2^2 - (m_1+m_2)g\sin\theta_1 + m_2[l_1\sin\alpha\cdot\omega_1^2 + g\sin\theta_2] \cos\alpha}{(m_1+m_2)l_1 - m_2l_1\cos^2\alpha}
\end{equation}
