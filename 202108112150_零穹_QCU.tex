...
\textbf{测量公理：}对同类量 $\boldsymbol{Q_1}$、$\boldsymbol{Q_2}$、$\boldsymbol{Q_3}$，若用 $\boldsymbol{Q_1}$ 测量 $\boldsymbol{Q_2}$ 得数为 $\alpha$，用 $\boldsymbol{Q_2}$ 测量 $\boldsymbol{Q_3}$ 得数为 $\beta$，则用 $\boldsymbol{Q_1}$ 测量 $\boldsymbol{Q_3}$ 得数为 $\alpha\beta$．即：
若
\begin{equation}
...
因为 $\beta\boldsymbol{Q}$ 测量 $\alpha(\beta\boldsymbol{Q})$ 得数为 $\alpha$，$\boldsymbol{Q}$ 测量 $\beta\boldsymbol{Q}$ 得数为 $\beta$，由测量公理，
