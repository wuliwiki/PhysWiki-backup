...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/FunLim_5.png}
\caption{对于一个$\epsilon$，存在对应的X} \label{FunLim_fig5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/FunLim_6.png}
\caption{对于任意一个$\epsilon$，都存在对应的X} \label{FunLim_fig6}
\end{figure}
