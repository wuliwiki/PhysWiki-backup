...
我们知道，Gibbs变还体现了系统做非体积功的能力 \upref{Td2Law}。系统发生$1 \Si{mol}$反应后\footnote{这么表述是不严谨的，因为$1 \Si{mol}$反应期间，系统的$J$也在变化。我们这里假定系统很大，在$1 \Si{mol}$反应期间系统的$J$几乎不变。当然如果你高兴，也可以取为$\dd \xi$，对于下述的分析没有本质影响，但是会麻烦不少。}，能做的非最大体积功是：
$$w = - \Delta_r G_M~,$$
如果系统是一个电池，那么非体积功用来驱动电荷：
$$w = NqE~,$$
其中$N$代表反应中转移的电子数量，$q$代表电子电荷，$E$是电池电动势。%在电化学中，更常用的方案是，$n$代表载流子物质的量，$F = q \cdot N_A$是法拉第常数。
因此，
...
那么，
$$E = E^* - \frac{RT}{Nq} \ln J ~.$$
可见，电池电动势与物质种类、活度积等有关，史称能斯特Nernst方程。能斯特方程部分解释了不少电池现象：电压与电极材料d温度对电压的影响、电压与电池剩余电量的联系
\end{example}
