...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/YoungM_1.pdf}
\caption{请添加图片描述} \label{YoungM_fig1}
\end{figure}
\textbf{杨氏模量（Young's modulus）}也叫\textbf{杨氏模数}或者\textbf{弹性模量}， 是衡量材料弹性的力学性质。 其定义为
