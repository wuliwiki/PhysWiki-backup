...
\begin{equation}
\begin{aligned}
\div \bvec A = \frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\qty[\pdv{\xi}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) \\
+ \pdv{\eta}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) + \pdv{z}(c^2\qty(\sinh^2\xi+\sin^2\eta)A_z)]
\end{aligned}
\end{equation}
\begin{equation}
\begin{aligned}
