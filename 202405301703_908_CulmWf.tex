...
在\enref{抛物线坐标系}{ParaCr}中可以解得\footnote{推导见 \cite{Bransden}。}满足该边界的库仑波函数的解析式为\footnote{Bransden\cite{Bransden} 12.222, 12.223}（\enrefMatlab 和 Mathematica 代码见这里\upref{FlCode}）
