...
为了证明方便，这里拓展二次型的概念到广义内积，即对称双线性函数，这是为了符合内积的对称性$(\bvec v,\bvec w)=(\bvec w,\bvec v)$，以及线性$(\bvec v_1+\bvec v_2,\bvec w)=(\bvec v_1,\bvec w)+(\bvec v_2,\bvec w)$。对称矩阵总能保证该性质成立。设$q(\bvec v)=v^T Q v$，拓展至广义内积
\begin{equation}
