...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/6fc1d0c1083c6c52.png}
\caption{二十世纪初期元素光谱、太阳光谱与恒星光谱的对比。} \label{fig_AsYs_2}
\end{figure}
...
\caption{超新星遗迹 LMC~N~63A 的影像分别在 X 射线（蓝色）、光学（绿色）和射电（红色）波段拍摄。其中的 X 射线辉光来自被超新星爆炸所产生的冲击波加热至约一千万摄氏度的物质。} \label{fig_AsYs_1}
\end{figure}
...
\begin{enumerate}
  ...
  \item Roth, H.（1932）。《缓慢收缩或膨胀的流体球及其稳定性》（A Slowly Contracting or Expanding Fluid Sphere and Its Stability）。Physical Review（物理评论），39（3）：525–529。Bibcode:~1932PhRv...39..525R。doi:~10.1103/PhysRev.39.525。
  \item Eddington, A.~S.（1988）[1926]。《恒星的内部结构》（Internal Constitution of the Stars）。Science（科学），52（1341）。纽约：剑桥大学出版社，第233–240页。Bibcode:~1920Sci....52..233E。doi:~10.1126/science.52.1341.233。ISBN~978-0-521-33708-3。PMID~17747682。
  \item Manley, D.~Mark（2012）。《著名的天文学家与天体物理学家》（Famous Astronomers and Astrophysicists）。美国肯特州立大学（Kent State University）。检索日期：2015 年 7 月 17 日。
  \item The~science.ca~team（2015）。《于贝尔·里夫斯——天文学、天体物理学与空间科学》（Hubert Reeves – Astronomy, Astrophysics and Space Science）。  
  GCS~Research~Society。检索日期：2015 年 7 月 17 日。
  \item “Neil deGrasse Tyson（尼尔·德格拉斯·泰森）”。海登天文馆（Hayden Planetarium）。2015 年。检索日期：2015 年 7 月 17 日。
\end{enumerate}
\subsection{延伸阅读}
\begin{itemize}
  \item Longair, Malcolm~S.（2006）。The Cosmic Century: A History of Astrophysics and Cosmology（宇宙世纪：天体物理学与宇宙学史）。  
  剑桥：剑桥大学出版社。ISBN~978-0-521-47436-8。
  \item Astrophysics, Scholarpedia Expert Articles（天体物理学——Scholarpedia 专家文章）。
\end{itemize}
\subsection{外部链接}
\begin{itemize}
  \item Astronomy and Astrophysics（天文学与天体物理学）：欧洲学术期刊。
  \item The Astrophysical Journal（天体物理学杂志）。
  \item Cosmic Journey: A History of Scientific Cosmology（宇宙之旅：科学宇宙学史）。  
  美国物理学会（American Institute of Physics），原始存档于 2008 年 10 月 21 日。
  \item International Journal of Modern Physics~D（现代物理学国际期刊·D 卷），World Scientific 出版。
  \item List and Directory of Peer-Reviewed Astronomy / Astrophysics Journals（天文学与天体物理学同行评议期刊名录）。
  \item Ned Wright’s Cosmology Tutorial（Ned Wright 宇宙学教程），加州大学洛杉矶分校（UCLA）。
\end{itemize}
