...
为什么这么叫呢？ 因为电 $2^N$ 极子产生的势能项可以用 $2^{N-1}$ 个电荷为 $q$ 的正电荷以及 $2^{N-1}$ 个电荷为 $-q$ 的负电荷按照一定空间位置摆放后， 取 $r \to \infty$ 得到． 用数学归纳法的思想， 我们可以认为若电 $2^N$ 极子的渐进势能为 $~1/r^{l+1}$， 那么把两个电荷相反的 $2^N$ 极子相距
