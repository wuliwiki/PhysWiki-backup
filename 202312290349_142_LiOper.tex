...
\textbf{证明：}由定理条件，若设 $\mat A=(a_{ij}), \mat A'=(a_{kj}'),\mat B=(b_{ij})$ ，则
\begin{align}
&\mathcal{A} e_i=\sum_{k} a_{ki} e_k, \label{eq_LiOper_1}\\
&\mathcal{A} e_j'=\sum_{k} a'_{kj} e'_k, \label{eq_LiOper_2}\\
& e_j'=\sum_i b_{ij} e_i~.
\end{align}

联立 \autoref{eq_LiOper_1} 和 \label{eq_LiOper_2} 后我们得到，
