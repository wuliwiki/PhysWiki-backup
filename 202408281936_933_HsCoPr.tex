...
由 $P$ 可以推出 $Q$， 说明 $P$ 中有充分的信息能得到 $Q$， 所以叫做 $Q$ 的\textbf{充分条件}。 $P$ 中包括得到 $Q$ 所必要的信息，还\textbf{可能}包括一些其他信息，例如由命题 $P$ 可以得出四边形任意两条临边垂直。 这些多出来的信息并不一定是得到 $Q$ 所必须的，因为还有许多其他的四边形四条边相等但并不是正方形。
