...
\begin{itemize}
\item Moyal 括号
\item Kontsevich 量子化公式
\end{itemize}
\subsection{参考文献}
\begin{itemize}
\item Y. Kosmann-Schwarzbach (2001) [1994], "Poisson algebra", Encyclopedia of Mathematics, EMS Press
\item Bhaskara, K. H.; Viswanath, K. (1988). Poisson algebras and Poisson manifolds*. Longman. ISBN 0-582-01989-3.
\end{itemize}