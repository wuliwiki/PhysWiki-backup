...
\hline
尼拉坎塔模型（Nilakanthan model）& 尼拉坎塔·索马亚吉（Nilakantha Somayaji，1444–1544）& 地心与日心混合模型（Geocentric and heliocentric） \quad 行星绕太阳公转，而太阳再绕地球运行的宇宙体系，与后来的第谷体系（Tychonic system）相似。\\
\hline
哥白尼宇宙（Copernican universe） \quad 尼古拉·哥白尼（Nicolaus Copernicus，1473–1543） \quad 日心说，行星圆轨道，空间有限（Heliocentric with circular planetary orbits, finite extent） \quad 首次发表于《天体运行论》（\emph{De revolutionibus orbium coelestium}）。太阳位于宇宙中心，地球及其他行星绕太阳公转，而月球绕地球运动。宇宙的外边界由“恒星天球”（sphere of fixed stars）限定。\\
\hline
第谷体系（Tychonic system） \quad 第谷·布拉赫（Tycho Brahe，1546–1601） \quad 地心与日心混合模型（Geocentric and heliocentric） \quad 行星绕太阳公转，而太阳再绕地球运行，与早期的尼拉坎塔模型相似。\\
\hline
布鲁诺宇宙学（Bruno's cosmology） \quad 焦尔达诺·布鲁诺（Giordano Bruno，1548–1600） \quad 空间无限、时间无限、均质、各向同性、无层级（Infinite extent, infinite time, homogeneous, isotropic, non-hierarchical） \quad 否定宇宙的层级结构，认为地球与太阳与其他天体相比并无特殊之处。恒星之间的虚空充满以太（aether），物质由同样的四种元素——水、土、火、气——组成，并具备原子性（atomistic）、泛灵性（animistic）与理性（intelligent）。\\
\hline
《论磁体》（\emph{De Magnete}） \quad 威廉·吉尔伯特（William Gilbert，1544–1603） \quad 日心说，空间无限延展（Heliocentric, indefinitely extended） \quad 继承哥白尼的日心体系，但拒绝“恒星天球”作为宇宙边界的假设，认为无证据支持其存在。\cite{ref47}\\
\hline
开普勒体系（Keplerian） \quad 约翰内斯·开普勒（Johannes Kepler，1571–1630） \quad 日心说，行星椭圆轨道（Heliocentric with elliptical planetary orbits） \quad 开普勒的发现将数学与物理学相结合，为现代太阳系结构奠定基础，但当时的远方恒星仍被视为附着于薄且静止的天球之上。\\
\hline
* & * & * & * \\
\hline
* & * & * & * \\
