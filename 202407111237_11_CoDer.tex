...
\begin{equation}
\begin{aligned}
\nabla_iT^{r_1r_2...r_a}_{s_1s_2...s_b}&=(\nabla_iT)(\partial_{r_1},\partial_{r_2}...\partial_{r_a},\theta^{s_1},\theta^{s_2}...
\theta^{s_b})\\
&=\partial_i\left(T(\partial_{r_1},\partial_{r_2}...\partial_{r_a},\theta^{s_1},\theta^{s_2}...
\theta^{s_b}) \\
& -\sum_{i=1}^a T(\partial_{r_1},\partial_{r_2}...\partial_{r_a},\theta^{s_1},\theta^{s_2}...
\theta^{s_b}) \\
& -\sum_{j=1}^b T(\partial_{r_1},\partial_{r_2}...\partial_{r_a},\theta^{s_1},\theta^{s_2}...
\theta^{s_b})~.
\end{aligned}
\end{equation}
