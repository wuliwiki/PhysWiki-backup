...
对于任意$X, Y, U, V\in\mathfrak{X}(M)$，有$<R(X, Y)U, V>=-<R(X, Y)V, U>$\footnote{证明难点提示：考虑$-g^{ar}(\partial_ig_{rt})(\partial_jg_{ka})+g^{ar}(\partial_jg_{rt})(\partial_ig_{ka})$这一项，由于$a, r$都是赝指标，}．
