...
设$f:\mathbb{P}H\to\mathbb{P}H$是一个对称变换，记$\ket{s'_\alpha}$是射线$f(\ket)$，那么由\autoref{WigThe_eq1} 以及“非零矢量和自己的内积恒为正实数”得
...
当系数比值相等时，能够定义$\mathcal{Q}(C_i\ket{s_i})=C_i\ket{s'_i}$，
