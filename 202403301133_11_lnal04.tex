...
\begin{example}{}
$\{\bvec x_1,\bvec x_2\}$是$V$上的一组基，$\{\bvec y_1,\bvec y_2,\bvec y_3\}$为$W$上的一组基。线性映射$f:V\rightarrow W$对基向量的作用为：$f(\bvec x_1)=2\bvec y_2+\bvec y_3\,,f(\bvec x_2)=\bvec 4y_1+3\bvec y_3$
\end{example}
\subsection{矩阵的坐标变换}
\subsection{线性映射的核与象}
