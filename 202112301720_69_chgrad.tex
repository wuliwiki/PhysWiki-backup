...
&=\frac{q \partial_i (R-\bvec v'\cdot \bvec R)}{(R-\bvec v'\cdot \bvec R)^2}-\frac{q\frac{\partial v_i}{\partial t}(R-\bvec v'\cdot \bvec R)-qv_i\partial_i(R-\bvec v'\cdot \bvec R)}{(R-\bvec v'\cdot \bvec R)^2}\\
&=\frac{q}{(R-\bvec v'\cdot \bvec R)^2}
\end{aligned}
\end{equation}