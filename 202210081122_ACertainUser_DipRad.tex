...
\caption{$\theta = \pi/2$时的电场强度大小随r关系示意图．原点附近由于远场近似不再有效而发散．在远处辐射场行为类似平面电磁波\upref{VcPlWv} .\href{https://www.geogebra.org/m/xnputtwr}{一个可动的立体模型}（站外链接）} \label{DipRad_fig1}
\end{figure}
