...
=(0, \cos^2\frac{\theta}{2}\bvec{v}+\cos\frac{\theta}{2}\sin\frac{\theta}{2}\hat{\bvec{n}}\times(\bvec{v}+\hat{\bvec{n}})\bvec{v}\sin^2\frac{\theta}{2}\hat{\bvec{n}})\\&
=(0, \cos\theta\bvec{v}+\sin\theta\hat{\bvec{n}}\times\bvec{v}+\hat{\bvec{n}}\cdot\bvec{v}\sin^2\theta\hat{\bvec{n}})
\end{aligned}
\end{equation}
