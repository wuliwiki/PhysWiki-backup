...
\caption{数列的极限（\href{https://wuli.wiki/apps/Lim0.html}{动画链接}）： 图中每点代表数列的一项， 数列的极限值为 $1$， 红色区域表示对距离的要求， 满足要求的项为红色， 不满足的为蓝色． 无论红色区域有多窄， 总能找到一个不等式 $n > N$ 使满足的} \label{Lim0_fig1}
\end{figure}
...
\begin{equation}
1/2, 1/4, 1/3, 1/5, 1/4, 1/6, 1/5, 1/7, \dots
\end{equation}
的极限是 $0$．
\end{example}
