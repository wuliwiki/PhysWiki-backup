...
由Egoroff定理，对于任意$\delta>0$，存在可测集$E_{\epsilon, \delta}$，使得其测度小于$\delta$且$\{f_n\}$在$E-E_{\epsilon, \delta}$上\textbf{一致收敛}到$f=0$．

因此，存在正整数$N_{\epsilon, \delta}$，使得只要正整数$n>N_{\epsilon, \delta}$，就有$f_$
