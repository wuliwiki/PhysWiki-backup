...
好的，我来翻译这段 **See also / References**，保持条目结构：
...
* 艾弗森括号（Iverson bracket）
* 拉普拉斯变换（Laplace transform）
* 示性函数的拉普拉斯算子（Laplacian of the indicator）
* 数学函数列表（List of mathematical functions）
* 马考利括号（Macaulay brackets）
* 负数（Negative number）
...
* Bracewell, Ronald Newbold (2000). *The Fourier transform and its applications* (第3版). New York: McGraw-Hill. p. 61. ISBN 0-07-303938-1.

---

要不要我把这些 **“参见” 条目** 整理成带 **中英文对照 + 简要解释** 的小表格？
