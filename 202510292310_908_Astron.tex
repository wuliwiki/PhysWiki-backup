...
\caption{地下\textbf{ANTARES中微子望远镜（ANTARES Neutrino Telescope）}。} \label{fig_Astron_12}
\end{figure}
一些来自遥远天体的事件可以通过\textbf{非依赖电磁辐射}的系统在地球上被观测到[93][94]。
