...
\begin{equation}
\begin{aligned}
\curl \bvec A =& \frac{1}{\sqrt{2}c^2\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{\eta}\qty(\sqrt{2}c\sinh\xi\sin\eta
A_\phi) - \pdv{\phi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta)]\uvec \xi\\
&+ \frac{1}{\sqrt{2}c^2\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{\phi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) - \pdv{\xi}A_phi]\uvec \eta
+ \\
&\frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\qty[\pdv{\xi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) - \pdv{\eta}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi)]\uvec z
\end{aligned}
\end{equation}
