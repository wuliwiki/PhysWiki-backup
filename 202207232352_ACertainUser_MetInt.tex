...
\subsection{缺陷}
如果金属中的原子都完全按这种理想的方式整整齐齐地排列，那材料科学也未免太无趣了（材料科学的书至少会薄半本！但同时，我们能用材料科学做的事也会少很多！）．实际上，如果你的眼光放得长远一些，不只局限于几个原子的大小，就会发现真实的金属晶体往往存在偏离理想结构的区域，称为缺陷．

\begin{definition}{缺陷}
实际金属中原子偏离理想排列而出现的不完整区域
\end{definition}

金属中缺陷的占比虽然不多，但却对材料的性能起到了决定性影响．“缺陷”这个词往往让人以为缺陷对于材料性质都是不利的，但事实并非如此，有些缺陷对于材料（某一方面的性能）可以起到积极作用．夸张点说，半个材料科学与制造技术的研究对象，就是理解并利用缺陷，以制造符合预期的材料．
...
以间隙点缺陷为例．当一个额外的原子填入了原本不存在原子的间隙，会发生什么呢？假设你在一台拥挤的电梯中，这时又挤入了一个人，那么你会感觉到一股更大的压力．事实上原子也是如此，额外的间隙原子挤压了其余原子，造成了额外的压力（或者称作内应力）．
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MetInt_9.png}
\caption{请添加图片描述} \label{MetInt_fig9}
\end{figure}
\subsection{微结构}
\subsubsection{晶粒与晶界}
\subsubsection{相界}
