...
V(r)=q\phi(r)
\end{equation}
我们继续电磁场中的狄拉克方程\upref{DiracE} 的讨论，在 Pauli-Dirac 表象下，令波函数 $\psi=\pmat{\varphi\\\chi}e^{-imt}$，并令 $A_\mu(\bvec r)=(\phi(r),\bvec 0)$，那么可以由\autoref{DiracE_eq5}~\upref{DiracE}得到
\begin{equation}
\begin{aligned}
...
\end{aligned}
\end{equation}
假设电子的总能量为 $E=m+E'$，在非相对论极限下 $E'\ll m$，