...
单射是合理的，即使$\bvec x$有两种分解，也会映射到一个同余类。比如设$\bvec x=\bvec{u}_1+\bvec{u}_2=\bvec{u'}_1+\bvec{u'}_2$，则$f(\bvec{u}_1+\bvec{u}_2+U_2)-f(\bvec{u'}_1+\bvec{u'}_2+U_2)=f(\bvec{u}_1+U_1\cap U_2)$。
