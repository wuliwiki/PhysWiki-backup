...
其中，由于很多人[包括小编Chain在内]对矩阵和行列式求导都不是很熟悉，所以我们需要补充一段行列式和矩阵求导的运算．\\

首先介绍行列式求导：\\
\begin{equation}
\frac{1}{\partial x}\begin{vmatrix} x_{1,1} & \cdots & x_{1,n} \\ \vdots & \ddots & \vdots \\ x_{n,1} & \cdots & x_{n,n} \end{vmatrix}
\end{equation}
