...
\caption{一个具有 6 个顶点和 7 条边的图} \label{fig_TUl_1}
\end{figure}
...
\caption{由维基百科编辑者（边）与不同语言版本的维基百科（顶点）在2013年夏季某一个月内的贡献所形成的网络图。\(^\text{[6]}\)} \label{fig_TUl_5}
\end{figure}
...
\caption{由维基百科编辑者（边）在 2013 年夏季某一个月内对不同语言版本的维基百科（顶点）所作贡献而形成的网络图。[6]} \label{fig_TUl_7}
\end{figure}
莱昂哈德·欧拉于1736年发表的关于柯尼斯堡七桥问题的论文被认为是图论史上的第一篇论文。\(^\text{[20]}\)这篇论文，以及范德蒙德关于骑士巡游问题的论文，延续了莱布尼茨开创的analysis situs（位置分析）思路。欧拉提出的关于凸多面体的边数、顶点数与面数关系的公式后来被柯西\(^\text{[21]}\)和吕利耶\(^\text{[22]}\)研究并推广，这标志着后来被称为拓扑学的数学分支的开端。
...
图论的第一本教材由Dénes Kőnig编写，并于 1936 年出版。\(^\text{[26]}\)另一部由Frank Harary于 1969 年出版的著作则被“公认为该领域的权威教材”，\(^\text{[27]}\)并使数学家、化学家、电气工程师和社会科学家能够彼此交流。Harary将该书的全部版税捐出，用以资助 Pólya 奖。\(^\text{[28]}\)
...
四色问题在一个多世纪里一直未被解决。1969 年，Heinrich Heesch发表了一种使用计算机解决该问题的方法。\(^\text{[29]}\)1976 年，Kenneth Appel 和 Wolfgang Haken给出了一个计算机辅助证明，该证明根本性地利用了Heesch提出的“放电法”思想。\(^\text{[30][31]}\)该证明需要通过计算机检验 1,936 种配置的性质，由于其复杂性，当时并未被完全接受。二十年后，Robertson、Seymour、Sanders 和 Thomas提出了一个更为简洁的证明，仅需考虑 633 种配置。\(^\text{[32]}\)
...
\item Vecchio, F (2017). “阿尔茨海默病中大脑连接的小世界结构与海马体积：基于 EEG 数据的图论研究”。Brain Imaging and Behavior. 11 (2): 473–485. doi:10.1007/s11682-016-9528-3. PMID 26960946. S2CID 3987492.
\item Vecchio, F (2013). “额颞叶痴呆中基于图论的大脑网络连接性评估”*。Neurology. 81 (2): 134–143. doi:10.1212/WNL.0b013e31829a33f8. PMID 23719145. S2CID 28334693.
\item Bjorken, J. D.; Drell, S. D. (1965). Relativistic Quantum Fields. New York: McGraw-Hill. p. viii.
\item Kumar, Ankush; Kulkarni, G. U. (2016-01-04). “从几何学角度评估基于导电网络的透明电极”。Journal of Applied Physics. 119 (1): 015102. Bibcode:2016JAP...119a5102K. doi:10.1063/1.4939280. ISSN 0021-8979.
\item Newman, Mark (2010). Networks: An Introduction (PDF). Oxford University Press. 原始 (PDF) 存档于 2020-07-28. 检索于 2019-10-30.
\item Grandjean, Martin (2015). “社会网络分析与可视化：重访 Moreno 的社会图”。改造后的网络严格基于 Moreno (1934) Who Shall Survive.
\item Rosen, Kenneth H. (2011-06-14). 离散数学及其应用（第 7 版）。New York: McGraw-Hill. ISBN 978-0-07-338309-5.
\item Kelly, S.; Black, Michael (2020-07-09). “graphsim: 一个用于从生物通路图结构中模拟基因表达数据的 R 包” (PDF)。Journal of Open Source Software. 5 (51). The Open Journal: 2161. Bibcode:2020JOSS....5.2161K. bioRxiv 10.1101/2020.03.02.972471. doi:10.21105/joss.02161. ISSN 2475-9066. S2CID 214722561.
\item Shah, Preya; Ashourvan, Arian; Mikhail, Fadi; Pines, Adam; Kini, Lohith; Oechsel, Kelly; Das, Sandhitsu R; Stein, Joel M; Shinohara, Russell T (2019-07-01). “癫痫动态中结构连接组的作用特征化”*。Brain. 142 (7): 1955–1972. doi:10.1093/brain/awz125. ISSN 0006-8950. PMC 6598625. PMID 31099821.
\item Biggs, N.; Lloyd, E.; Wilson, R. (1986). Graph Theory, 1736–1936. Oxford University Press.
\item Cauchy, A. L. (1813). “关于多面体的研究——第一篇论文”。Journal de l'École Polytechnique 9 (Cahier 16): 66–86.
\item L'Huillier, S.-A.-J. (1812–1813). “关于多面体测量的论文”。Annales de Mathématiques. 3: 169–189.
\item Cayley, A. (1857). “关于被称为树的解析形式的理论”。Philosophical Magazine, Series IV, 13 (85): 172–176. doi:10.1017/CBO9780511703690.046. ISBN 978-0-511-70369-0.
\item  Cayley, A. (1875). “论数学中被称为树的解析图形及其在化学化合物理论中的应用”。Berichte der Deutschen Chemischen Gesellschaft. 8 (2): 1056–1059. doi:10.1002/cber.18750080252.
\item Sylvester, James Joseph (1878). “化学与代数”。Nature. 17 (432): 284. Bibcode:1878Natur..17..284S. doi:10.1038/017284a0.
\item Tutte, W. T. (2001). Graph Theory Cambridge University Press, p. 30. ISBN 978-0-521-79489-3. 检索于 2016-03-14.
\item Gardner, Martin (1992). Fractal Music, Hypercards, and more…Mathematical Recreations from Scientific American. W. H. Freeman and Company, p. 203.
\item Society for Industrial and Applied Mathematics (2002). “George Pólya 奖”，载于 Looking Back, Looking Ahead: A SIAM History (PDF), p. 26. 原始 (PDF) 存档于 2016-03-05. 检索于 2016-03-14.
\item Heinrich Heesch (1969). Untersuchungen zum Vierfarbenproblem. Mannheim: Bibliographisches Institut.
\item Appel, K.; Haken, W. (1977). “每个平面图都是四色可着色的. 第一部分：放电法”(PDF)。Illinois J. Math. 21 (3): 429–490. doi:10.1215/ijm/1256049011.
\item Appel, K.; Haken, W. (1977). “每个平面图都是四色可着色的. 第二部分：可约性”。Illinois J. Math. 21 (3): 491–567. doi:10.1215/ijm/1256049012.
\item Robertson, N.; Sanders, D.; Seymour, P.; Thomas, R. (1997). “四色定理”。Journal of Combinatorial Theory, Series B. 70: 2–44. doi:10.1006/jctb.1997.1750.
\item Kepner, Jeremy; Gilbert, John (2011). Graph Algorithms in the Language of Linear Algebra. SIAM, p. 1171458. ISBN 978-0-898719-90-1.
\end{enumerate}
\subsection{参考文献}
\begin{itemize}
\item Lowell W. Beineke; Bjarne Toft; Robin J. Wilson: Milestones in Graph Theory: A Century of Progress, AMS/MAA, (SPECTRUM, v.108), ISBN 978-1-4704-6431-8 (2025).
\item Bender, Edward A.; Williamson, S. Gill (2010). Lists, Decisions and Graphs. With an Introduction to Probability.
\item Berge, Claude (1958). Théorie des graphes et ses applications.\item Paris: Dunod. 英文版：Wiley 1961；Methuen & Co, New York 1962；俄文版：莫斯科 1961；西班牙文版：墨西哥 1962；罗马尼亚文版：布加勒斯特 1969；中文版：上海 1963；1962 年第一版英文版的第二次印刷：Dover, New York 2001。
\item Biggs, N.; Lloyd, E.; Wilson, R. (1986). Graph Theory, 1736–1936. Oxford University Press.
\item Bondy, J. A.; Murty, U. S. R. (2008). Graph Theory. Springer. ISBN 978-1-84628-969-9.
\item Bollobás, Béla; Riordan, O. M. (2003). Mathematical results on scale-free random graphs. 载于 Handbook of Graphs and Networks(S. Bornholdt 和 H.G. Schuster 编), 第一版, Weinheim: Wiley VCH.
\item Chartrand, Gary (1985). Introductory Graph Theory. Dover. ISBN 0-486-24775-9.
\item Deo, Narsingh (1974). Graph Theory with Applications to Engineering and Computer Science (PDF). Englewood, New Jersey: Prentice-Hall. ISBN 0-13-363473-6. [PDF 原始存档于 2019-05-17].
\item Gibbons, Alan (1985). Algorithmic Graph Theory. Cambridge University Press.
\item Golumbic, Martin (1980). Algorithmic Graph Theory and Perfect Graphs. Academic Press.
\item Harary, Frank (1969). Graph Theory. Reading, Massachusetts: Addison-Wesley.
\item Harary, Frank; Palmer, Edgar M. (1973). Graphical Enumeration.\item New York: Academic Press.
\item Mahadev, N. V. R.; Peled, Uri N. (1995). Threshold Graphs and Related Topics. North-Holland.
\item Newman, Mark (2010). Networks: An Introduction. Oxford University Press.
\item Kepner, Jeremy; Gilbert, John (2011). Graph Algorithms in The Language of Linear Algebra.Philadelphia, Pennsylvania: SIAM. ISBN 978-0-89871-990-1.
\end{itemize}
\subsection{外部链接}
\begin{itemize}
\item “图论”，《数学百科全书》，EMS Press，2001 [1994]
\item 图论教程（存档于 Wayback Machine，2012-01-16）
\item 小型连通图的可搜索数据库
\item House of Graphs —— 一个带有基于绘图搜索功能的图的可搜索数据库
\item 图像图库：graphs（存档于 Wayback Machine，2006-02-06）
\item 简明注释的图论资源清单（为研究人员提供）[已被替代]
\item rocs —— 一个图论集成开发环境（IDE）
\item 路由器的社会生活 —— 一篇非技术性论文，讨论人与计算机的图结构
\item 图论软件—— 用于教授和学习图论的工具
\item 在线书籍与图书馆资源 —— 你所在图书馆及其他图书馆中的图论相关资料
\item 图算法列表（存档于 Wayback Machine，2019-07-13），附参考文献和图算法库实现链接
\end{itemize}
\subsubsection{在线教材}
\begin{itemize}
\item Phase Transitions in Combinatorial Optimization Problems, Section 3: Introduction to Graphs (2006)，作者 Hartmann 和 Weigt
\item Digraphs: Theory Algorithms and Applications (2007)，作者 Jorgen Bang-Jensen 和 Gregory Gutin
\item Graph Theory，作者 Reinhard Diestel
\end{itemize}