...
若逐次皮卡近似收敛，即
\begin{equation}
\lim_{n\rightarrow\infty}A^n\varphi=\varphi_0~,
\end{equation}
且极限曲线 $\varphi_0$ 属于皮卡映射的定义域，则微分方程\autoref{eq_PicMap_3} 有解。
\end{theorem}
\textbf{证明：}由于 $\varphi_0$ 属于 $A$ 的定义域，于是 $A$ 可以作用到 $\varphi_0$ 上，于是就有
\begin{equation}
A\lim_{n\rightarrow\infty}A^n\varphi=\lim_{n\rightarrow\infty}A^n\varphi
\end{equation}
