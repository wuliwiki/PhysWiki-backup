...
\item “历史版本” 界面上方加入一个选项（默认不选） “合并连续备份”， 选择以后， 所有连续的间隔 5 分钟的备份中只显示最后一个．

\item 在 “历史版本” 界面的每个版本右边显示 \verb|git diff| 返回的增减数， 如 \verb|++++---|， 每个版本左边显示 radio button， 当选中一个时， 可以通过界面下方的 “恢复” 按钮恢复， 当选中两个时， 跳转到对比页面， 使用 diff2html 对比两个版本．
