...
在研究时空的理论中，因果结构是一个基本问题．根据David B. Malament于1977年发表的论文\textsl{The class of continuous timelike curves determines the topology of spacetime}\footnote{Malament, Journal of Mathematical Physics 18:7, 1399-1404. }，在一个给定的时空中，确定了弱因果性就可以完全确定该时空的微分结构．本词条旨在解释与因果结构相关的部分概念．
...
\begin{itemize}
\item $y$是$x$的时序未来，如果存在一条未来导向的类时曲线自$x$出发，并经过$y$．这个关系常记为$x\ll y$．
\end{itemize}
