...
解： 圆盘中心 $A$ 点对于圆形轨道中心 $O$ 点的加速度为 $\bvec a_{S'}$ 圆盘边缘对于圆盘中心 $A$ 点的加速度为 $\bvec a_r$ ,那么圆盘边缘上一点在任意时刻的加速度 $\bvec a_S = \bvec a_{S'} + \bvec a_r$ ．
...
圆盘边缘上的点对于圆盘中心 $A$ 点的加速度等于圆盘线速度的平方除以半径
\begin{equation}
\bvec a_r = \frac{v^2}{r} = \frac{(\omega R)^2}{r}
\end{equation}

圆盘边缘上点的加速度为
\begin{equation}
\bvec a_S = \bvec a_{S'} + \bvec a_r = \omega^2 R (1 + \frac{R}{r})
\end{equation}
