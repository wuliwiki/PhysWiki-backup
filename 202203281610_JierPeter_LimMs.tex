...
因此，只需要取$\delta_k=1/2^k$，得到各$N_{\delta_k}$（记$N_{\delta_k}=n_k$），那么$\abs{f_{n_k}(x)}\epsilon$在$E-E_{\delta_k}$上处处成立，且$\opn{m}E_{\delta_k}<{\delta_k}$．也就是说，$\lim\limits_{k\to\infty}\opn{m}E_{\delta_k}=0$．
