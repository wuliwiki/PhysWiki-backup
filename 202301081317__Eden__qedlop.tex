...
&=-e^2\mu^{4-d} \int\frac{\dd[d]{k}}{(2\pi)^d} \frac{\gamma^\mu \not p \gamma_\mu + m\gamma^\mu\gamma_\mu}{(p^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}+i(\delta_2\not p -\delta_m)
\\
&=-e^2\mu^{4-d} \int\frac{\dd[d]{k}}{(2\pi)^d} \frac{(2-d)\not p + dm}{(p^2-m^2+i\epsilon)((p-k)^2-m^2+i\epsilon)}+i(\delta_2\not p -\delta_m)
\end{aligned}
\end{equation}
...
\end{equation}
由于根据洛伦兹结构，上述积分是一个洛伦兹矢量，且是关于 $p^\mu$ 地函数，因此
\begin{equation}
I^\mu = A(p^2) p^\mu
\end{equation}
