...
设费米子圈上某一条费米子线动量为 $l$，从它出发 $q_1,\cdots,q_n$ 依次为费米子圈上的 $n$ 条光子线。令 $p_i=l+\sum_{j=1}^i q_j$。
当光子 $k$ 夹在动量为 $q_i$ 和 $q_{i+1}$ 的两条光子线之间
费米子圈上的动量依次是 $l,l+q_1,\cdots,l+q_1+\cdots+q_i,
l+q_1+\cdots+q_i+k,\cdots,l+q_1+\cdots+q_n+k=l$。我们可以将费米子线 $l$ 减断，使得费米子圈变成一条费米子链。类似于先前的 Ward 等式的证明，我们有
\begin{equation}
k_\mu \mathcal{M}^\mu(k)=e[A_{n+1}-A_0] =e 
\end{equation}
