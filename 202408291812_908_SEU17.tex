...
\subsection{(10 分)}设某微扰体系的某个能级 $E$ 是 4 重简并的。相应的正规归一的能量本征态为 $|\varphi_{i}\rangle (i=1,2,3,4)$。在这 4 个简并态所张成的子空间中，微扰哈密顿量的非零矩阵元为

$$H_{ij} = \langle \varphi_{i} | \hat{H}' | \varphi_{j} \rangle = a,~$$其它矩阵元 $H_{ij}$ 为零,试求能级 $E$ 的一级修正 $\epsilon$。