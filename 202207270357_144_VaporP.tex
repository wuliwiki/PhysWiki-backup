...
\subsubsection{热力学证明}
在一个只有水的等温等压的活塞容器中\footnote{若要使活塞系统中液态水与水蒸汽能同时存在，容器的外压应精准地控制为p*；外压略高于此或略低于此都会导致液相或气相的消失．用吉布斯相律\upref{GBPL}的话说，此时f=C-P+1=0，系统的压力确定，即为饱和蒸气压．}，相变反应 $H_2O(l) \leftrightarrow H_2O(g)$ 达到平衡
