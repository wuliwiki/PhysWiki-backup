...
\footnote{本文参考 Wikipedia \href{https://en.wikipedia.org/wiki/Gauss's_law}{相关页面}．}电场的高斯定理（）是麦克斯韦方程组\upref{MWEq}中四条方程中的一条． 用电场线来形象地描述该定理， 就是正电荷会产生电场线， 负电荷会消除电场线． 产生和消除的电场线和电荷量成正比．
