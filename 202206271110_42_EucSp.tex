...
\end{definition}
\begin{example}{}
在直角坐标系中，若点 $\dot p,\dot q$ 的坐标分别为 $x_1,\cdots,x_n$ 和 $y_1,\cdots,y_n$ ，则 $\vec{pq}$ 坐标为 $y_1-x_1,\cdots,y_n-x_n$（\autoref{AfSp_the2}~\upref{AfSp}）．于是，点 $\dot p,\dot q$ 距离为（\autoref{EuVS_eq5}~\upref{EuVS}）
\begin{equation}
