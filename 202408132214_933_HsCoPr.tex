...
若逻辑连接词连接的两个命题$A,B$只有同时成立，整个复合命题才为真，则称这个逻辑连接词为\textbf{且}（and，也称为\textbf{而且}、\textbf{同}、\textbf{合取}），记作$A\land B$\footnote{符号不做硬性要求，下同。}。在上面的例子中，一个方程组中方程的关系、用来描述多重条件的关系，就是“且”的关系。
，“消元”依据的就是“且”这个前提。
这两个条件就是“且”的关系。“且”常被，比如
“且”就出现在交集的定义中。
