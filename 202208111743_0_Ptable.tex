...
\subsection{电子轨道的表达法}
现在我们简要说明一下如何表达电子轨道（排布规则见下）．

对于一个电子亚层，我们先写主量子数，再写角量子数（一般以$S, P,D,F,...$记），最后以上标标注该电子亚层上的电子数量．例如，$3S^2$指电子轨道$n=3$的S轨道$l=0$上有2个电子．

对于一个原子的电子排布，我们可以按能量从小到大的顺序，依次表示电子轨道．例如，第六号元素C（碳）的电子排布是$1S^2 2S^2 2P^2$．
