...
任取$A\in\mathbb{R}^n$，记$A_i=A\cap E_i$，$c_0=\opn{m^*}A$，$A_0=A-\bigcup_{i=1}^\infty E_i$，$c_k=\opn{m^*}A_0+\sum_{i=1}^k\opn{m^*}A_i$，那么由上一条性质，
\begin{equation}
\begin{aligned}
...
又由于各$\bigcup_{i=1}^k E_i$都是可测的，加上外测度的单调性，可得
\begin{equation}
...
\begin{equation}
\lim_{k\to \infty} \opn{m^*}(\bigcup_{i=0}^k A_i)\geq \opn{m^*} A
\end{equation}
