...
\]
由于$z\in{\left\{z:\left|\arg{z}\right|\le\pi/2-\delta\right\}}$，于是$\operatorname{Re} z\geq 1/2|z|\sin \delta$．这表明当$\left|z\right|$足够大时，$\operatorname{Re}z-c≥1/2 z\sin \delta$．因此
