...
\end{equation}
\begin{equation}
p_x = \frac12\sqrt{\frac{3}{2\pi}} \C_{1,-1}-C_{1,1}) = -\frac12\sqrt{\frac{3}{2\pi}} (C_{1,1} + C_{1,1}^*)~,
\end{equation}
\begin{equation}
p_y = \frac{1}{2\I}\sqrt{\frac{3}{2\pi}} (C_{1,-1}+C_{1,1}) = \frac{1}{2\I}\sqrt{\frac{3}{2\pi}} (C_{1,1}-C_{1,1}^*)~.
\end{equation}
