...
\end{equation}
把矢量 $\bvec B,\bvec C,\bvec D$ 在与矢量 $\bvec A$ 垂直的平面上投影，分别得到 $\bvec B',\bvec C',\bvec D'$． 由于平行线投影到平面后仍然是平行线， 所以平行四边形投影后还是平行四边形， 根据矢量加法的平行四边形法则\upref{GVecOp}有 $\bvec D'=\bvec B'+\bvec C'$． 接下来有
\begin{equation}
\begin{aligned}
