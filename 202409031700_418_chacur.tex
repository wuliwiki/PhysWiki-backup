...
这有一个直观的几何解释：在 $(x, t, u)$ 的三维空间中，曲面上任意一点 $P_0(x_0, t_0, u_0)$ 的法向量为 $n(u_x, u_t, -1) |_{P_0}$。在曲面 $u = u(x, t)$ 上，在点 $P_0$ 处的切向量为 
\begin{equation}
\tau = \left.\left(\dv{x}{s}, \dv{t}{s}, \dv{u}{s}\right) \right|_{P_0} ~.
\end{equation}
