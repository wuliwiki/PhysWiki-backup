...
\begin{itemize}
\item 先把系统视作一个整体，进行受力分析。此时，系统中各刚体之间的约束力是内力，均可被忽略。可以想象将系统装进一个箱子，这样外界就只看到了一个箱子以及与箱子连接的部分，而对箱子内部的情况一无所知。这样，我们就能暂时不用考虑系统中各组件间复杂的内力，从而简化问题。
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/RGDFA_16.pdf}
\caption{请添加图片描述} \label{RGDFA_fig16}
\end{figure}
