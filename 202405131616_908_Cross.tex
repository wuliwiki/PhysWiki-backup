...
向量叉乘在物理定律中十分常见， 例如在讨论力学中的\enref{力矩}{Torque}， 角动量\upref{AngMom}， 以及电磁学中的洛伦兹力\upref{Lorenz}， 安培力\upref{FAmp}时都会使用。 以下我们讨论的向量都是三维中的空间向量\upref{GVec}； 在讨论它们的坐标时， 我们默认取正交归一基底。
