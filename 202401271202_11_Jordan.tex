...
假设该子空间为4维。输入$x=(1\,0\,0\,0)^T$，得到$(0\,1\,0\,0)^T$。输入$(0\,1\,0\,0)^T$，得到$(0\,0\,1\,0)^T$。显然，$B$可以对基进行循环，因此把这种形式的基向量组$\opn{Span}\{x,Bx,B^2x,...B^{k-1}x\}$称为\textbf{循环基（cyclic basis）}。$W$则是$B$的\textbf{循环子空间（cyclic subspace）}。
