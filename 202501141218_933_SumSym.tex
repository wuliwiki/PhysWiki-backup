...
\hline
$\displaystyle\sum\limits_{i=a}^a f(i)$ & $\displaystyle\sum\limits_{i=1}^n 1$ & $\displaystyle\sum\limits_{i=1}^n i$ & $\displaystyle\sum\limits_{i=1}^n i^2$ & $\displaystyle\sum\limits_{i=1}^n i^3$  \\
\hline
$f(a)$ & $n$ & $\displaystyle\frac{n(n+1)}{2}$ & $\displaystyle\frac{n(n+1)(2n+1)}{6}$ & $\displaystyle\frac{n^4+2n^3+n^2}{4}= \left( \frac{n(n+1)}{2} \right)^2$ & * \\
\hline
\end{tabular}
\end{table}
\begin{itemize}
...
求和式 & 裂项方法 & 化简结果 \\
\hline
$\displaystyle\sum\limits_{i=1}^n \frac{1}{i(i+1)}$ & $\displaystyle\frac{1}{i(i+1)}=\frac{1}{i}-\frac{1}{i+1}$ & $\frac{n}{n+1}$ \\
\hline
* & * & * \\
\hline
* & * & * \\
