...
还应用于：
\begin{itemize}
  \item 物理学（卡尔纳普、迪特里希、罗素、香农、怀特海、赖欣巴赫、费弗里耶），
  \item 生物学（伍杰尔、塔斯基），
  \item 心理学（菲奇、亨佩尔），
  \item 法律与伦理（门格尔、克卢格、奥本海姆），
  \item 经济学（冯·诺伊曼、摩根斯特恩），
  \item 工程与实用科学（伯克利、施塔姆），
  \item 乃至形而上学（萨拉穆哈、舒尔茨、博亨斯基）。
\end{itemize}
此外，它在逻辑史研究中的应用也极为丰硕（卢卡谢维奇、舒尔茨、梅茨、贝克尔、穆迪、萨拉穆哈、迪尔、约尔丹、伯纳、博亨斯基、沙耶尔、英格尔斯）。[48]“数理逻辑还被应用于神学（德列夫诺夫斯基、萨拉穆哈、托马斯）。”[48]
