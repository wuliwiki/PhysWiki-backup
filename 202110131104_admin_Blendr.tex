...
如果在 Matlab 上有一张三维网格， 坐标存入三个二维矩阵 \verb|X, Y, Z|， 那么可以用一些脚本（例如\href{https://www.mathworks.com/matlabcentral/fileexchange/4512-surf2stl}{这个}）将其转换为 stl 文件再导入到 Blender． 例如用 Matlab 生成一个曲面
