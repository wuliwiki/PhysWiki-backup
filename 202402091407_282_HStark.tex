...
\item $n=2$
\begin{equation}
\ket{2,\pm\frac{3Z}{2}, 0} = \frac{1}{\sqrt{2}}(\ket{2,0,0}\pm\ket{2,1,0})~.
\end{equation}
\begin{equation}
\ket{2,1,\pm 1}~.
\end{equation}
\item $n=3$
\begin{equation}
\ket{3,\pm\frac{9Z}{2},0} = \frac{1}{\sqrt{3}}\ket{3,0,0} \pm \frac{1}{\sqrt{2}}\ket{3,1,0} + \frac{1}{\sqrt{6}}\ket{3,2,0}~.
\end{equation}
\begin{equation}
\ket{3,0Z,0} = \frac{1}{\sqrt{3}}\ket{3,0,0} - \sqrt{\frac{2}{3}}\ket{3,2,0}~.
\end{equation}
\end{itemize}
\begin{equation}
\ket{3,\pm 3\sqrt{3}/2,1} = (\ket{l=0}\pm\ket{l=1})/\sqrt 2~.
\end{equation}
