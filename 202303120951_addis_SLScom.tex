...
\subsubsection{安装依赖库}
\begin{itemize}
\item 可以在 GitHub 上下载对应的版本（推荐）： \href{https://github.com/MacroUniverse/SLISC0-libs-x64-ubuntu16.04}{Ubuntu16.04}， \href{https://github.com/MacroUniverse/SLISC0-libs-x64-ubuntu18.04}{Ubuntu18.04}， \href{https://github.com/MacroUniverse/SLISC0-libs-x64-ubuntu20.04}{Ubuntu20.04}， \href{https://github.com/MacroUniverse/SLISC0-libs-x64-ubuntu22.04}{Ubuntu22.04}， \href{https://github.com/MacroUniverse/SLISC0-libs-x64-centos7.9.2009}{CentOS7.9}
\item 如果国内访问 GitHub 较慢， 可以从百度网盘（不保证及时更新）。
\end{itemize}
