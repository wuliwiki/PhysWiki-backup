...
\addTODO{推导大概就是旋转微小角度然后取极限}
\begin{equation}
\dot {\bvec q} = \lim_{\Delta t\to 0}\frac{{\bvec q}(t+\Delta t) - {\bvec q}(t)}{\Delta t} = \bvec q(t)\lim_{\Delta t\to 0}\frac{{\bvec q}(\Delta t) - (1,0,0,0)}{\Delta t}
\end{equation}
