...
\subsection{局部描述}
在一定的温和条件下，可以通过局部方法来检验一个可微映射是否是微分同胚。这就是 Hadamard–Caccioppoli 定理\(^\text{[1]}\)：
...
\subsubsection{同伦类型}
\begin{itemize}
\item $S^2$ 的微分同胚群具有与其子群 $\mathrm{O}(3)$ 相同的同伦类型。这一点由 Steve Smale 证明。\(^\text{[2]}\)
...
在 4 维流形中，还出现了更奇特的现象。20 世纪 80 年代初，Simon Donaldson 和 Michael Freedman 的成果结合起来，发现了所谓的异类 $\mathbb{R}^4$：存在不可数多个两两不微分同胚的 $\mathbb{R}^4$ 开子集，每一个都与标准的 $\mathbb{R}^4$ 同胚；此外，还存在不可数多个两两不微分同胚的、与 $\mathbb{R}^4$ 同胚但无法光滑嵌入 $\mathbb{R}^4$ 的可微流形。

\subsection{参见}
\begin{itemize}
\item Anosov 微分同胚，例如 Arnold 的猫映射
\item 微分同胚异常，也称为引力异常，是量子力学中的一种异常
\item Diffeology，集合上的光滑参数化，由此构成一个微分空间
\item Diffeomorphometry，计算解剖学中对形态和结构的度量研究
\item 平展态射
\item 大微分同胚
\item 局部微分同胚
\item 超微分同胚）
...
\subsection{注释}
\begin{enumerate}
\item Steven G. Krantz; Harold R. Parks (2013). The implicit function theorem: history, theory, and applications. Springer. 第 6.2.4 定理. ISBN 978-1-4614-5980-4.
\item Smale (1959). "Diffeomorphisms of the 2-sphere". Proc. Amer. Math. Soc. 10 (4): 621–626. doi:10.1090/s0002-9939-1959-0112149-8.
\end{enumerate}
\subsection{参考文献}
\begin{itemize}
\item Krantz, Steven G.; Parks, Harold R. (2013). The implicit function theorem: history, theory, and applications. Modern Birkhäuser classics. Boston. ISBN 978-1-4614-5980-4.
\item Chaudhuri, Shyamoli; Kawai, Hikaru; Tye, S.-H. Henry (1987-08-15). "Path-integral formulation of closed strings" (PDF). Physical Review D. 36 (4): 1148–1168. Bibcode:1987PhRvD..36.1148C. doi:10.1103/physrevd.36.1148. ISSN 0556-2821. PMID 9958280. S2CID 41709882. Archived (PDF) from the original on 2018-07-21.
\item Banyaga, Augustin (1997). The structure of classical diffeomorphism groups. Mathematics and its Applications, vol. 400, Kluwer Academic. ISBN 0-7923-4475-8.
\item Duren, Peter L. (2004). Harmonic Mappings in the Plane. Cambridge Mathematical Tracts, vol. 156, Cambridge University Press. ISBN 0-521-64121-7.
\item "Diffeomorphism", Encyclopedia of Mathematics, EMS Press, 2001 [1994].
\item Hirsch, Morris (1997). Differential Topology. Berlin, New York: Springer-Verlag. ISBN 978-0-387-90148-0.
\item Kriegl, Andreas; Michor, Peter (1997). The convenient setting of global analysis. Mathematical Surveys and Monographs, vol. 53, American Mathematical Society. ISBN 0-8218-0780-3.
\item Leslie, J. A. (1967). "On a differential structure for the group of diffeomorphisms". Topology, 6 (2): 263–271. doi:10.1016/0040-9383(67)90038-9. ISSN 0040-9383. MR 0210147.
\item Michor, Peter W.; Mumford, David (2013). "A zoo of diffeomorphism groups on $\mathbb{R}^n$". Annals of Global Analysis and Geometry, 44 (4): 529–540. arXiv:1211.5704. doi:10.1007/s10455-013-9380-2. S2CID 118624866.
\item Milnor, John W. (2007). Collected Works Vol. III, Differential Topology. American Mathematical Society. ISBN 978-0-8218-4230-0.
\item Omori, Hideki (1997). Infinite-dimensional Lie groups. Translations of Mathematical Monographs, vol. 158, American Mathematical Society. ISBN 0-8218-4575-6.
\item Kneser, Hellmuth (1926). "Lösung der Aufgabe 41." Jahresbericht der Deutschen Mathematiker-Vereinigung (in German), 35 (2): 123.
\end{itemize}