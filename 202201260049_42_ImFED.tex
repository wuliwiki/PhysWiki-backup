...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/ImFED_1.pdf}
\caption{请添加图片描述} \label{ImFED_fig1}
\end{figure}
如图，沿着 $x=x_0$ 的竖直线，函数 $F(x,y)$ 变成一个变元 $y$ 的函数 $F(x_0,y)$．根据定理条件2：$F(x_0,y_0)=0$，根据定理条件3：$F()$
