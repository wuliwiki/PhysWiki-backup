...
\footn玻尔兹曼方程是动理学理论的奠基者路德维希 $\cdot$ 玻尔兹曼于1872年首先推导出来的，其可表示为下面的积分微分方程的形式：
...
\subsection{推导}
首先声明，为书写方便，我们这里的分布函数 $f(t,\bvec r,\Gamma)$ 代表相空间中单位体积元内的平均分子数，它等于通常的分布函数 $\pho(t,\bvec r,\Gamma)$（分子处于相空间中$(\bvec r,\Gamma)$ 附件单位体积元的概率） 乘以总分子数 $N$，这并不影响我们推导玻尔兹曼方程，这也可从 $f=N\pho$ 代入\autoref{BolzEQ_eq1} 看出\footnote{其实主要目的是为了贴合朗道的说法}．