...
\begin{equation}
C_{i_1,\dots, i_N} = \frac{1}{2^Nl_1\cdots l_N}\int_{-l_N}^{l_N}\cdots\int_{-l_1}^{l_1} \exp(-\I \frac{n_1 \pi}{l_1} x_1) \dots \exp(-\I \frac{n_N \pi}{l_N} x_N) f(x_1, \dots, x_N) \dd{x_1}\dots\dd{x_N}
\end{equation}
