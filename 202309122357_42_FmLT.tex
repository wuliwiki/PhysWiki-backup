...
\begin{equation}
k=p_1^{\alpha_1}p_2^{\alpha_2}\cdots p_n^{\alpha_n}, r=p_1^{\beta_1}p_2^{\beta_2}\cdots p_n^{\beta_n}, ks=p_1^{\alpha_1+\beta_1}p_2^{\alpha_2+\beta_2}\cdots p_n^{\alpha_n+\beta_n}
\end{equation}
其中 $p_1,\cdots,p_n$ 是小于 $p$ 的素数，而
\begin{equation}
p=p_1^0p_2^0\cdots p_n^{0}p~.
\end{equation}
$p$ 整除 $kr$ 意味着 $p$ 是 $kr$ 的因数，这相当于在 $kr$ 的用素数分解式中一定 