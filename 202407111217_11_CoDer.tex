...
\begin{equation}
\begin{aligned}
\nabla_{\partial_i}V&=(\partial_iV^j+\Gamma^j_{ik}V^k)\partial_k\\
(\nabla_{\partial_i} V)^j&=\partial_iV^j+\Gamma^j_{ik}V^k
\end{aligned}~.
\end{equation}
...
\end{equation}
现在我们欲求$(\nabla_iT)^{r_1r_2...r_a}_{s_1s_2...s_b}$，即
\begin{equation}
\nabla_iT^{r_1r_2...r_a}_{s_1s_2...s_b}=\nabla_iT(\partial_{r_1},\partial_{r_2}...\partial_{r_a},\theta^{s_1},\theta^{s_2}...\theta^{s_b})~.
\end{equation}
