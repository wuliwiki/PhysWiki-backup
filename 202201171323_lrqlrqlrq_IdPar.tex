...
\end{corollary}
\begin{exercise}{}
假设有三个粒子，一个处于$\psi_A$态，一个处于$\psi_B$态，一个处于$\psi_C$状态．假设$\psi_A,\psi_B,\psi_C$是正交的，构造三粒子为可分辨，全同玻色子，和全同费米子的总的波函数．在构造全同费米子（反对称）我们需要用到\textbf{斯莱特Slater行列式}\upref{symetr}
\end{exercise}
