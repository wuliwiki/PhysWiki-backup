...
\begin{equation}
\begin{aligned}
\div \bvec A = &\frac{1}{\sqrt{2}c^3\sinh\xi\sin\eta\qty(\sinh^2\xi+\sin^2\eta)}\Bigg[\sqrt{2}\pdv{\xi}(c^2\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) \\&+ \sqrt{2}\pdv{\eta}\qty(c^2\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) + \pdv{\phi}\qty(c^2\qty(\sinh^2\xi+\sin^2\eta)A_\ph)\Bigg]
\end{aligned}
\end{equation}
\begin{equation}
\begin{aligned}
