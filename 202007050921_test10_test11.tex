...
"$F_Y(y)=P(Y\leq y)=P(2X\leq y)=P(X\leq\frac y2)=\int_{-\infty}^\frac y2{f_X(x)}\operatorname dx$"v


"$\mathrm{这是方差}\sigma^2\mathrm{的单边检验}，\mathrm{原假设及备择假设为}H_0：\sigma^2=\sigma_0^2=64\;\;\;H_1：\sigma^2>\sigma_0^2=64\;\mathrm{检验统计量为}\frac{\left(n-1\right)S^2}{\sigma_0^2}，\mathrm{拒绝域为}\lbrack\chi_{0.05}^2\left(9\right),+\infty)．$"