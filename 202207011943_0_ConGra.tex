...
PBCG 的 C++ 代码见 \cite{NR3} 的 \verb|linbcg.h|， 其中 \verb|asolve()|． 另外 C++ 的 Eigen 库也提供 \verb|Eigen::BiCGSTAB| 算法． \verb|Matlab| 也有 \verb|x = bicgstab(A,b)| 函数（支持复数）． 其中 \verb|STAB| 意思是 \verb|stablized|， 单纯的 \verb|BiCG| 
