...
其实，通过\aref{条件命题的概念}{def_HsCoPr_3}，你可以注意到，条件命题由于其特殊的形式，尽管研究的也是两个命题的关系，但是它和“且”、“或”不同，$\Rightarrow$符号的左右两个命题并不满足交换律，也就是$P$（前件）和$Q$（后件）不能随意互换，这使得二者地位并不“平等”。下面研究条件命题的几个不同的形态。
...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/977aec7c48daaeea.png}
\caption{充分必要条件} \label{fig_SufCnd_2}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/b8c97ea69e5f63a9.png}
\caption{必要非充分条件} \label{fig_SufCnd_3}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/813479566ad8bd27.png}
\caption{充分非必要条件} \label{fig_SufCnd_4}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/72797bcad5cfcfdc.png}
\caption{既不充分也不必要} \label{fig_SufCnd_5}
\end{figure}
