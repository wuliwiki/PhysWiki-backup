...
由\autoref{PIntQM_eq4} ，对于\autoref{PIntQM_fig2} 中任意\textbf{给定路径}$\Gamma$，其起点与终点分别是$(x_0, t_0)$和$(x_n, t_n)$，则粒子沿着这条路径的概率传播的振幅为
\begin{equation}
\ali{
    \bra{x_n}\E^{-\I H t_n}\ket{x_0} &= \int\int\cdots\int\dd x_1\dd x_2
}
\end{equation}
