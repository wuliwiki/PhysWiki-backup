...
考虑到同胚就是“\textbf{双向连续双射}”，如果单连续映射的逆映射还是连续的，那它就是嵌入映射．注意，我们这里讨论的范围是较抽象的“点集拓扑”，在更具体的“微分拓扑”或“微分几何”中，（微分）嵌入的概念要求自然会更严格一些．

如果仅仅是单连续，是无法保证局部同胚的，如下面这个简单的反例：

\begin{example}{}

考虑单位圆$S^1$，表示为复平面上的集合$S^1=\{\E^{\I x}\mid x\in[0, 1)\}$．
