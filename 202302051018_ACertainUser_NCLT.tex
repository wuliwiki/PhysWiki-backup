...
\end{figure}
从微观上看，液体中的粒子并不保持静止，而是在时刻运动。这使液体的微观结构不同于热力学平衡态所假设的的“处处相同、均匀”：从结构上看，液体中的粒子时聚时散，由此出现小原子团（晶胚）；从能量上看，液体中每个小区域的能量总是在微小范围内不断浮动、“涨落”；从成分看，某区域内各组分的浓度也是不断浮动的。在一些教材中，这些动力学现象被归纳为“三大起伏”，即结构起伏、能量起伏与成分起伏。
