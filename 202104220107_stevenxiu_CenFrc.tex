...
这是一个可分离变量的一阶常微分方程， 
\\
（stevenxiu批注20210422：但由于符号的摇摆不定，所以事实上，从这条路，可以定性的分析，却不能走下面的积分来求解，哪怕只是求出一个隐参数表达，也是没有意义的．因为你不知道什么时候取正，什么时候取负，而$\dot r$是可以负的．这说明，相比于牛顿第二定律，积分带来了方程的信息的丢失．事实上，我们接下来会看到，Binet公式走的也是牛二，而不是能量．解决Bertrand定理，也不是从能量方程出发的．批注完毕）
