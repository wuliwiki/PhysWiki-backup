...
通常我们说 “波” 时， 它几乎可以是任意形状的， 例如一个波包\upref{WvPck}． 但我们先来讨论一种最简单的波动， 叫做\textbf{简谐波（sinusoidal wave）}． 简谐波也叫\textbf{平面波（plane wave）}， 在量子力学中很常见， 我们对这两个词不加区分． 之所以叫做平面波是因为三维平面波的等相位面都是平面．
