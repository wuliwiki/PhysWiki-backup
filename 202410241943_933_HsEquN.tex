...
对两列数字$a_1,a_2,\cdots,a_n;b_1,b_2,\cdots,b_n$，若$\forall i<j,a_i\leq a_j\land b_i\leq b_j$则称二者为顺序排列，也就是两个序列的增长方向是相同的。若$\forall i<j,a_i\leq a_j\land b_i\geq b_j$，则称二者为逆序排列，其他排列方式称为乱序排列，也就是两个序列的增长方向相反。排序不等式表示：逆序和$\leq$乱序和$\leq$顺序和，规范表述如下：
