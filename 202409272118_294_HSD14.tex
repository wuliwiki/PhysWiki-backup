...
(D)静止不动向左平移\\
(E)向左平移
\item 菲涅尔圆孔衍射中，对园孔轴上某一参考点，衍射孔仅包含 1/2 个半波带，现在操掉衍射屏，
点光强变为原来的1
A。1/2
B.2倍
C.1/4
D、4倍
E1倍
25.在单缝夫琅禾费衍射实验中，单色平行光沿水平方向垂直射向单缝，现将单缝向上平移一小段?
离，则观测屏上的条纹:
A向上平移
B，向下平移
C不动
D，间距变大
26.在光夫天费衍射实验中，单色平行光由垂直射向光改为斜入射光栅，观察到的光谐线
A最高级次变小，条数不变
B最高级次变大条数不变
C最高级次变大，条数变多
D.最高级次不变，条数不变
27.光栅的总缝数为N，光栅常数为d，则对某一级光谱而言，其分辨本领:
A.由N决定B由d决定
C由N决定
D由1/(Nd)决定
