...
根据卡诺定理的推论，任何一个工作于两个一定温度之间的可逆卡诺热机效率都仅与温度有关。由热机效率 $\eta = \frac{W}{Q_1}=1-\frac{Q_2}{Q_1}$，可以定义 $\theta_1$ 与 $\theta_2$ 的普适函数 $F(\theta_1, \theta_2) = \frac{Q_2}{Q_1}$，即这与 $Q_1$、$Q_2$ 等wu'guan
