...
\begin{itemize}
\item \href{https://github.com/MacroUniverse/littleshi.cn}{littleshi.cn}： 网站中所有静态页面， 服务器路径 \verb|/var/www/littleshi.cn|， 其中的 \verb`online` 子目录就是所有词条的 html 词条页面放置的地方。
