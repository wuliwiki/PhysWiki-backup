...
\begin{equation}
\bvec A^{(1)}=-\dfrac{\mu_0 I }{4\pi}\int_L \bvec x^{\prime}\cdot\nabla\dfrac{1}{|\bvec x|} \dd{l'}=\dfrac{\mu_0 I }{4\pi}\int_L \bvec x^{\prime}\cdot\dfrac{\bvec x}{|\bvec x|^3}\dd l^{\prime}\label{edy33_eq7}
\end{equation}
其中有 $\dd{\bvec x}^{\prime}=\dd l^{\prime}$， 因为 $ \bvec x^{\prime}$ 为闭合流管上的坐标．
全微分绕闭合回路积分为 $0$
\begin{equation}
0=\oint_L \dd{(\bvec x^{\prime}\cdot |\bvec x| R)\bvec x^{\prime}}=\oint_L (\bvec x^{\prime}\cdot\bvec R)\dd l^{\prime}+\oint_l (\dd l^{\prime}\cdot \bvec R)\bvec x^{\prime}\label{edy33_eq8}
\end{equation}
而
\begin{equation}
