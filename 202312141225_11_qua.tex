...
首先验证第三条，设$V_1$为$\{\bvec u\mid f(\bvec{v},\bvec u)=0,\forall \bvec v\in V\}$，证明思路为$\opn{Span}E_0=V=\opn{Span}F_0$。

容易验证，$\opn{Span}E_0\subseteq V$，现在通过反证法证明$ V\subseteq \opn{Span}E_0$。假设$\bvec x\in V,\bvec x\notin \opn{Span}E_0$则有