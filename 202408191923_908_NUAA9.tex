...
(1)$$\hat{H} = -\hat{\\mu} \cdot \mathbf{B} = \mu_0 B \hat{\sigma}_y = \mu_0 B \begin{pmatrix} 0 & -i \\\\ i & 0 \end{pmatrix}~$$
...
\\therefore \\text{电子自旋变为:} X(t) = \\begin{pmatrix} \\cos \\omega t \\\\ \\sin \\omega t \\end{pmatrix}
