...
\begin{enumerate}
\item 存在$\delta>0$，使得对任意符合$0<|x-x_0|<\delta$的$x$，都有$g(x)\leq f(x)\leq h(x)$；
...
若函数$f(x)$、$h(x)$满足：
\begin{enumerate}
\item 存在$\delta>0$，使得对任意符合$0<|x-x_0|<\delta$的$x$，都有$0\leq f(x)\leq h(x)$；
...
由函数极限定义，$\forall\varepsilon>0$，$\exists\delta_1>0$，$0<|x-x_0|<\delta\implies|h(x)|<\varepsilon$。
