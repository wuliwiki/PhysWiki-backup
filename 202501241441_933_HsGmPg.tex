...
在介绍\aref{数列和}{sub_HsSeFu_1}时，曾介绍过那个忘国际象棋棋盘上放麦粒的故事，当时曾提及“依此类推，每一格的麦粒数量是上一格的两倍。”敏锐的读者应该已经意识到，如果把每个格子中的麦粒数量看作是数列中的一项，那么这个“二倍”其实就是数列生成的递推规则。事实上，zhe zh

在讲故事时，也说过这背后有指数的力量，那么这个倍数关系是如何变成了指数的？下面就来研究这个问题。
