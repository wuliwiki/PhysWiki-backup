...
%=============================
% \chapter{数学} \label{cpt_1}
% %---------------------------------------
% TODO：根号二是无理数、整数和有理数一样多、（想到什么可以添加）
...
%---------------------------------------
\entry{原子的观念（转载）}{AtomId}
\entry{从天球的音乐到玻尔模型（转载）}{ClBohr}
...
\entry{ZFS 文件系统（Zettabyte File System）笔记}{ZFS}
...
%---------------------------------------
% Giacomo：几何向量这个板块的基本xie

\entry{几何向量}{GVec}
\entry{几何向量的线性组合}{GVecOp}
\entry{几何向量的内积}{Dot}
\entry{几何向量的线性相关、线性无关}{linDpe}
...
\part{数论、组合数学与离散数学} \label{prt_Combin}
%======================================
...
\entry{牛顿求根公式（牛顿迭代法）（Octave/matlab 绘图）}{NWTNRT}
