...
$$
\left[ \frac{3k+0}{3^{n+1}}, \frac{3k+3}{3^{n+1}} \right] = \left[ \frac{k}{3^n}, \frac{k+1}{3^n} \right]~
$$
中去除的开区间
$$
...
这里，每个闭区间
$$
\left[ \frac{3k+0}{3^n}, \frac{3k+3}{3^n} \right] = \left[ \frac{k}{3^{n-1}}, \frac{k+1}{3^{n-1}} \right]~
$$
中的中间三分之一区间
$$
...
通过与两端子区间
$$
\left[ \frac{3k+0}{3^n}, \frac{3k+1}{3^n} \right] \cup \left[ \frac{3k+2}{3^n}, \frac{3k+3}{3^n} \right]~
$$
的交集被“移除”。
