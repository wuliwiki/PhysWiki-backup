...
\begin{equation}
\bvec\omega = \dot\psi\uvec r + \dot\theta\uvec\theta + \dot\phi\uvec z = (\dot\psi + \dot\phi\cos\theta)\uvec r - \dot\phi\sin\theta\ \uvec\theta + \dot\theta\uvec\phi
\end{equation}
其中使用了 $\uvec z = \cos\theta\ \uvec r - \sin\theta\ \uvec\theta$
