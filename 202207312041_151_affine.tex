...
% keys 仿射变换 圆锥曲线
\subsection{引例}
由（1）知， \(E:\frac{x^2}{3}+\frac{y^2}{4}=1\)

置 \(x'=\frac{x}{\sqrt{3}},y'=\frac{y}{2}\) ，则 \(E\) 化为单位圆 \(x'^2+y'^2=1\) ， 且：
$$\text{A}'(0,-1)\,,\text{B}'\left(\frac{\sqrt{3}}{2},-\frac{1}{2}\right)\,,\text{P}'\left(\frac{\sqrt{3}}{3},-1\right)$$

容易发现 \(\triangle \text{OAB}\) 为等边三角形
我们猜想 \(\text{HN}\) 恒过 \(\text{A}\)，故只需证 \(\text{H},\text{N},\text{A}\) 三点共线，只需证：
$$\frac{\text{MN}}{\text{PN}}=\frac{\text{HM}}{\text{AP}}$$
而我们知道 \(\frac{\text{QM}}{\text{PQ}}=\frac{\text{TM}}{\text{AP}}\) ，即：
