...
一些常见的恒等式：
\begin{itemize}
\item 二项式定理：$\displaystyle(a+b)^n=\sum_{k=0}^n{\mathrm C}_n^ka^kb^{n-k}$，两个常见的特例为：完全平方（whole square）$(a\pm b)^2=a^2\pm2ab+b^2$和完全立方$(a\pm b)^2=a^3\pm 3a^2b+3ab^2\pm b^2$
\item 等幂和差公式：两个常见的特例为$a^2-b^2=(a+b)(a-b)$
