...
对称幂映射 $\opn{Sym}: V^{\times n} \to \opn{Sym}^n V$ 是一个对称映射，而且 $\opn{Sym}^n V$ 是所有到达域中“最小的”的（初对象，）：任意对称映射 $f: V^{\times n} \to W$，我们都有唯一确定的线性映射 $\bar{f}: \opn{Sym}^n V \to W$，满足 $f = \bar{f} \circ \opn{Sym}$，我们有交换图
\begin{equation}
\begin{CD}
