...
\item \verb|&[...]| 可以把方括号中的内容在左边用 \verb|#| 代替， 如 \verb|#.#\[Transpose] &[RandomInteger[{-5, 5}, {6, 6}]]| 可以随机生成对称矩阵． 也可以用 \verb|@| 代替方括号．
\end{itemize}
...
\item 函数选项：xian \verb|Options[shout] = {"a" -> 1, "b" -> 2}; shout[x_, OptionsPattern[]] := {x, OptionValue[a], OptionValue[b]};|
\end{itemize}
