...
\end{aligned}~
\end{equation}
因此只需令取满足 $\delta<\frac{\epsilon}{2\norm{x_0}},\abs{\lambda_0\pm \delta}<\frac{1}{2}$ 的 $\delta$ 作为 $\lambda_0$ 的邻域，而 $x_0$ 的邻域就取 $\epsilon$ 邻域，就有
\begin{equation}
\begin{aligned}
\norm{\lambda x-\lambda_0x_0}\leq\frac{\epsilon}{2}+\abs{\lambda-\lambda_0}\norm{x_0},\\
\end{aligned}~
\end{equation}
