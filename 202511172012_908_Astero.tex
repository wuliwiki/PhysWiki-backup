...
\item \textsc{Public~Domain}：本文部分内容并入自该公共领域资源：``Asteroids''. \textit{NASA~Solar~System~Exploration}. 26~October~2017. Retrieved 29~March~2022.
\item \textsc{Public~Domain}：本文部分内容并入自该公共领域资源：``Asteroids~(from~the~NEAR~press~kit)''. \texttt{nssdc.gsfc.nasa.gov}. Retrieved 29~March~2022.
\item Jones,~Andrew (18~May~2022). ``China~to~launch~Tianwen~2~asteroid-sampling~mission~in~2025''. \textit{Space.com}. Retrieved 29~September~2022.
\item Gibney,~Elizabeth (30~April~2019). ``China~plans~mission~to~Earth's~pet~asteroid''. \textit{Nature}. doi:10.1038/d41586-019-01390-5. PMID~32346150. S2CID~155198626. Retrieved 4~June~2019.
\item ``Resolution~B5~Definition~of~a~Planet~in~the~Solar~System'' (PDF). \textit{The~Minor~Planet~Center}. Archived (PDF) from the original on 9~October~2022. Retrieved 30~April~2022. （关于所有环日非卫星天体应统称为“小型太阳系天体”）
\item ``Pluto''. \textit{Questions~and~Answers~on~Planets}. International~Astrophysical~Union.
\item \textit{HADII~Abstracts. HAD~Meeting~with~DPS}. Denver,~CO. October~2013. Archived from the original on 1~September~2014. Retrieved 14~October~2013.
\item Nolin,~Robert (8~October~2013). ``Local~expert~reveals~who~really~coined~the~word~`asteroid' ''. \textit{Sun-Sentinel}. Archived from the original on 30~November~2014. Retrieved 10~October~2013.
\item Wall,~Mike (10~January~2011). ``Who~really~invented~the~word~`Asteroid'~for~space~rocks?''. \textit{Space.com}. Retrieved 10~October~2013.
\item \textit{Annual~of~Scientific~Discovery}. 1871. p.~316 — via Google~Books.
\item Bottke,~William~F.; Cellino,~Alberto; Paolicchi,~Paolo; Binzel,~Richard~P., eds. (2002). \textit{Asteroids~III}. Tucson:~University~of~Arizona~Press. p.~670. ISBN~978-0-8165-4651-0. Retrieved 30~March~2022. （关于缺乏小行星／彗星正式定义）
\item Harris,~Alan~W. (2011). ``Asteroid''. \textit{Encyclopedia~of~Astrobiology}. pp.~102–112. doi:10.1007/978-3-642-11274-4\_116. ISBN~978-3-642-11271-3.
\item Weissman,~Paul~R.; Bottke,~William~F.~Jr.; Levinson,~Harold~F. (2002). ``Evolution~of~Comets~into~Asteroids'' (PDF). \textit{Planetary~Science~Directorate}. Southwest~Research~Institute. Archived (PDF) from the original on 9~October~2022. Retrieved 3~August~2010.
\item ``Asteroids''. \textit{Solar~System~Dynamics}. \textit{Jet~Propulsion~Laboratory}. Archived from the original on 14~June~2006. Retrieved 8~December~2021.
\item ``Are~Kuiper~Belt~objects~asteroids?''. \textit{Ask~an~astronomer}. Cornell~University. Archived from the original on 3~January~2009.
\item Short,~Nicholas~M.~Sr. ``Asteroids~and~Comets''. \textit{Goddard~Space~Flight~Center}. NASA. Archived from the original on 25~September~2008.
\item ``Pluto~and~the~Developing~Landscape~of~Our~Solar~System''. \textit{International~Astronomical~Union}. Retrieved 13~April~2022.
\item ``Exploration:~Ceres''. \textit{NASA~Science:~Solar~System~Exploration}. 26~June~2019. Retrieved 12~April~2022.
\end{enumerate}
