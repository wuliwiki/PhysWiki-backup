...
全微分绕闭合回路积分为 $0$
\begin{equation}
0=\oint_L \dd{(\bvec x^{\prime}\cdot \bvec x)\bvec x^{\prime}}=\oint_L (\bvec x^{\prime}\cdot\bvec R)\dd l^{\prime}+\oint_l (\dd l^{\prime}\cdot \bvec R)\bvec x^{\prime}\label{edy33_eq8}
\end{equation}
而
\begin{equation}
