...
其中的曲线数据是笔者手动提取的， 见 “用 Matlab 手动提取图片中的曲线坐标\upref{plt2xy}”． 你也可以把自己的任何曲线的坐标散点 \verb|x, y| 保存到 \verb|logo_curve.mat|． 程序中使用了 “用 FFT 计算傅里叶变换（Matlab）\upref{FFTft}” 中的 \verb|FFT.m|
