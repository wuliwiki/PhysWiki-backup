...
\end{equation}
我们用这两个空间生成 $(2l_1+1)(2l_2+1)$ 维的张量积空间， 基底为 $\ket{l_1, m_1}\otimes\ket{l_2, m_2}$ 记为 $\ket{l_1, m_1, l_2, m2}$）。 张量积空间中一组显然的 \enref{{Complete Set of Commutable Operators （CSCO）}为}{Commut} % \addTODO{引用} （\cite{Sakurai} 1.4.36 有提到， 以及 \cite{Shankar}）
\begin{equation}
\{L_{1z}, L_{2z}\}~,
\end{equation}
