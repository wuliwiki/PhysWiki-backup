...
在高频电力系统中，为解决电磁波向外辐射的损耗以及与环境的干扰问题，常常采用波导进行电磁波的传输，波导是一根空心金属管，截面通常为矩形或圆形．如图是一矩形波导，其长宽为$a,b$，以长边为 $x$方向，短边为 $y$ 方向；$z$轴沿传播方向．则波导内电磁波满足亥姆霍兹方程\autoref{RHM_eq2} ，此时，应以 $\bvec E,\bvec H$ 代替 $u$，即是说电磁场分量满足\autoref{RHM_eq2} ，我们以计算 $\bvec E$ 为例．

由刚刚已证明的亥姆霍兹方程的通解\autoref{RHM_eq3} ，我们知道 $\bved E$ 各分量通解有\autoref{RHM_eq3} 得形式．而边界条件为
\begin{equation}
E_x=E_y=0,\pdv{E_x}{x}=0
\end{equation}
