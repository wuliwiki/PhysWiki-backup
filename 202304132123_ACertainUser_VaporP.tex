...
假设某压力、温度$(T,p)$下，一个只有水的等温等压的活塞容器中，水与水蒸气达到平衡\footnote{事实上，若要使活塞系统中液态水与水蒸汽能同时存在，容器的外压应精准地控制为p*；外压略高于此或略低于此都会导致液相或气相的消失。用吉布斯相律\upref{GBPL}的话说，此时f=C-P+1=0，系统的压力确定，即为饱和蒸气压。}。

此时，水蒸气的化学势应该等于液态水的化学势。
$$
\mu_g(T,p) = \mu_l(T,p)
$$
同时，该压力下水蒸气的化学势是
$$
\mu_g(T,p) = \mu_g^\ominus(T,p^\ominus) + RT \ln p
$$
由于液态水是凝聚态物质，因此液态水对压力不敏感。
$$
\mu_l(T,p) = \mu_l^\ominus(T,p^\ominus)
$$
水蒸气的化学势与水的化学势由相变Gibbs变联系
$$
\mu_g^\ominus(T,p^\ominus) = \mu_l^\ominus(T,p^\ominus) + \Delta_l^g G_M
$$
综合以上四式，
$$
p = p^\ominus e^{-\frac{\Delta G^*}{RT}
$$
