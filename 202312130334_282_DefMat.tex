...
\end{theorem}
证明： 把 $\bvec v\Her \mat A \bvec v$ 看作 $1\times 1$ 的矩阵， 根据\autoref{eq_HerMat_2}~\upref{HerMat}， 有 $(\bvec v\Her \mat A \bvec v)\Her = \bvec v\Her \mat A\Her \bvec v$，而厄米矩阵满足 $\mat A\Her=\mat A$ 得证。
