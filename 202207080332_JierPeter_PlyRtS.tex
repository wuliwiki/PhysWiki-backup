...
\pentry{Galois扩张\upref{GExt}，多项式的结式与判别式\upref{RDPly}}
...
\begin{theorem}{}
设$f\in\mathbb{F}[x]$，且$\opn{ch}\mathbb{F}\neq 2$．则
...
如果$\sigma_0\in\opn{Gal}(f:\mathbb{F})$是一个\textbf{对换}，那么显然$\sigma_0 d=-d$．由此可得，任意$\sigma\in\opn{Gal}(f:\mathbb{F})$是奇变换当且仅当$\sigma d=-d$，是偶变换当且仅当$\sigma d=d$．
