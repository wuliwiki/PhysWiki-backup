...
设$\forall a\in\mathbb{F}$，存在$b\in\mathbb{F}$使得$a=b^p$，但反设存在\textbf{不可分}的不可约多项式$f(x)\in\mathbb{F}[x]$在其分裂域$\mathbb{K}$上有重根．

由\autoref{CmplD_the3} ，存在$h(x)\in\mathbb{F}[x]$
