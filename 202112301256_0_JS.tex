...
\end{lstlisting}
把这段程序复制到一个文本文件， 并命名为 \verb|test.html|， 用 Chrome 打开即可自动运行． 按 F12 可打开调试窗口和命令行． 调试窗口支持 breakpoint 和逐行调试， 实时查看变量．
...
\item 输入框如 \verb|<input id="b"><br>|， 获取或更改文字用 \verb|document.getElementById('b').value|
\end{itemize}
