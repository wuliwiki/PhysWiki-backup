...
这个表示方式的好处是：随着参数 $t$ 的变化，可以清楚地描述出抛物线上点的位置变化。例如，当 $t$ 从负变正时，$y$ 从负变正，表示点沿抛物线从左侧向右侧移动。这种表示在物理、工程中常用于描述抛射体的运动轨迹或光线反射路径。你也可以根据具体问题，将参数方程稍作变化来适应不同的抛物线形式。
