...
\begin{equation}
\leftgroup{
B = \frac{(k^2 - b^2)\sin(ba)\exp(-\I ka)}{(k^2 + b^2)\sin(ba) + 2\I kb\cos(ba)} A\\
C = \frac{\I k (k + b) \exp[-\I (k+b)a/2]}{(k^2 + b^2)\sin(ba) + 2\I kb \cos(ba)} A\\
D = \frac{\I k(b-k) \exp[-\I (k-b)a/2]}{(k^2 + b^2)\sin(ba) + 2\I kb \cos(ba)} A\\
F = \frac{2\I kb \exp(-\I ka)}{(k^2 + b^2)\sin(ba) + 2\I kb\cos(ba)} A
}\end{equation}

透射率， 反射率分别为
\begin{equation}
T = \abs{\frac{E}{A}}^2 = \frac{4k^2b^2}{(k^2 + b^2) \sin[2](ba) + 4k^2b^2\cos[2](ba)}
\end{equation}

\begin{equation}
R = \abs{\frac{B}{A}}^2 = \frac{(k^2 - b^2) \sin[2](ba)}{(k^2 + b^2) \sin[2](ba) + 4k^2b^2\cos[2](ba)}
\end{equation}

当 $0 < E < V_0$ 时， 系数解为
\begin{equation}
\leftgroup{
B = \frac{(\kappa ^2 + k^2)\sinh(\kappa a)}{(k^2 - \kappa ^2) \sinh(\kappa a) + 2\I k\kappa  \cosh(\kappa a)} A\\
C = \frac{k(\I \kappa  - k) \exp(-\kappa a)}{(k^2 - \kappa ^2) \sinh(\kappa a) + 2\I k\kappa  \cosh(\kappa a)} A\\
D = \frac{k(\I \kappa  + k) \exp(\kappa a)}{(k^2 - \kappa ^2) \sinh(\kappa a) + 2\I k\kappa  \cosh(\kappa a)} A\\
F = \frac{2\I k\kappa  \exp(-\I ka)}{(k^2 - \kappa ^2) \sinh(\kappa a) + 2\I k\kappa  \cosh(\kappa a)} A
}\end{equation}

\begin{equation}
T = \abs{\frac{E}{A}}^2 = \frac{4k^2\kappa ^2}{(\kappa ^2 - k^2) \sinh[2](\kappa a) + 4k^2\kappa ^2\cosh[2](\kappa a)}
\end{equation}

\begin{equation}
R = \abs{\frac{B}{A}}^2 = \frac{(\kappa ^2 + k^2) \sinh[2](\kappa a)}{(\kappa ^2 - k^2) \sinh[2](\kappa a) + 4k^2\kappa ^2\cosh[2](\kappa a)}
\end{equation}
