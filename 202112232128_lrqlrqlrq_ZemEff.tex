...
显然总能量为：
\begin{equation}
E=E_2+E_{fs}^1+E_z = -3.4\rm{eV}+\frac{\alpha^2}{2^3}\left[\frac{3}{8}+\frac{l(l+1)-m_lm_s}{l(l+1/2)(l+1)}\right](13.6 \rm eV)+\mu_BB(m_l+2m_s)
\end{equation}
...
$|n \ l \ m_l \ m_s\rangle$& * & * & * \\
\hline
$|1\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|2\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|3\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|4\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|5\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|6\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|7\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
$|8\rangle = |2\ 0 \ 0 \ \frac{1}{2}\rangle$ & * & * & * \\
\hline
\end{tabular}
\end{table}
\end{example}
