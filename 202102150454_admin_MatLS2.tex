...
令 $A:X \to Y$ 的零空间（\autoref{LinMap_def2}~\upref{LinMap}）为 $X_0$， $X_1$ 为 $X_0$ 在 $X$ 中的一个补空间（$X_0\oplus X_1 = X$， \autoref{DirSum_def1}~\upref{DirSum}）， 令 $Y_1 = A(X)$， 那么映射 $A:X_1\to Y_1$ 是一一对应的．
\end{theorem}
...
\end{equation}
\end{corollary}
证明： 见\autoref{MatLS2_eq1}， $X_0\oplus X_1 = X$， $X$ 的维数等于 $X_0, X_1$ 维数之和， 由于 $X_1$ 与 $Y_1$ 一一对应， 维数都是 $R$． 证毕．
