...
\begin{theorem}\label{Quaternion Product Associativity, Hamiltonian Definition, Lemma}
...
\begin{equation}
    \begin{aligned}
        A(BC) ={}& (a_0+a_1\I+a_2\J+a_3\K)\times\qty((b_0+b_1\I+b_2\J+b_3\K)(c_0+c_1\I+c_2\J+c_3\K))\\
        ={}& (a_0+a_1\I+a_2\J+a_3\K)\times((b_0c_0)+(a_0b_1+a_1b_0+a_2b_3-a_3b_2)\I+)
    \end{aligned}
\end{equation}
