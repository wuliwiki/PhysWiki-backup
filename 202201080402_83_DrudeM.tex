...
\begin{equation}
\bvec v_{avg} = -\frac{e\bvec\label{ZemEff_eq17} E \tau}{m}; \ \bvec j =\left(\frac{ne^2\tau}{m}\right)\bvec E
\end{equation}
...
\begin{example}{}
计算在$t$时段间电子两次碰撞之间在离子上平均损耗的能量：
首先，我们假设碰撞前的平均速度为$\bvec v_0$，由 \autoref{ZemEff_eq17} 可得碰撞之后的平均速度为$\bvec v=\bvec v_0 -\frac{e\bvec\label{ZemEff_eq17} E \tau}{m}$
\end{example}
