...
以 $L$ 与准线位于焦点两侧的情形为例，如 \autoref{fig_Para3_1} 所示，过点$P$作一条垂直于准线的直线，与准线交于点$A$，与 $L$交于点$A$ 。由于 $PA$ 表示点 $P$ 到准线的距离，而根据抛物线的定义有 $|PA| = |FP|$，因此有：
\begin{equation}
|AB|=|PA| +|PB| =~.
\end{equation}
线段 $AB$ 的长度是固定的，因此 $r + |PB|$ 的值在点 $P$ 变化时保持不变，恒为常数。
