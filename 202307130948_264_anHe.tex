...
\psi(\bvec{r},\dd{t})\approx \E^{-\frac{\I}{\hbar}E_{n,\bvec{k}}\dd{t}}\psi_{n,\bvec{k}+\frac{\bvec{F}\dd{t}}{\hbar}}-\frac{\bvec{F}}{m}\dd{t}\cdot\sum_{l\neq n}\frac{\bra{u_{l,\bvec{k}}}\hat {\bvec p}\ket{u_{n,\bvec{k}}}}{E_{n,\bvec{k}}-E_{l,\bvec{k}}}\psi_{l,\bvec{k}}(\bvec{r})~.
\end{equation}
因为$\frac{\bvec{F}}{m}\dd{t}$是小量，我们再做一个类似于\autoref{eq_anHe_3}最后化简时的把戏，将\autoref{eq_anHe_3}
