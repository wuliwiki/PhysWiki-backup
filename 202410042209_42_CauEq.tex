...
在柯西序列上可以定义等价关系（\autoref{def_Relat_1}），而通过等价关系可以从原集合的得到一个商集。下面将表明，这个由柯西序列得到的商集也具有度量空间的结构，并且原度量空间可看作它的柯西序列等价关系得到的商空间的子空间。
...
\begin{corollary}{}\label{cor_CauEq_1}
...
由\autoref{cor_CauEq_1} ，我们可以把 $X$ 看作 $X^*$ 的子空间。
