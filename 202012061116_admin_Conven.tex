...
\item 由于几何矢量\upref{GVec}和实数列矩阵有一一对应的关系， 几何矢量也可以采用粗体加正体（大小写均可， 如 $\bvec a, \bvec R$）．
\item 为了区分矢量和坐标的不同， 矩阵的坐标表示为  一般矢量空间中的矢量 直接用普通变量字母（如 $x, y, u, v$）或者使用狄拉克符号（如 $\ket{x}, \ket{y}, \ket{u}, \ket{v}$）
