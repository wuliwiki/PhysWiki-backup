...
\subsection{液体理论}
液体理论认为，液体是“长程（时间、空间）无序、短程有序”的．从结构上看，液体中存在时聚时散的小原子团（晶胚）；从能量上看，液体中的能量分布不是完全均匀的，而是存在“涨落”：某区域的能量在微小范围内不断浮动；从成分看，类似于能量，某区域内各组分的浓度也是不断浮动的．在一些教材中，这三类现象被归纳为“三大起伏”，即结构起伏、能量起伏与成分起伏．
...
假设由于结构起伏，液体中已形成一半径为r的球形固体晶胚．前后总自由能变化： 
...
当晶核半径等于临界形核半径$r=r_k$时，所需的形核功最大，称为\textbf{临界形核功 A}．可证明，此时$A=\frac{1}{3}\Delta G_S=\frac{4}{3}\pi r^2 \gamma$%；换句话说，体积自由能变只能弥补表面自由能升高的2/3，剩余1/3的表面自由能变必须由周围液体对其额外做功．
