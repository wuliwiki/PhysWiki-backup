...
由正弦定理，$\frac{a}{b}=\frac{\sin{\alpha}}{\sin{\beta}}$．其中$\alpha=\varphi-\theta$，$\beta=\frac{\pi}{2}-\theta-\varphi$．则$\frac{\sin{\alpha}}{\sin{\beta}}=\frac{\sin{(\varphi-\theta)}}{\sin{(\frac{\pi}{2}-\theta-\varphi)}}=\frac{\sin{(\varphi-\theta)}}{\cos{(\varphi+\theta)}}=$
