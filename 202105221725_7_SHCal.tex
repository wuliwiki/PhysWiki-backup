...
\begin{corollary}{圆柱面的单纯同调群}
由\autoref{SHCal_lem2} 和\autoref{SHCal_lem3} 知，$K$的任何闭链都同调于$k\sum (a_1a_2+a_2a_3+a_3a_1)$，其中$k\in\mathbb{Z}$．类比\textbf{零维的单纯同调群}中“指数”以及用指数定义的群同态，我们也可以定义
\end{corollary}
