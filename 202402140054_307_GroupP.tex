...
对于$n$种旋转的情况，(我们把保持不变的操作算作旋转0次，当然，$r=0$和$r=n$表示同一种情况，即没有转动)易见，当旋转一次时，当且仅当所有珍珠同一颜色时，才是一个不动点。对于一般情况$d^r$，即旋转$r$次，$1\le r\le n$， 翻转轴一定经过一颗珍珠。位于这颗珍珠，以及翻转轴任意一侧的珍珠，一共有$(n+1)/2$个，我们可以随意为它们选择颜色，从而得到$k^\frac{n+1}{2}$个不动点。类似情况，当$n$偶数时，如果翻转轴经过两颗珍珠，一共有$k^{\frac{n}{2}+1}$个不动点，如果翻转轴不经过珍珠，一共有$k^{\frac{n}{2}}$个不动点。
\end{example}
