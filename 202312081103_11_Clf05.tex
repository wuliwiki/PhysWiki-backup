...
\end{corollary}
proof.
设$A=v_1\wedge v_2\wedge...\wedge v_n$，由基本推论\autoref{eq_clf02_1}~\upref{clf02}得，上式可以写为$A\llcorner B=(v_1\wedge v_2...)\llcorner B=(v_1\llcorner (v_2\llcorner...(v_n\llcorner B))$
