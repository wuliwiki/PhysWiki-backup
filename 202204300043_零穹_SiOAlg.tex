...
\end{equation}
就意味 $A^m-\sum_\limits{i=0}^{m-1}\lambda_i\mathcal A^i$是极小多项式．
...
由于每一线性算子都有与之对应的子代数 $\mathbb{F}[\mathcal A]$ ，其至少是一维的（这一维对应基底 $\mathcal{E=A}^0$），而上述表明 $\mathbb{F}[\mathcal A]$ 的维度 $m$ 一定存在，且 $1\leq m\leq n$