...
\end{equation}
这说明电场散度在小球内为常量， 所以散度在包含小球的高斯面内的体积分就是 $\div \bvec E$ 乘以球体体积 $V$ 得 $Q/\epsilon_0$， 这就验证了高斯定理的积分形式（\autoref{EGauss_eq2}~\upref{EGauss}）．
...
\end{equation}
这样， 我们就得到了矢量场 ${\uvec r}/{r^2}$ 在 $\bvec r = \bvec 0$ 处的， 原本没有定义的散度． 该式的意义在于对它做体积分可以得到确切的值．
