...
= 0.~
$$
当流动为 **不可压缩流** 时，流体质点的密度 $\rho$ 不会随时间变化，其**物质导数**为零：$\frac{\mathrm{D} \rho}{\mathrm{D} t} = 0$.
...
= 0.~
$$
因此，在不可压缩的纳维–斯托克斯方程**中，黏性项的第二部分将消失（参见“不可压缩流”部分）。

这一系统由四个方程组成，是应用最广泛、研究最深入的形式。尽管与其他形式相比更为简洁，但它仍然是一个**非线性的偏微分方程系统**，其解析解依然非常难以获得。
