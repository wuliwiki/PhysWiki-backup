...
重根$(\lambda_j,\lambda_{j+1}...\lambda_k)$分别对应特征子空间$W_j,W_{j+1}...W_k$，它们依然是相互正交的。所以$W_j\oplus W_{j+1}...\oplus W_k\subset W$为讨论方便，下设实对称矩阵A只有一个重根，证明依然能被分解为数个不变子空间，代数重数等于几何重数，即。