...
\item Ubuntu 中 \verb|apt install openblas| 会安装 \verb|cblas.h|， 但没有 \verb|lapacke.h|， 可能重新编译会更好
\begin{lstlisting}
...
-- Installing: /usr/local/include/openblas/openblas/lapacke_mangling.h
-- Installing: /usr/local/lib/pkgconfig/openblas.pc
-- Installing: /usr/local/share/cmake/OpenBLAS/OpenBLASConfig.cmake
-- Installing: /usr/local/share/cmake/OpenBLAS/OpenBLASConfigVersion.cmake
-- Installing: /usr/local/share/cmake/OpenBLAS/OpenBLASTargets.cmake
-- Installing: /usr/local/share/cmake/OpenBLAS/OpenBLASTargets-release.cmake
\end{lstlisting}
\end{itemize}
