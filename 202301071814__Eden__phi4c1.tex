...
\begin{equation}
\delta_Z = 0,\quad \delta_m = -\frac{\lambda}{2(4\pi)^{d/2}}\mu^{4-d} \frac{\Gamma(1-d/2)}{(m^2)^{1-d/2}}=\frac{\lambda}{32\pi^2}\left(\frac{1}{\epsilon}+1-\gamma+\log\left(\frac{4\pi\mu^2}{m^2}\right)\right)
\end{equation}
