...
为了方便暂且假设所有 $M=0$， 有
\begin{equation}\ali{
F^{(vz1)}_{\lambda,\lambda'} &= \mel{\mathcal{Y}_{l_1 l_2}^{LM}}{F^{(vz1)}}{\mathcal{Y}_{l_1' l_2'}^{L'}}\\
...
& \quad\int Y_{l_2m_1}^*(\uvec r_1) F^{(vz2)}(\uvec r_1)Y_{l_2' m_2'}(\uvec r_1)\dd{\Omega_1}\\
&= \delta_{l_1, l_1'} \sum_{m_2} \bmat{l_1 & l_2 & L\\ -m_2 & m_2 & 0}\bmat{l_1' & l_2' & L'\\ m_1 & m_2 & 0} \times\\
