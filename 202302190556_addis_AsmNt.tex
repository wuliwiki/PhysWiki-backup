...
参考\href{https://cs.lmu.edu/~ray/notes/gasexamples/}{一些 x86-64 的例子}， \href{https://www.tutorialspoint.com/assembly_programming/index.htm}{Tutorials Point}（提供一些 cpu 原理， 但用的是 NASM）。
...
\item \verb|push %xxx| 是把寄存器的值 push 到 stack 顶部。
