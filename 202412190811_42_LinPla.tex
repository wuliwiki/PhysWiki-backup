...
\end{aligned}~
\end{equation}
其中 $x_B=(x_1,\cdots,x_m)^T,x_N=(x_{m+1},\cdots,x_n)^T,\lambda=(\lambda_1,\cdots,\lambda_),b=(b_1,\cdots,b_n)^T,c=(c_1,\cdots,c_n)^T$, $B$ 是 $A=(a_{ij})$ 的前 $m$ 列构成的矩阵，$N$ 是后 $n-m$ 列构成的矩阵。
\end{theorem}
