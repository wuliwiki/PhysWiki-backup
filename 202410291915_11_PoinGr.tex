...
\begin{equation}
\begin{aligned}
& {\left[J_i, J_j\right]=\I \varepsilon_{i j k} J_k, \quad\left[J_i, K_j\right]=\I \varepsilon_{i j k} K_k, \quad\left[J_i, P^j\right]=\I \varepsilon^{i j k} P^k} \\
& {\left[K_i, K_j\right]=-\I \varepsilon_{i j k} J_k, \quad\left[P^i, P^j\right]=0, \quad\left[P^i, K_j\right]=-\I \delta^i_j H} \\
& {\left[J_i, H\right]=0, \quad\left[P^i, H\right]=0, \quad\left[H, K_i\right]=-\I P^i}
\end{aligned}~.
\end{equation}
