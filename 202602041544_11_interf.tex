...
在\autoref{sub_mcwave_1}，我们导出了如下规律，倘若两个简谐波的初相位差为0，那么空间中波程差为$n\lambda$的位置是振动加强点，波程差为$(2n+1)\lambda/2$则为振动减弱点。本章，我们将利用这个规律求得干涉实验的一些特点。

首先，我们回顾一下光是什么呢？作为电磁波，有电场和磁场两个分量，且都在做简谐振动，振动方向与传播方向垂直。
\subsection{双缝干涉}
\subsubsection{理论推导}
