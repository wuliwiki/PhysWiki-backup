...
\end{figure}
为了更进一步地解决这个问题，我们需要建立一个更复杂的模型。如\autoref{MetDfm_fig8} 所示，我们假设滑移面是红色面，滑移方向是黑色线。那么，外力F在滑移方向上的分切应力为
\begin{equation}
\tau=\frac{F \cos \lambda}{A/{\cos \phi}}=\frac{F}{A}{\cos \lambda}{\cos \phi}
\end{equation}

其中，$\lambda$与$\phi$之和不一定为$90^\circ$，他们是相对独立的变量。至于为什么力要除以面积，这是使用了在材料科学中更实用、准确的概念，应力。你可以不大严谨地权且理解为“压强”。\textsl{霍金曾经说过，文章每多一个公式，就少一半读者，但我没霍金那么厉害，我只能迫不得已地在这里放一个公式（}

只有当这个应力大于某一个最小值时，位错才会开始滑移。这个最小值被称为临界分切应力$\tau_s$。
$$
\tau>\tau_s\Rightarrow\text{位错开始滑移}
$$
