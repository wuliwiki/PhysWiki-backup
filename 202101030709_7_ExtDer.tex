...
\addTODO{添加引用：\textsl{Gauge Fields, Knots and Gravity}}
\addTODO{百科中尚未创建“规范场论”部分．}
...
其中$\mathbb{R}^4$可以写成三维空间和一维时间的乘积：$\mathbb{R}^3\times\mathbb{R}$．这个四维欧几里得空间中的时间轴记为$x^0$轴，空间轴则记为$x^2, x^2, x^3$轴．在这种表示下，$\partial_tB$就成了$\partial_0B$．
...
麦克斯韦方程组的剩下两个方程的表示，需要引入新的概念，因此本节暂且不表．
