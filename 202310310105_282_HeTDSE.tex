...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/d64c045a77cd39a6.png}
\caption{束缚态分波截断噪音 2 （缩小时间步长，增加 Krylov 阶数）} \label{fig_HeTDSE_5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/678cf8e374066cc5.png}
\caption{} \label{fig_HeTDSE_8}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/c6e7d5bad4e807c4.png}
\caption{完美波形} \label{fig_HeTDSE_6}
\end{figure}
