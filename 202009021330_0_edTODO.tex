...
\item 增加一个 “改进意见” 按钮， 图标用一个包含感叹号的三角形， 放到 “对齐” 图标的右边． 图标可以下拉选择 “草稿”（\verb|\issueDraft|）， “缺引用”（\verb|\issueNeedCite|）， “未完成”（\verb|\issueTODO|） ， “缺说明”（\verb|\issueAbstract|）， “缺预备知识”（\verb|\issueMissDepend|）．
