...
三维欧几里得空间是我们最为熟悉的空间，其性质也非常好，易于研究。本节讨论的是三维空间中的可微/光滑参数曲线 $f: I = (a, b) \to \mathbb{R}^3$ 的性质，介绍了Frenet向量组以及该组中向量之间的关系，并引入了曲率、挠率等概念。

\addTODO{定义Frenet向量组需要用到$C^2$的条件，单纯$C^1$是不够的。}
