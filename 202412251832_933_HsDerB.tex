...
反比例函数&$\displaystyle\frac{1}{x},x^{-1}$             & $\displaystyle-\frac{1}{x^2}$           \\ \hline
...
表中常数函数和反比例函数实际上可以看作幂函数的一种特例。例如，常数函数对应幂函数 $x^n$ 中 $n=0$ 的情形，而反比例函数 $y = \frac{1}{x}$ 则对应 $n = -1$ 的情形。特意将反比例函数与以 $\E$ 为底的对数函数单独列出，目的是帮助初学者更好地区分这些容易混淆的部分。初学者在理解这两类函数时，往往会因其形式相似而混淆，尤其是在导数计算中。
