...
现在，我们证明 $\{(1/n) y_n\}$ 在 $E$ 中有界：任意零邻域 $U$，存在 $U_i\subset U$（ $\{U_n\}$  时确定邻域系）。又因为 $y_n\in U_n$，所以 $y_n\in U_n\subset U_i\subset U,n\geq i$，即 $\{y_n\}\rightarrow 0$。

而 $\{A(1/n y_n)\}$ 在 $E_1$ 中无界（因为它不属于零邻域 $V$），因此 $A$ 无界。此矛盾证明了命题。
