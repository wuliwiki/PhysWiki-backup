...
\begin{equation}
\gamma\color{OliveGreen}\vec{a}\color{Black}(\color{OliveGreen}\vec{a}\color{Black}\times\color{Red}\vec{b}\color{Black})-\gamma\color{Red}\vec{b}\color{Black}(\color{OliveGreen}\vec{a}\color{Black}\times \color{OliveGreen}\vec{a}\color{Black}) = \color{OliveGreen}\vec{a}\color{Black}\times\qty(\color{OliveGreen}\vec{a}\color{Black}\times\color{Red}\vec{b}\color{Black}) = 
~\end{equation}
