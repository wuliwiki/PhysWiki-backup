...
\item 由de Morgan公式，$\bigcap_{i=1}^\infty E_i=[\bigcup_{i=1}^\infty E_i^C]^C$，因此只需证明$\bigcup_{i=1}^\infty E_i$是可测集即可．我们首先证明，当$E_i$两两不交的时候，$\bigcup^\infty_{i=1}E_i$是可测的．任取$A\in\mathbb{R}^n$，记$c_0=\opn{m^*}A$，$c_k=\opn{m^*}(A\cap[\bigcup_{i=1}^k E_k])$，那么$\lim\limits_{k\to \infty}c_k=\opn{m^*}(A\cap[\bigcup_{i=1}^\infty E_k])$
