...
6. Euler, Leonhard（1736），“Theorematum quorundam ad numeros primos spectantium demonstratio” \[关于素数的若干定理的证明]，《圣彼得堡科学院院刊》（*Commentarii Academiae Scientiarum Imperialis Petropolitanae*，拉丁文），第 8 卷，第 141–146 页。
7. Ore 1988，第 273 页。
8. Hensel, Kurt（1913），《数论》（*Zahlentheorie*，德文），德国柏林与莱比锡：G. J. Göschen，第 103 页。
9. Albert 2015，第 206 页。
10. Trappe, Wade；Washington, Lawrence C.（2002），《编码理论与密码学导论》（*Introduction to Cryptography with Coding Theory*），Prentice-Hall，第 78 页，ISBN 978-0-13-061814-6。
11. 如果 $y$ 与 $n$ 不互素，则欧拉定理不成立，但这种情况极少见，因此通常不予考虑。事实上，如果偶然出现这种情况，就可以轻易分解 $n$，从而破解对应的 RSA 实例。
12. Sloane, N. J. A.（编），“数列 A128311（$2^n - 1 - 1$ 除以 $n$ 的余数）”，*在线整数数列百科全书*（The On-Line Encyclopedia of Integer Sequences），OEIS 基金会。
13. Sarrus, Frédéric（1819–1820），“Démonstration de la fausseté du théorème énoncé á la page 320 du IXe volume de ce recueil” \[对本集第九卷第 320 页所述定理之错误性的证明]，《纯与应用数学年刊》（*Annales de Mathématiques Pures et Appliquées*，法文），第 10 卷，第 184–187 页。
14. Rempe-Gillen, Lasse；Waldecker, Rebecca（2013-12-11），“4.5.1 引理（模质数的单位根）”，《初学者的素数判定》（*Primality Testing for Beginners*），美国数学学会（American Mathematical Society），ISBN 9780821898833。

---

如果你愿意，我可以帮你把 **References（参考文献）** 部分也翻译掉，这样费马小定理的全文就完全完成了。
