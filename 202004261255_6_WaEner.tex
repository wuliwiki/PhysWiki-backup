...
为了更精确地描述波在介质中的分布情况，引入能量密度的概念介质中单位体积的波动能量，称为\textbf{波的能量密度}，用$w$表示，设弦线的横截面积为$S$，其体密度为$\rho$，它与线密度$\rho_l$的关系为$\rho_l=\rho S$，则能量密度
\begin{equation}
...
\begin{equation}
\frac{1}{\mathrm{T}} \int_{0}^{\mathrm{T}} \sin ^{2} \omega t \mathrm{d} t=\frac{1}{2}
\end{equation}
所以能量密度在一个周期内的平均值为
\begin{equation}
