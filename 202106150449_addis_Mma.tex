...
\item \verb|E| 或 \verb|\[ExponentialE]| 自然对数
\item \verb|Degree| 1° 角的弧度
\end{itemize}
...
\item 调整字体大小 \verb|Ctrl + 鼠标滚轮|．
\item 快捷键 \verb|Shift + Enter| 执行选中的行．
\item 快捷键 \verb|Ctrl + L| 可以调用最近的输入．
\item 快捷键 \verb|Ctrl + Shift + L| 可以调用最近的输出．
\item 快捷键 \verb|Ctrl + _| 输入下标． 相当于 \verb|Subscript[x, y]|．
\item 快捷键 \verb|Ctrl + /| 输入分式， 相当于 \verb|x / y|．
\item 快捷键 \verb|Ctrl + 2| 或 \verb|Ctrl + @| 输入根式， 相当于 \verb|Sqrt[]|．
\end{itemize}
