...
然而 streaking trace 需要的不是上式的概率而是某个方向的概率． 我们只需稍作修改， 把\autoref{HeAnal_eq36} 结合结合\autoref{CulmWf_eq6}~\upref{CulmWf} 即可．

理论上， 如果把\autoref{HeAnal_eq10} 对所有 $n_1, l_1, m_1$ 求和， 应该得到\autoref{HeAnal_eq11} ．
