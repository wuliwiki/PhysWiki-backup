...
\caption{\autoref{WigThe_eq5} 的几何推导．图中显示了$1$和$1+\frac{C_\alpha}{C_\beta}$两个点，红圈表示模与$\abs{1+\frac{C_\alpha}{C_\beta}}$相同的点的集合，绿圈表示} \label{WigThe_fig1}
\end{figure}
