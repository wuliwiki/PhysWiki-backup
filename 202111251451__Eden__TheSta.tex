...
因此
\begin{equation}
\alpha=-\frac{\mu}{T},\beta=\frac{1}{kT}
\end{equation}
玻尔兹曼分布可以写为：
\begin{equation}
...
或者我们利用推导玻尔兹曼分布时用的拉格朗日乘子公式\autoref{MBsta_eq7}~\upref{MBsta}，可以得到
\begin{equation}
\delta(S/k)-\alpha \delta N-\beta \delta E=0
\end{equation}
由此可得
\begin{equation}
\qty(\frac{\partial S}{\partial N})_{V,E}=\alpha,\qty(\frac{\partial S}{\partial E})_{V,N}=\beta
\end{equation}
