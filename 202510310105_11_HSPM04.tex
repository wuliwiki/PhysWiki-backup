...
如果现在再给定一个运动轨迹$\bvec r_2(t)=(x_2(t),y_2(t))$，并进行叠加呢？也就是说，物体的真正轨迹为$\bvec r'(t)=(x_1+x_2,y_1+y_2)$。这种合成和分解显然基于矢量的可加性。比如$x$轴上有两个运动，$x_1=5t,x_2=8t^2$，那么合运动就可以\textbf{看作}是速度为$5m/s$

运动是由力决定的，如果我们不知道物体的实际轨迹，可以根据牛顿定律进行运动的分解。比如
