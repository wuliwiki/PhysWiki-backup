...
\begin{equation}
\begin{aligned}
& q\bvec{v}_\parallel q^{-1}\\
    ={}& \qty(\cos\frac{\theta}{2}, \hat{\bvec{n}}\sin\frac{\theta}{2})\times\qty(0, \bvec{v}_\parallel)\times\qty(\cos\frac{\theta}{2}, -\hat{\bvec{n}}\sin\frac{\theta}{2})\\
    ={}& \qty(\hat{\bvec{n}}\cdot\bvec{v}_\parallel \sin\frac{\theta}{2}, \bvec{v}_\parallel\cos\frac{\theta}{2})\times\qty(\cos\frac{\theta}{2}, -\hat{\bvec{n}}\sin\frac{\theta}{2})\\
    ={}& \hat{\bvec{n}}\cdot\bvec{v}_\parallel\sin\frac{\theta}{2}\cos\frac{\theta}{2}-\hat{\bvec{n}}\cdot\bvec{v}_\parallel\cos\frac{\theta}{2}\sin\frac{\theta}{2}, \\
    & -\hat{\bvec{n}}(\hat{\bvec{n}}\cdot\bvec{v}_\parallel)\sin^2\frac{\theta}{2}+\bvec{v}_\parallel\cos^2\frac{\theta}{2}\\
    ={}& (0, )
\end{aligned}
~\end{equation}
