...
两体问题研究的对象是两个可以看成质点的物体，质量分别为 $m_1,m_2$，位矢分别为 $\bvec r_1,\bvec r_2$。它们之间的相互作用势是 $V(r)=V(|\bvec r_1-\bvec r_2|)$，也就是说只和两者的距离有关。\enref{开普勒问题}{CelBd}、\enref卢瑟福散射\upref{RuthSc} 都属于两体问题。
