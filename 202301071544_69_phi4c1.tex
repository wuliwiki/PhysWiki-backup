...
下面再来计算 $\delta_\lambda$，四点截肢的单圈图共有三种，分别对应 $u,s,t$ 通道的双粒子散射图。除了计算三个单圈图的贡献，还有一个抵消项顶点。所以
\begin{equation}
i\mathcal{M}(p_1p_2\rightarrow p_3p_4) = -i\lambda + (-i\lambda)^2 \int \frac{\dd[4]{k}}{(2\pi)^4} \frac{i}{k^2-m^2+i\epsilon} \frac{i}{(k+p_1+p_2)^2-m^2} + (p_2\leftrightarrow p_3)+(p_2\leftrightarrow p_4)-i\delta_\lambda
\end{equation}
