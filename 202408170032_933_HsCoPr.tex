...
解析：
\begin{itemize}
\item 原本命题是初中学过的矩形的一个性质。如果完全写成简单命题组合的形式，应该是：$\forall x\in A,P(x)\Rightarrow (Q(x)\land)$
\item 否定与原本命题的真伪相反，否定时“任意”会变成“存在”，并根据条件命题的否定是“$P\land\lont Q$”可得后面的结论。事实上，由于矩形
\end{itemize}
\end{itemize}
\end{exercise}
