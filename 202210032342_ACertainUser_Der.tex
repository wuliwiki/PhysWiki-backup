...
类似于单侧极限\upref{FunLim}，我们也可以引入单侧导数的概念．如果B点从右侧趋近A点，但始终不运动到A点的左侧，那么此时切线的斜率即为该点处函数的右侧导数值，可以记为$f'_+(x)$．用极限的语言就是
\begin{equation}
...
\begin{example}{}
如图，在棱角处，虽然函数有定义，且左、右导数均存在，但他们的大小不相同，因此在棱角处该函数不可导．
\begin{figure}[ht]
\centering
