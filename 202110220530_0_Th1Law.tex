...
热力学第一定律是\textbf{能量守恒}在热力学中的形式． \textbf{热量}是指当热学系统出现温度差时引起的能量转移， 记为 $Q$． 热力学第一定律表明， 外部对系统传递的热量等于系统对外做功加上系统的内能增加：
\begin{equation}\label{Th1Law_eq1}
\Delta Q = W + \Delta E
\end{equation}
我们把系统的压强记为 $P$， 体积记为 $V$． 系统的内能 记为 $E$， 有时也用字母 $U$ 表示．热力学第一定律的另一种表述是：\textbf{第一类永动机}是不可能造成的．

虽然功和热都是能量的转移， 但热是通过微观粒子的无规则相互作用传递的， 而功在热力学中特指宏观的作用力．对于容器中的气体，设其压强为 $P$，体积为 $V$，那么对外做功可以写成积分形式：
\begin{equation}
W = \int P \dd{V}
\end{equation}
热力学第一定律写成微分形式是
