...
\hline
弗里德曼零曲率宇宙（Friedmann zero-curvature）& 爱因斯坦与德西特（Einstein and De Sitter，1932） \quad 膨胀的平坦空间（Expanding flat space），$k = 0$，$\Lambda = 0$，临界密度（Critical density） \quad 曲率常数 $k = 0$。据称该宇宙是无限的（但解释上含糊），被描述为“无界而有限的宇宙”（Unbounded cosmos of limited extent）。该模型永远膨胀，是所有已知宇宙模型中“最简单”的一种。以弗里德曼命名，但非其本人提出。其减速因子 $q = 1/2$，意味着宇宙的膨胀速率在逐渐减慢。
\hline
原始大爆炸模型（The original Big Bang, Friedmann–Lemaître） \quad 乔治·勒梅特（Georges Lemaître，1927–1929） \quad 膨胀宇宙（Expansion），$\Lambda > 0$，且 $\Lambda > |\text{Gravity}|$ \quad 宇宙常数 $\Lambda$ 为正，且其量级大于引力。宇宙从一个高密度初态（“原初原子” \emph{primeval atom}）起始，随后经历两个阶段的膨胀。$\Lambda$ 被用于“使宇宙失稳”以促成膨胀。（勒梅特被公认为“大爆炸模型之父”。）
\hline
振荡宇宙（Friedmann–Einstein Oscillating universe） \quad 弗里德曼主张于 1920 年代 \quad 膨胀与收缩交替循环（Expanding and contracting in cycles） \quad 时间无始无终，从而避免“时间起点悖论”。宇宙经历永恒的循环：大爆炸（Big Bang）之后是大坍缩（Big Crunch）。（这是爱因斯坦在否定其 1917 年静态模型后提出的首选方案。）
\hline
爱丁顿宇宙（Eddington universe） \quad 阿瑟·爱丁顿（Arthur Eddington，1930） \quad 先静态后膨胀（First static then expands） \quad 基于爱因斯坦 1917 年的不稳定静态宇宙，其平衡被扰动后进入膨胀状态；随着物质的不断稀释，演化为德西特宇宙。宇宙常数 $\Lambda$ 支配引力效应。
\hline
米尔恩运动相对论宇宙（Milne universe of kinematic relativity） \quad 爱德华·米尔恩（Edward Milne，1933, 1935）；威廉·H·麦克雷（William H. McCrea，1930s） \quad 运动学膨胀（Kinematic expansion without space expansion） \quad 否定广义相对论与空间膨胀范式。模型未将引力作为初始假设。符合宇宙学原理（cosmological principle）与狭义相对论（special relativity）。宇宙由一个有限的球形粒子（或星系）云构成，在无限且空旷的平坦空间中膨胀。它具有中心与边界（粒子云表面），边界以光速膨胀。其引力解释复杂且缺乏说服力。
\hline
弗里德曼–勒梅特–罗伯逊–沃尔克模型族（Friedmann–Lemaître–Robertson–Walker class of models） \quad 霍华德·罗伯逊（Howard Robertson）、阿瑟·沃尔克（Arthur Walker，1935） \quad 均匀膨胀宇宙（Uniformly expanding） \quad 一类均匀且各向同性的宇宙模型。时空分解为均匀曲率空间与宇宙时间，所有共动观察者共享同一宇宙时。此系统化形式被称为弗里德曼–勒梅特–罗伯逊–沃尔克度规（FLRW metrics）或罗伯逊–沃尔克度规。
\hline
稳态宇宙（Steady-state, Bondi–Gold） \quad 赫尔曼·邦迪（Hermann Bondi）、托马斯·戈尔德（Thomas Gold，1948） \quad 膨胀、稳态、无限（Expanding, steady state, infinite） \quad 物质的生成速率维持恒定密度。物质不断从“无中”产生（continuous creation out of nothing from nowhere）。宇宙呈指数膨胀。减速因子 $q = -1$。
\hline
稳态宇宙（Steady-state, Hoyle） \quad 弗雷德·霍伊尔（Fred Hoyle，1948） \quad 膨胀、稳态但不稳定（Expanding, steady state; but unstable） \quad 物质的生成速率维持恒定密度。然而，由于物质生成速率必须与空间膨胀速率精确平衡，该体系在本质上是不稳定的。
\hline
双重等离子宇宙（Ambiplasma universe） \quad 汉尼斯·阿尔文（Hannes Alfvén）、奥斯卡·克莱因（Oskar Klein，1965） \quad 等离子体宇宙（Cellular universe, expanding by matter–antimatter annihilation） \quad 基于等离子体宇宙学（plasma cosmology）。宇宙被视为由“双层结构”分隔的“超星系”（meta-galaxies）组成的泡状体系。其他宇宙由其他泡泡形成。持续的物质–反物质湮灭（matter–antimatter annihilation）使这些泡泡保持分离并不断远离，从而防止它们相互作用。
\hline
布兰斯–迪克理论（Brans–Dicke theory） \quad 卡尔·H·布兰斯（Carl H. Brans）、罗伯特·H·迪克（Robert H. Dicke） \quad 膨胀宇宙（Expanding） \quad 基于马赫原理（Mach's principle）。引力常数 $G$ 随宇宙膨胀而变化。然而，“没有人能确切说明马赫原理究竟意味着什么。”\,[\emph{citation needed}]
\hline
* & * & * & * \\
\hline
* & * & * & * \\
