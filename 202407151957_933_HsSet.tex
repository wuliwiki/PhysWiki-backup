...
提前提醒一下，由于集合是高中阶段第一个接触到的概念，这篇文章会涵盖许多与集合相关的新概念，请不要被这些它们的数量吓倒，它们其实都是一些自然而然的概念，在高中阶段也并不要求对他们进行过深的探索。同时，请务必理解这部分的内容，哪怕暂时不熟悉这些概念的名称，但一定要理解他们的意思，理解不同概念之间的差异点会很有帮助。由于这些概念很常用，在使用时再逐步熟悉它们名称就可以了。
