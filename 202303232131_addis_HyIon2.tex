...
\begin{equation}
\begin{aligned}
&\quad\int \psi_{\bvec k}^{(-)}(\bvec r)^* z \psi_{nlm}(r,\theta,\phi) r^2 \dd{r}\dd{\Omega}\\
&= \sum_{l',m'} \frac{\I^{-l}}{k} \E^{\I\sigma_l} Y_{l,m}(\uvec k) \int \frac{1}{r} \sqrt{\frac{2}{\pi}} F_{l'}\qty(\eta, kr) Y_{l',m'}^*(\uvec r) \qty(r \sqrt{\frac{8\pi}{3}} Y_{1,0}(\uvec r))R_{n,l}(r) Y_{l,m}(\bvec r) r \dd{r}\dd{\Omega}\\
&= \sqrt{\frac{16}{3}}\sum_{l',m'} \frac{\I^{-l'}}{k} \E^{\I\sigma_{l'}} Y_{l',m'}(\uvec k) \int F_{l'}\qty(\eta, kr) R_{n,l}(r) r \dd{r} \int Y_{l',m'}^*(\uvec r)Y_{1,0}(\uvec r)Y_{l,m}(\bvec r) \dd{\Omega} \times\\
&= \sqrt{\frac{4}{\pi}} \sum_{l'} \frac{\I^{-l'}}{k} \E^{\I\sigma_{l'}} \int F_{l'}\qty(\eta, kr) R_{n,l}(r) r \dd{r}\\
& \qquad \sum_{m'}  Y_{l',m'}(\uvec k)  (-1)^{m'}\sqrt{{(2l'+1)(2l+1)}} \pmat{l'& 1& l\\ 0 & 0 & 0}\pmat{l' & 1 & l\\  -m' & 0 & m}
\end{aligned}
\end{equation}
