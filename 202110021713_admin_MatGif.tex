...
要用 Matlab 制作一个完整的动画（例如这个演示\href{https://wuli.wiki/apps/Lim0.html}{数列极限的动画}）， 可以先写一个程序画好每一帧后用 \verb|saveas()| 函数自动保存为 \verb|1.png|， \verb|2.png|, 等， 共 60 张图， 如\autoref{MatGif_fig1}．
\begin{figure}[ht]
\centering
