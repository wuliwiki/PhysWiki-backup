...
长度规范的思路是： 如果使 $\bvec A_L \equiv 0$， 就可以简化该式． 用不带撇的变量表示库仑规范， 我们令
...
\end{equation}
利用规范变换（\autoref{QMEM_eq5}~\upref{QMEM}）， 以及 $-\pdv*{\bvec A_C}{t} = \bvec {\mathcal E}$， （$\bvec {\mathcal E}(t)$ 是除静电场以外的含时电场）（库伦规范+偶极子近似，引用未完成）以及 $\varphi_C = 0$
