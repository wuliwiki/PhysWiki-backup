...
\autoref{the_CauEq_4} 中 \autoref{eq_CauEq_1} 表明，在 $X^*$ 中，由 $X$ 中的点所构成的任何柯西序列 $\{x_n\}$ 都收敛到 $X^*$ 中的某一点，即收敛到用这个序列本身所定义的点 $x^*\in X^*$。其次，因为 $X$ 在 $X^*$ 中稠密，所以对 $X^*$ 中的点构成的任一柯西序列 $\{x_n^*\}$，只需取 $X$ 中
