...
\pentry{解析几何\nref{nod_JXJH}，圆\nref{nod_HsCirc},函数的变换}{FunTra}}{nod_32e0}
...
先来研究水杯杯口那种略微压扁的圆形轮廓，只从几何变化的角度入手，参考 \enref{ 中介绍的变换方法，从单位圆出发，研究其经过轴向放缩后所形成的曲线。具体地，考虑将单位圆在 $x$ 轴和 $y$ 轴方向分别拉伸 $p$ 倍和 $q$ 倍（其中 $p, q$ 为任意正数）。单位圆的方程为：
\begin{equation}
x^2 + y^2 = 1~.
\end{equation}
