...
我们给出一些不是唯一析因环的例子。
\begin{itemize}
\item 环 $\mathbb{Z}[\sqrt{-2}]=\{a+b\I\sqrt{2}|a, b\in\mathbb{Z}\}$ 存在有多种因式分解方式的元素。比如说，$6$ 可以分解为 $2\times (1+\I\sqrt{2})\times(1-\I\sqrt{2})$，也可以分解为 $(2+\I\sqrt{2})\times(2-\I\sqrt{2})$。
...
给定一个整环，如何判断它是否是唯一析因环呢？有限析因性通常是容易判断的，如$\mathbb{Z}[\sqrt{-2}]$中，任意元素$a+b\I \sqrt{2}$的真因子之模长一定小于$\abs{a+b\I\sqrt{2}}$，这就足以判断有限析因性\footnote{当然，我们已经知道$2$}——但
