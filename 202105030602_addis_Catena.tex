...
\begin{equation}
L(x) = \int_0^x \sqrt{1 + y'^2} \dd{x}
\end{equation}
区间 $[0, x]$ 所受重力为 $G = \lambda L g$． 根据受力分析， $x$ 点的斜率为 $[0, x]$ 所受重力除以水平拉力 $T$， 这样就得到了xuanl $y(x)$ 的微分—积分方程
\begin{equation}
y'(x) = \frac{g\lambda}{T} \int_0^x \sqrt{1 + y'^2} \dd{x}
\end{equation}
