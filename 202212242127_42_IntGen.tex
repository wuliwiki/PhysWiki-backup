...
下面将介绍常微分方程的一般积分，它是常微分方程解的一般形式。物理学中“运动积分”（或“运动方程的积分”）（运动积分\upref{motint}）和“循环积分”中的“积分”之所以叫“积分”的原因，可以在本词条得到解答。
...
\textbf{有时}我们说方程组的积分，不是指等式\autoref{IntGen_eq9} ，而是指函数 $\varphi_i(x,y_1,\cdots,y_n)$。就是说，若把方程组的任何解代入函数 $\varphi(x,y_1,\cdots,y_n)$ 中，$\varphi$ 成为常数，则函数 $\varphi$ 叫作这方程组的\textbf{积分}。  
