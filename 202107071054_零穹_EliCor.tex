...
\begin{equation}
\begin{aligned}
\curl \bvec A =& \frac{1}{\sqrt{2}c\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\sqrt{2}\sinh\xi\sin\eta\pdv{\eta}
...
\end{equation}
\begin{equation}
\laplacian s = \frac{1}{\sqrt{2}c^3\sinh\xi\sin\eta\qty(\sinh^2\xi+\sin^2\eta)}\qty(\pdv{\xi}\qty(\sqrt{2}c\sinh\xi\sin\eta\pdv{s}{\xi}) + \pdv{\eta}\qty(\sqrt{2}c\sinh\xi\sin\eta\pdv{s}{\eta})  )+ \pdv{\phi}\qty(\frac{1}{\qty(2c^2\sinh\xi\sin\eta) }\pdv[2]{s}{\phi})
\end{equation}
