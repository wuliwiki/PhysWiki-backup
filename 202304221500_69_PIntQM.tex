...
\begin{theorem}{量子力学路径积分公式}
    ...
    \end{equation}
    那么 $\bra{x_f}e^{-i\hat HT}\ket{x_i}$ 的路径积分表达式为
    \begin{equation}
        \bra{x_f}e^{-i\hat HT}\ket{x_i}=\mathcal{N}\cdot\int \mathcal D[x] \exp\left(iS[x,\dot x]\right)
    \end{equation}
...
\begin{equation}
\begin{aligned}
        \bra{x_f}e^{-i\hat HT}\ket{x_i}&=\int d x_1\cdots d x_{N-1}
        \bra{x_f}e^{-i\hat H a}\ket{x_{N-1}}\bra{x_{N-1}}e^{-i\hat H a}
        \ket{x_{N-2}}\bra{x_{N-2}}\cdots \ket{x_{1}}\bra{x_{1}}e^{-i\hat H a}\ket{x_i}
        \\
        &=\int d x_1\cdots d x_{N-1}\frac{d p_1}{2\pi} \cdots \frac{d p_N}{2\pi}
        \bra{x_f}e^{-i\hat H a}\ket{p_N}\langle p_N|x_{N-1}\rangle 
        \\
        &\quad \times\bra{x_{N-1}}e^{-i\hat H a}
        \ket{p_{N-1}}\langle p_{N-1}|x_{N-2}\rangle
        \cdots \bra{x_{1}}e^{-i\hat H a}\ket{p_1}\langle p_1 | x_i\rangle
\end{aligned}
\end{equation}

将 $e^{-i\hat H a}=\exp[-ia[\hat p^2/2m + \hat V(\hat x)]]$ 改写为
\begin{equation}
        e^{-i\hat H a}
        =\exp[-ia\hat V(\hat x)]\exp\left[-ia\frac{\hat p^2}{2m}\right]+O(a^2)
\end{equation}
