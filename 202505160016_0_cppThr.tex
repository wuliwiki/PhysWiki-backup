...
void consumer(int id) {
    for (int i = 0; i < 10; ++i) {
        ...
        // not thread-safe is unlocked
        // (buffer might be poped by others and empty)
