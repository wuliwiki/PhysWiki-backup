...
如图\autoref{fig_HWBMtd_1} ，空间中存在三个源点$S_1$、$S_2$和$S_3$，其振动分别是$3\cos (t+0.45\pi)$、$5\cos t$和$3\cos (t-0.3\pi)$；三个源点在场点$P$处分别独立产生的振动为$0.6\cos(t-0.05\pi)$、$\cos(t-0.5)$和$1.05\cos t$，表示为如图所示的三个箭头，其中$\theta_1=0.12\pi$，$\theta_2=-0.33\pi$以及$\theta_3=0.17\pi$。
