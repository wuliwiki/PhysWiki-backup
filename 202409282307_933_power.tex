...
根据前面的分析，$n=-4,m=5,a<0$，所以函数的定义域是$({-\infty},0)\cup(0,{+\infty})$，是偶函数，函数图像关于$y$轴对称。在第一象限的区域$\rm{III,VI}$中，即在$(0,1)$区间内的图像在$y=1$上方，在$(1,+\infty)$区间内的图像在$y=1$xi方，。在$(0,{+\infty})$上递减，在({-\infty},0)上递增。过点$(-1,1),(1,1)$。
\end{exercise}
