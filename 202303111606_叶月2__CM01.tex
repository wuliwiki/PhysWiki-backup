...
\end{theorem}
由于$\frac{1}{t}\int \frac{dG}{dt}dt=\frac{1}{t}G\big|_{t_0}^{t_1}$，对于保守系，$\lim \limits_{t \to \infty}G\big|_{t_0}^{t_1}\leq \left|{G_{max}-G_{min}}\right|$，即分母为有限值，则无穷远时间后定理成立。
\begin{corollary}{势能为齐次线性函数}
容易证明，当势能为齐次函数，即$V(ax,ay,az)=a^nV(x,y,)$
\end{corollary}
