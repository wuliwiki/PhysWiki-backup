...
\item 密度矩阵是半正定矩阵。可以从\autoref{eq_denMat_1} 看到，对任意态 $\ket\varphi$，总是有 $\bra\varphi \rho \ket\varphi\ge 0$
\end{itemize}
...
但另一方面，如果非对角元非零，则一定意味着相干，因为非对角元非零代表着至少有一个$C_p^k\left(C_q^k\right)^*$非零，且并未因为经典平均抵消。因此我们称非对角元为相干项。
...
这说明了在能量表象下，密度矩阵$\rho$的布局数不变，而相干项以体系的 Bohr 频率震荡。
