...
现在我们来推导该对易子：
\begin{equation}
[\hat{\phi}(x),\hat{\phi}^\dagger(y)]=\int\frac{\mathrm d^3p}{\sqrt{2 E_{\vec p}}}\frac{\mathrm d^3p'}{\sqrt{2 E_{\vec p'}}}\mathrm {e}^{\mathrm {i}py}\mathrm {e}^{-\mathrm {i}p'x}[a_{\vec {p'}},a^\dagger_{\vec p}]+ [b^\dagger_{\vec {p'}},b_{{\vec p}}]~,
\end{equation}
