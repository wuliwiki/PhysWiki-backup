...
一个通用的结论是： 刚体在延轴方向叠加任意多次， 转动惯量公式不变． 例如波圆盘和圆柱体， 又例如细棒（中心轴）和薄长方体（共面轴）． 这是因为假设两个物体转动惯量分别为 $I_1 = \alpha M_1 R^2$ 和 $I_2 = \alpha M_2 R^2$， 总质量 $M = M_1 + M_2$， 那么总转动惯量为 $I = I_1 + I_2 = \alpha M R^2$．
