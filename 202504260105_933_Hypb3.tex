...
可以看到，推导得到的 \autoref{eq_Hypb3_3} 与 \autoref{eq_Hypb3_5} 在形式上完全一致\footnote{即此时$\left(\displaystyle\frac{m}{2}\right)^2=\displaystyle c^2-\left(\frac{m}{2}\right)^2=2$}。关于\autoref{ex_Hypb3_1} 有几点需要特别注意：
\begin{itemize}
