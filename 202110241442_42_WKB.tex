...
\textbf{2.渐进形式}
 ...
 $\opn{Ai(x)},\opn{Bi(x)}$ 函数的渐进形式\upref{AiryF} 为
\begin{equation}\label{WKB_eq22}
\begin{aligned}
\opn{Ai}(\xi) &\overset{\xi \to +\infty}{\longrightarrow} \frac{c_1}{2\sqrt{\pi} \xi^{1/4}} \exp(-\frac{2}{3}\xi^{3/2})\\
\opn{Ai}(\xi) &\overset{\xi \to -\infty}{\longrightarrow} \frac{c_1}{\sqrt{\pi} \abs{\xi}^{1/4}} \sin(\frac{2}{3}\abs{\xi}^{3/2}+\frac{\pi}{4})\\
\opn{Bi}(\xi) &\overset{\xi \to +\infty}{\longrightarrow} \frac{1}{\sqrt{\pi} \xi^{1/4}} \exp(\frac{2}{3}\xi^{3/2})\\
\opn{Bi}(\xi) &\overset{\xi \to -\infty}{\longrightarrow} \frac{1}{\sqrt{\pi} \abs{\xi}^{1/4}} \cos(\frac{2}{3}\abs{\xi}^{3/2}+\frac{\pi}{4})
\end{aligned}
\end{equation}

\textbf{3．连接公式}\cite{GriffQ}
