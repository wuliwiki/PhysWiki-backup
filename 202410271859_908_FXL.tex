...
\hline
\textbf{Transformation} & \textbf{Operator} & \textbf{Position} & \textbf{Momentum} \\
\hline
Translational symmetry & \( X(\mathbf{a}) \) & \( \mathbf{r} \to \mathbf{r} + \mathbf{a} \) & \( \mathbf{p} \to \mathbf{p} \) \\
\hline
Time translation & \( U(t_0) \) & \( \mathbf{r}(t) \to \mathbf{r}(t + t_0) \) & \( \mathbf{p}(t) \to \mathbf{p}(t + t_0) \) \\
\hline
Rotational invariance & \( R(\hat{\mathbf{n}}, \theta) \) & \( \mathbf{r} \to R(\hat{\mathbf{n}}, \theta) \mathbf{r} \) & \( \mathbf{p} \to R(\hat{\mathbf{n}}, \theta) \mathbf{p} \) \\
\hline
Galilean transformations & \( G(\mathbf{v}) \) & \( \mathbf{r} \to \mathbf{r} + \mathbf{v}t \) & \( \mathbf{p} \to \mathbf{p} + m \mathbf{v} \) \\
\hline
Parity & \( P \) & \( \mathbf{r} \to -\mathbf{r} \) & \( \mathbf{p} \to -\mathbf{p} \) \\
\hline
T-symmetry & \( T \) & \( \mathbf{r} \to \mathbf{r}(-t) \) & \( \mathbf{p} \to -\mathbf{p}(-t) \) \\
\hline
\end{tabular}
\caption{Transformations in Classical Mechanics}
\end{table}
