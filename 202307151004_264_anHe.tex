...
现在我们可以来算速度了，继续忽略外力$\bvec{F}$的高阶项，则有：
\begin{equation}
\bvec{v}=\frac{\dd{\ev{\bvec{r}}}}{\dd{t}}=\frac{\I}{\hbar}\ev{[\hat{H},\hat{\bvec{r}}]}=\frac{\I}{\hbar}\ev{[\frac{\hat{\bvec{p}}^2}{2m}+V(\bvec{r})-\bvec{F}\cdot\bvec{r},\hat{\bvec{r}}]}=\frac{\I}{\}~.
\end{equation}
