...
$P$到渐近线$\displaystyle y={b\over a} x$的距离为：
\begin{equation}
h=\frac{\displaystyle{b\over a}x_0-y_0}{\displaystyle{b^2\over a^2}+1}~.
\end{equation}
$P$作渐近线$\displaystyle y={b\over a} x$的平行线与另一条渐近线$\displaystyle y=-{b\over a} x$的交点满足下面的方程：
\begin{equation}
\begin{cases}
a\\
b
