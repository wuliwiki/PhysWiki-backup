...
事实上，主应力就是应力矩阵\upref{STRESS}的本征值\upref{EigVM}．对一个应力矩阵计算他的本征值，就能求解他的主应力．因此，主应力的求解是公式化的、不需要太多\textsl{灵性}．

对于二维情况，主应力就是方程
$$\sigma_p^2+(\sigma_x+\sigma_y)\sigma_p+\sigma_x\sigma_y-\tau^2=0$$
的两个根 
$$\sigma_p=\frac{\sigma_x+\sigma_y \pm \sqrt{(\sigma_x-\sigma_y)^2+4\}}{}$$