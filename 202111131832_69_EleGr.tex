...
设三维空间中 $z=0$ 下方是导体，$z=0$ 上方是真空．在 $(0,0,a)(a>0)$ 处有一个电荷量为 $+q$ 的电荷．求全空间的电势．

区域 $V$ 为 $z=0$ 上方空间．导体给出了边界条件 $\phi(\bvec r')|_{\partial V}=0$．用 Dirichlet 格林函数方法来求解．设 $r''=(0,0,-a)$，容易构造出以下函数
\begin{equation}
G_D(\bvec r,\bvec r')=\frac{1}{|\bvec r-\bvec r'|}-\frac{1}{|\bvec r''-\bvec r'|}
\end{equation}
它在区域 $V$ 内满足 Dirichlet 格林函数的两个条件．
\end{example}
