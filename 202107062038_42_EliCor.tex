...
\left\{
    \begin{aligned}
&\pdv*{\bvec{r}}{\xi}=c\sinh\xi\cdot\cos\eta\uvec{x}+c\cosh\xi\cdot\cos\eta\uvec{y}\\
...
\left\{
    \begin{aligned}
    &\uvec{\xi}=\frac{\pdv*{\bvec{r}}{\xi}}{\Big|\pdv*{\bvec{r}}{\xi}|}=\sinh\xi\cdot\cos\eta\uvec{x}+c\cosh\xi\cdot\cos\eta\uvec{y}\\
