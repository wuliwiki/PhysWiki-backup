...
\end{equation}
 即
 \begin{equation}
 \vec{pq_1},\vec{pq_2}\in U\Rightarrow \vec{pq_1}+\lambda(\vec{pq_2}-\vec{pq_1})\in\Pi
 \end{equation}
 取 $\dot{q_1}=\dot{p}$ ，并注意到 $\vec{pp}=0$，带入上式即得 $\vec{pq_2}\in U\Rightarrow\lambda\vec{pq_2}\in U$．取 $\lambda=\frac{1}{2}$，则 $\vec{pq_1},\vec{pq_2}\in U\Rightarrow \frac{1}{2}(\vec{pq_2}+\vec{pq_1})\in\Pi$，从而
$2\qty(\frac{1}{2}(\vec{pq_2}+\vec{pq_1}))\in U$
