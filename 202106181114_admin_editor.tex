...
\item 若要对整个百科全文搜索， 用\href{https://github.com/MacroUniverse/PhysWiki/tree/master/contents}{这个页面}， 若要搜索所有作者的编辑历史， 用\href{https://github.com/MacroUniverse/PhysWiki-backup}{这个页面}．
\end{itemize}
