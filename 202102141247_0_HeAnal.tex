...
\end{aligned}
\end{equation}
然而 streaking trace 需要的不是上式的概率而是某个方向的概率． 我们只需稍作修改， 把\autoref{HeAnal_eq9} 结合\autoref{CulmWf_eq6}~\upref{CulmWf} 即可．
...
同样， streaking trace 需要的不是上式的概率而是某个方向的概率． 我们只需稍作修改， 把\autoref{HeAnal_eq36} 结合结合\autoref{CulmWf_eq6}~\upref{CulmWf} 即可．
