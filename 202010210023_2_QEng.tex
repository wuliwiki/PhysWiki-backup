...
设带电直导线长为$L$，线电荷密度为$\lambda$，导线水平放置．以导体棒中点为坐标原点，建立$xOy$坐标系．现考虑导体棒的中垂线上与其距离为$d$的$P$点的电势．如下图所示．
...
对导线上的某一电荷微元，有$\dd q=\lambda \dd x$，该电荷微元到导线某一侧的任一点$P$的距离为$r=\sqrt{x^2+d^2}$，那么该电荷微元对导线某一侧的任一点$P$贡献的电势为
\begin{equation}
...
&=\frac{\lambda }{4 \pi \epsilon_{0}}\ln_{}{\frac{l+\sqrt{l^2+4d^2}}{-l+\sqrt{l^2+4d^2}}}
\end{aligned}
\end{equation}
