...
\subsection{均匀形核}
均匀形核理论假定固体晶胚直接从均匀液体中产生。在液体中，由于结构、能量起伏，液体中时而形成小原子团（晶胚）。假定液体中已形成一半径r的球形固体晶胚。
\begin{figure}[ht]
\centering
...
我们来分析晶胚形成前后系统自由能\upref{GibbsG}的变化：形成晶胚的过程中，虽然液-固相变降低了体积自由能 \upref{PTTVC2}，但新产生的相界面又提高了表面自由能\upref{sftens}，二者间存在竞争。因此，形成晶胚前后，系统总自由能变化： 
...
那么，液体中好不容易才形成的这一小晶胚能否顺利长大？这取决于晶胚的长大能否继续降低系统的自由能\upref{GibbsG}。仔细分析 \autoref{eq_NCLT_1} ，或者观察\autoref{fig_NCLT_2} ，我们就会发现，只有当晶胚的初始半径$r$大于某个半径$r_k$时，晶胚的长大能降低系统的自由能；否则，晶胚的减小反而能降低自由能。这意味着，任何半径小于$r_k$的晶胚都将自发缩小、衰亡。此半径称为\textbf{临界形核半径}。
\begin{figure}[ht]
\centering
...
一方面，随温度降低、过冷度升高，形核功降低，相应的能垒也降低，这有利于形核；但另一方面，随过冷度升高，原子从液相到固相的短程扩散被抑制，这不利于形核。如\autoref{fig_NCLT_7} 所示，这对矛盾使形核率随过冷度升高而先快后慢。用Arrhenius公式可以表示为
