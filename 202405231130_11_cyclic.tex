...
易证$\ev yG_1\cong \ev{y}\times G_1$\footnote{由于$G_1$是不变的，验证该性质时使之为$e$即可。画出韦恩图，这个清晰地看到，该同构实际上是把陪集映射到对应的点上，$$}。然后我们来看$G/G_1\ev{y}$，若结果是$\{e\}=eG_1\ev{y}$，定理自然得证。若结果并不是这个极大循环子群，那么我们可以用$G$继续商去$G_1\ev{y}$，在商群里找到另一个元素$z$，重复上述过程。