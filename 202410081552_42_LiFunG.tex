...
\textbf{证明：}由\autoref{lem_LiFunG_1} ，任一 $\xi\in L/\ker f$ 的代表元 $x$ 可写为 $x=\alpha x_0+y,y\in\ker f$。又 $\alpha x_0$ 和 $x$ 等价，因此 $\alpha x_0\in \xi$，即每一 $\xi$ 都有形如 $\alpha x_0$ 的代表元。即 $[\xi]=\alpha[x_0]$。 
