...
对比以上两式可以把双电离微分截面表示为
\begin{equation}
\pdv{\sigma_j}{\Omega_1}{\Omega_2} = \frac{2\pi m \omega k_1^2k_2^2}{s(\omega)}  P_{j\to {(\bvec k_1,\bvec k_2)}}~.
\end{equation}
即
\begin{equation}
\sigma_j(\omega) = \frac{2\pi m \omega k_1^2k_2^2}{s(\omega)}  P_{j\to {(\bvec k_1,\bvec k_2)}}~.
\end{equation}
