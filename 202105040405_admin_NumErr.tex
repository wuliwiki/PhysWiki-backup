...
\subsection{误差}
\textbf{误差（errors）}的基本概念在高中物理里面应该有所涉及，这里就不仔细展开了． 对于科学计算而言，我们所关注的主要是\textbf{相对误差(relative error)}和\textbf{绝对误差(absolute error)}．
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/NumErr_1.png}
\caption{请添加图片描述} \label{NumErr_fig1}
\end{figure}
