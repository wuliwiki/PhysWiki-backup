...
给定一组列矩阵$\mathcal{V}_1, \mathcal{V}_2, \cdots, \mathcal{V}_n$，如果存在\textbf{不全为零}的系数$a_1, a_2, \cdots, a_n$使得$a_1\mathcal{V}_1+a_2\mathcal{V}_2+\cdots+a_n\mathcal{V}_n$是\textbf{零矩阵}，那么称这组列矩阵\textbf
