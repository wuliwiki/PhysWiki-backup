...
\subsection{变量}
\begin{itemize}
\item \verb|Head[...]| 可用于判断一个对象的类型， 如 \verb|Head[1]| 是 Integer， \verb|Head[Pi]| 是 Symbol， \verb|Head[2/3]| 是 Rational， \verb|Head[3.14]| 是 Real， \verb|Sin[1]|  是 Sin， \verb|Head[2 Pi/3]| 是 Times．
