...
\begin{equation}
\begin{aligned}
&\mel{\frac{1}{r}\psi_{l',m}(r)Y_{l,m}}{\cos\theta\pdv{r}}{\frac{1}{r}\psi_{l',m}(r)Y_{l',m}}\\
&= \mel{\frac{1}{r}\psi_{l',m}(r)}{\cos\theta}{\frac{1}{r}\dv{r}\psi_{l',m}(r)}\\
& -\mel{\frac{1}{r}\psi_{l',m}(r)}{\frac{1}{r}\cos\theta}{\frac{1}{r}\psi_{l',m}(r)}~.
\end{aligned}
\end{equation}
