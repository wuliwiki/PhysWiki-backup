...
圆盘中心 $A$ 点相对于圆形轨道中心 $O$ 点的加速度， 也就是 $S'$ 相对于 $S$ 的加速度为（$\uvec R = \bvec R/R$ 是 $\bvec R$ 的单位向量）
\begin{equation}
...
\end{equation}
例如当 $\bvec r$ 和 $\bvec R$ 同方向时（点 $P$ 离 $O$ 最远）
\begin{equation}
\bvec a_S = -(R^2/r + 2r + 3R)\omega^2 \uvec R
\end{equation}
反方向时（点 $P$ 离 $O$ 最近）
\begin{equation}
\bvec a_S = (R^2/r + R)\omega^2\uvec R
\end{equation}
