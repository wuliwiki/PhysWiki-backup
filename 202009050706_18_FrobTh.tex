...
如果$u=u(x),u(x_0)=u_0$是这方程组的解, 那么根据偏导数的交换性, 显然可得
...
\end{equation}
在点$(x_0,u_0)$处成立. 因此, 欲使得\autoref{FrobTh_eq1}对于任何初值$u(x_0)=u_0$都可积, 则\autoref{FrobTh_eq2}必须在$U\times V$中处处成立. 显然\autoref{FrobTh_eq2}处处成立当且仅当向量场
$$
