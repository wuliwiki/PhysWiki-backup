...
& \qquad[\delta_{l_1',l_1+1}(l_1+1)\mathcal C_{l_1,m_1} - \delta_{l_1,l'_1+1}(l'_1+1)\mathcal C_{l'_1,m_1}]~.
}\end{equation}
...
& \qquad[\delta_{l_2',l_2+1}(l_2+1)\mathcal C_{l_2,m_2} - \delta_{l_2,l'_2+1}(l'_2+1)\mathcal C_{l'_2,m_2}]~.
}\end{equation}
