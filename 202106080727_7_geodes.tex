% 测地线
% keys geodesic|联络|直线|匀速直线运动|相对论|流形|manifold|connection|Christoffel 符号
...
也就是说，在$M$上，这条曲线可以表示为$c(t)=y^i(t)\partial_i$，其中$\partial_i$是点$\varphi(c(t))$处坐标偏微分算子对应的切向量，它们构成$U$的一个局部坐标系；各$y^i$是$c(t)$上的光滑函数，也是$\varphi(c(t))$上的光滑函数，同时还随着$t$变化而变化．
...
\begin{equation}
\begin{aligned}
\frac{D}{\dd t}T(t)&=\nabla_{c'(t)}(\dot{y}^i\partial_i|_{c(t)})\\
&=\frac{\dd}{\dd t}[y(c(t))]\partial_i+
\end{aligned}
\end{equation}
