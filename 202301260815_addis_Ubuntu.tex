...
\item 需要在 \verb`/etc/default/keyboard` 里面添加一行 \verb`XKBOPTIONS=ctrl:swapcaps`
\item 删除键盘快捷键 Alt+F5： \verb`gsettings set org.gnome.desktop.wm.keybindings unmaximize "['<Super>Down']"`
