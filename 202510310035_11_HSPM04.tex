...
\subsection{运动的合成与分解}
想象一下，物体在平面直角坐标系上运动，令它的运动轨迹表示为\bvec r(t)=(x(t),y(t))，每确定时刻$t$，就确定了该物体的位置。如果我们把每个时刻物体的位置投影到$x$轴或者$y$轴，相当于该物体在对应轴上亦有一个运动，x轴上物体作$x(t)$这一直线运动，$y$轴上同理。我们把这种“投影”结果称为物体的分运动，把物体实际运动称为合运动。
