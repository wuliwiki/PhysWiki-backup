...
给定域$\mathbb F$上的线性空间$V$，其上有一二次型$q$.理想同上定义，商代数则为几何代数(\textbf{geometric algebra})，即
\begin{equation}
...
v\cdot v=q(v)~,
\end{equation}
理想首先是正规子群。回想对正规子群求商集时，若$a，b$等价，即属于同一左陪集，那么$a^{-1}b$也属于该正规子群。因而，\autoref{eq_clf01_1} 的等价关系实际上指的是
