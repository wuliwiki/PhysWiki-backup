...
\end{equation}
要求任意矢量 $\bvec v = (v_1, v_2)\Tr$ 的旋转矩阵， 可以将 $\bvec v$ 表示成 $\uvec x$ 和 $\uvec y$ 的线性组合 $\bvec v = v_1\uvec x + v_2\uvec y$． 由\autoref{Mat_eq17}\upref{Mat}， 该线性组合的旋转变换等于 $\uvec x, \uvec y$ 分别做旋转变换再做同样的\href{https://youtu.be/kYB8IZa5AuE?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab&t=228}{线性组合}
， 即
\begin{equation}
\ali{
