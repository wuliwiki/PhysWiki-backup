...
\begin{equation}
\bvec F_x=-q\frac{\partial \phi}{\partial x}-q\frac{\partial \bvec A_x}{\partial t}+q\bvec v_y(\frac{\partial \bvec A_y}{\partial x}-\frac{\partial \bvec A_y}{\partial x})-q\bvec v_z(\frac{\partial \bvec A_z}{\partial x}-\frac{\partial \bvec A_x}{\partial z})~,
\end{equation}
利用$\frac{\mathrm{d}A(\bvec x,t)}{\mathrm{d}t}=\frac{\partial A}{\partial t}+\frac{\partial A}{\partial}$