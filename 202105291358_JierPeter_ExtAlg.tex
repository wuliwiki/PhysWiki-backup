...
\begin{equation}
f\wedge g(v_1, v_2, \cdots, v_{n+m})=\sum\limits_{\}\opn{sgn}(\sigma) f(x_{\sigma(1)}, x_{\sigma(2)}, \cdots, x_{\sigma(n)})\cdot g(x_{\sigma(n+1)}, \cdots, x_{\sigma(n+m)})
\end{equation}
其中$\sigma$是一个$n+m$元置换，$\opn{sgn}\sigma$
