...
\item \href{https://cmake.org/cmake/help/latest/module/CheckCXXSourceCompiles.html}{check_cxx_source_compiles(代码变量 输出变量)} 可以判断某个源码是否可以编译成功．
\end{itemize}

\subsection{依赖}
\begin{itemize}
\item \verb|find_package(包名)|
\item \verb|包名| 会在 \verb|CMAKE_MODULE_PATH| 的路径里面搜索名为 \verb|Find包名.cmake| 的文件．
\end{itemize}
