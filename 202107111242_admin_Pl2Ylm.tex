...
\subsection{推导}
理论上， \autoref{Pl2Ylm_eq1} 可以通过计算\autoref{SphHar_eq7}~\upref{SphHar} 得到， 但这个积分较为复杂， 可能需要借助 Mathematica 等工具\footnote{其实 Mathematica 也未必算得出一般表达式只能算给定的 $l, m$．}
\begin{equation}
\begin{aligned}
...
但是更简单的方法是把平面波看作定态薛定谔方程\upref{SchEq}
\begin{equation}
