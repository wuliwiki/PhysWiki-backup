...
\end{equation}
\begin{equation}
\ev{v^2}=A\int_{0}^{v_{max}} v^2\sin[2](\frac{\pi v}{v_{max}})\dd v=A\qty[\sin(\frac{\pi v}{v_{max}})\qty(\frac{v^2}{\frac{\pi }{v_{max}}}-\frac{2}{(\frac{\pi v}{v_{max}})^2})-\cos(\frac{\pi v}{v_{max}})]
\end{equation}
\end{example}