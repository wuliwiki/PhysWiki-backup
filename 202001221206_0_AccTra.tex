...
\subsection{一般情况}
类比\autoref{Vtrans_eq2}\upref{Vtrans}， 若两参考系之间有可能存在转动， $\bvec a_{r}$ 的定义会变得更微妙． 为简单起见， 我们现在只在 $S$ 系中讨论问题． 定义 $t$ 时刻点 $P$ 在 $S'$ 系中的固定点相对于 $S$ 系的加速度为 $\bvec a_{r}$． 那么有（比\autoref{AccTra_eq1} 多出了一项）
