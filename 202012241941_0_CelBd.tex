...
\pentry{中心力场问题\upref{CenFrc}， 万有引力\upref{Gravty}， 库仑定律\upref{ClbFrc}椭圆的三种定义\upref{Elips3}， 双曲线的三种定义\upref{Hypb3}， 抛物线的三种定义\upref{Para3}}
...
在开普勒问题中， 质点的运动轨道是圆锥曲线的一种， 力心处于焦点． 质点的机械能（动能加势能） $E$ 和角动量 $L$ 可以唯一地确定轨道的形状和大小． 轨道的形状一般由离心率 $e$ 描述， 大小由半通径 $p$ 描述（\autoref{Cone_eq5}~\upref{Cone}）． $E < 0$ 对应椭圆轨道， $E = 0$ 对应抛物线轨道\footnote{显然只有引力（$k < 0$）可以产生非正机械能， 即椭圆轨或抛物线轨道．}， $E > 0$ 对应双曲线轨道． 注意双曲线轨道有两支， 当 $k < 0$ （引力）时取离中心天体较近的一支， $k > 0$ （斥力）时取较远的一支．
\begin{align}
