...
假设 $p=2$, $q=1$，则表达式为 $\frac{x^2}{4} + y^2 = \lambda$，从内到外对应的参数值分别为$\lambda = 0.5,0.75, 1,1.5,2,2.5$。
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/6a64b2ebccddafb7.png}
\caption{椭圆族$\displaystyle\frac{x^2}{4} + y^2 = \lambda,(\lambda>0)$}\label{fig_Elips3_7}
\end{figure}

这样通过引入一个参数，就能够代表很多具有相似性质的椭圆，使得在一些问题求解的时候，能够更容易。
