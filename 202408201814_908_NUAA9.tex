...
其中\begin{aligned}
    H_{nl}^{'(t)} &= \int \gamma_n^*(x) F(x) e^{-\frac{t}{\tau}} \gamma_l(x) dx = e^{-\frac{t}{\tau}} \int \gamma_n^*(x) F(x) \gamma_l(x) dx \\\\
    &= e^{-\frac{t}{\tau}} F_{nl}, \quad F_{nl} = \int \gamma_n^*(x) F(x) \gamma_l(x) dx.
\end{aligned}