...
\end{lstlisting}
对于\verb|func2d(y,x)|函数进行二重积分， 其中\verb|a,b|为变量 $x$ 的积分区间，$ a < b $，而\verb|gfun(x)|到\verb|hfun(x)|为变量 $y$ 的积分区间，注意被积函数中变量$ y $与$ x $的位置必须和相应的积分限位置对应。\verb|args=()|中为向函数\verb|func2d(y,x)|中传递的参量，比如函数\verb|func2d(y,x,c,d,f)|，其中\verb|c,d,f|为向被积函数传递的参数，而
