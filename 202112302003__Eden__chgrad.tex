...
\begin{equation}
\begin{aligned}
\bvec S&=\frac{q}{4\pi R^2}\qty(\bvec{\hat n}\times (\bvec{\hat n}\times \bvec a'))^2=\frac{q}{4\pi R^2}\qty(\bvec {\hat n}(\bvec{\hat n}\cdot \bvec a')-\bvec a')^2\\
&=\frac{q}{4\pi R^2}\qty( -(\bvec{\hat n}\cdot \bvec a')^2+a'^2 )=\frac{q}{4\pi R^2}(\bvec{\hat n}\times \bvec a')^2\\
&=\frac{qa^2\sin^2\theta}{4\pi R^2}
\end{aligned}
\end{equation}
