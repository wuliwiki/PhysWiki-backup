...
E = \hbar \omega
\end{equation}
为满足周期的定义（$T_a = 2\pi/\omega_a$）， 必须令 $\beta_\omega = 1/\beta_t$． 使用以上 $\beta_E$ 和 $\beta_t$ 的关系， 可得原子单位下光子能量等于角频率
\begin{equation}\label{AU_eq2}
E_a = \omega_a
\end{equation}
我们以后会发现， 使用原子单位后所有得 $\hbar$ 都恰好被消去了， 所以一些文献中直接说 “原子单位中 $\hbar = 1$”， 但这并不利于理解． 这句话的一种理解方式是
