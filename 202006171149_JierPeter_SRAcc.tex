...
\vec{a'}=\frac{\dd}{\dd t}\vec{u'}\cdot\frac{\dd t}{\dd t'}=\frac{(1-v^3)^{3/2}}{(1-\vec{u}\vec{v})^3}[\vec{a}-\frac{1}{\sqrt{1-v^2}+1-v^2}(\vec{a}\times\vec{v})\times\vec{v}+\sqrt{1-v^2}(\vec{a}\times\vec{u})\times\vec{v}]
