...
若点列 $\{t_n^{-1}y_n\}$ 包含 $\{x_n\}$ 的无限个点，即任意 $N>0$，有 $i>N$，使得 $x_i\in\{y_n\}$。那么对任意 $N>0$，存在 $N_2>0$， 使得 $i\geq N_2$， $y_i\in \{x_n|n\geq N\}$：否则，存在 $N>0$，使得对任意 $N_2>0,i\geq N_2$，都有 $y_i\notin\{x_n|n\geq N\}$，于是一切 $$
