...
仿照\autoref{SHCal_eq1} 的变换过程，容易证明$a_4a_5+a_5a_6+a_6a_4$同调于$a_1a_2+a_2a_3+a_3a_1$．

根据\autoref{SHCal_lem1} ，任何闭链都可以表示为那七个链的组合，又因为是闭链，这种组合一定是$n_1(a_1a_2+a_2a_3+a_3a_1)+n_2(a_4a_5+a_5a_6+a_6a_4)+n_3(a_1a_4)$，其中各$n_i\in\mathbb{Z}$．
