...
下面我们来用一种极其简单的办法对单个天体在中心天体的万有引力作用下的运动进行简单的数值计算． 事实上运动方程存在解析解（见开普勒三定律\upref{Keple}）， 所以以下的算法只是用于演示数值解常微分方程的大致原理． 这种方法可以轻易地拓展到多个天体的情况， 而多体情况没有一般的解析解． 一种效率更高的常微分方程数值算法可见四阶龙格库塔法\upref{OdeRK4}．
