...
若定义在$D$上的函数$f(x)$，若函数在$I\subseteq D$上，对$\forall x_1,x_2\in I,x_1< x_2$满足：
\begin{equation}
f(x_1)<f(x_2)~.
\end{equation}
则称函数$f(x)$在区间$I$上\textbf{单调递增（monotonically increasing}），或函数$f(x)$在区间$I$上是\textbf{增函数}；若满足
\begin{equation}
f(x_1)>f(x_2)~.
\end{equation}
