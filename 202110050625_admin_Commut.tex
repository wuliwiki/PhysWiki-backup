...
\subsection{具体计算}
若给出两个对易的厄米矩阵 $\mat A, \mat B$， 先对 $\mat A$ 对角化， 得到本征列矢量组成的矩阵 $\mat P$， 做相似变换 $\mat P \mat A\mat P^{-1}$， 然后会发现 $\mat P \mat B\mat P^{-1}$ 是块对角矩阵， 其本征列矢量组成的矩阵可以排成块对角矩阵 $\mat R$， 每个块都是酉矩阵， 事实上
