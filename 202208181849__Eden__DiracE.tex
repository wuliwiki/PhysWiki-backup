...
\end{equation}
利用 $\gamma$ 矩阵的 weyl 手性表示\autoref{Dirac_eq9}~\upref{Dirac}，将上述方程改写为
\begin{equation}
\begin{aligned}
&(i\partial_0 - A_0-\bvec \sigma\cdot \bvec p)\psi_R=m\psi_L\\
&(i\partial_0-A_0+\bvec \sigma\cdot \bvec p)\psi_L = m\psi_R
\end{aligned}
\end{equation}
