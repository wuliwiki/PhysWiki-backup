...
\begin{itemize}
\item 虽然题目将不变量由椭圆中的“距离和”变为了“距离差”，但对比 \aref{椭圆的推导过程}{ex_Elips3_1} 可以发现，推导的过程和结构其实完全一致。唯一的区别在于数值关系的变化：原本椭圆中为 $m > 2c$，而在这里变为 $m < 2c$。为了使分母保持正值，这一变化最终导致 \autoref{eq_Hypb3_3} 与 \autoref{eq_Elips3_4} 在形式上有所差异。
