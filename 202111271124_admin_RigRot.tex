...
\subsection{角加速度与力矩}
要分析刚体的转动与受力的关系， 就要对系统使用角动量定理\upref{AMLaw}． 在这里 “系统” 指的就是刚体本身， 不包含任何相对刚体存在转动的物体． \autoref{RigRot_fig2} 中的转轴可以认为是一个数学上的直线而不是真实中机械的转轴， 不提供任何力和力矩． 现实中约束刚体延该数学转轴旋转的可能是不同的机械结构， 例如通过轴承将物体固定在一根不旋转的杆上， 此时杆则不属于刚体的一部分， 杆对旋转体的所有作用力都视为系统外力． 另一种大同小异的情况例如若杆与物体相对固定并一起转动， 则杆可以视为刚体的一部分， 
