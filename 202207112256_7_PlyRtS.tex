% 三次与四次多项式的根
% keys Galois理论|求根公式|五次方程|5次方程|Galois群|resolvent polynomial|Galois预解式|伽罗华预解式|伽罗瓦预解式
...
\subsubsection{英文翻译\footnote{取多伦多大学课件的版本，PDF地址：http://www.math.toronto.edu/alfonso/347/Tartagliaspoem.pdf}}
...
\subsubsection{中文翻译及数学翻译\footnote{中文翻译是笔者做的，数学翻译取自https://www.maa.org/press/periodicals/convergence/how-tartaglia-solved-the-cubic-equation-tartaglias-poem．}}

某与某立方一起//和别的数能对齐//再找二数相差它
...
你要学会不惊奇//它们相乘总相宜//等于新数三次方
\begin{equation}
uv=(p/3)^3
\end{equation}

于是一般有残余//三次根号相减去//所得莫非你所求
