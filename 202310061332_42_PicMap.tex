...
若皮卡映射定义域上的曲线连续可导，且逐次皮卡近似收敛且收敛曲线在皮卡映射的定义域内，则微分方程\autoref{eq_PicMap_3} 有解。
\end{theorem}
\textbf{证明：}\autoref{eq_PicMap_1} 说明皮卡映射 $A$ 连续，又逐次皮卡近似收敛，且收敛曲线在皮卡映射定义域内（意味着收敛曲线连续），就有
\begin{equation}
A\lim_{n\rightarrow\infty}A^n\varphi\overset{A\text{的连续性}}{=}\lim_{n\rightarrow\infty}A^{n+1}\varphi \overset{\text{收敛性}}{=}\lim_{n\rightarrow\infty}A^n\varphi~.
\end{equation}
