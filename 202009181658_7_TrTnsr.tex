...
对$V$进行基的变换，如果过渡矩阵是$a_{ij}$，即新的基中基向量$\bvec{e}'_{i}=a_{ji}\bvec{e}_i$，那么我们易得：

\begin{equation}
T'_{i}=f(\bvec{e}'_i)=f(a_{ji}\bvec{e}_i)=a_{ji}f(\bvec{e}_i)
\end{equation}
...
给定线性空间$V_1$和$V_2$，其中$\opn{dim}V_1=\opn{dim}V_2=k$
