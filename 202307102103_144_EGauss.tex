...
\begin{figure}[ht]
\centering
\includegraphics[width=8 cm]{./figures/769e81c67d53eced.pdf}
\caption{$\bvec E \cdot \dd {\bvec A} = E \dd A \cos \theta$} \label{fig_EGauss1}
\end{figure}
...
一个老生常谈的问题是，假如电场与高斯面不垂直，那么求通量时要乘上电场与面法向量的夹角的余弦 $\cos \theta$。有很多种方法论证这背后的原因，笔者最喜欢的解释是：电场总能被分解为垂直于面与平行于面的分量，而只有那些垂直于面的分量是真正“流出/进”面的电场、平行部分并没有真正离开面，因此，计算通量时只应该考虑电场的垂直分量。
