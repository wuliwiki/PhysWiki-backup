...
因此，高中数学理所当然地以“集合”作为一切后面学习的开始。

提醒一下，这篇文章会涵盖不少与集合相关的新概念（当然也包括集合本身），，它和你以往的数学经验不太会有直接的关系，但请不要被这些概念的数量吓倒，，它只是名字比较新，事实上却与生活经验联系密切，每个完成高中阶段学习的同学都会认为这部分内容是最简单的。

，它们其实都是一些自然而然的概念。

请务必理解这部分的内容，哪怕暂时不熟悉这些概念的名称，也一定要理解他们的意思。高中阶段并不要求对集合进行过深的探索，借助学习集合的机会可以体会一下高中数学思考方式的不同，这个不同是会延伸到未来高等教育中数学甚至其他学科中的。
