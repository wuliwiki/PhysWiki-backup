...
国际单位下的一维含时薛定谔方程为\autoref{test2_tab1}~\upref{test2}
\begin{equation}
-\frac{\hbar^2}{2m} \pdv[2]{\Psi}{x} + V\Psi= \I\hbar \pdv{\Psi}{t} -\frac{\hbar^2}{2m} \pdv[2]{\Psi}{x} -\frac{\hbar^2}{2m} \pdv[2]{\Psi}{x} + 123234
\end{equation}
