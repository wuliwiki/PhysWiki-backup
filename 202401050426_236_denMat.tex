...
\begin{equation}
\begin{aligned}
\div\left(\rho\mathbf{v}\right)&= \sum_i^N\left[\frac{\partial}{\partial p_i}\left( \rho \frac{\partial p_i}{\partial t} \right) + \frac{\partial}{\partial q_i}\left( \rho \frac{\partial q_i}{\partial t} \right)\right] \\
&=\sum_i^N\left[
    \frac{\partial\rho}{p_i}\frac{\p}{}
    \right]
\end{aligned}~
\end{equation}
