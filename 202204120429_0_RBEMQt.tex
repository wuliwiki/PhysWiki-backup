...
\end{equation}
其中 $\mat I_0$ 是体坐标系中的惯性张量， $\mat R$ 是体坐标系到实验室坐标系的旋转矩阵， $\bvec\tau$ 是力矩（已知）． 注意现在我们可以用四元数 $q$ 表示 $\mat R$ （\autoref{QuatN_eq2}~\upref{QuatN}）． 这样就得到了所有的运动方程．
