...
根据\autoref{tgSpa_the1} 的证明，我们知道$f$的各分量$f_i$都处处有非零梯度．设$r_1$和$r_2$的起点都是$p\in N$，那么用$(U, \varphi)$计算可得：$\dd/\dd t(\varphi\circ r_1+\varphi\circ r_2)=\dd/\dd t (\varphi\circ(r_1+r_2))$，而在$(V, \phi)$中计算可得$\dd/\dd t(\phi\circ r_1+\phi\circ r_2)=\dd/\dd t (f\circ\varphi\circ(r_1+r_2))=\partial f/\partial\bvec{v}\cdot\dd/\dd t (\varphi\circ(r_1+r_2))$．
