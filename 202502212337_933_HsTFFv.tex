...
\end{equation}
这意味着 $\sin x$ 向左平移 $\displaystyle\frac{\pi}{2}$ 得到 $\cos x$，从而可以推出 $\sin x$ 具有对称轴$\displaystyle x=\frac{\pi}{2}$和$\displaystyle x=\frac{3}{2}\pi$。当然，反过来也可以认为$\cos x$向右平移 $\frac{\pi}{2}$ 得到$\sin x$，即$\cos x$ 具有对称中心$\displaystyle \frac{\pi}{2}$和$\displaystyle x=\frac{3}{2}\pi$。
