...
\end{aligned}
\end{equation}
此式为$\dd u,\dd v,\md w$的二次齐次多项式，其含有乘积 $\dd  \md q_j(i,j=1,2,3\text{且}i\neq j)$ 的项的系数为
\begin{equation}
2\Big(\pd{\varphi_1}{q_i}\cdot\pd{\varphi_1}{q_j}+\pd{\psi_1}{q_i}\cdot\pd{\psi_1}{q_j}+\pd{\omega_1}{q_i}\cdot\pd{\omega_1}{q_j}\Big)
\label{fz3}
\end{equation}
