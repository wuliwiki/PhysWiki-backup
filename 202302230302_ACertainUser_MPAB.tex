...
\end{tabular}
\end{table}
除了加速度，其余项完全相同；但加速度变换的物理含义非同一般：再次根据牛二$\bvec F = m \bvec a$，物体的加速度与其受力直接相关。因此，在非惯性系中看来，物体似乎受额外的假想力，例如惯性力\upref{Iner}、离心力\upref{Centri}、科氏力\upref{Corio}。在非惯性系中，牛二的形式化为$\bvec F + \bvec F_\text{惯} +\bvec F_\text{科} = m \bvec a_{K2} $

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/MPAB_7.pdf}
\caption{在地面惯性系$K1$看来，板车以及车上的货物在向右加速，货物自然根据$\bvec F=m \bvec a$受到来自板车后侧的支持力；而在板车非惯性参考系$K2$看来，货物似乎受一个惯性力，不得不被压在板车的后方。} \label{MPAB_fig7}
\end{figure}
