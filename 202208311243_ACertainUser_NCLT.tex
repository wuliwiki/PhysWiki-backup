...
现在，我们简单地讨论一下形核速度与温度（过冷度）之间的联系．形核率即为单位体积、时间内液体中产生的晶核数量．%\textsl{太长不看：随温度降低、过冷度升高，形核速率先快后慢．}

一方面，随过冷度升高，相变所需形核功减少，这有利于形核；但另一方面，随过冷度升高，原子从液相到固相的短程扩散被抑制，这不利于形核．因此，原则上形核速率随过冷度呈现先快后慢的特点．用Arrhenius公式可以表示为
