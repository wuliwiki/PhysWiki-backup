...
\subsection{体坐标系}
在体坐标系中列出\autoref{RBEqM_eq6} 往往可以简化\autoref{RBEqM_eq6}． 这么做时， 通常令体坐标系的三个轴与刚体的三个主轴\upref{PrncAx}重合， 这样 $\mat I_0$ 就是三个主转动惯量 $I_1,I_2,I_3$ 构成的对角矩阵． 令角（加）速度矢量和力矩在实验室坐标系中的坐标为
\begin{equation}
