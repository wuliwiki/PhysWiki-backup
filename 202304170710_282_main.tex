...
\chapter{Linux 系统} \label{cpt_170}
%---------------------------------------
...
% \chapter{汇编语言和编译原理} \label{cpt_compile}
%---------------------------------------
...
\chapter{Julia 语言笔记} \label{cpt_176}
%---------------------------------------
...
\chapter{Julia 编程基础} \label{cpt_177}
%---------------------------------------
...
\part{计算物理} \label{prt_CalPhy}
%======================================
\chapter{经典力学} \label{cpt_CalCM}
%---------------------------------------

\chapter{量子力学} \label{cpt_CalQM}
%---------------------------------------
