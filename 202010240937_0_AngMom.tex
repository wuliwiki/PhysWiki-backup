...
\end{aligned}
\end{equation}
根据质心系的性质， 最后两项中的求和为零． 另外根据\autoref{SysMom_eq2}~\upref{SysMom}， $M\bvec v_c$ 就是系统总动量， 也相当于所有质量集中于质心获得的动量． 所以我们可以定义所谓的 “质心角动量”
\begin{equation}
\bvec L_c = \sum_i \bvec p_i = M \bvec v_c
\end{equation}


  可以表示为系统总质量 $M = \sum_i m_i$ 乘以质心速度 $\bvec v_c$， 
