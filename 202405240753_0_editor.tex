...
每篇文章的 label 与文件名相同， 转换后输出的网页文件（html）也有相同的文件名， 可以在浏览器的地址栏中看到。例如本文的 LaTeX 文件是 \verb|editor.tex|， label 是 \verb|editor|， 转换成旧版网页为 \href{https://wuli.wiki/online/editor.html}{wuli.wiki/online/editor.html}，新版百科界面的网址为 \href{https://wuli.wiki/editor}{wuli.wiki/editor}。
