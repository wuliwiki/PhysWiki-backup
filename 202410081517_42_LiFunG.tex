...
\begin{corollary}{}
任一 $x\in L$，对固定的满足 $f(x_0)\neq0$ 的 $x_0$，存为唯一 $\alpha\in\mathbb F,y\in \ker f$，
\end{corollary}
...
由于 $f$ 不恒为0，因此存在 $x_0$，使得 $f(x_0)\neq0$。不失一般性，设 $f(x_0)=1$（否则用 $\frac{x_0}{f(x_0)}$ 替代 $x_0$）。任一 $x\in L$，令 $y=x-f(x)x_0$，则 $f(y)=0$，即 $y\in\ker f$。因此任一 $x\in L$，可
