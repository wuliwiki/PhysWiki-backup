...
\item 据报道，阿兰·古思（Alan Guth）在 Edge 基金会的一次访谈中曾作出此论述（\emph{Edge Foundation interview}）。出处：EDGE，网页存档于 2016 年 4 月 11 日。  

\item 桑普尔，伊恩（Ian Sample，2014 年 6 月 4 日）：“因分析存在缺陷的指控，引力波的发现化为尘埃”（\emph{Gravitational waves turn to dust after claims of flawed analysis}）。《卫报》（\emph{The Guardian}）。  

\item 考恩，罗恩（Ron Cowen，2015 年 1 月 30 日）：“引力波发现正式被否认”（\emph{Gravitational waves discovery now officially dead}）。《自然》（\emph{Nature}）。doi:10.1038/nature.2015.16830。S2CID 124938210。  

\item 奥弗贝，丹尼斯（Dennis Overbye，2014 年 12 月 1 日）：“新图像细化了对早期宇宙的认识”（\emph{New Images Refine View of Infant Universe}）。《纽约时报》（\emph{The New York Times}）。取自 2014 年 12 月 2 日。  

\item Leonard & McClure 2004，第 32–33 页。  

\item 克劳奇，C. L.（C. L. Crouch，2010 年 2 月 8 日）：“《创世纪》1:26–27 作为人类神圣血统的陈述”（\emph{Genesis 1:26–7 As a statement of humanity's divine parentage}）。《神学研究杂志》（\emph{The Journal of Theological Studies}），61 (1): 1–15。doi:10.1093/jts/flp185。  

\item “BICEP2 2014 结果发布”（\emph{BICEP2 2014 Results Release}）。美国国家科学基金会（National Science Foundation），2014 年 3 月 17 日。取自 2014 年 3 月 18 日。  

\item “出版物——宇宙计划”（\emph{Publications – Cosmos}）。欧洲空间局（ESA）网站：www.cosmos.esa.int。取自 2018 年 8 月 19 日。  

\item 查尔斯·卡恩（Charles Kahn，1994）。《阿那克西曼德与希腊宇宙学的起源》（\emph{Anaximander and the Origins of Greek Cosmology}）。印第安纳波利斯：哈克特出版社（Hackett Publishing）。  
