...
\item 如果 $u_0, \dots, u_N$  满足 $u_1 - u_0, u_2 - u_0,\dots, u_N - u_0$， 那么就说它们在 \textbf{general position}． 这个性质与顺序无关．
...
\item A Hilbert space: 1. has an inner product, 2. each Cauchy sequence is convergent.
