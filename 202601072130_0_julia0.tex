...
\item 要编译 debug 版本，命令行用 \verb`make debug`（\href{https://docs.julialang.org/en/v1/devdocs/backtraces/}{文档}）。 注意 make 的之前可能需要挂个梯子（v2r 比较快）。remote 名字 \verb`origin` 不能改。
