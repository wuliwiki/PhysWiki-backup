...
&=log\prod_{i=1}^m \frac{1}{\sqrt{2\pi}\sigma}exp\left(-\frac{\left(\epsilon^{\left(i\right)}\right)^2}{2\sigma^2}\right)\\
&=\sum_{i=1}^m log\prod_{i=1}^m \frac{1}{\sqrt{2\pi}\sigma}exp\left(-\frac{\left(\epsilon^{\left(i\right)}\right)^2}{2\sigma^2}\right)\\
&=m\,log\frac{1}{\sqrt{2\pi}\sigma}-\frac{1}{\sigma^2}
}
\end{equation}
