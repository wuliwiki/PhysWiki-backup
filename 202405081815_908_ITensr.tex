...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Moment_of_inertia}{相关页面}。}我们已经初步学习了\enref{刚体绕固定轴的转动}{RigRot}，现在我们做一个更一般的讨论， 也就是惯性系中刚体绕某个固定点的转动， 注意这个固定点未必是质心。 刚体绕固定轴转动只有一个自由度 $\theta$， 而绕固定点转动却可以有 3 个\enref自由度\upref{RigBd}。 为了讨论方便， 本文以旋转的固定点作为坐标原点。
