...
设 $M$ 是由依赖于参量 $x_1,t_1$ ，定义域为柱体 $\abs{x-x_1}\leq b',\abs{t-t_1}\leq a'$，满足 $\abs{\varphi(x_1,t_1,t)}\leq \abs{x}+K\abs{t-t_1}$ 的连续函数 $\varphi(x_1,t_1,t)$ 构成的度量空间\upref{Metric}，其上的度量 $d$ 定义为
\begin{equation}
