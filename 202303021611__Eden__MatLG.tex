...
我们通常要研究某个 $n$ 维复空间上保内积的线性变换，即 $(u,v)=(Mu,Mv),\forall u,v\in \mathbb{C}_n$。这也就意味着 $u^\dagger v=u^\dagger M^\dagger M v$ 对于任意 $n$ 维复向量 $u,v$ 都成立，因此幺正群被定义为
\begin{equation}
\begin{aligned}
U(n)=\{ M\in M_n(n,\mathbb C): M^\dagger M=I \}
\end{aligned}
\end{equation}
可以证明 $U(n)$ 是 $n^2$ 维的李群。
