...
\subsubsection{电磁学相关}
把精细结构常数\upref{FinStr}记为 $\alpha$． 国际单位中有 $a_0 = \hbar/(\alpha c m_e)$． 原子单位中有 $c = 1/\alpha$， $\epsilon_0 = 1/(4\pi)$， $\mu_0 = 4\pi\alpha^2$， $\mu_0\epsilon_0 = \alpha^2$， 对平面电磁波 $E/B = 1/\alpha$． 坡印廷矢量为 $\bvec s = \bvec E \cross \bvec B/(4\pi\alpha^2)$． 电磁场能量密度 $\rho_E = (\abs{\bvec E}^2  + \abs{c\bvec B}^2)/(8\pi)$．
