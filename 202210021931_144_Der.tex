...
一个一元函数 $y = f(x)$ 在直角坐标系中表示为一条曲线． 在切线与割线\upref{TanL}中，我们已经了解了如何绘制函数曲线的切线与割线．现在，让我们进行更细致的探讨．
...
怎么写出割线的直线方程呢？根据高中数学知识，我们知道
\begin{equation}
y-y_B=\frac{y_B-y_A}{x_B-x_A}(x-x_A)=\frac{f(x_B)-f(x_A)}{x_B-x_A}(x-x_A)
\end{equation}

如让我们固定A点不动，让B点逐渐趋近于A点，使割线逐步趋向于切线．
