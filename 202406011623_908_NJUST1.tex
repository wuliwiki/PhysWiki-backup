...
[x \left| n \right\rangle = \frac{1}{\alpha} \left( \sqrt{\frac{n+1}{2}} \left| n+1 \right\rangle + \sqrt{\frac{n}{2}} \left| n-1 \right\rangle \right), \quad \alpha = \sqrt{\frac{\mu \omega}{\hbar}}\]
