...
\end{equation}
其和\autoref{eq_ODEUC_9} 一起称为关于微分方程\autoref{eq_ODEUC_9} 的\textbf{变分方程}。于是\autoref{eq_ODEUC_10} 表明方程\autoref{eq_ODEUC_9} 的解关于初始条件 $x_1$ 的导数 $g_*$ 是满足初始条件 $y(t_0)=E$ 的\autoref{eq_ODEUC_11} 的解。