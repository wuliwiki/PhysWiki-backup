...
证明： 
用数学归纳法证明。
$m=1$显然成立。设$i=m-1$成立，需要证明$i=m$成立。用反证法，假设$i=m$时，$\bvec {x_1},\bvec {x_2}...\bvec{x_m}$。则$\bvec {x_1},\bvec {x_2}...\bvec{x_m}$线性相关，则有：
\begin{equation}
x_m=a^1\lambda_1\bvec {x_1}+a^2\lambda_2\bvec {x_2}+...a_{m-1}
\end{equation}
