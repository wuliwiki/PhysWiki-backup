...
数字少一点还好说，如果数字过多，要么要写一堆的数字和乘号，要么每次都要写$\cdots$。鉴于这个连续相乘的使用次数太多，数学家们发明了一种用来表示连乘的运算：阶乘。当然，说是新运算，就像乘法一样，只要保证见到了能认识，那么觉得“我多写几遍数字也没事”的话，自然可以展开来写，事实上，在计算的时候往往是展开来算的。
