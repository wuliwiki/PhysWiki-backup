...
psi = volkov_1d(k_fun, x, t);
for i = 1:Nt
    figure(1); clf;
    plot(x, [real(psi(:,i)), imag(psi(:,i))]);
    hold on;
    axis([-10,10,-0.07,0.1]);
    grid on;
    scatter(x_ball(i), 0.08, 'k');
    plot([0, force(i)], [1,1]*0.09, 'LineWidth', 5);
    pause(0.04);
end
\end{lstlisting}
