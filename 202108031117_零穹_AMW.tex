...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/AMW_2.png}
...
\end{equation}
给出了阱中至少存在一个能级的条件．由此可见，给定了不相等的 $V_1$ 和 $V_2$ 后，总可以找到一个很窄的阱宽 $L$，使得该阱中不能存在离散能级，\autoref{AMW_fig2} 中可看出在 $0<L<0.5$ 处\autoref{FSW_eq3} 无解．对 $V_1=V_2$而言，上式总能得到满足．