...
其中，第三个等号是利用正弦加法公式 $\sin(\alpha + \beta) = \sin\alpha \cos\beta + \cos\alpha \sin\beta$，展开 $\sin(\omega x + \varphi_0 + \Delta \varphi)$
...
\begin{equation}
A = \sqrt{C^2 + D^2} = \sqrt{(A_0 + A_1 \cos \Delta \varphi)^2 + (A_1 \sin \Delta \varphi)^2}~,
\end{equation}
\begin{equation}
