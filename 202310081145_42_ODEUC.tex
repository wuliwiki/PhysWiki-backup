...
下面证明唯一性：设 $g_1(x,t),g_2(x,t)$ 都是初值条件 $g(x,t_0)=x$ 的微分方程\autoref{eq_ODEUC_5} 的解。由于 $g_1,g_2\in M$，所以可对其实行皮卡映射。由于在解存在的区域里皮卡映射是压缩映射，故成立（为何度量变成范数见线性算子度量空间\upref{ONorm}）
