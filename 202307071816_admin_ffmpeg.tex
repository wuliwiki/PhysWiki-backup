...
\subsection{字母}
\begin{itemize}
\item 如果要不想让视频被字幕破坏， 可以在视频下面拓宽一条空间， 然后打印字幕： \verb|ffmpeg -i input.mp4 -vf "pad=width=iw:height=ih+120:color=black,subtitles=input.srt:force_style='MarginV=100,Alignment=10'" output.mp4|
\end{itemize}
