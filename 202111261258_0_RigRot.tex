...
在定轴转动的情况下， 根据\autoref{RigRot_eq6}， 当系统外对系统延轴方向的力矩 $\tau_z$ 为零时， 角动量 $\bvec L$ 的 $z$ 分量 $L_z$ 守恒．  这意味着刚体的角加速度为零（\autoref{RigRot_eq7}）， 也就是刚体做匀速转动． 类比到质点的直线运动， 就是当 $F = ma$ 中 $F = 0$ 时， 加速度为零， 质点做匀速运动， 动量守恒．

可见和匀速运动不需要外力维持一样， 匀速转动也并不需要延轴方向的外力矩维持． 然而在现实生活中， 就像水平直线轨道上具有初速度的小球会由于与轨道的摩擦力， 空气阻力等各种外力下最终停止运动， 具有初始角速度的物体也会在轴承的摩擦、空气阻力等外力矩的作用下最终停止转动． 但这与角动量守恒并不矛盾．
