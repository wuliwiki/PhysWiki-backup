...
【更新】最新版改名为 MPLAPACK， 见 \href{https://github.com/nakatamaho/mplapack}{GitHub 仓库}． 推荐的用 Docker 编译需要 3 小时左右， 但很稳定． 编译完成以后， library 安装到 container 的目录 \verb|/home/docker/MPLAPACK| 中． \verb|__float128| 也真正的支持了．
