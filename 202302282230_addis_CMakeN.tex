...
\item \verb|foreach(变量 IN 列表) ... endforeach()| 可以循环。 另一个种如 \verb|foreach(变量 变量1 变量2 ...) ... endforeach()| 可以循环。 \href{https://cmake.org/cmake/help/latest/command/foreach.html}{文档}。
