...
\item 令 $-\infty \leqslant a < b \leqslant \infty$， 令 $L_2(a, b)$ 为所有 measurable 函数 $u :]a, b[ \to \mathbb R$， 满足 $\int_a^b \abs{u}^2 \dd{x} < \infty$． 那么 $L_2(a, b)$ 是无穷维的实希尔伯特空间， 内积为 $(u, v) := \int_a^b uv \dd{x}$．
\end{itemize}
