...
大家有没有想过，计算机的 CPU 是如何进行运算的呢？我们知道在计算机的逻辑电路中，所有的数据都是通过 0 和 1 来表示的，例如当一根导线处于高电平就代表 1 否则代表 0。 那如果八根导线表示一个数，而另外八根导线表示另一个数，那么如何通设计一个逻辑电路可以输出它们相加的结果呢？
...
\item （私货）强烈推荐游戏：\href{https://turingcomplete.game/}{图灵完备}
