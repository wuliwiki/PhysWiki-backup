...
\end{figure}
\begin{itemize}
\item 在外加电场下，介质中产生大量电偶极子\upref{Dielec}，这种过程称为介质的极化。这使介质具有电偶密度（电极化强度）$\bvec P = \lim_{\Delta V \to 0} \frac{\sum \bvec p_i}{\Delta V}$ \upref{ElecPo}
\item 电偶极子导致了极化电荷 $\bvec \rho_P = - \div \bvec P$。\upref{ElePAP}
\item 极化电荷产生了额外的电场，电荷感受到的电场是外加电场与极化场的和。也就是说，电介质的存在改变了电场的分布。\upref{EFIDE} $\bvec E = \bvec E_0 + \bvec E'$, $\div \bvec E = \frac{\rho_f+\rho_P}{\epsilon_0}$
