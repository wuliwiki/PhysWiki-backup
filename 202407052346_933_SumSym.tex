...
想象一下这样一个场景，老师要求你计算从1到100的所有自然数的和，你和其他的同学一样，都是在从$1$开始一个一个往上加。这时你旁边的那问题是的没错，就是那个流传很广泛的高斯小时候计算求和的故事。当然，我们这篇的内容不是介绍如何快速的计算这个和，而是我们怎么样把这件事情用一个符号来表示出来，就是如何才能把这个一个一个往上加的行为用一个比较简短的记号来表示出来。
