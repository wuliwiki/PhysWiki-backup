...
\item 在 client 机器上， \verb|sudo mount -t nfs [host]:/home/mpiuser/文件夹 ~/文件夹|。 其中 \verb|host| 是 ip 地址或者域名。
\item 用 \verb|df -h| 查看是否成功。
\item 要每次开机都自动 mount， 可以 \verb|vim /etc/fstab|， 添加一行 \verb|[host]:/home/mpiuser/文件夹 /home/mpiuser/文件夹 nfs|
\end{itemize}
