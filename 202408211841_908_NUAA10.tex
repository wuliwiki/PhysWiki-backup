...
\textbf{二级修正}
\begin{equation}
E_1^{(2)} = \sum_{l \neq 1} \left\frac{| \langle 1 | H' | l \rangle}{E_1^{(0)} - E_l^{(0)}} \right|^2 = \sum_{l \neq 1} \frac{4\lambda^2}{\pi^2 l^2} \times \frac{\sin^2 \left( \frac{l \pi x}{2} \right)}{E_1^{(0)}(1 - l^2)} = \frac{8 g \mu A^2}{\pi^2 \hbar^2} \sum_{l \neq 1} \frac{1 - \cos l \pi}{2(l^2 - 1)}
