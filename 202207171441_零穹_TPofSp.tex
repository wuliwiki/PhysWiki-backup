...
&=\psi_1\qty(\qty((\alpha u^i+\beta u'^i)w^k\epsilon_i+(\alpha v^j+\beta v'^j)w'^k\eta_j)\otimes\xi_k)\\
&=(\alpha u^i+\beta u'^i)w^k\epsilon_i\otimes\xi_k+(\alpha v^j+\beta v'^j)w'^k\eta_j\otimes\xi_k\\
&=(\alpha u+\beta u')\otimes w+(\alpha v+\beta v')\otimes w\\
