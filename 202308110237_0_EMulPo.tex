...
\begin{equation} % 已小心推导若干次
p_z = \frac12\sqrt{\frac{3}{\pi}} C_{1,0}~,
\end{equation}
\begin{equation} % 已小心推导若干次
p_x = \sqrt{\frac{3}{2\pi}} \frac{C_{1,-1}-C_{1,1}}{2} = -\sqrt{\frac{3}{2\pi}} \Re[C_{1,1}]~,
\end{equation}
\begin{equation} % 已小心推导若干次
p_y = \sqrt{\frac{3}{2\pi}} \frac{C_{1,-1}+C_{1,1}}{2\I} = \sqrt{\frac{3}{2\pi}} \Im[C_{1,1}]~.
\end{equation}
