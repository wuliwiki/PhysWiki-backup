...
&-\mathcal{M}(p_1+k,\cdots,p_n;p'_1,\cdots,p'_m)-\cdots-\mathcal{M}(p_1,\cdots,p_n+k;p'_1,\cdots,p'_m)
\right)
\end{aligned}
\end{equation}
用费曼图可以表示为
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/ward_6.png}
\caption{Ward 等式示意图} \label{ward_fig6}
\end{figure}