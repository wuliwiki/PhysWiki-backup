...
\vmat{
2-\lambda & 0 & 0&0&0\\
0&2-2\I-\lambda&2&0&0\\
0&2&2+2\I-\lambda&0&0\\
0&0&0&0-\lambda&-\I\\
0&0&0&i&0-\lambda
}=0
\end{equation}
...
\begin{equation}
\bvec{A_1}=\pmat{2}\quad ,\bvec{A_2}=\pmat{2-2\I&2\\2&2+2\I}\quad
...
解得 $\bvec{A}$ 的本征值为： $\lambda_1=\lambda_2=\lambda_3=2,\lambda_4=1,\lambda_5=-1$

a.对 $\lambda_1=\lambda_2=\lambda_3=2$ ，解 $(\bvec{A}-2\bvec{E})\bvec{x}=\bvec{0}$，得基础解系：

b.对 $\lambda_4=1$ ，解 $(\bvec{A}-2\bvec{E})\bvec{x}=\bvec{0}$，得基础解系：

c.对 $\lambda_5=-1$ ，解 $(\bvec{A}-2\bvec{E})\bvec{x}=\bvec{0}$，得基础解系:
\addTODO{结合上文说明和证明}
