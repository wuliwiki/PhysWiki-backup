...
渐近线是指在某个方向上，曲线无限接近于一条直线，但不与其相交，且在无穷远处两者之间的距离无限接近于零。
...
若曲线  $C$  上任意一点  $(x, y)$  与直线  $L:Ax+by+c=0$  的距离  $d(P, L)$ 在某方向趋于无穷远时趋于零，即：
\begin{equation}
\lim_{x\text{ 或 }y \to +\infty \text{ 或 } -\infty} d(P(x, y), L) = 0~.
\end{equation}
则称  $L$  是曲线 $C$  的渐近线。
