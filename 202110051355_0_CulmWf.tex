...
\footnote{参考资料： \cite{Brandsen}， Wikipedia， 据说 \cite{Merzbacher} 也有． 另一个是 “F Morales et al 2016 J. Phys. B: At. Mol. Opt. Phys. 49 245001” 的附录．}本文使用原子单位制\upref{AU}． \textbf{库仑波函数（Coulomb wave function）}是类氢原子% 链接未完成
的散射态波函数． % 链接未完成
