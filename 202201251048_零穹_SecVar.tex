...
把函数 $F$ 展开为泰勒级数并且引用符号\autoref{Varia_eq6}~\upref{Varia}
\begin{equation}
...
&=\int_a^b\qty[F_y\delta y+F_{y'}\delta y'+\frac{1}{2}\qty(F_{yy}\delta y^2+2\overline{F}_{yy'}\delta y\delta y'+\overline{F}_{y'y'}\delta y'^2)]\dd x
\end{aligned}
\end{equation}
