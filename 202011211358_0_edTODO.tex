...
\item 关于对比页面： 网址使用 \verb|wuli.wiki/history/|， 使用 注意页面上需要可以选择 \verb|diff2html| 程序的 \verb|diffStyle| （char, word, line 等， 其中 char 非常重要， 否则连续的中文字符都会被看成一个 word）．

\item 另外做一个 “查看历史版本” 页面．
