...
\item \verb`sudo apt-mark hold 包名` 可以在 \verb`apt upgrade` 的时候不更新一些包，会显示 \verb`The following packages have been kept back`，要 unhold，用 \verb`sudo apt-mark unhold <package>`
