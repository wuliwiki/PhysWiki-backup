...
=\pmat{
0 & c_{0m} & 0 & 0 & \dots\\
c_{0m} & 0 & 2c_{1m} & 0 &\dots\\
0 & 2c_{1m} & 0 & 3c_{2m} &\dots\\
\vdots & 0 & 3c_{2m} & 0 & \dots}~.
\end{equation}
...
\end{aligned}
\end{equation}
另外由\autoref{eq_SphHar_18}~\upref{SphHar} 得
\begin{equation}
\mat F^{(v2)}
=\pmat{
0 & c_{0m} & 0 & 0 & \dots\\
...
\end{equation}
\begin{equation}
F^{(v2)}_{l,l'} = -\mel{Y_{l,m}}{\cos\theta + \sin\theta\pdv{\theta}}{Y_{l',m}}~.
\end{equation}
