...
\end{equation}
特殊地， 如果限制函数的自变量为实数而因变量为复数（$f: \mathbb R \to \mathbb C$）， 它也能叫做复变函数． 例如在计算振动和波动时， 我们经常会见到
\begin{equation}
...
正因为如此， 研究复变函数的许多性质可以借助矢量分析的工具．

矢量场可以用于把复变函数可视化． 但更常用的可视化还是分别画出两个标量场 $u(\bvec r)$ 和 $v(\bvec r)$．
