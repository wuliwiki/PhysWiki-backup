...
\begin{equation}
E_n = E_n^0 + \lambda E_n^1 + \lambda^2 E_n^2 + \dots = \mel{\psi_n^0 + \lambda\psi_n^1 + \lambda^2\psi_n^2 + \dots}{H^0 + \lambda H^1}{\psi_n^0 + \lambda\psi_n^1 + \lambda^2 \psi_n^2 + \dots}~.
\end{equation}
