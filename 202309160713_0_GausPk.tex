...
\int f(x) \dd{x} = -\I\frac{A_0}{2} \sqrt{\frac{\pi}{a}} \exp(-\frac{k^2}{4a}) \erfi\qty(\frac{k + 2 \I a x}{2 \sqrt{a}}) + C~.
\end{equation}
...
\begin{equation}
f(x) = \leftgroup{
&A_0\cos^2\qty(\frac{\pi x}{L}) \E^{\I k_0x} && (\abs{x-x_0} < L/2)\\
&0 && (\text{otherwise})~.
}\end{equation}
...
\begin{equation} % Mathematica 已验证
\begin{aligned}
\int A_0\cos^2\qty(a x) \E^{\I k_0x} \dd{x} &= -\I\frac{A_0}{4}\E^{\I kx}\qty(\frac{2}{k} +\frac{\E^{2\I ax}}{2a+k} -\frac{\E^{-2\I ax}}{2a-k}) + C\\
&= \frac{A_0}{4} \qty(\frac{2\sin(k x)}{k} +\frac{\sin[(2 a+k)x]}{2 a+k} +\frac{\sin[(2 a-k)x]}{2 a-k})\\
&+\I\frac{A_0}{4} \qty(-\frac{2\cos(k x)}{k} -\frac{\cos[(2 a+k)x]}{2 a+k} +\frac{\cos[(2 a-k)x]}{2 a-k}) + C~.
\end{aligned}
\end{equation}
