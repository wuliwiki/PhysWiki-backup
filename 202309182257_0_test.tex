...
\cdots & \langle n'l'm| \hat{p}_z |nlm \rangle & 0 & -\langle n'l'm| \hat{p}_z |n,l+1,m \rangle & \cdots \\
\cdots & 0 & 0 & 0 & \cdots \\
\cdots & -\langle n',l'-1,m| \hat{p}_z |nlm \rangle & 0 & \langle n'l'm| \hat{p}_z |nlm \rangle & \cdots \\
\ddots & \vdots & \vdots & \vdots & \ddots \\
\end{pmatrix} \]~.
\end{equation}
