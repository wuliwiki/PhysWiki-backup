...
由\enref{Euler-Maclaurin 求和公式}{EMSum},$\sum_\limits{k=1}^n \frac{1}{k}=\int_1^n \frac{1}{x}dx+\frac{ln1+lnn}{2}+\int_1^n \psi(x) \frac{-1}{x^2}dx=\int_1^n \frac{1}{x}dx+\frac{ln1+lnn}{2}-\int_1^n \psi(x) \frac{1}{x^2}dx=$