...
我们知道 $\mat A$ 的第 $i$ 列代表的矢量就是 $X$ 空间中的第 $i$ 个基底映射到 $Y$ 空间的对应矢量． 我们把 $A$ 的 $N$ 列对应的 $N$ 个矢量记为 $\{\bvec \alpha_i\}$． 下面我们根据 $\mat A$ 的不同性质来分类讨论方程组的解．

我们知道矩阵的秩 $R$ 等于线性无关的行数或列数\upref{MatRnk}．
