...
\begin{lstlisting}[language=matlab, caption=hydrogen\_trans\_dipole\_plane\_z.m]
...
function dipole_z = hydrogen_trans_dipole_coulomb_sph(Z, k1, l1, m1, ...
                                          n2, l2, m2, r_max)
...
% 未验证
function dipole_z = hydrogen_trans_dipole_coulomb_plane(...
    Z, k1, th1, ph1, l1, m1, n2, l2, m2, r_max)
hydrogen_trans_dipole_coulomb_sph(Z, k1, l1, m1, ...
                          n2, l2, m2, r_max)
end
\end{lstlisting}
