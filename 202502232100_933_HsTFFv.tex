...
由于$\cos x$是偶函数，而$A_0,A_1$是定值，所以A^2或|A|

利用 余弦和差公式：

\cos(\varphi_0 - \varphi_1) = \cos\varphi_0 \cos\varphi_1 + \sin\varphi_0 \sin\varphi_1



结合余弦函数的性质，这 说明 $A$ 随着 $\left|\bar\varphi-\varphi\right|$ 的增大而 减小。
