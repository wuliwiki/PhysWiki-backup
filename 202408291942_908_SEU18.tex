...
7. 在动量表象中，动量算符$\hat{p}_0$对其本征值$\rho_0$对应的本征函数\\
   (A) $\delta(\rho-\rho_0)$; \\
   (B) $\psi_{\rho_0}(x) = \sqrt{\rho_0}\\sin(\\rho_0 x/\\hbar)$; \\
   (C) $\psi_{\rho_0}(x) = \sqrt{\\rho_0}\\sin(\\rho_0 x/\\hbar)$; \\
   (D) $\psi_{\rho_0}(x) = \exp(\\rho_0 x/\\hbar)$\\