...
\item 更复杂的函数也可以用 \verb|Module[]| 定义如 \verb|f[x0_] := Module[{x = x0}, While[x > 0, x = Log[x]]; x]|． 格式为 \verb|\verb|Module[{a,b,...}, expr]|， 或 |\verb|Module[{a=1,b=2,...}, expr]| 其中第一个大括号中声明本地变量以及初始化．
