...
综上，\autoref{PIntQM_eq1} 表达的是：求粒子从$x_0$出发、经过$t_2$后出现在$x_2$的概率振幅，应先求出粒子经过$t_1$后传播到$x_1$后再从$x_1$经过$t_2-t_1$后传播到$x_2$的振幅，然后把所有可能的$x_1$遍历一遍，把得到的所有\textbf{路径}的振幅求积分．
