...
\begin{equation}
E_1^{(2)} = \frac{8 g \mu^2 A^2}{\pi^4 \hbar^2} \sum_{k=1}^\infty \frac{1}{4k(k+1)} = \frac{-2 g \mu^2 A^2}{\pi^4 \hbar^2} \sum_{k=1}^\infty \left(\frac{1}{k} - \frac{1}{k+1}\right) = \frac{-2 g \mu^2 A^2}{\pi^4 \hbar^2}~
\end{equation}
