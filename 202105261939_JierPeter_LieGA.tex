...
$Xf$在$p\in G$处的取值可以如下计算，其中取$c:I\to G$使得$\frac{\dd}{\dd t}c(t)|_{t=0}=X_e$，$c(0)=e$，而$e$是$G$的单位元：
\begin{equation}
...
为了证明上面这段话，我们又只需要证明$f\circ l_{p*}\circ c$是一个$G\times I\to \mathbb{R}$的guang'hua
