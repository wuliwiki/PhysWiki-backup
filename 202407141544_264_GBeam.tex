...
E(x,y,z)=\frac{\I\E^{-\I k(z-z_1)}}{\lambda(z-z_1)}\iint_s E\left(x_1,y_1,z_1\right)\E^{-\I k\left(\frac{(x-x_1)^2+(y-y_1)^2}{2(z-z_1)}\right)}\,dx_1dy_1~
\end{equation}
%简便起见令$L=z-z_1$，
%\begin{equation}
...
\begin{equation}
u(x,y,z)=\frac{I}{\lambda(z-z_1)}\iint_s u\left(x_1,y_1,z_1\right)\E^{-\I k\left(\frac{(x-x_1)^2+(y-y_1)^2}{2(z-z_1)}\right)}\,dx_1dy_1~
\end{equation}
