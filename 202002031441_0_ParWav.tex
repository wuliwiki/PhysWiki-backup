...
存在一组变换系数 $c_l$ 使
\begin{equation}
\psi(\bvec r) = \frac{1}{r} \sum_l c_l \sin(kr - \frac{\pi l}{2} + \delta_l) Y_{l,0}(\bvec r)
\end{equation}
满足边界条件\autoref{ParWav_eq1}．

令\autoref{ParWav_eq1} 中散射幅为
\begin{equation}
...
\end{equation}
将\autoref{ParWav_eq2} 和\autoref{ParWav_eq12} 代入\autoref{ParWav_eq1}， 再逐项与? 对比，得
\begin{equation}
