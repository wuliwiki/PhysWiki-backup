...
\begin{equation}
\leftgroup{
&A = \mathcal{N}\cdot [(k^2 + b^2)\sin(2bl) + 2\I kb \cos(2bl)]\\
&B = \mathcal{N}\cdot (k^2 - b^2)\sin(2bl)\exp(-2\I kl)\\
&C = \mathcal{N}\cdot \I k (k + b) \exp[-\I (k+b)l]\\
&D = \mathcal{N}\cdot \I k(b-k) \exp[-\I (k-b)l]\\
&F = \mathcal{N}\cdot 2\I kb \exp(-2\I kl)
}\end{equation}
其中归一化系数为
\begin{equation}
...
满足归一化条件（链接未完成）
\begin{equation}
\abs{A}^2 + \abs{B}^2 + \abs{F}^2 = \frac{1}{\pi}
\end{equation}
...
\begin{equation}
\leftgroup{
&A = \mathcal{N}\cdot [(k^2 - \kappa ^2) \sinh(2\kappa l) + 2\I k\kappa  \cosh(2\kappa l)]\\
&B = \mathcal{N}\cdot (\kappa ^2 + k^2)\sinh(2\kappa l)\exp(-2\I kl)\\
&C = \mathcal{N}\cdot k(\I \kappa  - k) \exp(-\kappa l)\exp(-\I kl)\\
&D = \mathcal{N}\cdot k(\I \kappa  + k) \exp(\kappa l)\exp(-\I kl)\\
&F = \mathcal{N}\cdot 2\I k\kappa  \exp(-2\I kl)
}\end{equation}
\begin{equation}
\mathcal{N} = \frac{1}{\sqrt{\pi}\sqrt{(k^2+\kappa^2)^2\sinh^2(2\kappa l) + 8k^2\kappa^2}}
\end{equation}
