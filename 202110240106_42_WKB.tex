...
\dv[2]{u}{\xi}-\xi u=0
\end{equation}
这是艾里函数\upref{AiryF}满足的微分方程\autoref{AiryF_eq2}~\upref{AiryF}．显然，$u$ 应是 $\mathrm{Ai}(\alpha x)$ 和 $\mathrm{Bi}(\alpha x)$ 的线性组合
\begin{equation}
u=c_1 \mathrm{Ai}(\alpha x)+c_2 \mathrm{Bi}(\alpha x)
\end{equation}
