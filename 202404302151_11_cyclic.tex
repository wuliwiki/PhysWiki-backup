...
设$H$为$G$的任意子群，因为共轭子群的阶与原群相等，即对于任意$g\in G$都有$|gHg^{-1}|=|H|$，题设条件使得$G$的任意子群都是正规子群——$H\lhd G$。设$G'=G/H$且$H_1$是
...
设$r_1\neq r_2$，且$r_1^d=r_2^d$。在$G_{n-1}$中，$<r_1>$和$<r_2>$是两个阶数相同，但元素不同的子群，这与题设矛盾，所以$r_1\rightarrow r_1^d$是单射。