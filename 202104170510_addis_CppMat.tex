...
public:
    ...
    CmatDoub(long N1, long N2): m_N1(N1), m_N2(N2) { new double m_p[N1*N2]; };
    Doub& operator()(Long_I i, Long_I j) { return p[m_N2*i + j]};
    Long n1() const { return m_N1; };
    Long n2() const { return m_N2; };
    long long 
