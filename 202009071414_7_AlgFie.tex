...
\item 将以上步骤推广，对于每$k$个元素$v_i\in V$，我们定义一个新的元素$v_1\wedge v_2\wedge\cdots\wedge v_k$，要求它满足\textbf{反对称性}和\textbf{结合性}，即$(v_1\wedge v_2)\wedge v_3=\v_1\wedge(v_2\wedge v_3)$，这样就可以摆脱括号而直接将三个元素的
\end{itemize}
