...
其中 $\chi_{1,2}$ 和 $\chi_{2,1}$ 的转换就是把每项中第一个箭头和第二个箭头互换， 例如 $\downarrow\uparrow$ 变为 $\uparrow\downarrow$． 其中对称子空间是 $N(N+1)/2$ 维的， 反对称子空间是 $N(N-1)/2$ 维的， 他们互为互补的子空间． 我们把推导留到 “粒子交换算符\upref{ExchOp}” 中．
