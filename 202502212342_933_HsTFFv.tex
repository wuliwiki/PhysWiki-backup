...
由于$\tan x$和$\cot x$都是奇函数，因此不论二者如何转化都无法得到对称轴。


另外根据\aref{诱导公式}{eq_HsTrFu_14}，sinx向左平移$pi/2$个单位可以得到cosx，sinx向右平移$pi/2$个单位可以得到-cosx，使得sinx本身也存在两个对称轴x=pi/2和x=-pi/2。而
