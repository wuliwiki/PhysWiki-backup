...
\end{theorem}
\begin{theorem}{}
同\autoref{the_ODEUC_1} 叙述，当 $v\in C^r$($r\geq2$)，则 $g\in C_x^{r-1}$。
\end{theorem}
\textbf{证明：} 假设对定理对 $<r$ 成立。则
\begin{equation}
 v\in C^r\Rightarrow v_*\in C^{r-1}\Rightarrow v_y(x,t,y)=v_*(x,t)y\in C^{r-1}\Rightarrow g_*\in C_x^{r-2}\Rightarrow g\in
\end{equation}
