...
\item 合并矩阵/矢量 \verb|Join[{{1,2},{3,4}},{{5,6},{7,8}}]| 得 \verb|{1,2},{3,4},{5,6},{7,8}|， 在最外层合并（列主元的第一个维度）． 等效于 \verb|Join[{{1,2},{3,4}},{{5,6},{7,8}},1]|
\item \verb|Join[{{1,2},{3,4}},{{5,6},{7,8}},2]| 得 \verb|{{1,2,5,6},{3,4,7,8}}|， 在最外第二层合并（列主元的第二个维度）．
\end{itemize}
