...
其中第一项就是 $E_n^1/\mathcal{E}_z$。 第二项第三项分别是二阶和三阶小量，所以第三项可忽略。 根据\autoref{eq_TIPT2_4}~\upref{TIPT2}， 第二项的 $\mel{\psi_n^0}{z}{\psi_n^1}$ 就是 $E_n^2/\mathcal{E}_z$，所以
\begin{equation}
...
\end{equation}
和电场成正比，而二阶修正（\autoref{eq_TIPT2_2}~\upref{TIPT2}）
\begin{equation}
