...
常数 $K_{cd}$ 用来定义单位坎德拉（Candela，发光强度单位）。具体的，通过将频率为 $540 \Si{THz}$ 的单色辐射的发光效率的固定数值 $K_{cd}$ 取为 $683$ 来定义的，单位为 $\Si{Im/W}$，等于 $cd sr W−1$ 或cd sr kg−1 m−2 s3，其中千克、米和秒是根据h、c和ΔΓCs来定义的。
