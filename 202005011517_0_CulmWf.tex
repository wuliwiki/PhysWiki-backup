...
\footnote{参考资料一个是 Wikipedia， 另一个是 “F Morales et al 2016 J. Phys. B: At. Mol. Opt. Phys. 49 245001” 的附录． 据说 Merzbacher 的量子力学也有}本词条使用原子单位． \textbf{库仑波函数（Coulomb wave function）}是类氢原子% 链接未完成
的散射态波函数． % 链接未完成
