...
\subsection{标准常微分方程}
在代数学中，解决各种代数方程组解的个数问题的定理起了很大的作用，例如，断定 $n$ 次多项式恰有 $n$ 个根（计入重数）的代数学基本定理．同样，在微分方程理论中，也要问微分方程解的个数问题．可以证明，每一微分方程组的解的集合有连续统的势\footnote{即解的个数与区间 $[0,1]$ 中点的个数一样多．}，所以并不关心解的个数wen'w'i