...
考虑映射$\sigma:\mathbb{F}\to\mathbb{F}$，定义为$\sigma(a)=a^p$．则显然有$\sigma(ab)=\sigma(a)\sigma(b)$和$\sigma(a+b)=(a+b)^p=a^p+b^p=\sigma(a)+\sigma(b)$，因此这是一个\textbf{域同态}．

如果$\sigma(a)=a^p=b^p=\sigma(b)$，那么
