...
\begin{equation}
\begin{aligned}
\frac{\cos<\bvec n,\overrightarrow{F_1P}\rangle}{\cos\langle\bvec n,\overrightarrow{F_2P}\rangle} &=\frac{a^2 b^2+b^2cx_0}{a^2 b^2-b^2cx_0}\; \sqrt{\frac{(x_0-c)^2+y_0^2}{(x_0+c)^2+y_0^2}} \\
