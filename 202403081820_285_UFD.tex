...
是否所有形如$\mathbb{Z}[\sqrt{-n}]$（$n$为正整数）的环都不是唯一析因环呢？答案是否定的，比如$\mathbb{Z}[\I]$和$\mathbb{Z}[\sqrt{-2}]$等就是唯一析因环。不过对于这两个环，证明它们是欧几里得环更加方便，由此可知它们是唯一析因环，详情请参见\textbf{欧几里得环}\upref{EuRing}。
