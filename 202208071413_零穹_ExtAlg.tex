...
\begin{equation}\label{ExtAlg_eq10}
Q\wedge R=(-1)^{qr}R\wedge Q
\end{equation}

\textbf{证明提示：}由\autoref{ExtAlg_the1} ，可用形如
 \begin{equation}
\begin{aligned}
...
\end{aligned}
\end{equation}
的式子分别将 $Q,R$ 展开．然后由\autoref{ExtAlg_eq6} ，可将 $R$ 的展开中每一项的基底的矢量一个个和前面矢量对换到 $Q$ 的基底前，最后就得到\autoref{ExtAlg_eq10} .
\end{example}
