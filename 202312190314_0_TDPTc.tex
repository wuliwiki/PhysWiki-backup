...
\begin{equation}
g(E) = k f(k) \propto k \abs{\mel{\alpha'}{W}{\alpha}}^2 \abs{\tilde f\qty(E_0-E)}^2~.~
\end{equation}

\begin{equation}
k_c = \frac{\int_0^\infty k [k^2 f(k)] \dd{k}}{\int_0^\infty k^2 f(k) \dd{k}}~
\end{equation}

\begin{equation}
E_c = \frac{\int_0^\infty E g(E)\dd{E}}{\int_0^\infty g(E)\dd{E}}
=\frac{\int_0^\infty \frac{k^2}{2} k^2f(k)\dd{k}}{\int_0^\infty k^2f(k)\dd{k}}~
\end{equation}