...
&\ \ \ \ -\frac{qa'_iR}{(R-\bvec v'\cdot \bvec R)^2}\\
&=\frac{q(1+v'_i)}{(R-\bvec v'\cdot \bvec R)^3}\qty(R_i(1-v'_jv'_j)-v_i'(R-\bvec v'\cdot \bvec R))+\frac{q(1+v'_i)R_iR_ja'_j}{(R-\bvec v'\cdot \bvec R')^3}
\end{aligned}
\end{equation}