...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/CSN13_2.png}
\caption{请添加图片描述} \label{CSN13_fig2}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/CSN13_1.png}
\caption{请添加图片描述} \label{CSN13_fig1}
\end{figure}
