...
\verb|/etc/ufw/sysctl.conf|, 注释掉 \verb|net.ipv4.ip_forward=1|.
\verb|/etc/default/ufw|， 设置 \verb|DEFAULT_FORWARD_POLICY="ACCEPT"|
\verb|/etc/ufw/before.rules|， 在 filter rules 之前添加如下几行：
