...
\begin{aligned}
\int f(x) \dd{x} &= -\I\frac{A_0}{4}\E^{\I kx}\qty(\frac{2}{k} +\frac{\E^{2\I ax}}{2a+k} -\frac{\E^{-2\I ax}}{2a-k})\\
&= \frac{A_0}{4} \qty(\frac{\sin[(2 a-k)x]}{2 a-k}+\frac{\sin[(2 a+k)x]}{2 a+k}+\frac{2\sin(k x)}{k})\\
&+\I\frac{A_0}{4} \qty(\frac{\cos[(2 a-k)x]}{2 a-k}-\frac{\cos[(2 a+k)x]}{2 a+k}-\frac{2\cos(k x)}{k})~.
\end{aligned}
\end{equation}
