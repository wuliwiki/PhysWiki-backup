...
&\quad+\Gamma_{\rho \sigma}^{r_1} T^{\sigma r_2 \ldots r_a}{ }_{s_1 \ldots s_b}+\ldots+\Gamma_{\rho \sigma}^{r_a} T^{r_1 \ldots r_{a-1} \sigma}{ }_{s_1 \ldots s_b}\\
&\quad-\Gamma^\sigma \sigma{ }_{\rho s_1} T^{r_1 \ldots r_a}{ }_{\sigma s_2 \ldots s_b}-\ldots-\Gamma_{\rho s_b}^\sigma T^{r_1 \ldots r_a}{ }_{s_1 \ldots s_{b-1} \sigma}~.
\end{aligned}
\end{equation}
