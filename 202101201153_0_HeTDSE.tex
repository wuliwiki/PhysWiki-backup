...
\begin{itemize}
\item 123\textbf{parahelium}: singlet spin, 对称波函数， 存在 1s 基态（我们使用的）． \textbf{orthohelium}: triplet spin, 反对称波函数， 不存在 1s 基态， 但其他束缚态的能量相对较低．

\item 123\textbf{基态能量}（数值计算）： -2.9037244au （-79.014366 eV）
