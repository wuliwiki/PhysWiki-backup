...
\item 要编译 debug 版本，命令行用 \verb`make debug`（\href{https://docs.julialang.org/en/v1/devdocs/backtraces/}{文档}）。 注意 make 的之前可能需要挂个梯子。remote 名字 \verb`origin` 不能改。
...
\end{lstlisting}
\item 最新的 v1.12.0 中 \verb`make debug` 失败，提了 \href{https://github.com/JuliaLang/julia/issues/57675}{issue} 正在修复。撤回到 v1.10.10 编译成功。 最新：2025-11-15 的 89243d1cdf 编译成功（开始了用 jl 重写 lower 代码）。
