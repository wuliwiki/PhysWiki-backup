...
\begin{itemize}
\item 启动文件夹： \verb|C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp|（也可以通过 \verb|Win+R| 中输入 \verb|shell:startup| 打开）。 把任何程序，脚本，或者他们的快捷方式放进来，可以在用户登录后执行。
\end{itemize}
