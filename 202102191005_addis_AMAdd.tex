...
\subsection{升降算符法}
要如何从 $L^2$ 矩阵的一般形式\autoref{AMAdd_eq4} 得到其本征值以及本征矢呢？ 可以先从唯一非简并的两个 $M$ 空间入手（参考\cite{GriffQ}）， 由\autoref{AMAdd_eq5} 和\autoref{AMAdd_eq6} 得
\begin{equation}
\begin{aligned}
...
\end{aligned}
\end{equation}
所以令 $L^2$ 的量子数为 $L$， 本征值为 $\hbar^2L(L+1)$， 那么 $\ket{l_1, m_1 = \pm l_1, l_2, m_2 = \pm l_2}$ 对应 $L = l_1 + l_2$．

接下来， 对 $\ket{l_1, m_1 = l_1, l_2, m_2 = l_2}$ 使用 $L_z$ 的降算符 $L_- = L_-^{(1)} + L_-^{(2)}$ 就得到了 
