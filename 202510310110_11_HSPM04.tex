...
如果现在再给定一个运动轨迹$\bvec r_2(t)=(x_2(t),y_2(t))$，并进行叠加呢？也就是说，物体的真正轨迹为$\bvec r'(t)=(x_1+x_2,y_1+y_2)$。这种合成和分解显然基于矢量的可加性。比如$x$轴上有两个运动，$x_1=5t,x_2=8t^2$，那么合运动就可以\textbf{看作}是速度为$5\,m/s$的匀速直线运动与初速度为$0$，加速度为$16\,m/s^2$的匀加速直线运动合成。
