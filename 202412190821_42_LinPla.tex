...
\begin{definition}{典则形式，基变量}
\autoref{eq_LinPla_4} 称为\autoref{eq_LinPla_2} 的\textbf{典则形式}，其中 $x_B$ 称为\textbf{基变量}，对应 $x_N=0$ 的\autoref{eq_LinPla_4} 的解称为\textbf{基本解}，$\lambda$ 称为检验数，  
\end{definition}
