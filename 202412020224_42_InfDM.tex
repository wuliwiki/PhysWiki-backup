...
&=\frac{h}{2L}\sum_{m=1}^{N}u(x_m)\cos\qty(\frac{\pi}{L}(x-x_m))\sum_{k=-\frac{N}{2}+1/2}^{\frac{N}{2}-1/2}e^{\I k\frac{\pi}{L}(x-x_m)}\\
&=\frac{h}{2L}\sum_{m=1}^{N}u(x_m)\cos\qty(\frac{\pi}{L}(x-x_m))\frac{e^{\I (-N/2+1/2)\frac{\pi}{L}(x-x_m)}-e^{\I (N/2+1/2)\frac{\pi}{L}(x-x_m)}}{1-e^{\I \frac{\pi}{L}(x-x_m)}}\\
&=\frac{h}{2L}\sum_{m=1}^{N}u(x_m)\cos\qty(\frac{\pi}{L}(x-x_m))\frac{e^{-\I \frac{N\pi}{2L}(x-x_m)}-e^{\I \frac{N\pi}{2L}(x-x_m)}}{e^{-\I \frac{\pi}{2L}(x-x_m)}-e^{\I \frac{\pi}{2L}(x-x_m)}}\\
&=\frac{h}{2L}\sum_{m=1}^{N}u(x_m)\cos\qty(\frac{\pi}{L}(x-x_m))\frac{\sin\qty(\frac{N\pi}{2L}(x-x_m))}{\sin\qty(\frac{\pi}{2L}(x-x_m))}.
\end{aligned}~
\end{equation}
从而
\begin{equation}
