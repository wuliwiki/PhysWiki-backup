...
次卫星（subsatellite，也称为 moonmoon）——绕天然卫星运行的卫星

Yarkovsky–O'Keefe–Radzievskii–Paddack 效应（也称 YORP 效应）——Yarkovsky 效应的二阶变化，能够改变小天体的自转速率
...
如需我将这些条目变成 `itemize` 列表或整合为参考链接格式，也可以告诉我。
