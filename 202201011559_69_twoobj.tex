...
从上面的运动方程可以求解出 $\rho$ 关于 $t$ 的函数；然而具体要解出轨道形状，还需要知道 $\phi$ 关于 $t$ 的函数，这就又需要借助角动量守恒方程．为了快速求出轨道形状，我们通常令 $u=1/\rho$ 对上面的\autoref{twoobj_eq3} 进行化简．注意到 $\dot \rho=\rho^2 \dot u$由于可以得到
\begin{equation}
\frac{1}{2}\mu \dot u^2
\end{equation}