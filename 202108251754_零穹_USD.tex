...
\end{example}
\subsection{量纲}
物理学中常常遇到改变单位制的情况，假定问题涉及两个单位制（分别称为“旧制”和“新制”），人们当然关心任一物理量类 $\tilde{\boldsymbol{Q}}$ 在新、旧两制的单位的比值，即 $\hat{\boldsymbol{Q'}}/hat{\boldsymbol{Q}}$，其中 $\hat{\boldsymbol{Q'}},\hat{\boldsymbol{Q}}$ 分别表示 $\tilde{\boldsymbol{Q}}$ 在新、旧liang'zhi