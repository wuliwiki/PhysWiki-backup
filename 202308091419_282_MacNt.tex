...
\item 在编辑文本时， Mac 的 \verb|Fn + Delete| 相当于 Windows 的 \verb|Delete|，可以向右删除。 但外接 Windows 键盘的 \verb|Fn + Delete| 无效。
\item 但从布局上来看， 左边的 \verb|Win| 和 \verb|Alt| 应该互换一下（可以在系统设置的键盘设置中更改）
