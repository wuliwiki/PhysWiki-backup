...
M(c_1)>d_1>d_2>M(c_2)
\end{equation}
与\autoref{VarDef_the1} 证明同样的理由，取充分大的 $n$，可以得到包含在 $[a,b]$ 内的一对区间 $[x_0,x_0+\frac{\pi}{n}]$ 和 $[x_1,x_1+\frac{\pi}{n}]$，它们分别包含着点 $c_1$ 和 $c_2$，并且在前一区间上面 $M(x)>d_1$，而在另一区间上， $M(x)<d_2$． 定义函数
\begin{equation}
\eta'(x)=\begin{cases}
&\sin^2[n(x-x_0)],\quad &x\in[x_0,x_0+\frac{\pi}{n}]\\
