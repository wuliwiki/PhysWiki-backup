...
\begin{equation}
I_\alpha(x_1, x_2) = \int_{-\infty}^{+\infty} \delta_\alpha(x-x_1) \delta_\alpha(x-x_2) \dd{x}
\end{equation}
我们希望证明 $\lim_{\alpha\to\infty }I_\alpha(x_1, x_2) = \delta(x_2 - x_1)$． 首先对于给定的 $x_2 \ne x_1$， 显然 $\lim_{\alpha\to\infty }I_\alpha(x_1, x_2) = 0$． 所以只需证明
\begin{equation}
\lim_{\alpha\to\infty }\int_{-\infty}^{+\infty} I_\alpha(x_1, x_2) \dd{x_2} = 1
\end{equation}
交换积分顺序得
\begin{equation}
\begin{aligned}
