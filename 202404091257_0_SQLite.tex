...
\item \verb|SQLite::Transaction transaction(database, SQLite::Transaction::IMMEDIATE);| 开始 transaction， \verb|transaction.commit();| 结束。 也可以用 \verb|SQLite::Transaction::EXCLUSIVE|， 默认是 \verb|SQLite::Transaction::DEFERRED|
\end{itemize}
