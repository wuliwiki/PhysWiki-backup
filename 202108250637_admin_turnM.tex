...
\caption{运行结果1} \label{turnM_fig1}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/turnM_2.pdf}
\caption{运行结果2} \label{turnM_fig2}
\end{figure}
...
[X1,Y1,Z1] = turn(X,Y,Z,[0,0,1],pi/10);
[X2,Y2,Z2] = turn(X,Y,Z,[0,0,1],pi/5);
plot3(X1, Y1, Z1);
plot3(X2, Y2, Z2);
\end{lstlisting}
