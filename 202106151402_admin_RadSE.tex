...
该方程的解取决于 $V(r)$ 的具体形式． 当 $V(r\to \infty)$ 为有限值时， 对于每个较小的 $l$， 可能找到有限个束缚态， 即有限个 $n$． 而 $l$ 叫做\textbf{角量子数（angular quantum number）}， 束缚态能量 $E_{n,l}$ 由这两个量子数共同决定． 随着 $l$ 不断增加， 方括号中的等效势能越来越浅， 最终有可能导致径向方程不存在束缚态解．
