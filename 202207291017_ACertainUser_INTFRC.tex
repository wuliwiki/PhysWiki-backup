...
2. 选取左半段（或右半段）杆件．此时杆件截面处的内力变成了“外力”．类似于钉子模型\upref{RGDFA}，内力的效果是一个任意方向的力与一个力偶．同样的，此时还不能确定力的方向，先标注为两个互相垂直的力
\begin{figure}[ht]
\centering
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/INTFRC_3.png}
\caption{请添加图片描述} \label{INTFRC_fig3}
\end{figure}
杆件内力分布图示意图．蓝色为作用于刚体上的外力．内剪切力的方向记为向下为正}