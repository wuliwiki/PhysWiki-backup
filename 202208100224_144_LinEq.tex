...
可以分别从行与列的角度来理解线性方程组的几何含义．\footnote{本文参考了Gilbert Strang的《线性代数》课程．}更深刻、数学的表示可以见线性方程组的仿射解释\upref{AS2LF}．
...
关于线性方程组的解，我们有如下定理．记m为$\mat A$的行数，n为$\mat A$的列数，r为$\mat A$的矩阵的秩\upref{MatRnk}．
