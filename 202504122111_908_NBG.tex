...
- 一个关系 \( R \) 定义为：
  \[
  R(Z_1, \dots, Z_k) \iff \psi_R(Z_1, \dots, Z_k)
  \]
...
- 一个运算 \( P \) 定义为：
  \[
  u \in P(Z_1, \dots, Z_k) \iff \psi_P(u, Z_1, \dots, Z_k)
  \]

- 一个术语定义为：
  - 变量和特殊类是术语。
  - 如果 \( P \) 是一个带有 \( k \) 个参数的运算，并且 \( \Gamma_1, \dots, \Gamma_k \) 是术语，则 \( P(\Gamma_1, \dots, \Gamma_k) \) 是一个术语。