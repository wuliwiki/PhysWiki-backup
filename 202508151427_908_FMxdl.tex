...
* Albert, A. Adrian（2015）\[1938]，《现代高等代数》（*Modern higher algebra*），剑桥大学出版社，ISBN 978-1-107-54462-8。
* Burton, David M.（2011），《数学史/导论》（*The History of Mathematics / An Introduction*，第 7 版），麦格劳-希尔出版社，ISBN 978-0-07-338315-6。
* Long, Calvin T.（1972），《初等数论导论》（*Elementary Introduction to Number Theory*，第 2 版），列克星敦：D. C. Heath and Company，LCCN 77171950。
* Mahoney, Michael Sean（1994），《皮埃尔·德·费马的数学生涯，1601–1665》（*The Mathematical Career of Pierre de Fermat, 1601–1665*，第 2 版），普林斯顿大学出版社，Bibcode:1994mcpd.book…..M，ISBN 978-0-691-03666-3。
* Ore, Oystein（1988）\[1948]，《数论及其历史》（*Number Theory and Its History*），多佛出版社，ISBN 978-0-486-65620-5。
* Pettofrezzo, Anthony J.；Byrkit, Donald R.（1970），《数论基础》（*Elements of Number Theory*），恩格尔伍德克利夫斯：Prentice Hall，LCCN 71081766。
\subsection{延伸阅读}

* Paulo Ribenboim（1995），《素数记录新书》（*The New Book of Prime Number Records*，第 3 版），纽约：施普林格出版社，ISBN 0-387-94457-5，第 22–25、49 页。
\subsection{外部链接}
\begin{itemize}
