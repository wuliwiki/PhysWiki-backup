...
\textbf{儒略日历（Julian calendar）}是一种非常简单的日历， 常用于天文学以及衡量时间间隔． 在儒略日历中， 任何时刻可以用一个实数表示． 首先我们设置一个时刻并把它称为 \textbf{epoch}： UT 时间的公元前 4713 年的一月一日（周一）中午 12 点—— 这早于有历史记载的最早时间． 接下来 UT 时间每过一天， 儒略数就增加 1．
