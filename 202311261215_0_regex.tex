...
\begin{example}{}
\begin{itemize}
\item 要搜索例如 \verb|error=1.23e-13| 格式的字符串，且找出最大的 \verb|error|。 可以先搜索 \verb|error=.*e-13|， 手动把 \verb|-13| 依次替换为 \verb|-12| 等， 直到没有结果。 例如最大的指数时 \verb|e-10|， 然后再尝试 \verb|error=9\..*e-10|， \verb|error=8\..*e-10| 等。
