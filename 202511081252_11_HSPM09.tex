...
\end{equation}
$A$ 为振幅，是未定chang's表示物体偏离平衡距离的最大距离；$\omega$ 为角频率，表示简谐运动物体振动的快慢；称$\omega t+\varphi_0$为相位，知道物体所处的振动相位，就能得到其状态信息如位移，速度等。称初始时刻的相位$ \varphi_0$ 为初相位，表示 $t=0$ 时，简谐运动物体所处的状态。
