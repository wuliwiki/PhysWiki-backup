...
\subsection{哈密顿方程}
\textbf{哈密顿方程（Hamilton's equations）}也叫\textbf{哈密顿正则方程（Hamilton's canonical equations）}是一组关于 $N$ 个广义坐标 $q_i$ 和 $N$ 个共轭动量（\autoref{Lagrng_eq13}~\upref{Lagrng}） 作为变量的微分方程组， 共有 $2N$ 条方程． 与拉格朗日方程相比， 虽然方程的个数多了一倍， 但是方程却由二阶变为了一阶．
