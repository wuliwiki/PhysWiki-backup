...
下面以$d > 0$ 为例分析，也即数列和分布在一条开口向上的抛物线上。这时说明抛物线的导数为正，这也正对应\autoref{cor_HsAmPg_2} 中“$\{a_n\}$ 是递增数列”的判断。既然分布开口向上的抛物线上，那么必然有最小值。根据平时对于抛物线的分析，已知一个零点是原点，那么如果抛物线的对称轴在原点左侧，则定义域内最小的值ji
