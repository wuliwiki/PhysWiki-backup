...
=(-\bvec{v}\cdot\hat{\bvec{n}}\sin{\theta/2}, \bvec{v}\cos{\theta/2}+\hat{\bvec{n}}\times\bvec{v}\sin{\theta/2})\cdot (\cos{\theta/2}, -\hat{\bvec{n}}\sin{\theta/2})\\&
=(0, \bvec{v}\cdot\hat{\bvec{n}}\sin^2{\theta/2}\hat{\bvec{n}}+\cos^2{\theta/2}\bvec{v}+\sin{\theta/2}\cos{\theta/2}\hat{\bvec{n}}\times\bvec{v})
\end{aligned}
\end{equation}

如果取$\bvec{v}\perp\hat{\bvec{n}}$，那么上式可以化简为$qvq^{-1}=(0, \cos^2{\theta/2}\bvec{v}+\hat{\bvec{n}}\times\bvec{v}\sin{\theta/2}\cos{\theta/2})$
