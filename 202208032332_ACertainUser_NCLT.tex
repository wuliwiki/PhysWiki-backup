...
随后，系统将自发发生减少自由能的过程．如图所示，只有当晶胚的初始半径r大于某个值时，自由能减少的方向才是晶胚自发长大的方向，否则晶胚将自发衰亡．此半径称为\textbf{临界形核半径}．
\begin{figure}[ht]
\centering
...
\subsection{非均匀形核}
非均匀形核理论假定晶胚从容器表面、液体中的杂质处产生．实际上可以发现，非均匀形核所需的临界过冷度（一般小10倍）、临界形核功更小，因而往往是实际中更常见的形核过程．
