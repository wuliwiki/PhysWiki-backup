...
\begin{equation}
\braket{n_1,l_1,m_1,\bvec r_2}{\Psi} = \frac{1}{r_2} \sum_{l_2,m_2}\psi_{l_2,m_2}(r_2) Y_{l_2,m_2}(\uvec r_2)
\end{equation}
\begin{equation}
\psi_{l_2,m_2}(r_2) = \int_0^\infty r_1 R_{n_1,l_1}(r_1) \psi_{l_1,l_2}^{m_1,m_2}(r_1,r_2)\dd{r_1}
\end{equation}
于是该分波的单电子分布为
\begin{equation}
P_\gamma(\bvec r_2) = 2\abs{\braket{n_1,l_1,m_1,l_2,m_2,\bvec r_2}{\Psi}}^2
\end{equation}
径向分布为
