...
\end{figure}
那么自然而然的，合振动的振幅取决于两个位移矢量的合成，当两个位移矢量同向，也就是相位差为$2k\pi(k\in \mathbb{N}_0)$时，合振动振幅最大，我们把质点所在位置称之为振动加强点；当它们方向相反，即相位差为$k\pi(k\in \mathbb{N}_0)$时，合振动振幅最小，此时位置则是振动减弱点。如果这两个波波长相同，那么相应的，振动加强点的波程差为$k\lambda $，振动减弱点的波程差为$k\lambda/2$。
