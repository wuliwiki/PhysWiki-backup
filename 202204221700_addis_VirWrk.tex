...
例如在\autoref{Lagrng_ex3}~\upref{Lagrng}和\autoref{Lagrng_ex4}~\upref{Lagrng}中， 需要先暂停杆的转动， 才能讨论虚功． 由于暂停了时间， 一切运动都是假想的， $\pdv*{\bvec r_j}{t} = \bvec 0$， 一切增量都用 $\delta$ 代替微分负号 $\dd{}$．
