...
\begin{theorem}{本原元定理}\label{PrmtEl_the1}
...
\begin{example}{}
考虑$\mathbb{Z}_p$上全体\textbf{二元}有理式构成的域，记为$\mathbb{Z}_p(x, y)$．也可以理解为，$x, y$是$\mathbb{Z}_p$的两个超越元．当然，我们不考虑域扩张$\mathbb{Z}_p(x, y)/\mathbb{Z}_p$，因为这是超越扩张，不在我们讨论范围内．
