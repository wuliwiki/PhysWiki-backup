...
如何安装 Linux 命令行？ 你可以直接在电脑上安装一个 Linux 系统， 也可以在 Win10 下使用 WSL（已经安装 win10 系统的话建议使用后者）， 如果是 win7 系统， 可以安装一个 MinGW。 安装方法请自行搜索。 本文以 Ubuntu 系统为例（Linux 有不同的版本， Ubuntu 是广泛使用的一个）。
