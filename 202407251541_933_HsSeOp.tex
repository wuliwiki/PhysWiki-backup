...
简单来讲，集合$A$和集合$B$的公共元素组成的集合就是集合$A$与$B$的交集。某种意义上，“交集”就好像两个集合做了一个“乘法”，而做乘法的是元素的存在性，假设存在是1而不存在是0导致重复的元素只能存在一个。
...
简单来讲，集合$A$和集合$B$的全部元素组成的集合就是集合$A$与$B$的并集。某种意义上，就好像两个集合做了一个“加法”，只不过由于集合的概念比较特殊，导致重复的元素只能存在一个。
