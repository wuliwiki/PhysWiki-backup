...
现在，我们简单地讨论一下形核速度与温度（过冷度）之间的联系．%\textsl{太长不看：随温度降低、过冷度升高，形核速率先快后慢．}

一方面，随过冷度升高，相变所需形核功减少，有利于形核；但另一方面，随过冷度升高，原子从液相到固相的短程扩散被抑制，不利于形核．因此，原则上形核速率随过冷度呈现先快后慢的特点．用Arrhenius公式可以表示为
$$C=Ae^{-\frac{\Delta G}{kT}}e^{-\frac{Q}{kT}}$$
其中$\Delta G$是形核功，Q是原子扩散的激活能．
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/NCLT_7.png}
\caption{形核率与温度的示意图．引自Callister, Material Science and Engineering An Introduction} \label{NCLT_fig7}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/NCLT_8.png}
\caption{请添加图片描述} \label{NCLT_fig8}
\end{figure}对于纯金属的凝固等简单的液-固相变过程，在达到足够高的过冷度前，凝固速度已足够快、液体已完全凝固，因此形核率不体现下降．
