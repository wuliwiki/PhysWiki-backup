...
\begin{equation}
\begin{aligned}
\div \bvec A = &\frac{1}{\sqrt{2}c^3\sinh\xi\sin\eta\qty(\sinh^2\xi+\sin^2\eta)}\Bigg[\pdv{\xi}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) \\&+ \pdv{\eta}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) + \pdv{z}\qty(c^2\qty(\sinh^2\xi+\sin^2\eta)A_z)\Bigg]
\end{aligned}
\end{equation}
\begin{equation}
\begin{aligned}
