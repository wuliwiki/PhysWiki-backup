...
\end{equation}
\textbf{证明：} 显然：用量 $\boldsymbol{Q_1}$ 测量 $Q_1\boldsymbol{Q_1}$ 得数为 $Q_1$，用量 $\boldsymbol{Q_2}$ 测量 $Q_2\boldsymbol{Q_2}$ 得数为 $Q_2$，而用量 $\boldsymbol{Q_1}$ 测量 $\boldsymbol{Q_2}$ 得数为 $\frac{\boldsymbol{Q_2}}{\boldsymbol{Q_1}}$．所以，由测量公理，用量 $\boldsymbol{Q_1}$ 测量 $Q$  
\end{example}