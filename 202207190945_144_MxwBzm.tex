...
\footnote{参考 \cite{新热} 以及维基百科\href{https://en.wikipedia.org/wiki/Maxwell-Boltzmann_distribution}{相关页面}．}

\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MxwBzm_1.png}
\caption{请添加图片描述} \label{MxwBzm_fig1}
\end{figure}

理想气体分子的速率分布由\textbf{麦克斯韦—玻尔兹曼}分布来描述
\begin{equation}
