...
\end{equation}
那么我们可以设$y=\frac{\dd x}{\dd t}$，以$y$为未知函数．此时$\frac{\mathrm{d}^2}{\dd t^2}x=\frac{\dd}{\dd t}y=\frac{\dd y}{\dd x}\frac{\dd x}{\dd t}=y\frac{\dd y}{\dd x}$．类似地，$\frac{\mathrm{d}^3}{\dd t^3}x=y\qty(\frac{\dd y}{\dd x})^2+y^2\frac{\mathrm{d}^2}{\dd x^2}$．一般地，我们可以证明任何$\frac{\mathrm{d}^k}{\dd t^k}x$都可以用$y$和$y$关于$x$的各阶导函数表示出来．这样
