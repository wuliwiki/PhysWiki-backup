...
\end{aligned}
\end{equation}
其中的$\bvec{\Omega}_{n,\bvec{k}}$称为Berry曲率。聪明的小伙伴一眼就能看出来了，等式右边第一项正是准经典模型中的电子的群速度，但后一项显然与外力的方向垂直。在均匀电场下，有：
\begin{equation}
-\hbar\frac{\dd{\bvec{k}}}{\dd{t}}=\nabla(E_{n,\bvec{k}}+e\bvec{E}\cdot\bvec{r})~.
\end{equation}
\begin{equation}
