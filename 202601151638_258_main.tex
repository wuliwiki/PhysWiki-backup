...
\chapter{数学家} \label{cpt_2ac}
%---------------------------------------
\entry{华罗庚（Hua Luogeng）（综述）}{Luogen}
\entry{丢番图（Diophantus）（综述）}{DPHT}
\entry{丘成桐（Shing-Tung Yau）（综述）}{QCT}
\entry{阿基米德（Archimedes）（综述）}{Archim}
\entry{欧几里得（Euclid）（综述）}{Euclid}
\entry{埃米·诺特（Emmy Noether）（综述）}{AMnt}
\entry{阿瑟·凯利（Arthur Cayley）（综述）}{Cayley}
\entry{埃利·嘉当（Élie Cartan）（综述）}{Cartan}
\entry{乔治·布尔（George Boole）（综述）}{George}
\entry{乔治·格林（George Green ）（综述）}{QZgl}
\entry{索菲斯·李（Sophus Lie）（综述）}{SFSL}
\entry{欧多克索斯（Eudoxus of Cnidus）（综述）}{ODK}
\entry{毕达哥拉斯（Pythagoras）（综述）}{Pythag}
\entry{亨利·庞加莱（Henri Poincaré）（综述）}{HLPJL}
\entry{拉扎尔·卡诺（Lazare Carnot）（综述）}{Lazare}
\entry{约翰·伯努利（Johann Bernoulli）（综述）}{YHBNL}
\entry{威廉·哈密顿（William Rowan Hamilton）（综述）}{WLHMD}
\entry{伊本·海什木（Ibn al-Haytham）（综述）}{YBH}
\entry{雅克·阿达马（Jacques Hadamard）（综述）}{YKadm}
\entry{艾萨克·巴罗（Isaac Barrow）（综述）}{ASKbl}
\entry{詹姆士·金斯（James Jeans）（综述）}{James}
\entry{阿尔-花拉子米（Al-Khwarizmi）（综述）}{HLZM}
\entry{海因茨·霍普夫（Heinz Hopf）（综述）}{HYCH}
\entry{雅各布·伯努利（Jacob Bernoulli）（综述）}{YGBbnl}
\entry{丹尼尔·伯努利（Daniel Bernoulli）（综述）}{BNL}
\entry{库尔特·哥德尔（Kurt Gödel）（综述）}{KRT} 
\entry{约瑟夫·傅里叶（Joseph Fourier）（综述）}{YSf}
\entry{斯特凡·巴拿赫（Stefan Banach）（综述）}{STFbnh}
\entry{伯恩哈德·黎曼（Bernhard Riemann）（综述）}{BEHDLM}
\entry{埃尔德什·帕尔（Paul Erdős）（综述）}{ARPR}
\entry{恩斯特·策梅洛（Ernst Zermelo）（综述）}{Zerme}
\entry{尼尔斯·阿贝尔（Niels Henrik Abel）（综述）}{NRSAB}
\entry{约翰·冯诺依曼（John von Neumann）（综述）}{Neuman}
\entry{大卫·希尔伯特（David Hilbert）（综述）}{David}
\entry{雨果·斯坦豪斯（Hugo Steinhaus）（综述）}{YGstgs}
\entry{安德鲁·怀尔斯（Andrew Wiles）（综述）}{Andrew}
\entry{弗朗索瓦·韦达（François Viète）（综述）}{WD}
\entry{布莱斯·帕斯卡（Blaise Pascal）（综述）}{BLSpsk}
\entry{乔治·斯托克斯（Sir George Stokes）（综述）}{QZstks}
\entry{詹姆斯·格雷果里（James Gregory）（综述）}{ZMs}
\entry{亚伯拉罕·棣莫弗（Abraham de Moivre）（综述）}{YBLH}
\entry{皮埃尔·德·费马（Pierre de Fermat）（综述）}{Pierre}
\entry{格奥尔格·康托尔（Georg Cantor）（综述）}{Canto}
\entry{戈特洛布·弗雷格（Gottlob Frege）（综述）}{Gottlo}
\entry{约翰·福布斯·纳什（John Forbes Nash Jr.）（综述）}{JFNJY}
\entry{西梅翁·德尼·泊松（Siméon Denis Poisson）（综述）}{BSDN}
\entry{乔治·比德尔·艾里（George Biddell Airy）（综述）}{AL}
\entry{卡尔·威尔施特拉斯（Karl Weierstrass）（综述）}{Karl}
\entry{埃瓦里斯特·伽罗瓦（Évariste Galois）（综述）}{AWLS}
\entry{卡尔·魏尔施特拉斯（Karl Weierstrass）（综述）}{KRTS}
\entry{帕夫努季·切比雪夫（Pafnuty Chebyshev）（综述）}{PFNJ}
\entry{伯恩哈德·波尔查诺（Bernard Bolzano）（综述）}{Bolzan}
\entry{约翰·查尔斯·菲尔兹（John Charles Fields）（综述）}{Charle}
\entry{奥古斯丁-路易·柯西（Augustin-Louis Cauchy）（综述）}{August}
\entry{亚历山大·格罗滕迪克（Alexander Grothendieck）（综述）}{AlGr}
\entry{克里斯蒂安·哥德巴赫（Christian Goldbach）（综述）}{Goldba}
\entry{斯坦尼斯瓦夫·乌拉姆（Stanisław Ulam）（综述）}{Ulam}
\entry{斯里尼瓦瑟·拉马努金（Srinivasa Ramanujan）（综述）}{LMLJ}
\entry{皮埃尔-西蒙·拉普拉斯（Pierre-Simon Laplace）（综述）}{LPLS}
\entry{阿德里安-马里·勒让德（Adrien-Marie Legendre）（综述）}{adla}
\entry{卡齐米日·库拉托夫斯基（Kazimierz Kuratowski）（综述）}{KQKLS}
\entry{亚历克西·克洛德·克莱罗（Alexis Clairaut）（综述）}{Alexis}
\entry{约翰·彼得·古斯塔夫·勒热纳·狄利克雷（Peter Gustav Lejeune Dirichlet）（综述）}{YBGL}
...
\chapter{物理学家} \label{cpt_3ac}
%---------------------------------------
\entry{杨振宁（综述）}{YZL}
\entry{李政道（Tsung-Dao Lee）（综述）}{Tsung}
\entry{约翰·惠勒（John Archibald Wheeler）（综述）}{YHhl}
\entry{利昂·库珀（Leon Cooper）（综述）}{LAkb}
\entry{列夫·朗道（Lev Landau）（综述）}{LFLD}
\entry{汉斯·贝特（Hans Bethe）（综述）}{Hans}
\entry{约翰·巴丁（John Bardeen）（综述）}{Yhbd}
\entry{尼尔斯·玻尔（Niels Bohr）（综述）}{NRSbr}
\entry{尤金·维格纳（Eugene Wigner）（综述）}{YJwgn}
\entry{利奥·西拉德（Leo Szilard）（综述）}{Szilar}
\entry{乔治·伽莫夫（George Gamow）（综述）}{QZjmf}
\entry{斯蒂芬·霍金（Stephen Hawking）（综述）}{HJ}
\entry{赫尔曼·外尔（Hermann Weyl）（综述）}{WR}
\entry{艾萨克·牛顿（Isaac Newton）（综述）}{Newton}
\entry{戈特弗里德·莱布尼茨（综述）}{LBNC}
\entry{恩里科·费米（Enrico Fermi）（综述）}{ELK}
\entry{爱德华·泰勒（Edward Teller）（综述）}{ADHTL}
\entry{马克斯·玻恩（Max Born）（综述）}{BE}
\entry{罗伯特·胡克（Robert Hooke）（综述）}{HK}
\entry{詹姆斯·焦耳（综述）}{JR}
\entry{伊西多·拉比（Isidor Rabi）（综述）}{YXDlb}
\entry{爱德华·康登（Edward Condon）（综述）}{ADHkd}
\entry{约翰·沃利斯（John Wallis）（综述）}{YHALS}
\entry{勒内·笛卡尔（René Descartes）（综述）}{DKE}
\entry{保罗·狄拉克（Paul Dirac）（综述）}{DLK1}
\entry{莉泽·迈特纳（Lise Meitner）（综述）}{LZm}
\entry{约翰·蓝道尔（John Randall）（综述）}{YHldr}
\entry{阿诺德·索末菲（Arnold Sommerfeld）（综述）}{ANOSf}
\entry{维尔纳·海森堡（Werner Heisenberg）（综述）}{Heisen}
\entry{路易·德布罗意（Louis de Broglie）（综述）}{Brogli}
\entry{沃尔夫冈·泡利（Wolfgang Pauli）（综述）}{Pauli2}
\entry{迈克尔·法拉第（Michael Faraday）（综述）}{FLD}
\entry{鲁道夫·佩尔斯（Rudolf Peierls）（综述）}{LDF}
\entry{莱昂哈德·欧拉（Leonhard Euler）（综述）}{OL1}
\entry{格奥尔格·欧姆（Georg Ohm）（综述）}{GOM}
\entry{伽利略·伽利莱（Galileo Galilei）（综述）}{JLL}
\entry{菲利普·莱纳德（Philipp Lenard）（综述）}{FLPL}
\entry{古斯塔夫·赫兹（Gustav Ludwig Hertz）（综述）}{GSTFhz}
\entry{马克·奥利芬特（Mark Oliphant）（综述）}{MKalft}
\entry{詹姆斯·弗兰克（James Franck）（综述）}{ZMSflk}
\entry{约翰·考克饶夫（John Cockcroft）（综述）}{YHkrf}
\entry{奥利弗·亥维赛（Oliver Heaviside）（综述）}{ALFkws}
\entry{罗伯特·奥本海默（J. Robert Oppenheimer）（综述）}{ABHM}
\entry{欧内斯特·劳伦斯（Ernest Lawrence）（综述）}{ONST}
\entry{弗雷德里克·塞茨（Frederick Seitz）（综述）}{Seitz}
\entry{詹姆斯·查德威克（James Chadwick）（综述）}{ZMcdw}
\entry{约翰内斯·开普勒（Johannes Kepler）（综述）}{KPL1}
\entry{帕斯夸尔·约尔丹（Pascual Jordan）（综述）}{YRD}
\entry{安德烈-马里·安培（André-Marie Ampère）（综述）}{AP}
\entry{让·勒朗·达朗贝尔（Jean le Rond d'Alembert）（综述）}{BR}
\entry{亨德里克·卡西米尔（Hendrik Casimir）（综述）}{KXMR}
\entry{路德维希·玻尔兹曼（Ludwig Boltzmann）（综述）}{BRZM}
\entry{克里斯蒂安·惠更斯（Christiaan Huygens）（综述）}{HGS}
\entry{古斯塔夫·基尔霍夫（Gustav Kirchhoff）（综述）}{JRHF}
\entry{加布里埃尔·李普曼（Gabriel Lippmann）（综述）}{LPM}
\entry{钱德拉塞卡拉·拉曼（C. V. Raman）（综述）}{QDLlm}
\entry{赫尔曼·冯·亥姆霍兹（Hermann von Helmholtz）（综述）}{HEMfhm}
\entry{乔治·基斯佳科夫斯基（George Kistiakowsky）（综述）}{QZJS}
\entry{乔赛亚·威拉德·吉布斯（Josiah Willard Gibbs）（综述）}{QSY}
\entry{萨特延德拉·纳特·玻色（Satyendra Nath Bose）（综述）}{BOSE}
\entry{卡尔·弗里德里希·高斯（Carl Friedrich Gauss）（综述）}{KRGS}
\entry{詹姆斯·克拉克·麦克斯韦（James Clerk Maxwell）（综述）}{Clerk}
\entry{苏布拉马尼扬·钱德拉塞卡（Subrahmanyan Chandrasekhar）（综述）}{Sbl}
% \entry{角动量简介}{CM2}
...
\entry{尼古拉·特斯拉（Nikola Tesla）（综述）}{Tesla}
\entry{威廉·爱德华·韦伯（Wilhelm Eduard Weber）（综述）}{Eduard}
...
\entry{集成电路}{icJCDL}
\entry{进制、二进制}{Binary}
\entry{文本文件与字符编码（ASCII、Unicode）}{encode}
...
\entry{高德纳（综述）}{GDN}
\entry{阿瑟·康普顿（综述）}{KPD}
\entry{查尔斯·巴贝奇（综述）}{CRSBQ}
\entry{埃托雷·马约拉纳（综述）}{ATL}
\entry{约翰·麦卡锡（综述）}{YHMKX}
\entry{艾兹赫尔·戴克斯特拉（综述）}{ACHR}
% \chapter{天体物理}\label{cpt_astrops}
%---------------------------------------
...
%---------------------------------------
\entry{【导航】高中数学}{HsMOv}
\entry{数字与函数回顾（高中）}{HsFunB}
\entry{因式分解与一元二次方程（高中）}{quasol}
\entry{几何与解析几何初步（高中）}{HsGeBa}
%---------------------------------------
...
\entry{导数（高中）}{HsDerv}
\entry{导数的计算（高中）}{HsDerB}
\entry{导数的性质与构造（高中）}{HsDerC}
\entry{函数视角下的三角函数（高中）}{HsTFFv}
\entry{正弦型函数（高中）}{HsSinF}

\entry{等式与不等式（高中）}{HsEquN}
\entry{解方程与解不等式（高中）}{SolEqI}
\entry{线性方程组（高中）}{LinEqu}
\entry{恒等式与恒成立不等式（高中）}{HsIden}

\entry{数列（高中）}{HsSeFu}
\entry{等差数列（高中）}{HsAmPg}
\entry{等比数列（高中）}{HsGmPg}
\entry{求和符号（高中）}{SumSym}
\entry{数学归纳法（高中）}{MathId}
%---------------------------------------
...
\entry{双曲线（高中）}{Hypb3}
\entry{抛物线（高中）}{Para3}
\entry{圆锥曲线与圆锥（高中）}{ConSec}
\entry{圆锥曲线的统一定义（高中）}{HsCsFD}
\entry{射影几何视角下的圆锥曲线（高中）}{HsPGCC}

\entry{极坐标系}{Polar}
\entry{圆锥曲线的极坐标方程（高中）}{Cone}
...
\entry{图的顶点度}{DGraph}
\entry{图的连通性}{GraCon}
\entry{链、路、圈、回}{PatCyc}
\entry{Euler 图}{EulerG}
% \entry{Hamilton 图}{HamGra}
\entry{树与林}{TreFor}
\entry{图空间与赋权图}{GraSpa}
...
\entry{哈密顿量含时情况下时间演化算符的具体形式}{HtTEO}
\entry{泊松括号}{poison}
\entry{正则变换}{CanTra}
\entry{正则变换 2}{ClsMec}
...
\entry{算符平均值的演化、Ehrenfest 定理}{Ehrenf}
\entry{概率流密度}{PrbJ}
\entry{可观测量的相容性}{MsrCmp}
\entry{不确定性原理}{Uncert}
% \entry{一维高斯波包的时间—能量不确定度的计算}{EngBW}
...
\entry{分子轨道理论}{MOEO1}
\entry{分子点群与特征标表}{MPG1}
\entry{对称性匹配的线性组合}{SALCs}
...
\entry{弦的运动方程}{StEOM}
\entry{弦的作用量原理}{StrAct}
\entry{闭弦与无向弦的谱}{CUStSp}
\entry{开弦的谱}{OStSp}
\entry{开弦量子化}{OStQu}
\entry{粒子的小群分类（量子场论）}{WigCla}
...
\entry{无碰撞暗物质的引力坍缩}{Colli}

\entry{引力原子}{GAtom}

\entry{pi 介子衰变}{pideca}
...
\entry{Python 的安装}{Python}
\entry{Python 环境搭建}{Pyc1}
\entry{Python 第一步}{Pyc2}
...
\entry{yolov5 算法代码解析一}{yolov5}
\entry{yolov5 算法代码解析二}{yolo2}
...
\entry{Toeplitz 矩阵}{ToepM}
\entry{导数近似之差分矩阵算法}{DifMa}
\entry{傅里叶变换的差分矩阵}{InfDM}
% \entry{条件数}{ConNum}
...
\entry{中国科技大学 2014 年考研普通物理 A 考试试题}{ZKD14}
\entry{中国科技大学 2014 年考研普通物理 B 考试试题}{ZKD14B}
\entry{中国科技大学 2015 年考研普通物理考试题}{ZKD15}
\entry{中国科技大学 2015 年考研普通物理（B）}{USTC15}
\entry{中国科技大学 2016 年考研普通物理}{USTC16}
\entry{中国科技大学 2016 年考研普通物理 A 考试试题}{ZKD16A}
\entry{中国科技大学 2016 年考研普通物理 B 考试试题}{ZKD16B}

\entry{复旦大学 2004 量子真题}{FDU04}
\entry{复旦大学 2015 年考研普通物理}{FDU15}

\entry{四川大学 2006 年硕士物理考试试题（933）}{CD06}
\entry{四川大学 2007 年硕士物理考试试题（933）}{CD07}
\entry{四川大学 2008 年硕士物理考试试题（933）}{CD08}
\entry{四川大学 2009 年研究生入学物理考试试题（947）}{CD09}
\entry{四川大学 2013 年硕士物理考试试题（933）}{CD13}
...
\entry{南京理工大学 2009 年 研究生入学考试试题 普通物理（B）}{NJU09}
\entry{南京理工大学 2010 年 研究生入学考试试题 普通物理（B）}{NJU10}
...
\entry{浙江大学 2011 年硕士入学量子力学考试试题}{ZDLZ11}
\entry{浙江大学 2012 年 考研 量子力学}{ZJU12}
\entry{浙江大学 2012 年硕士入学量子力学考试试题}{ZDLZ12}
\entry{浙江大学 2014 年 考研 量子力学}{ZJU14}
\entry{浙江大学 2014 年硕士入学量子力学考试试题}{ZDLZ14}
...
\entry{陕西师范大学 2007 年 考研 量子力学}{SNNU07}
...
\part{综述} \label{prt_zongsu}
%=====================================
\chapter{数学} \label{cpt_sx1}
%---------------------------------------
\entry{群（综述）}{GroupM}
\entry{李群（综述）}{LQun}
\entry{数论（综述）}{SHuLun}
...
\entry{链式法则（综述）}{LSFZ}
\entry{笛卡儿积（综述）}{DKR}
\entry{微积分学（综述）}{Calcul}
\entry{康托尔集（综述）}{KTRJ}
\entry{序数算术（综述）}{Ordina}
\entry{罗素悖论（综述）}{LSBL}
\entry{选择公理（综述）}{AC}
\entry{佐恩引理（综述）}{ZornS}
\entry{介值定理（综述）}{JZDL}
...
\entry{指数函数（综述）}{ZShs}
\entry{抽象代数（综述）}{CXds}
\entry{几何代数（综述）}{jiheds}
\entry{布尔代数（综述）}{BRds}
\entry{结合代数（综述）}{JHds}
\entry{交错代数（综述）}{JCds}
\entry{乔丹代数（综述）}{QDds}
\entry{泊松代数（综述）}{BOsong}
\entry{海森伯群（综述）}{HSBQ}
\entry{洛伦兹群（综述）}{LuoLz}
\entry{代数拓扑（综述）}{DSTP}
\entry{微分拓扑（综述）}{WFTP}
\entry{微分同胚（综述）}{WeiFTP}
\entry{完备空间（综述）}{WBKJ}
\entry{仿射空间（综述）}{FSKJ}
\entry{拓扑空间（综述）}{TPKJ}
\entry{泡利矩阵（综述）}{PLJZ}
\entry{霍普夫代数（综述）}{HPFds}
\entry{几何拓扑学（综述）}{JHtpx}
\entry{拓扑不变量（综述）}{TPbbl}
\entry{域上的代数（综述）}{YSds}
\entry{非结合代数（综述）}{FJHds}
\entry{康托尔定理（综述）}{KTDL}
\entry{康托尔悖论（综述）}{KTRBL}
\entry{朴素集合论（综述）}{PSJHL}
\entry{点集拓扑学（综述）}{DJTP}
\entry{皮亚诺公理（综述）}{PYN}
\entry{费马大定理（综述）}{FMDL}
\entry{费马小定理（综述）}{FMxdl}
\entry{泰勒斯定理（综述）}{Thales}
\entry{莫雷拉定理（综述）}{MLLdl}
\entry{洛必达法则（综述）}{LbdFZ}
\entry{高尔顿钉板（科普）}{GRDDB}
\entry{庞加莱猜想（综述）}{PJLCX}
\entry{连续统假设（综述）}{COhy}
\entry{棣莫弗公式（综述）}{DMFGS}
\entry{薛定谔方程（综述）}{XDEfc}
\entry{超几何函数（综述）}{CJHhs}
\entry{素数证明书（综述）}{SSzm}
\entry{格林恒等式（综述）}{GLHds}
\entry{分部积分法（综述）}{FbJf}
\entry{哥德巴赫猜想（综述）}{GDBHCX}
\entry{柯西积分公式（综述）}{KXjfgs}
\entry{庞特里亚金类（综述）}{PTLyjl}
\entry{欧几里得空间（综述）}{OJLDkj}
\entry{欧几里得几何（综述）}{OJLJH}
\entry{普莱费尔公理（综述）}{PLFRgl}
\entry{拉普拉斯方程（综述）}{LPLSFC}
\entry{新基础集合论（综述）}{XJCJH}
\entry{卡迈克尔函数（综述）}{KMKRhs}
\entry{单位阶跃函数（综述）}{DWJYhs}
\entry{克利福德代数（综述）}{KLFds}
\entry{柯西积分定理（综述）}{KXjfdl}
\entry{高斯散度定理（综述）}{GSsd}
\entry{拉普拉斯算子（综述）}{LpLsZ}
\entry{柯西-黎曼方程（综述）}{KExiLM}
\entry{Softmax 函数（综述）}{SoHs}
\entry{切比雪夫多项式（综述）}{QBXFdx}
\entry{魏尔施特拉斯函数（综述）}{WRST}
\entry{希尔伯特旅馆悖论（综述）}{HPGH}
\entry{哥德尔不完备定理（综述）}{Godle}
\entry{巴拿赫-塔斯基定理（综述）}{BTS}
\entry{布拉利-福尔蒂悖论（综述）}{BLFR}
\entry{博苏克-乌拉姆定理（综述）}{BSKwlm}
\entry{柯西-施瓦茨不等式（综述）}{KXSW}
\entry{阿贝尔-鲁菲尼定理（综述）}{ABRR}
\entry{布劳威尔不动点定理（综述）}{BLWRbd}
\entry{勒文海姆–斯科伦定理（综述）}{Skolem}
\entry{策梅洛-弗兰克尔集合论（综述）}{Zermel}
\entry{拉普拉斯-贝尔特拉米算子（综述）}{LPLSbr}
\entry{冯·诺伊曼-博内斯-哥德尔集合论（综述）}{NBG}

\chapter{经典力学} \label{Lx_1}
%---------------------------------------
\entry{动量（综述）}{DL}
\entry{角动量（综述）}{JDL}
\entry{热力学（综述）}{RLX}
...
\entry{库仑定律（综述）}{KL}
\entry{泊松方程（综述）}{BSFC}
\entry{粒子物理学（综述）}{Partic}
\entry{哈密顿力学（综述）}{HMD}
\entry{微正则系统（综述）}{WZZXT}
\entry{开普勒定律（综述）}{KPL}
\entry{安培力定律（综述）}{APDL}
\entry{刘维尔定理（综述）}{LWR}
\entry{麦克斯韦妖（综述）}{MaxWY}
\entry{巨正则系综（综述）}{JZXT}
\entry{刚体动力学 （综述）}{GTDL}
\entry{达朗贝尔原理（综述）}{DAP}
\entry{牛顿运动定律（综述）}{NEW01}
\entry{欧拉运动定律（综述）}{OLYD}
\entry{能量守恒定律（综述）}{NLSH}
\entry{平方反比定律（综述）}{PFFBDL}
\entry{拉格朗日力学 （综述）}{LGL}
\entry{麦克斯韦方程组（综述）}{MAXS}
\entry{费曼-海尔曼定理（综述）}{FMHRM}
\entry{牛顿万有引力定律（综述）}{NEWW}
\entry{普朗克黑体辐射定律（综述）}{HTFS}
\entry{法拉第电磁感应定律（综述）}{FLDL}
\entry{纳维-斯托克斯方程（综述）}{NWstks}
\entry{库拉托夫斯基闭包公理（综述）}{KLTFSJ}
\entry{麦克斯韦-玻尔兹曼分布（综述）}{MKBR}

\chapter{量子力学} \label{cpt_LZ1}
%------------------------------------
\entry{自旋（综述）}{Spin1}
\entry{衍射（综述）}{YS}
\entry{干涉 (物理学)（综述）}{GSWLX}
\entry{盒中气体（综述）}{GasBOX}
\entry{量子引力（综述）}{LZYL}
\entry{零点能量（综述）}{LD}
\entry{密度矩阵（综述）}{MDJZ}
\entry{普朗克常数（综述）}{PLKCS}
\entry{卡西米尔效应（综述）}{KMXR}
\entry{自旋统计定理（综述）}{ZXTJDL}
\entry{玻尔兹曼因子（综述）}{BRCMLZ}
\entry{原子吸收光谱（综述）}{AAS}
\entry{量子力学的诠释（综述）}{QMinet}
\entry{泡利不相容原理（综述）}{PLBXR}
\entry{费米-狄拉克统计（综述）}{FermiD}
\entry{玻色–爱因斯坦统计（综述）}{BSAYST}
\entry{麦克斯韦-玻尔兹曼统计（综述）}{MBTJ}
\entry{格罗斯–皮塔耶夫斯基方程（综述）}{GLS}

\chapter{天文学} \label{cpt_TW1}
%------------------------------------
\entry{天体（综述）}{TianTI}
\entry{星群（综述）}{Asteri}
\entry{星族（综述）}{Stpo}
...
\entry{鸟神星（综述）}{Makema}
\entry{妊神星（综述）}{Haumea}
\entry{柯伊伯带（综述）}{Kuiper}
\entry{似地行星（综述）}{Eaan}
\entry{系外卫星（综述）}{Exomoo}
\entry{恒星光谱（综述）}{Stcl}
\entry{星际行星（综述）}{RoPl}
\entry{海洋行星（综述）}{Ocwo}
\entry{脉冲星行星（综述）}{Pupl}
...
\entry{考古天文学（综述）}{ArmY}
\entry{哥白尼原则（综述）}{CoPr}
\entry{小行星卫星（综述）}{Minor}
\entry{引力波天文学（综述）}{Gras}
\entry{帕洛马天文台（综述）}{Paloma}
\entry{黄道十二宫（综述）}{Astsi}
\entry{半人马小行星}{Centau}
\entry{太阳系外行星（综述）}{Exopla}
...
\entry{计算机视觉（综述）}{JSJ}
\entry{人工智能史（综述）}{RGZN}
\entry{编程语言理论（综述）}{BCYY}
\entry{人工神经网络（综述）}{RGSJ}
\entry{人工智能对齐（综述）}{RGZNDQ}
\entry{自然语言处理（综述）}{ZR}
\entry{蒙特卡罗方法（综述）}{MTKL}
\entry{计算复杂性理论（综述）}{JSFZ}
\entry{计算机系统结构（综述）}{CORE}

\chapter{其他} \label{cpt_QT1}
%------------------------------------
\entry{欧拉角（综述）}{OLJ}
\entry{狄拉克方程（综述）}{DLK}
\entry{马约拉纳方程（综述）}{MYLN}
\entry{杨-米尔斯理论（综述）}{Yang}
\entry{斯托克斯定理（综述）}{STKS}
