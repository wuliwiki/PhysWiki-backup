...
首先我们把刚体看做质点系， 作质心到转轴的垂线， 以垂足为坐标原点， 以转轴指向纸内的方向为 $z$ 轴正方向， 令质心\upref{CM}的位置矢量为 $\bvec r_c$（与转轴垂直）， 计算刚体的合力矩为（参考\autoref{Torque_ex1}~\upref{Torque}）
\begin{equation}\label{RigRot_eq14}\ali{
\bvec \tau &= \sum_i \bvec r_i \cross (m_i \bvec g)
= \sum_i (m_i \bvec r_i) \cross \bvec g \\
