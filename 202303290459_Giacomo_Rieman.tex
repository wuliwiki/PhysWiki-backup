...
我们可以证明闭区间$[a, b]$上的单调函数最多只有可数个不连续点\autoref{confun_def1}~\upref{confun}（待添加，参考\footnote{https://en.wikipedia.org/wiki/Discontinuities_of_monotone_functions}），实际上我们可以把定理推广为
