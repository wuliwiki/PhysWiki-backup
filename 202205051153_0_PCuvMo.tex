...
虽然我们可以直接由定义根据直角坐标写出加速度分量如 $a_x = \dv*[2]{x}{t}$， $a_y = \dv*[2]{y}{t}$， 但有时候我们采用另一种正交分解会更方便， 即把加速度分解到和速度垂直和平行的两个方向．
...
把速度矢量表示为大小和方向的标量积， 有 $\bvec v = v\uvec v$． 那么根据求导法则（\autoref{DerV_eq3}~\upref{DerV}），加速度为\footnote{特别注意速度大小的变化率 $\dv*{v}{t}$ 和速度 $$}
