...
再次由\autoref{SpltFd_the1}~\upref{SpltFd}的证明过程\footnote{这次要的是“适当选择同态映射可以把一个根映射到同一个不可约多项式的任意根上”．}，可知$\{\varphi_1\alpha, \cdots, \varphi_n\alpha\}$包含$\opn{irr}(\alpha, \mathbb{F})$的所有根．于是，$f=\opn{irr}(\alpha, \mathbb{F})$
