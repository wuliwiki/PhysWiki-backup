...
\sigma = E \varepsilon~.
\end{equation}
其中$\sigma$是\enref{应力}{STRESS}，$\varepsilon$是\enref应变\upref{Strain}，$E$被称为\textbf{杨氏模量（Young's modulus）}，也叫\textbf{杨氏模数}或者\textbf{弹性模量}， 是用于衡量材料弹性的力学属性，物理含义类似弹簧的劲度系数$k$。杨氏模量具有压强的量纲（\enref{国际单位：帕斯卡}{SIunit}）。
