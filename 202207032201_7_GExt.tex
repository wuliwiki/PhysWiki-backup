...
注意$\mathbb{KE}\cap \mathbb{K}=\mathbb{K}$．构造\textbf{群同态}$\varphi:\opn{Gal}(\mathbb{KE}/\mathbb{E})\to\opn{Gal}(\mathbb{K}/\mathbb{K}\cap\mathbb{E})$，定义为$\varphi (\sigma) = \sigma\mid_{\mathbb{K}}$．显然这是一个满同态．

如果存在$\sigma_1, \sigma_2\in\opn{Gal}(\mathbb{KE}/\mathbb{E})$，使得$\varphi(\sigma_1)=\varphi(\sigma_2)$，则$\sigma_1\sigma_2^{-1}$保$\mathbb{K}$不变．
