...
&=\pdv{\bra a}{t}A(t)\ket{a}+\bra{a}\pdv{A}{t}\ket{a}+\bra{a}A\pdv{\ket{a}}{t}\\
&=\left\langle \pdv{A}{t}\right\rangle+\frac{1}{\I\hbar}\bra{a}-HA+AH\ket a\\
&=\left\langle \pdv{A}{t}\right\rangle+\frac{\I}{\hbar}\left\langle [H,A]\right\rangle~,
\end{aligned}
\end{equation}
得证。
