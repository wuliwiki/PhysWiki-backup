...
\item 其他一些操作和\enref{} NumPy\upref{numpy} 数组类似， 如 \verb|len(mat)| 获取元素个数， \verb|shape(mat)| 或者 \verb|mat.shape| 获取形状。 又如 \verb|Matrix([1,2])| 的形状是 \verb|(2,)|， 而 \verb|Matrix([[1,2]])| 的形状是 \verb|(1,2)|。
