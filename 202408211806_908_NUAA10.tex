...
&= \int_{0}^{a} \left( A_1^2 \psi_1^2 + A_2^2 \psi_2^2 + 2 A_1 A_2 \psi_1 \psi_2 \cos \left( \frac{E_2 - E_1}{\hbar} t_0 \right) \right) dx \\
...
&= \int_{0}^{a} \left( \frac{4}{5a} \left( 1 - \cos \frac{2\pi x}{a} \right) + \frac{1}{5a} \left( 1 - \cos \frac{4\pi x}{a} \right) + \frac{4}{5a} \cos \frac{\pi x}{a} \cos \frac{3\pi x}{a} \cos \frac{3\pi^2 \hbar t_0}{2ma^2} \right) dx \\
