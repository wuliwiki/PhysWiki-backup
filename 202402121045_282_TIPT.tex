...
简并时，\autoref{eq_TIPT_5} 和\autoref{eq_TIPT_4} 相当于把 $H^1\ket{\psi_n^0}$ 投影到每个 $E_m^0$ 子空间中再除以 $(E_n^0-E_m^0)$ 再求和。所以在每个子空间中，用任意一组正交归一基底代替 $\bra{\psi_m^0}$ 都可以，未必需要好本征态。 例如计算氢原子 stark 效应时可以直接用 $\bra{}$
