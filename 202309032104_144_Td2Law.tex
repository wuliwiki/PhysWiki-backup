...
$$\text{系统平衡} \Leftrightarrow \text{系统熵达到最大} \Leftrightarrow S=S_{max} \Leftrightarrow \delta S = 0~.$$
\end{corollary}

\begin{theorem}{热动平衡判据}
基于平衡判据与数学推导，我们发现 平衡的孤立系统中压强、温度与化学势（如果你还不知道什么是化学势，不用担心，以后会知道的）处处相同，此谓热动平衡判据 \upref{equcri} 。具体的推导参考“热动平衡判据 \upref{equcri} ” 与“相变平衡条件 \upref{PhEquv} ”。
$$
