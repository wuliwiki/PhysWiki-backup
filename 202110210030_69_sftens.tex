...
通过这个判据我们可以推出许多结论．例如容器中充满液体 $A$，液体 $A$ 中悬浮着一滴的液体 $B$，其形状近似为半径为 $r$ 的球体．那么总自由能的变分为
\begin{align}
\delta{\mu_A+\mu_B}&=-S_A\delta T-p_A\delta V_A+\sigma_A\delta S-S_B\delta T-p_B\delta V_B+\sigma_B\delta S\\
&=(p_B-p_A)4\pi r^2\dd r + (\sigma_A+\sigma_B)8\pi r\dd r=0
\end{align}
所以我们发现，$p_A\neq p_B$，在这个热力学稳定平衡的系统中，由于表面张力的存在，有压强差．
