...
\caption{$u_1=0.2x_1$．$\varepsilon_{11}=0.2$（其余为$0$），微元发生拉伸变形} \label{Strain_fig5}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/Strain_6.pdf}
\caption{$u_1=0.2x_2$. $\varepsilon_{12}=0.2$,微元发生简单的剪切变形} \label{Strain_fig6}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/Strain_8.pdf}
\caption{$u_1=0.2x_2, u_2=0.2x_1$.$\varepsilon_{12}=0.4$，微元发生剪切变形} \label{Strain_fig8}
\end{figure}
\begin{figure}[ht]
\centering
