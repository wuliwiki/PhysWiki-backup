...
反证$\bvec v\in \opn{ker}B^k\cap\opn{Im}B^k$，可令$\bvec v=B^k\bvec u$。则有$B^k\bvec v=B^2k\bvec u=\bvec 0$，则$\bvec u\in \opn{ker}B^{2k}=\opn{B^k}$，那么我们有$\bvec v=B^k\bvec u=\bvec 0$，得证。
