...
&\frac{\sqrt{2m}}{\hbar}\int_a^x\sqrt{E-V(y)}\dd y=\frac{2}{3}(-\xi)^{3/2},\quad(E>V)\\
&-\I\frac{\sqrt{2m}}{\hbar}\int_a^x\sqrt{V(y)-E}\dd y=-\frac{2}{3}(-\xi)^{3/2},\quad(E<V)
\end{aligned}\right.
\\
\sqrt{k(x)}
&=\left\{\begin{aligned}
-(-\xi)^{1/4}\frac{2mV'(a)}{\hbar^2}),\quad(E>V)\\
-(-\xi)^{1/4}\frac{2mV'(a)}{\hbar^2}),\quad(E<V)
\end{aligned}\right.
\end{aligned}
\end{equation}
...
\frac{C}{(-\xi)^{1/4}}\E^{\frac{2}{3}(-\xi)^{3/2}+\delta}\\
\frac{C}{(-\xi)^{1/4}}\E^{\frac{2}{3}(-\xi)^{3/2}+\delta}
\end{aligned}\right.
\end{equation}
