...
\mathcal{L}=\mathrm{\I} \bar{\psi} \gamma^{\mu} \partial_{\mu} \psi-m \bar{\psi} \psi \quad\left(\bar{\psi}=\psi^{\dag} \gamma^{0}\right)
\end{equation}
对\autoref{qed4_eq20} 的\Psi进行变分可得到\autoref{qed4_eq21}．
