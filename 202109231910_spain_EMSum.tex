...
&=\frac{(2n+1)!}{2\pi}\int_{0}^{\pi}\frac{\E^{-2n\mathrm i\theta}}{\E^{e^{i \theta}}-1} d \theta+\frac{(2 n+1) !}{2 \pi} \int_{0}^{\pi} \frac{e^{-2 n i \theta}}{e^{e^{-i \theta}}-1} d \theta=\frac{(2 n+1) !}{2 \pi} \int_{0}^{\pi}-e^{-2 n i \theta} d t
\end{aligned}
$$
