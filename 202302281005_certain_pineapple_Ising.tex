...
注：本文中的自选实际上为二倍的自选，所以电子自选被取值为$\pm 1$，系数被吸纳入$J$与$B$中。
...
在$B=0$时，分两种情况，当$T=0$时，$m$根据磁场趋向\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/Ising_1.png}
\caption{请添加图片描述} \label{Ising_fig1}
\end{figure}于0的方向可分别取值$\pm1$，当$T\neq0$时， $s=0$。
