...
\autoref{fig_NN_4} 和\autoref{fig_NN_5} 分别表示的是两个输入变量$x_1$,$x_2$之间的逻辑与问题和逻辑或问题。这两个基本的布尔运算很容易由感知机解决。
...
隐含层的存在使得神经网络具有非线性可分的能力。事实上，两层感知机就能表示所有的逻辑函数[2]。
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/85760f884011b87c.png}
