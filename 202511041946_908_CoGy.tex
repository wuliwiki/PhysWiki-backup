...
\hline
数论派宇宙演化论（Samkhya Cosmic Evolution） \quad 迦毗罗（Kapila，公元前 6 世纪），阿修里（Asuri）之弟子 \quad “自性”（\emph{Prakriti}，物质）与“神我”（\emph{Purusha}，意识）之关系（Relation between Matter and Consciousness） \quad 
“自性”（Prakriti，物质）是生成世界（world of becoming）的根源，是一种纯粹的潜能（pure potentiality），依次演化为二十四种“原理”（tattvas）。这种演化之所以可能，是因为 Prakriti 始终处于其三种组成要素（称为“性” \emph{gunas}）之间的张力状态之中：善性（Sattva，轻明或纯净）、动性（Rajas，激情或活动）、惰性（Tamas，惯性或沉重）。数论派的因果理论被称为“有因论”（\emph{Satkārya-vāda}，theory of existent causes），其核心主张为：无物可凭空生灭，所有的演化不过是原始自然（primal Nature）从一种形式向另一种形式的转化。\,

圣经宇宙学（Biblical cosmology） \quad 《创世纪》创世叙事（\emph{Genesis creation narrative}） \quad 漂浮于无限“混沌之水”中的地球（Earth floating in infinite "waters of chaos"） \quad 地球与天穹构成一个位于无限“混沌之水”中的整体；其上方的“穹苍”（\emph{firmament}）阻隔外部的“混沌之海”。

阿那克西曼德模型（Anaximander's model） \quad 阿那克西曼德（Anaximander，约公元前 560 年） \quad 地心说（Geocentric），圆柱形地球，空间无限而时间有限；首个纯机械模型（first purely mechanical model） \quad 地球静止地漂浮于无限空间的中心，不受任何支撑。\cite{ref32} 起初，在冷热分离之后，一团火球出现，像树皮包裹树干一样环绕着地球。此火球破裂后形成了宇宙的其他部分。宇宙如同一个由火充盈的空心同心圆环系统，其边缘布满洞孔，如笛孔一般；并无真正的天体，唯有火光透过孔隙射出。共有三层圆环，从地球向外依次为：恒星（包括行星）、月亮与巨大的太阳。\cite{ref33}
```
