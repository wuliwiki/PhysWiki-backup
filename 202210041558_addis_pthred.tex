...
\addTODO{\verb|pthread_exit()| 是什么？ \verb|joint()| 怎么实现？ \verb|mutex| 怎么实现？ 见\href{https://www.geeksforgeeks.org/thread-functions-in-c-c/}{这里}， 以及\href{https://www.geeksforgeeks.org/mutex-lock-for-linux-thread-synchronization/}{这里}．}
