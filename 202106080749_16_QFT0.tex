...
\end{equation}
这是一个比较粗糙的说法．电子的外腿相当于因子$| e^+ e^- \rangle $,$\mu$子外腿相当于因子$\langle \mu^+ \mu^- |$.顶点相当于是$H_I$．光子内线相当于因子$|\gamma\rangle\langle\gamma|$．这里$\mu$的意思是光子是个矢量粒子．那么实际上散射振幅$\mathcal M$\autoref{QFT0_eq2} 拆解为
