...
默认安装路径是 \verb|/usr/local/boost|， 二进制文件在子目录 \verb|lib/| 如果没有 sudo 权限也可以指定安装目录， 详情参考\href{https://www.boost.org/doc/libs/1_76_0/more/getting_started/unix-variants.html#easy-build-and-install}{安装说明}． 注意编译时间可能较长！
