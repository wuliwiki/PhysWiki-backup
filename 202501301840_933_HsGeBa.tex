...
一个点到一条直线的距离，指的是该点与直线上最近点之间的长度。具体来说，从该点作一条\textbf{垂线（perpendicular line）}到该直线，并标记垂线与直线的交点，称为\textbf{垂足（foot of the perpendicular）}。点到直线的距离即为该点与垂足之间的线段长度。换句话说，这一距离等于该点到直线的\textbf{垂线段（perpendicular segment）}的长度。


即从该点到直线作\textbf{垂线（perpendicular line）}，其垂足与该点之间的线段长度。换句话说，这一距离等于该点到直线的\textbf{垂线段（perpendicular segment）}的长度。
...
对于一条线段，若有一条直线经过该线段的中点，并且与该线段垂直，则称这条直线为该线段的\textbf{垂直平分线（Perpendicular Bisector）}。任何位于垂直平分线上的点，到线段两端点的距离相等。反之，若某个点到线段两端点的距离相等，则该点一定在这条线段的垂直平分线上。
