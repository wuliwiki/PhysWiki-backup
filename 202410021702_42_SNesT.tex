...
在 $\{x_n\}$ 中选取这样的点 $x_{n_1}$作为闭球的中心，使得一切 $n\geq n_1$，$d(x_n,x_{x_1})<1/2$（根据柯西序列\autoref{def_cauchy_3}）。然后在 $\{x_n\}$ 中选取 $x_{n_2}$，使得 $n_2>n_1$，且对一切 $n\geq n_2$，$d(x_n,x_{x_2})<1/2^2$。
