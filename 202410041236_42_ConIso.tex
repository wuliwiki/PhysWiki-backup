...
\begin{equation}
\begin{aligned}
\abs{d(x,y)-d(x_0,y_0)}&\leq\abs{d(x,y_0)+d(y,y_0)-d(x_0,y_0)}\\
&\leq\abs{d(x,x_0)+d(y_0)+d(y,y_0)-d(x_0,y_0)}\\
&\xlongequal{d\text{的非负性和对称性}}d(x_0,x)+d(y_0,y).
\end{aligned}~
\end{equation}
