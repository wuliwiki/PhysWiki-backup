...
\hline
\dfracH 电场强度 $E$ & $\dfrac{1}{2G}\sqrt{\dfrac{c^7}{\pi\epsilon_0 \hbar}}$ & $6.4528172(14)\e{61}$ \\
\hline
...
\end{equation}
这是 $\hbar, G, c$ 使用幂的乘积拼凑出长度量纲的唯一组合： 令 $\beta_x = \hbar^a G^b c^c k_B^d$ 即可解出 $a = b = 1/2, c = -3/2, d = 0$． 其他的物理量的转换常数也可以通过解 $a,b,c$ 的形式得到．
