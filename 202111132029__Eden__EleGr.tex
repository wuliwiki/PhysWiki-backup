...
&=\frac{q}{4\pi\epsilon_0}\qty(\frac{1}{|\bvec r-\bvec r_1|}+\frac{1}{|\bvec r-\bvec r_2|})-\frac{E_z(\bvec r')}{2\pi\epsilon_0|\bvec r-\bvec r_1|}
\end{aligned}
\end{equation}
上式的推导中利用了高斯定理将 $E_z(\bvec r')=\partial \phi(\bvec r')/\partial z'$ 用 $\sigma(\bvec r')/\epsilon_0$ 替换．$\sigma$ 是导体边界上的面电荷密度．由此
