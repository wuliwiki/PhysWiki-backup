...
然后证明，实对称矩阵$A$的不同特征值对应相互正交的特征向量。为了表示方便，以下回归A作为对称变换的意义，括号表示内积。设$\boldsymbol x_1,\boldsymbol x_2$为A的两个特征向量，那么我们有
...
因此，利用施密特正交化后的特征向量组，我们可以把实对称矩阵化为对角矩阵。可以验证，对角元即对应的特征值。即：如果该标准正交基为$\{x_1,x_2,x_3...x_n\}$，对角化结果$\opn{diag}(\lambda_1,\lambda_2,...\lambda_n)$
