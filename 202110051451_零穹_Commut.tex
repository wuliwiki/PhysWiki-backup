...
\vmat{
2-\lambda & 0 & 0&0&0\\
0&3-\sqrt{5}-\lambda&2&0&0\\
0&2&1-\sqrt{5}-\lambda&0&0\\
0&0&0&0-\lambda&-\I\\
0&0&0&i&0-\lambda
}=0
\end{equation}
...
\begin{equation}
\bvec{A_1}=\pmat{1}\quad ,\bvec{A_2}=\pmat{3-\sqrt{5}&2\\2&1-\sqrt{5}},\quad
...
解得 $\bvec{A}$ 的本征值为： $\lambda_1=2,\lambda_2= ,\lambda_3=$
\addTODO{结合上文说明和证明}
