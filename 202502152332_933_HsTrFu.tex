...
这里的三角函数定义上似乎与之前的幂函数、指数函数和对数函数不太一样。尽管仍然是运算，但这里的运算并非是直接的代数运算，而是涉及到了几何图形，涉及到了长度等概念。这对高中阶段的影响不大，但在高等数学中，这样的定义其实带来了一些循环论证的问题，因此在未来数学专业的学习中还会调整定义。但不论如何调整，他们描述的概念雏形还是来源于最开始的直角三角形中的三角函数。做出来的更多是为了逻辑上的通顺而做的扩展。其实很多概念都是这样，最开始的
