...
那么我们怎么数学地形容“函数增长得越来越快”？我们知道，函数的变化速率可以用相应函数的导数 \upref{Der} $f'(x)$表示；而“增长得越来越快”意味着$f'(x)$越来越大；而$f'(x)$越来越大意味着$f'(x)$的导数$f''(x)>0$，即函数的二阶导数大于零 \upref{HigDer} 。按照物理的话术说，“速度越来越快”意味着“加速度大于零”。
