...
\end{equation}
\begin{equation}
\laplacian s = \frac{1}{\sqrt{2}c^3\sinh\xi\sin\eta\qty(\sinh^2\xi+\sin^2\eta)}\qty(\sqrt{2}c\sin\eta\pdv{\xi}\qty(\sinh\xi\pdv{s}{\xi}) + \pdv{\eta}\qty(\sqrt{2}c\sinh\xi\sin\eta\pdv{s}{\eta})  )+ \frac{1}{2c^2\sinh^2\xi\sin^2\eta }\pdv[2]{s}{\phi}
\end{equation}
