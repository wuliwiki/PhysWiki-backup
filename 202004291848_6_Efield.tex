...
\begin{equation} \label{Efield_eq_1}
E=\frac{\lambda}{2 \pi \varepsilon_{0} a}
\end{equation}
\autoref{Efield_eq1}表明，无限长带电直棒附近某点的电场强度$\mathbf E $与该点离带电直棒的距离$a $成反比，$\mathbf  E $的方向垂直于直棒．若$\lambda$为正，$\mathbf E $沿$Oy $轴的正方向；若$\lambda$为负，$\mathbf E $沿$Oy $轴的负方向．以上结果对有限长的细直棒来说，在靠近直棒中部附近的区域（$a\ll L$）也近似成立．
\end{example}
