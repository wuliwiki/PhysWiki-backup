...
为了方便暂且假设所有 $M=0$， 有
\begin{equation}\ali{
F^{(vz1)}_{\lambda,\lambda'} &= \mel{\mathcal{Y}_{l_1 l_2}^{LM}}{F^{(vz1)}}{\mathcal{Y}_{l_1' l_2'}^{L'M'}}\\
&= \delta_{l_2, l_2'} \sum_{m_1,m_2, m_1'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M}\bmat{l_1' & l_2' & L'\\ m_1' & m_2 & M'} \times\\
& \quad\int Y_{l_1m_1}^*(\uvec r_1) F^{(vz1)}(\uvec r_1)Y_{l_1' m_1'}(\uvec r_1)\dd{\Omega_1}\\
&= \delta_{l_2, l_2'} \sum_{m_1} \bmat{l_1 & l_2 & L\\ m_1 & -m_1 & 0}\bmat{l_1' & l_2' & L'\\ m_1 & -m_1 & 0} \times\\
& \quad\int Y_{l_1m_1}^*(\uvec r_1) F^{(vz1)}(\uvec r_1)Y_{l_1' m_1}(\uvec r_1)\dd{\Omega_1}~.
}\end{equation}
最后的积分可以参考\autoref{eq_HyTDSE_13}~\upref{HyTDSE}。 同理，
\begin{equation}\ali{
F^{(vz2)}_{\lambda,\lambda'} &= \mel{\mathcal{Y}_{l_1 l_2}^{LM}}{F^{(vz1)}}{\mathcal{Y}_{l_1' l_2'}^{L'M'}}\\
&= \delta_{l_1, l_1'} \sum_{m_1,m_2, m_1'} \bmat{l_1 & l_2 & L\\ m_1 & m_2 & M}\bmat{l_1' & l_2' & L'\\ m_1' & m_2 & M'} \times\\
& \quad\int Y_{l_1m_1}^*(\uvec r_1) F^{(vz2)}(\uvec r_1)Y_{l_1' m_1'}(\uvec r_1)\dd{\Omega_1}\\
&= \delta_{l_1, l_1'} \sum_{m_1} \bmat{l_1 & l_2 & L\\ m_1 & -m_1 & 0}\bmat{l_1' & l_2' & L'\\ m_1 & -m_1 & 0} \times\\
& \quad\int Y_{l_1m_1}^*(\uvec r_1) F^{(vz2)}(\uvec r_1)Y_{l_1' m_1}(\uvec r_1)\dd{\Omega_1}~.
}\end{equation}
