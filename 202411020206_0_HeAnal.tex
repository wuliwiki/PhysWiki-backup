...
\begin{equation}
\bar E = \iint \pdv{\sigma_j}{\Omega_1}{\Omega_2} s(\omega) \dd{\omega}\dd{\Omega_1}\dd{\Omega_2} = \iint \pdv{\sigma_j}{\Omega_1}{\Omega_2}  \frac{s(\omega(k_1,k_2))}{2\pi m}\dd{k_1}\dd{k_2}\dd{\Omega_1}\dd{\Omega_2}~.
\end{equation}
其中
\begin{equation}
