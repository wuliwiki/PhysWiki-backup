...
\end{figure}
继续递归，访问到第一个叶子节点，叶子节点自更新其自己 $\alpha$、$\beta$ 信息。由于是 Max 层，更新 $\alpha$ 信息：
\begin{figure}[ht]
\centering
...
\end{figure}
之后继续递归搜索，轮到下一个叶子节点，自更新 $\alpha$、$\beta$ 信息。因为是在 Max 层所以更新自己的 $\alpha$ 信息。
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/672220ed1a89a429.png}
\caption{请添加图片标题} \label{fig_mmsab_27}
\end{figure}
