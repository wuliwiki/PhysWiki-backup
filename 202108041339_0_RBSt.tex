...
再来看一般情况， 每个人施加的力除了竖直分量还有水平分量． 令水平的力为 $F_1', F_2'$ （向外为正）， 两受力点到质心的高度差为 $h_1, h_2$ （受力点低于质心为正）， 由水平方向和竖直方向的受力平衡和力矩平衡得
\begin{equation}
\begin{aligned}
&F_1' = F_2'\\
&F_1 + F_2 = Mg\\
...
\end{aligned}
\end{equation}
我们发现， 由于 $F'$ 可取任意实数， 所以无论两个受力点在哪里， 只要 $h_1 \ne h_2$ 总能通过调节 $F'$ 使 $\abs{F_1} > \abs{F_2}$ （即第一人的合力大于第二人）或者 $\abs{F_1} < \abs{F_2}$ （即第一人的合力小于第二人）．
\end{example}
