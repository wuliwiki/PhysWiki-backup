...
\item \verb`(with-exception-catcher ...)`
\end{itemize}
...
\end{lstlisting}
\item \verb`(trycatch (thunk) (lambda (e) (handler e)))` 等效于 \verb`(with-exception-catcher hand thunk)`
\end{itemize}
...
\item 例如 \verb`aliases` 定义了一个类似于 \verb`std::stringstream` 的构造函数
\begin{lstlisting}[language=none]
