...
\begin{equation}
\begin{aligned}
\div \bvec A = &\frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\Bigg[\pdv{\xi}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) \\&+ \pdv{\eta}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) + \pdv{z}(c^2\qty(\sinh^2\xi+\sin^2\eta)A_z)\Bigg]
\end{aligned}
\end{equation}
\begin{equation}
\begin{aligned}
&\curl \bvec A = \frac{1}{c\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{\eta}(A_z) - \pdv{z}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta)]\uvec \xi\\
&\quad + \frac{1}{c\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{z}(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) - \pdv{\xi}(A_z)]\uvec \eta
+ \frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\qty[\pdv{u}(gA_v) - \pdv{v}(fA_u)]\uvec w
\end{aligned}
\end{equation}
\begin{equation}
