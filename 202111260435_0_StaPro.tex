...
要说明的是， “系统的状态” 可能会有不同的定义． 热力学研究的主要是上述的宏观状态， 但在统计力学中， 即使气体处于确定的宏观状态， 也可能对应不计其数的不同微观状态． 微观状态在这里是指气体中每一个粒子的运动参数． 要完整描述 $N$ 个质点的微观状态， 就需要每个粒子的位置和动量 $(\bvec r_i, \bvec p_i)$ （$i=1,\dots,N$） 共 $6N$ 个参数．
\end{example}
