...
再看含 bridge function 的矩阵元：
\begin{equation} \ali{
D_{(im), (iN)} &= \frac{-1}{a_i^{3/2} \sqrt{a_i + a_{i+1}}} \sqrt{w_{0m}} f'_N(t_k)
\qquad (1< m < N)~,
} \end{equation}

\begin{equation} \ali{
D_{(iN), (iN)} &= \frac{-1}{(a_i + a_{i+1})} \sqrt{w_{0N}} \qty[\frac{1}{a_i} f'_N(t_N) + \frac{1}{a_{i+1}} f'_1(t_1)]~,
} \end{equation}

\begin{equation} \ali{
D_{(iN), (i+1,n)} &= \frac{-1}{a_{i+1}^{3/2} \sqrt{a_i + a_{i+1}}} \sqrt{w_{01}} f'_n(t_1)
\qquad (1< n < N)~,
} \end{equation}
