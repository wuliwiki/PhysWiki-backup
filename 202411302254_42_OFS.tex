...
&=\sum_{n=-\infty}^\infty \frac{1}{2\pi}\ev{e^{\I z_n x},f}e^{\I z_n x}\Delta z_n.
\end{aligned}~
\end{equation}
这恰好就是定义在区间 $[-\infty,\infty]$ 上的函数 $F(z)=\frac{1}{2\pi}\ev{e^{\I z x},f}e^{\I z x}$ 的积分
\begin{equation}\label{eq_OFS_7}
\int_{-\infty}^\infty F(z)\dd z~
\end{equation}
的近似级数和。当 $\Delta z_n=\frac{\pi}{L}\rightarrow0$ ，即 $L\rightarrow\infty$ 时，\autoref{eq_OFS_6} 就正好是\autoref{eq_OFS_7} 。因此
\begin{equation}
f(x)=\int_{-\infty}^\infty F(z)\dd z
\end{equation}
