...
&=\frac{q}{4\pi\epsilon_0}\qty(\frac{\sqrt{\bvec{r}^2+\bvec{r}_1^2-\bvec{r}\cdot\bvec{r}_2}-\sqrt{\bvec{r}^2+\bvec{r}_2^2-\bvec{r}\cdot\bvec{r}_1}}{\abs{\bvec{r}-\bvec{r}_1}\abs{\bvec{r}-\bvec{r}_2}})\\
&\doteq \frac{q}{4\pi\epsilon_0}\qty(\frac{\sqrt{\bvec{r}^2}-2\frac{\bvec{r}\cdot\bvec{r}_1}{2\sqrt{\bvec{r}^2}}-\sqrt{\bvec{r}^2}+2\frac{\bvec{r}\cdot\bvec{r}_2}{2\sqrt{\bvec{r}^2}}}{\bvec{r}^2})\\
&=\frac{1}{4\pi\epsilon_0}\qty(\frac{\frac{q}{2}(\bvec{r}\cdot(\bvec{r}_2-\bvec{r}_1))}{\bvec{r}^2\abs{\bvec{r}}})
\end{aligned}
\end{equation}
