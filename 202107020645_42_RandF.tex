...
&=\frac{A}{2}\qty{\frac{v^3}{3}-\qty[\sin(\frac{2\pi v}{v_{m}})\qty[\frac{v^2}{(\frac{2\pi }{v_{m}})^2}-\cos(\frac{\pi v}{v_{m}})\qty[\frac{v^2}{\frac{\pi}{v_{m}}}-\frac{2}{(\frac{\pi}{v_{m}})^3}]}\Bigg|_0^{v_{m}}\\
