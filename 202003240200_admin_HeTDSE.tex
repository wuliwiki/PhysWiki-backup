...
\subsection{基本数据}
\textbf{parahelium}: singlet spin, 对称波函数， 存在 1s 基态（我们使用的）． \textbf{orthohelium}: triplet spin, 反对称波函数， 不存在 1s 基态， 但其他束缚态的能量相对较低．

数值计算的基态能量： -2.9037244 a.u. （-79.014366 eV）．

90eV 的 xuv 光子能量为 3.3074390 a.u.， 所以单电离后电子的末动能为 0.4037146
