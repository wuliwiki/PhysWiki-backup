...
−
1
{\displaystyle {\mathfrak {a}}_{j}/{\mathfrak {a}}_{j-1}} is central in 
�
/
�
�
−
1
{\displaystyle {\mathfrak {g}}/{\mathfrak {a}}_{j-1}} for each j. By Engel's theorem, a Lie algebra over any field is nilpotent if and only if for every u in 
�
{\displaystyle {\mathfrak {g}}} the adjoint endomorphism