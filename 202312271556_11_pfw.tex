...
设$(U,\phi),(V,\psi)$是$M$上相容的图。$\{\widetilde e_i\}$与$\{\widetilde \theta_i\}$分别是$U$和$V$上切空间的基矢，则$\psi\circ\phi^{-1}:\phi(U\cap V)\rightarrow\psi(U\cap V)$是光滑的。现在设\textbf{该转移映射的坐标表示}为
\begin{equation}
\psi\circ \phi^{-1}(x)=()
\end{equation}