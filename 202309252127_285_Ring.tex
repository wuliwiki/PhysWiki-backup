...
一个\textbf{环（ring）}是一个集合 $R$ 与两种运算 “加” 和 “乘”， 分别记为 $+$ 和 $\cdot$。 其中加法配合 $R$ 中所有元素构成一个\textbf{阿贝尔群}\upref{Group}，加法群的单位元通常称为\textbf{零元}，记为 $0$；乘法配合集合 $R$ 构成一个\textbf{半群}，其中 $R^*=R-\{0\}$。除了加法和乘法分别构成两个群之外，还要求加法和乘法满足分配律
\begin{itemize}
