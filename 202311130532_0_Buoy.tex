...
\end{figure}
把曲面内部的液体作为一个整体做受力分析， 其质量为 $m = \rho_0 V_0$， 所受重力为 $mg = \rho_0 V_0 g$。 由于曲面中液体保持静止， 说明曲面外的液体对曲面内的液体施加的合力与它的重力等大反向，这个力就是\textbf{浮力（buoyancy）}。 现在我们如果把曲面内的液体替换为一块密度为 $\rho$ 的物体， 由于曲面形状不改变， 外界液体对该物体的浮力仍然为
\begin{equation}\label{eq_Buoy_1}
F = \rho_0 V_0 g~.
\end{equation}

\subsection{等效法}
注意 $V_0$ 为物体在水中部分的体积， 如果物体只有部分在水中， 根据以上分析， 只有被浸泡的部分受到液体的压力， 所以 $V_0$ 只是水平面以下部分的体积。 这就是所谓的 “物体所受的浮力等于它排开液体的重力”。
