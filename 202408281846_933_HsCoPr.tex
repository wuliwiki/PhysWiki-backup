...
\end{equation}
其中：命题$P$称为前件（antecedent），命题$Q$称为后件（consequent），读作“若$P$，则$Q$”、“如果$P$，那么$Q$”或者“$P$蕴含$Q$”\footnote{事实上，用逻辑连接词表示的蕴含的定义是$\lnot P\lor Q$。但涉及这个定义的讨论，已超出高中的范畴，关于蕴含还有很多知识，可以参考\enref{命题及其表示法}{Propos}。}。
\end{definition}

在高中阶段，对“若$P$，则$Q$”理解为表示“如果命题$P$为真，那么命题$Q$也为真”就可以了。
