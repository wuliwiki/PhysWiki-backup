...
e^{-2iE_0T}|\langle\Omega|x\rangle|^2\bra{\Omega} T[\hat x(t_1)\cdots \hat x(t_n)]\ket{\Omega}\\
&=\mathcal{N}\int \mathcal{D}[x] x(t_1)\cdots x(t_n) \exp(i S[x,\dot x])\\
&\lim\limits_{T\rightarrow \infty(1-i\epsilon)}
\langle x_f,T| x_i,-T\rangle=e^{-2iE_0T}|\langle\Omega|x\rangle|^2\langle\Omega|\Omega\rangle\\
