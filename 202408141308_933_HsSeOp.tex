...
\issueDraft
\end{issues}
相信此刻的你，已经基本了解了集合的基础知识。就像小学接触数字那样，认识了十以内的数字，就要开始接触他们的加减乘除了，“加减乘除”被称为\textbf{运算}（operations），本文介绍的就是集合的基本运算。另外，当你学过\enref{复合命题}{HsCoPr}后，回过头来再看这里的内容，可以加深对这部分内容的理解。当然，以防你不熟悉逻辑符号，本文也会在逻辑符号出现时予以说明。
