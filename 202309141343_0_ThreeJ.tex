...
\autoref{eq_SphHar_5}~\upref{SphHar}
\begin{equation}
\begin{aligned}
&\quad \int Y_{l_1 m_1}^*(\uvec r) Y_{l_2 m_2} (\uvec r) Y_{l_3 m_3}(\uvec r) \dd{\Omega}\\
...
根据\autoref{eq_AsLgdr_7}~\upref{AsLgdr}， 有
\begin{equation}
\pdv{\theta}Y_{l,m}(\uvec r) = \frac{1}{\sin\theta} [(l-m+1)Y_{l+1,m}(\uvec r) - (l+1)\cos\theta Y_{l,m}(\uvec r)]~
\end{equation}

\begin{equation}
\begin{aligned}
\int Y^*_{l+1, m}(\uvec r)\sin\theta\pdv{\theta}Y_{l,m}(\uvec r)\dd{\Omega} = (l-m+1) - (l+1)\int Y^*_{l+1, m}\cos\theta Y_{l,m}(\uvec r)\dd{\Omega}\\
= (l-m+1) - (l+1)\sqrt{\frac{(l+1)^2-m^2}{(2l+1)(2l+3)}}~
\end{aligned}
~\end{equation}
