...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Magnetic_monopole}{相关页面}．}磁单极子是电动力学中的一个假设， 至今未被真实观测到． 在麦克斯韦方程组\upref{MWEq} 出现后， 人们注意到若假设磁单极子存在并能像电荷产生电场那样产生磁场以及像电流产生磁场那样产生电场， 那么电场 $\bvec E$ 和磁场 $\bvec B$ 的地位就完全平等了．

若定义磁荷 $q_m$ 的单位为 $\Si{Am}$（安培·米）， $\rho_m$ 为磁荷的体密度， 则
\begin{equation}
\begin{aligned}
