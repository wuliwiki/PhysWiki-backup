...
\subsection{一般情况}
类比\autoref{Vtrans_eq2}\upref{Vtrans}， 若两参考系之间有可能存在转动， $\bvec a_{r}$ 的定义会碰到更大的困难． 


 我们定义 $t$ 时刻 $S'$ 系中的固定点相对于 $S$ 系的加速度为 $\bvec a_{r}$． 那么是否仍然有 $\bvec a_S = \bvec a_{S'} + \bvec a_r$ 呢？ 并不是． 正确的表达式需要添加一项
