...
\end{equation}
下面要讨论另一种等效的波函数和薛定谔方程叫\textbf{动量表象（momentum representation）}。 在 “\enref{傅里叶变换与矢量空间}{FTvec}” 中， 我们提到可以把函数也就是这里的波函数 $\ket{\psi}$ 看作某个无穷维空间中的矢量， 在正交归一的狄拉克 $\delta$ 函数\upref{Delta}基底以及平面波\upref{PWave}基底上的展开系数（即坐标\upref{Gvec2}）。
