...
\begin{aligned}
\bvec E&=\frac{q\qty((1-v'^2)(\bvec R-\bvec v'R))}{(R-\bvec v'\cdot \bvec R)^3}-\frac{q\qty(\bvec R\times (\bvec a'\times \bvec R)-R \bvec R\times (\bvec a'\times \bvec v'))}{(R-\bvec v'\cdot \bvec R)^3}\\
...
E=\frac{q}{R^2}\frac{\qty((1-v'^2)(\bvec {\hat n}-\bvec v'))}{(1-\bvec v'\cdot \bvec{\hat n})^3}+\frac{q}{R}\frac{\qty(\bvec{\hat n}\times ((\bvec{\hat n}-\bvec v')\times \bvec a'))}{(1-\bvec v'\cdot \bvec{\hat n})^3}
\end{equation}

\autoref{chgrad_eq2}  就是带电粒子产生的电场．