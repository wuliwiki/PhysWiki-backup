...
\end{equation}
唯一与实函数\enref（$f:\mathbb R \to \mathbb R$）\upref{functi}的导数不同的是，这里的减法是\textbf{向量相减}，结果还是向量。除以 $\Delta t$ 相当于\enref{向量的数乘}{GVec} $1/\Delta t$，结果也是向量。 所以 $\dv*{\bvec v}{t}$ 也是一个向量关于标量 $t$ 的函数。
