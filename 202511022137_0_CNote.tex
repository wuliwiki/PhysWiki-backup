...
\item 这里 \verb`atomic_store/load` 是最严格的，适合新手，可以假设顺序就是代码中的那样，
 \verb`atomic_store/load_explicit(xxx, memory_order_seq_cst)`
\item memory_order_relaxed < memory_order_release/acquire < memory_order_acq_rel < memory_order_seq_cst
\end{itemize}
