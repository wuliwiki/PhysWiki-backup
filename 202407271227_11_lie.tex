...
\begin{equation}
\left(\mathcal{L}_X f\right)_p=\left.\frac{\partial}{\partial t}\right|_{t=0}\left(\theta_t^* f\right)_p=\left.\frac{\partial}{\partial t}\right|_{t=0}(f\circ\theta_t)=X_pf~.
\end{equation}
\subsection{对微分形式作用}
\subsection{李导数的基本性质}