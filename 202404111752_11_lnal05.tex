...
任取$\mathbb R^{s,t,u}$上的一组标准正交基$\{\boldsymbol{e}_i\}$，使得前$s$个基向量的平方为$1$，后$t$个基向量平方为$-1$，最后$u$个基向量平方为$0$。如果过渡矩阵P将这组基变为一组标准正交基${\boldsymbol{\theta}_i}$，且$\boldsymbol{e}_i\cdot \boldsymbol{e}_i=\boldsymbol{\theta}_i\cdot\boldsymbol{\theta}_i$对所有$i$成立，那么称$P$是$\mathbb R^{s,t,u}$上的正交矩阵。
