...
\begin{equation}
\begin{aligned}
(\nabla_i T)^{r_1 r_2 \ldots r_a}_{s_1 s_2 \ldots s_b} &= (\nabla_i T)(\theta_{r_1}, \theta_{r_2}, \ldots, \theta_{r_a}, \partial^{s_1}, \partial^{s_2}, \ldots, \partial^{s_b}) \\
&= \partial_i [T(\theta_{r_1}, \theta_{r_2}, \ldots, \theta_{r_a}, \partial^{s_1}, \partial^{s_2}, \ldots, \partial^{s_b}) ] \\
&\quad - \sum_{r_k=r_1}^{r_a} T(\theta_{r_1}, \ldots, \nabla_i \theta_{r_k}, \ldots, \theta_{r_a}, \partial^{s_1}, \partial^{s_2}, \ldots, \partial^{s_b}) \\
&\quad - \sum_{s_j=s_1}^{s_b} T(\theta_{r_1}, \theta_{r_2}, \ldots, \theta_{r_a}, \partial^{s_1}, \ldots, \nabla_i \partial^{s_j}, \ldots, \partial^{s_b})\\
