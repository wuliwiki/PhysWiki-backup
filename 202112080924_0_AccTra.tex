...
解： 我们先令 $S'$ 的原点为点 $A$， 且 $S'$ 系无相对转动． 那么在 $S'$ 系中， bian'yuan'sha角速度为
\begin{equation}

\end{equation}


圆盘中心 $A$ 点对于圆形轨道中心 $O$ 点的加速度为 $\bvec a_r$ 圆盘边缘对于圆盘中心 $A$ 点的加速度为 $\bvec a_{S'}$， 那么圆盘边缘上一点在任意时刻的加速度 $\bvec a_S = \bvec a_r + \bvec a_{S'}$ ．
\addTODO{未完成}
\end{example}
