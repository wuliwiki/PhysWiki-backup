...
电荷的转换常数为\footnote{如果我们认为 $\Si{C_g}$ 和 $\Si{C}$ 是相同的量纲， 则 $\beta_q = 1$．}
\begin{equation}
...
\end{equation}
可得电磁场具有相同的单位． 转换常数为（量纲为速度倒数）\footnote{2020 新国际单位标准以前， 这个数值精确等于 $1/100$, 新标准需要乘以 $\sqrt{\mu_0/(4\times 10^{-7}\pi)}$ 的数值．}
\begin{equation}
