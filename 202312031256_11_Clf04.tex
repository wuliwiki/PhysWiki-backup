...
$e_1$和$e_2$是一组正交基，但其张成的空间无法扩展为全空间的正交基。这是由子空间的退化性导致的。反设存在$v\in V$并与$e_1,e_2$构成标准正交基，且$v=ae_1+be_2+ce_3$，由正交性解得$a=c=0$，则该向量与$e_2$平行，所以假设不成立。
...
\end{equation}
\end{theorem}
Proof.把$u$写为基的线性组合，由外积的幂零性可知，必要性是显然成立的。下面证明充分条件。
