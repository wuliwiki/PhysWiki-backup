...
另一方面，我们可以做一些更细致的探讨。比如，我们假定一个放能过程 $\Delta U < 0$，并且分类讨论 $\Delta S$.

1. $\Delta S > 0$，那么 $q \le T\Delta S$，热二允许$q$是一个正值，即热流入系统。根据之前的论述，
$$
w_\text{非体} = q - \Delta U \ge - \Delta U 
~,
$$
别忘了，$\Delta U<0$，那么$-\Delta U>0$。这种情况下，系统能够从外界吸收热并将其转换为非体积功！这与我们对热二的“效率上限”粗浅理解似乎有一些矛盾。这表明我们应该谨慎地处理热二问题，而不能一言以蔽之。

2.$\Delta S < 0$，那么 $q \ge T\Delta S < 0$，$q$只能是负值，即热流出系统。同样，
$$
