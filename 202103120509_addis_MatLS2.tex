...
\autoref{MatLS2_the1} 这个定理可以帮助我们理解线性方程组解的结构\upref{LinEq}． 可得线性映射的一个重要性质
\begin{corollary}{}
...
\end{corollary}
证明： 前者证明后者只需要使用\autoref{LinMap_cor1}~\upref{LinMap}， 再根据单射的定义， $0\in X$ 是零空间中的唯一向量． 后者证明前者： $N_0 = 0$ 即\autoref{MatLS2_the1} 中的 $X = X_1$， 与值空间 $Y_1 = A(X)$ 有一一对应关系． 证毕．
