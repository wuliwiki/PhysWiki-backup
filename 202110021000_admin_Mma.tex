...
Mathematica 相对于 Matlab， Python 等偏数值计算的语言最大的特点就是专注于符号计算以及变精度计算． 其中变精度计算能追踪误差， 保证输出结果的最后一位小数正确．
...
\item 通过散点画折线图用 \verb|ListLinePlot[{{x1,y1},{x2,y2},...}]| 如果省略 或者画多条线 \verb|ListLinePlot[{{y1,y2,...},{z1,z2...}}]|． 第二个参数用 \verb|Mesh -> All| 可以除了折线还画出数据点．
