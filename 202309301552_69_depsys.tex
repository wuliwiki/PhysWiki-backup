...
由于近独立子系中粒子可以近似视为独立的，因此研究系统的热力学性质可以通过研究单粒子的微观状态入手。假设系统中单粒子可能处于这样一些能级 $\epsilon_1,\epsilon_2,\cdots$，它们可以通过求解单粒子哈密顿量 $\hat H_1$ 的本征值得到，因此也可能存在重复的情况： $\epsilon_i=\epsilon_j(i\neq j)$，我们称这种情况为能级\textbf{简并}。在这里我们用下标 $s$，用 $\epsilon_s,s=1,2,\cdots$ 来标记这些单粒子态能级。
