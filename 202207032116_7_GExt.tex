...
当上述条件成立时（即$\mathbb{M}/\mathbb{F}$是正规扩张，或者任意等价命题成立），任取$g, h\in\opn{Gal}(\mathbb{K}/\mathbb{F})$且它们模$\opn{Gal}(\mathbb{K}/\mathbb{M})$同余，即$g^{-1}h\in\opn{Gal}(\mathbb{K}/\mathbb{M})$．
