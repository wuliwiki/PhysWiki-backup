...
由于$f$是反对称的，因此必然至少有两个向量其内积不为$0$，如$f(\bvec {\varepsilon}_1,\bvec x_2)=k\neq 0$，设$\bvec {\varepsilon}_2=k^{-1}\bvec x_2$并拓展至$V$上的一组基：
\begin{equation}
\bvec {\varepsilon}_1,\bvec \varepsilon_2,\bvec\eta_3,...\bvec\eta_n~,
\end{equation}
设$f(\bvec \eta_i,\bvec\varepsilon_1)=k^i,f(\bvec \eta_i,\bvec\varepsilon_2)=k'_i$
\begin{equation}
\bvec\eta'_i=\bvec\eta_i-f(\bvec \eta_i,\bvec\varepsilon_2)\bvec\varepsilon_1+f(\bvec \eta_i,\bvec \varepsilon_1)\bvec \varepsilon_2,\,i=3...n~.
\end{equation}