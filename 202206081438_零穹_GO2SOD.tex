...
由常微分方程组阶的定义\autoref{ODEPr_sub2}~\upref{ODEPr}，可知方程组\autoref{GO2SOD_eq9} 是 $m$ 个关于 $y_i$ 为 $n_i$ 阶的 $\sum\limits_{i=1}^{m}n_i$ 阶微分方程组，而\autoref{GO2SOD_eq10} 是 $\sum\limits_{i=1}^{m}n_i$ 个关于 $z_i$ 为1阶的 $\sum\limits_{i=1}^m n_i$ 阶的微分方程组．