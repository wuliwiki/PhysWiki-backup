...
\begin{equation}
\leftgroup{
B = \frac{(k^2 - l^2)\sin(la)\exp(-\I ka)}{(k^2 + l^2)\sin(la) + 2\I kl\cos(la)} A\\
C = \frac{\I k (k + l) \exp[-\I (k+l)a/2]}{(k^2 + l^2)\sin(la) + 2\I kl \cos(la)} A\\
D = \frac{\I k(l-k) \exp[-\I (k-l)a/2]}{(k^2 + l^2)\sin(la) + 2\I kl \cos(la)} A\\
