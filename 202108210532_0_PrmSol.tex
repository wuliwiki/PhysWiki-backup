...
\subsubsection{角边角}
如果\autoref{PrmSol_eq1} 给出了 “边角边” 的关系， 那么我们再来看 “角边角”
\begin{equation}
\tan^2\gamma = \frac{\sin^2\beta \sin^2\theta_1}{\cos^2\theta_1 - \cos^2\beta \cos^2\theta_2 - \sin^2\beta\cos^2\theta_2\cos^2\theta_1}
\end{equation}
这可以直接使用两次
