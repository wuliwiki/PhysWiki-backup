...
\item 提高编辑效率 （未完成）
\item 编译 pdf （未完成）： 仅限在\href{http://wuli.wiki/note/}{小时云笔记}中使用． 点击下载按钮， 即可用 TeXlive 的 XeLaTeX 编译 \verb|main.tex| 文件， 详见 “安装使用 TeXlive\upref{TeXliv}”． 也可以在 Linux 环境直接用 \verb|make| 命令．
\end{enumerate}
