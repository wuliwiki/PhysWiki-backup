...
质量 $m$ 乘以速度 $v^\mu$，得到质量为 $m$ ，速度为 $v^\mu$ 的粒子的4-动量 $p^\mu:=mv^\mu=m\dv{x^\mu}{\tau}$。非相对论的3-动量守恒 $\vec p_N=m\vec v_N$ 强烈表明4-动量 $p^\mu$ 也是守恒的。事实上由 $\vec p_N$ 为常数，得 $\vec v_N$ 为常数（因为是Lorentz标量 $m$ 是常量），从而 
\begin{equation}
\dv{}{t}p^\mu=\dv{}{t}\qty(\frac{m}{\sqrt{1-v_N^2}},\frac{m\vec v_N}{\sqrt{1-v_N^2}})=0.~
\end{equation}
即 $p^\mu$ 为常矢量。上式即是3-动量守恒在4-动量守恒的推广。
