...
\textbf{平移切比雪夫多项式}第一类和平移第二类切比雪夫多项式与标准切比雪夫多项式之间的关系如下：[18]
$$
...
大约在 1990 年，术语“第三类”和“第四类”切比雪夫多项式开始使用，尽管这些多项式在此之前已经以“翼型多项式”（airfoil polynomials）的名称被研究。根据 J. C. Mason 和 G. H. Elliott 的说法，这些术语由 Walter Gautschi 在与正交多项式领域的同事讨论后提出。\[21]
...
其中 $\theta = \arccos x$。\[21]\[22]
它们与\*\*狄利克雷核（Dirichlet kernel）\*\*是一致的。
