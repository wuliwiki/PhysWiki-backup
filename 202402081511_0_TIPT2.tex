...
\begin{equation}
\frac{1}{E_n^0-E_m^0}\sum_{m'}^{E_{m'}\ne E_n}\frac{\mel{\psi_m^0}{H^1}{\psi_{m'}^0}\mel{\psi_{m'}^0}{H^1}{\psi_n^0}}{E_n^0 - E_{m'}^0} = \braket{\psi_m^0}{\psi_n^2} + \frac{E_n^1}{E_n^0-E_m^0}\frac{\mel{\psi_m^0}{H^1}{\psi_n^0}}{E_n^0 - E_m^0}~.
\end{equation}
