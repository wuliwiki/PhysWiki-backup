...
\subsection{账号和申请创作}
要使用编辑器，您需要进行\href{https://wuli.wiki/forum}{注册}， 登录成功后， 访问 \verb|wuli.wiki/editor| 即可。 如果您只是进行一些偶尔的微小修改如错别字和笔误，则无需申请成为作者。 但如果您需要进行更多创作或修改， 原则上需要申请。 您的任何修改都需要我们在后台审核后方可生效，这个过程一般需要一天。
