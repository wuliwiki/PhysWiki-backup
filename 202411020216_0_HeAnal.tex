...
对比以上两式可以把微分截面表示为
\begin{equation}
\pdv{\sigma_j}{\Omega_1}{\Omega_2} = \frac{2\pi m}{s(\omega(k_1,k_2))} \omega(k_1,k_2) P_{j\to {(\bvec k_1,\bvec k_2)}} \cdot k_1^2k_2^2~.
\end{equation}




 $\bvec k$ 的函数， 也可以看成是单位矢量 $\uvec k$ 和 $\omega$ 的函数
\begin{equation}
