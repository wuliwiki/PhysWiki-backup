...
先考虑离散情况， 画出概率树（未完成）， 在第 $N$ 次开奖时第一次中奖的概率为（注意要保证前 $N-1$ 次未中奖）
\begin{equation}
(1-\Delta P)^{N-1} \Delta P
\end{equation}
...
接下来， 我们假设该彩票开奖的时间越来越短， 但始终保持 $\lambda$ 不变． 那么在极限 $\Delta t\to 0$ 的极限为 $\lambda\E^{-\lambda t}\Delta t$， 所以概率分布为
\begin{equation}
