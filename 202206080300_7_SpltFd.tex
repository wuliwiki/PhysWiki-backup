...
\begin{example}{}
给定实数域$\mathbb{R}$及其上的多项式$f(x)=x^3-1$，则$f\in\mathbb{R}[x]$的分裂域为$\mathbb{R}(\omega)=\{a+b\omega+c\omega^2 \mid a, b, c\in\mathbb{R}\}$，其中$\omega$是$1$的三次单位根$\frac{1}{2}(-1+\I\sqrt{3})$．
\end{example}
