...
\subsection{精确定义的常数}
\footnote{本词条参考 Wikipedia \href{https://en.wikipedia.org/wiki/Physical_constant}{相关页面}， 以及 NIST 的 2018 CODATA \href{https://physics.nist.gov/cuu/Constants/Table/allascii.txt}{常数表}。}2019 年 5 月 20 日生效的国际单位制\upref{SIunit}中精确定义了 7 个基本单位（SI base units）， 每个基本单位的大小都可以由这些常数的定义测量出来。
