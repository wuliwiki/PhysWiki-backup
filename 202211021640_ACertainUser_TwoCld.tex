...
要证明 $\bvec p_A \cdot \bvec p_B = 0$

只需证明 $v_{Ax}v_{Bx}+v_{Ay}v_{By}=0$

因为\autoref{TwoCld_eq2} ，所以只需证明 $v_{Ax}v_{Bx}-v_{Ay}^2=0$

将\autoref{TwoCld_eq3} 代入\autoref{TwoCld_eq4} ，即$2v_{Ax}v_{Bx} = v_{Ay}^2 + v_{By}^2$
