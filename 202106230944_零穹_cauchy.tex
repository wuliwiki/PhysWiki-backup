...
\end{equation}
由于序列$\qty{x_i}$为柯西序列，故 $\forall\varepsilon>0$，$\exists N$，当 $n,m>N$时，就有 $d(x_n,x_m)<\varepsilon$．这意味着若令 $y_i=d(x_i,y)$，则 ${y_i}$ 为柯西序列．又 $d(x_i,y)\in \mathbb R$，所以 ${y_i}$ 为实数域上的柯西序列．
