...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Mechanical_equilibrium}{相关页面}和 \cite{新力}．}在惯性系中， 如果刚体所受的所有合外力与合外力矩\upref{Torque}都为零， 则我们说它处于\textbf{静力平衡（static equilibrium）}． 其中合外力（矩）是指所有施加在刚体上的力（矩）的矢量和． 通常来说， 静力平衡意味着刚体保持静止不动， 但严格来说刚体质心做匀速运动以及刚体绕质心做匀速转动也属于静力平衡．
