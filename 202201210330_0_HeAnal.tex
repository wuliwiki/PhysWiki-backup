...
\subsubsection{每个 channel 的单电子位置分布}
...
\begin{equation}
\Psi_{n_1,l_1}(\bvec r_1, \bvec r_2) = \sum_{m_1} \braket{n_1,l_1,m_1}{\Psi}(\bvec r_2) \ket{n_1,l_1,m_1}(\bvec r_1)
\end{equation}
\begin{equation}
\int \abs{\Psi_{n_1,l_1}(\bvec r_1, \bvec r_2)}^2 \dd[3]{r_1}
\end{equation}
