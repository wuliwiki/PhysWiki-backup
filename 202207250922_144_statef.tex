...
X=f(T,P,n)
\end{equation}
在X是强度量（与系统的尺度无关，例如温度、压力、单位内能等）而非广度量（与系统的尺度有关，例如内能、熵、体积等）时，可省去物质的量条件．
\begin{equation}
X=f(T,P)
\end{equation}
...
如果我们能知道两个偏导数，利用全微分关系式，我们可以刻画任意准静态过程的内能改变量；或者更进一步，直接得到任意$T$,$P$下的$E=E(T,P)$（难过的是，这在实操上一般不大可行）．
\end{example}
