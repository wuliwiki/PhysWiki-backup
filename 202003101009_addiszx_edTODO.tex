...
\item 已使用 \href{http://www.wiris.net/client/editor/resources/help.html?v=7.9.0.6564}{MathType Web} 作为公式编辑器插件，目前属于内测阶段，仅超级管理员可使用．该插件为动态加载，国内测试加载时间约为 10s．
\item 已知的 bug：
\item Edge 下公式排版存在问题
\item 点击“确定”按钮不能正常插入公式
