...
\item \verb|int MPI_Send(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm)| 其中 \verb|dest| 是进程 \verb|id|， \verb|tag| 是一个编号， \verb|comm| 一般是 \verb|MPI_COMM_WORLD| （所有进程）．
