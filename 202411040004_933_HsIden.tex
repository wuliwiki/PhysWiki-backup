...
\hline
$x\in[-{3\pi\over4}+2k\pi,{\pi\over4}+2k\pi]\quad (k\in\mathbb{Z})$&$\sin x\leq\cos x$&$x={\pi\over4}+k\quad (k\in\mathbb{Z})$\\
\hline
$x\in[{\pi\over4}+2k\pi,{5\pi\over4}+2k\pi]\quad (k\in\mathbb{Z})$&$\sin x\geq\cos x$&$x={\pi\over4}+k\quad (k\in\mathbb{Z})$\\
\hline
