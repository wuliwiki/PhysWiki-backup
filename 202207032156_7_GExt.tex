...
注意$\mathbb{KE}\cap \mathbb{K}=\mathbb{K}$．构造\textbf{群同态}$\varphi:\opn{Gal}(\mathbb{KE}/\mathbb{E})\to\opn{Gal}(\mathbb{K}/\mathbb{K}\cap\mathbb{E})$，定义为$\varphi \sigma = \sigma\mid_{\mathbb{K}}$．
