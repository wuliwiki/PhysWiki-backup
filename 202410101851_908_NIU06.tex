...
\begin{enumerate}
        ...
        \item 一平面简谐波方程（波数 $k$）为 $y_1 = 4 \cos 2 \pi \left( \frac{t}{T} - \frac{x}{\lambda} \right)$，在 $x = \frac{\lambda}{2}$ 处有一反射壁，若平面波从空气传到反射壁而反射，反射时振幅不变，已知空气为波介质，则反射波波动方程为 \underline{\hspace{3cm}}，波节点的位置为 \underline{\hspace{3cm}}。
    \end{enumerate}