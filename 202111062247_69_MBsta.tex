...
我们下面要谈的是\textbf{理想气体}系统的\textbf{玻尔兹曼分布}，它\textbf{不涉及全同粒子假设}，即粒子之间是可区分的．我们将得到同经典统计中一样的结果\upref{MxwBzm}．
...
\begin{aligned}
\alpha=\ln\left[\frac{V(2m k_B T/\pi \hbar^2)^{3/2}}{N}\right]
\end{aligned}
...
\begin{equation}
\Delta N=\frac{N}{V}\left(\frac{1}{8\pi m k_B T}\right)^{3/2}e^{-\frac{1}{2mk_B T}(p_x^2+p_y^2+p_z^2)}\Delta x\Delta y\Delta z\Delta p_x\Delta p_y\dd p_z
\end{equation}
