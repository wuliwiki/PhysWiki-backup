...
\begin{equation}
\alpha'= -\alpha + 2m\pi, \qquad \beta' = -\beta + 2n\pi~.
\end{equation}
此时，$\alpha', \beta'$ 在上半平面且关于$y$轴对称，即$\alpha'=\pi-\beta'+2t\pi$，带入\autoref{eq_HsTrFu_5} 并令 $k = m+n-t$，得到：
\begin{equation}
\alpha = -\pi-\beta + 2k\pi, \qquad (k\in\mathbb{Z})~.
\end{equation}

的结果与\autoref{eq_HsTrFu_6} 相同。
