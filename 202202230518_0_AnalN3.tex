...
\item 11.1 设 $\mathscr R$ 是由集构成的一个\textbf{类（family of sets）}\footnote{集合的集合叫类}， 并且由 $A\in \mathscr R$， $B\in \mathscr R$ 能推出 $A\bigcup B\in \mathscr R$， $A- B\in \mathscr R$． 就说 $\mathscr R$ 是\textbf{环}．
