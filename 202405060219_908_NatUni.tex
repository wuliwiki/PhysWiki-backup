...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Natural_units}{相关页面} 以及 \href{https://en.wikipedia.org/wiki/Planck_units}{普朗克单位制}。}在高能物理和场论中， 我们往往使用一套\enref{无量纲单位制}{NoUnit}， 使得普朗克常数 $\hbar = 1$ 真空光速 $c = 1$， 万有引力常数 $G = 1$ 以及玻尔兹曼常数 $k_B = 1$。 这个单位制也称为\textbf{普朗克单位制（Plank units）}。 下面我们来进行说明，首先给出和国际单位制\upref{SIunit}之间的转换常数：
