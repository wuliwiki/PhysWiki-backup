...
(d\rightarrow 4)&= -i\lambda \frac{m^2}{2(4\pi)^2} \frac{1}{\epsilon/2\cdot(\epsilon/2-1)} \left(\frac{4\pi\mu^{2}}{m^2}\right)^{\epsilon/2}\Gamma(1+\epsilon/2) + i(p^2\delta_Z-\delta_m),\quad \epsilon=4-d\\
&=\frac{i\lambda m^2}{32\pi^2}\left(\frac{2}{\epsilon}+1+\log\left(\frac{4\pi\mu^2}{m^2e^{\gamma}}\right) \right)+ i(p^2\delta_Z-\delta_m),\quad \epsilon=4-d
\end{aligned}
\end{equation}
