...
\]
若函数$\phi$满足定理中提到的三个条件，则$F(z)$变换对于$\operatorname{Re} z>c$是存在的．即：当$\operatorname{Re} z>c$时，积分收敛．注意\eqref{LapAsm_eq3}意味着存在正整数N，当n>N时，对一切的0<t<\delta\left(0<\delta<\sfrac{\pi}{2}\right)，总有
