...
\end{equation}
\end{theorem}
\textbf{证明}： 设 $\{\epsilon_i\},\{\eta_j\},\{\xi_k\}$ 分别是 $V_1,V_2,V_3$ 的基底，那么 $\psi_1,\psi_2$ 分别将基矢 $(\epsilon_i\otimes\eta_j)\otimes\xi_k$ 和 $\epsilon_i\otimes\eta_j$ 映到 $\epsilon_i\otimes(\eta_j\otimes\xi_k)$ 和 $\eta_j\otimes\epsilon_i$  
