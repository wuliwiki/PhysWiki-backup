...
\begin{corollary}{}
设$\mathbb{K}/\mathbb{F}$是可分扩张，且$\mathbb{K}$中任意元素关于$\mathbb{F}$的最小多项式次数最大的是$n$，那么$[\mathbb{K}:\mathbb{F}]\leq n$．
\end{corollary}

\textbf{证明}：

取$\alpha\in\mathbb{K}$，使$\opn{deg}\opn{Irr}(\alpha:\mathbb{F})=n$．

任取$\beta\in\mathbb{K}$，则由Artin本原性\autoref{PrmtEl_the2} ，存在$\gamma\in\mathbb{K}$使得$\mathbb{F}(\alpha, \beta)=\mathbb{F}(\gamma)$．
