...
极值点：给定函数 $y=f(x)$，若对于一点 $x_0$ ,存在的某一邻域 $\left( x_0-δ，x_0+δ \right)$ $\left( δ>0 \right)$ ，使对于此邻域中的任意点 $x$ ，都有 $f(x) \leq f\left(x_0\right)$ ，称 $x_0$ 是的极大值点；若都有 $f(x) \geq f\left(x_0\right)$ ，则称 $x_0$ 为极小值点。极大值点与极小值点统称为极值点。
