...
推导：设质量为$m$的物体，在水平方向受到恒定的合外力$\bvec F$，以$\bvec v_1$的速度开始运动，加速到$\bvec v_2$．根据匀变速直线运动（\autoref{HSPM01_eq4}~\upref{HSPM01}）、牛顿第二定律（\autoref{HSPM03_eq1}~\upref{HSPM03}）和功（\autoref{HSPM07_eq1}） 可得：
\begin{equation}
