...
\begin{aligned}
&A=k_{\text{终}}J_1\cdots J_l\\
&A'=k'_{\text{终}}J'_1\cdots J'_l
\end{aligned}
\end{equation}
其中， $k_{\text{终}}\neq k'_{\text{终}}$．
...
\begin{equation}
\mathrm{dim}\tilde{\boldsymbol{A}}=\qty(\mathrm{dim}\tilde{\boldsymbol{J}}_1)^{\sigma_1}\cdots\qty(\mathrm{dim}\tilde{\boldsymbol{J}}_l)^{\sigma_l}
\end{equation}
