...
% 零点（Frrom wikipedia): Corresponding to each eigenvalue { \lambda _{n}} is a unique (up to constant multiple) eigenfunction { y_{n}=y_{n}(x)} with exactly {n-1} zeros in  { [a,b]}, called the nth fundamental solution.
\end{issues}
