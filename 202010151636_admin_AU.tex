...
把精细结构常数\upref{FinStr}记为 $\alpha$， 国际单位中有 $a_0 = \hbar/(\alpha c m_e)$． 原子单位中有 $c = 1/\alpha$， $\epsilon_0 = 1/(4\pi)$， $\mu_0\epsilon_0 = \alpha^2$， 对平面电磁波 $E/B = 1/\alpha$． 坡印廷矢量为 $\bvec j = 4\pi\alpha^2 \bvec E \cross \bvec B$． 电磁场能量密度
\begin{equation}
\rho_E = \frac{1}{8\pi} (\abs{\bvec E}^2  + \abs{c\bvec B}^2)
\end{equation}
