...
\end{theorem}
\textbf{证明：}1. 令 $A:D_A\rightarrow E_1$ 是 $E$ 到 $E_1$ 上的线性连续算子。 我们利用反证法证明：设 $M\subset D_A$ 是有界集，而 $AM\subset E_1$ 无界。由于拓扑线性空间上线性算子连续只需在一点连续即可（可由\autoref{the_tvs_1}推得），因此可以认为 $$ 那么存在 $$
