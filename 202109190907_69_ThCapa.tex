...
可以看出，当固定体积升高温度时，吸收热量为 $C_V\Delta T$，当固定温度改变体积时，吸收热量为 $L_V\Delta V$，其中 $L_V=p+(\partial U/\partial V)_T$．对于理想气体来说， $(\partial U/\partial V)_T=0$，所以固定温度时系统内能不变，系统吸收的热量等于对外做功 $p\dd V$．
