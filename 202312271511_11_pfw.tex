...
\begin{equation}
\frac{\partial}{\partial x^i}\bigg|_p=\phi^{-1}_* (\frac{\partial}{\partial x^i})\bigg|_{\phi(x)}~.
\end{equation}
该定义与光滑函数的定义是自洽的。设$\{\widetilde{e_i}\}$为$U$上$p$点的切空间基矢，对应$\phi (U)$上切空间的基矢$\{{e_i}\}$，并设$f\in C^{\infty}(U)$，那么我们有：
\begin{equation}
\begin{aligned}
\widetilde e_i f=\frac{\partial}{\partial x^i}\bigg|_p f&= (\frac{\partial}{\partial x^i})\bigg|_{\phi(x)}(f\circ \phi^{-1}\\
&=e_i\hat f~.
\end{aligned}
\end{equation}