...
6.如图所示，有3张平面两两相交，交线相互平行，它们的方程$$a_{il}x + a_{i2}y + a_{i3}z = d_i \quad (i=1,2,3)~$$组成的线性方程组的系数矩阵和增广矩阵分别记为$\mat A , \overline{ \mat A} $，则 $(\quad)$\\
...
3.幂级数$\displaystyle \sum_{n=0}^\infty \frac{(-1)^n}{(2n)!} x^n$



设函数八u)可导，z = /(sin y - sin x) + xy, 
则一—- . - +         . 一
1加1加
COS  X     彻cosy切
(10)微分方程$2yy'- r - 2 $ = 0满足条件y(O) = 1的特解 y =
2 
(11)幕级数2
(- 1)" 
几 =O    (2n) ! 
...
2 , 
(14)设随机变掀X的概率密度为八x)  = (f'    <
O        x  < 2 'F(x)为X的分布函数，E(X)为X的 0,    其他，
数学期望，则Pj F(X)  > E(X) - 1 l     —