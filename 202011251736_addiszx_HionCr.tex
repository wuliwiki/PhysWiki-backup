...
P_{j\to i} = \frac{q^2}{4c m^2 \omega_{ij}^2} \abs{\uvec e \vdot\mel{i}{\bvec p}{j}}^2 s(\omega_{ij})
\end{equation}
...
\begin{equation}
\pdv{\sigma}{\Omega} = \frac{m\omega k q^2}{4c} \abs{\mel{i}{\uvec e \vdot\bvec r}{j}}^2
\end{equation}
速度规范下有（\autoref{HionCr_eq5} ）
\begin{equation} % 已验证与 Merzbaucher eq 19.86 相同
\pdv{\sigma}{\Omega} = \frac{k q^2}{4c m \omega} \abs{\mel{i}{\uvec e \vdot \bvec p}{j}}^2
\end{equation}
