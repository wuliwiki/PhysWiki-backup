...
以置换点缺陷为例．当一个杂原子置换了原本的小原子，如果杂原子大于原本的原子，那会发生什么呢？这就好像你在一台电梯中，好巧不巧又挤进来一位善良的胖子．那么你会感觉到一股更大的压力．事实上原子也是如此，大原子挤压了相邻的其余原子，并造成了额外的压力．
\begin{figure}[ht]
\centering
...
\subsubsection{晶粒与晶界}
或许你还对\autoref{MetInt_fig1} （提示：原子的规则排列）记忆犹新．在整块金属中，原子还是老老实实规规矩矩地沿同一个方向排列吗？答案当然是...否定的．实际中，金属的原子排列可能更像这样：
\begin{figure}[ht]
\centering
