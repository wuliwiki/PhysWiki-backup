...
\end{equation}
\begin{equation}
\phi_{n_1, l_1, m_1, k_2, l_2, m_2}(\bvec r_1, \bvec r_2) = \frac{1}{\sqrt{2}} [\phi_{n_1, l_1, m_1}(\bvec r_1)\phi_{l_2, m_2}(k_2, \bvec r_2) + \phi_{n_1, l_1, m_1}(\bvec r_2)\phi_{l_2, m_2}(k_2, \bvec r_1)]
\end{equation}
