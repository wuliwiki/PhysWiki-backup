...
\item 可以在 \href{https://github.com/MacroUniverse/PhysWiki-log}{github 页面}进行百科的全文搜索， 输入关键词， 选择 “in this repository”． 但可惜该方法不能匹配连续中文字符中的一段， 可以把完整的代码下载或者 clone 到电脑上再用其他软件
