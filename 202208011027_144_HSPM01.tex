...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/HSPM01_1.png}
\caption{讨论运动之前先要指明参考系，不然犹如“盲人摸象”} \label{HSPM01_fig1}
\end{figure}
\footnote{图片来自网络}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/HSPM01_3.png}
\caption{请添加图片描述} \label{HSPM01_fig3}
\end{figure}
\begin{itemize}
