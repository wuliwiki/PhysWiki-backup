...
令 $\bvec\omega$ 是 $S'$ 相对于 $S$ 的瞬时角速度， 角速度和速度之间有 $\bvec v = \bvec \omega \cross (\mat R \bvec r')$（\autoref{CMVD_eq5}~\upref{CMVD}）． 我们可以把叉乘用矩阵乘法表示为（\autoref{CrosMt_eq3}~\upref{CrosMt}）
