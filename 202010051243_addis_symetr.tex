...
若将\autoref{symetr_ex2} 中的两个粒子改为 $N$ 个粒子， 如何将状态 $\ket{i_1}\ket{i_2}\dots\ket{i_N}$ （反）对称化呢？ 稍加思考会发现我们只需要写出 $\ket{i_1},\ket{i_2}\dots\ket{i_N}$ 的所有不同顺序的排列即可： 如果这 $N$ 个单粒子态都是不同的， 那么一共有 $N!$ 种排列， 且互相正交归一．
