...
\begin{equation}
\leftgroup{
&B = (k^2 - b^2)\sin(2bl)\exp(-2\I kl) A/M\\
&C = \I k (k + b) \exp[-\I (k+b)l] A/M\\
&D = \I k(b-k) \exp[-\I (k-b)l] A/M\\
&F = 2\I kb \exp(-2\I kl) A/M
}\end{equation}
其中
\begin{equation}
M = (k^2 + b^2)\sin(2bl) + 2\I kb \cos(2bl)
\end{equation}
...
\begin{equation}
\leftgroup{
&B = (\kappa ^2 + k^2)\sinh(2\kappa l) A/M\\
&C = k(\I \kappa  - k) \exp(-2\kappa l) A/M\\
&D = k(\I \kappa  + k) \exp(2\kappa l) A/M\\
&F = 2\I k\kappa  \exp(-2\I kl) A/M
}\end{equation}
其中
\begin{equation}
M = (k^2 - \kappa ^2) \sinh(2\kappa l) + 2\I k\kappa  \cosh(2\kappa l)
\end{equation}
