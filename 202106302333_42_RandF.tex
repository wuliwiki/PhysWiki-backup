...
&=A\qty{\sin(\frac{\pi v}{v_{max}})\qty[\frac{4v^3}{(\frac{\pi}{v_{max}})^2}-\frac{24v}{(\frac{\pi}{v_{max}})^4}]-\cos(\frac{\pi v}{v_{max}})\qty[\frac{v^4}{(\frac{\pi}{v_{max}})}-\frac{12v^2}{(\frac{\pi}{v_{max}})^}]}\\
\end{aligned}
\end{equation}
\end{example}