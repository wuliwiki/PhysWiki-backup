...
要把\autoref{eq_Gravty_1} 推广到具有连续质量分布的物体并不难，用定积分的思想，只需要先把每个物体切割成均匀的小块，再把这些小块看成质点计算分别计算两两之间得引力在进行矢量相加即可。 当这些小块切割得越来越小，计算的结果也越来越精确。
\begin{equation}
\bvec F_{12} = -G\int\int \frac{\uvec r_{12}}{r_{12}^2}  \cdot \rho_1(\bvec r_1) \rho_2(\bvec r_2) \dd[3]r_1 \dd[3]r_2~.
\end{equation}
