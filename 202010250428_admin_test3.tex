...
\begin{equation}\label{test3_eq8}
E = \mel{\Psi}{H_0}{\Psi}
\end{equation}
...
\end{equation}
所以动量绝对值的分布函数为
\begin{equation}\label{test3_eq5}
...
\begin{equation}\label{test3_eq6}
...
\begin{equation}\label{test3_eq7}
...
\begin{equation}\label{test3_eq36}
\bra{\phi_{n_1, l_1, m_1}}\braket{C_{l_2, m_2}(k_2)}{\Psi} = \sqrt{\frac{2}{\pi}} \iint r_1 R_{n_1,l_1}(r_1) F_{l_2}(\eta_2, k_2 r_2) \psi_{l_1, l_2}^{m_1, m_2}(r_1, r_2) \dd{r_1} \dd{r_2}
\end{equation}
\begin{equation}
