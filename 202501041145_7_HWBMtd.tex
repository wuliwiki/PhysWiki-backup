...
这个式子本身看起来并不直观，我们可以用复数的几何表示来直观理解计算过程：每一项$\frac{A_iC}{L_i^{n/2}}\exp\qty(\I\omega_i(t-\varphi_i))$都表示一个箭头，$\frac{A_iC}{L_i^{n/2}}$是其长度，$\omega_i(t-\varphi_i)$是其角度；每个箭头都随着时间逐渐旋转，角速度为$\omega_i$
