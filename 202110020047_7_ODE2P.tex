...
x^2\frac{\mathrm{d}^2}{\dd t^2}+x\frac{\dd y}{\dd x}+(x^2-n^2)y=0
\end{equation}

首先把\autoref{ODE2P_eq18} 改写为
\begin{equation}
\frac{\mathrm{d}^2}{\dd t^2}+\frac{1}{x}\frac{\dd y}{\dd x}+(1-\frac{n^2}{x^2})y=0
\end{equation}
...
将\autoref{ODE2P_eq19} 代入\autoref{ODE2P_eq18} ，k
