...
m\ddot x =  - kx
\end{equation}
这是一个单自变量\textbf{常微分方程\upref{ODE}}． 由于弹簧振子满足这个方程，因此我们以弹簧振子为代表，将一切形如\autoref{SHO_eq1} 的方程称为\textbf{简谐振子方程}，或者将一切能量与位置关系满足胡克定律的系统称为简谐振子\footnote{如\textbf{量子简谐振子}\upref{QSHOop}．}．
