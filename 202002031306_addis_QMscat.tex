...
\begin{equation}
\begin{aligned}
\sigma(k) &= \int \abs{f(k,\theta)}^2 \dd{\Omega} = \sum_{l=0}^\infty \sqrt{\frac{4\pi}{2l+1}} \abs{f_l(k)}^2\\
&=  \sum_{l=0}^\infty \sigma_l(k) = \frac{4\pi}{k^2} \sum_{l=0}^\infty (2l + 1) \sin^2 \delta_l(k)
\end{aligned}
\end{equation}
