...
或者更简单地，如果你坐在一个水池旁边，观察到总有水流流出水池，那么你一定会知道，水池中必定有一个水源。电场也是一样，如果你观察到某一空间中有静流出的电场，那么高斯定律告诉我们这片区域内一定有一些电荷（如果是负电荷，那么可以理解为总有水流流进水池，那看来水池里有一只吸水怪，或者一个大坑）。当然必须强调一下，电场并不是“真正的流”，电场的“流出”不会导致电荷的减少（但是电流会，因为电荷守恒）。
