...
在发电厂中，有一种高大耸立的冷却装置，一打眼会觉得他好像是一个圆台，但仔细观察可以发现，其外形类似一个中间收紧、两端张开的沙漏，而且外形也并非是直线而是略带弯曲的曲线。这种造型并非出于美观考虑，而是源于精巧的工程设计：它不仅能有效抵御强风、节省材料，还能提升散热效率。这一形状可以通过某种特定的曲线绕一条轴旋转而成，而这些设计背后正是这一形状特性的体现。
...
在数学中，这类曲线早已被深入研究，其图像由两条彼此对称、互不相交的分支组成，虽然共享同一个坐标原点，但各自无限延伸，永不相遇。这种曲线被称为“双曲线”。
