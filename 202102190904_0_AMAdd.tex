...
\subsection{CG 系数}
每个 $M$ 子空间中两组基底可以通过一个酉矩阵 $\mat U_M$ 来进行转换， 酉矩阵的矩阵元 $\braket{l_1, m_1, l_2, m_2}{L, M}$ 被称为 \textbf{Clebsch–Gordan 系数}或者简称 \textbf{CG 系数}． 详见 “CG 系数\upref{SphCup}”．
...
\end{equation}
$L^2$ 矩阵的具体形式和两组基底的排列顺序有关， 通常令 $\ket{l_1, m_1, l_2, m_2}$ （$m_2 = M - m_1$）以 $m_1$ 从大到小的顺序排列， $\ket{L, M}$ 以 $L$ 从大到小排序．
