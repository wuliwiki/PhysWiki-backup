...
\end{equation}
这是径向薛定谔方程更常见的形式， 方括号中可以看作\textbf{一维等效势能}（类比经典力学的情况\autoref{CenFrc_eq6}~\upref{CenFrc}）． 该方程的解取决于 $V(r)$ 的具体形式． 一般来说， 对于每个较小的 $l$， 可能找到有限个束缚态 $E_{n,l}$， 随着 $l$ 不断增加， 方括号中的等效势能越来越浅， 最终有可能导致径向方程不存在束缚态解．
