...
\subsection{双电子系统}
双电子完全也可以分别使用\autoref{HeAna2_sub1} 和\autoref{HeAna2_sub2} 两种方法． 这是完全一样的． 精确的球面波本征态（归一化但未对称化）记为 $\ket{l_1,l_2,L,n_1,k_2}$， 注意并不存在精确的 $\ket{l_1,m_1, l_2, m_2, n_1, k_2}$ 本征态
\begin{equation}
\ket{l_1,l_2,L,n_1,k_2} = \frac{1}{r_1r_2}\psi_{n_1, k_2}(r_1, r_2)\mathcal Y_{l_1,l_2}^{L, 0}(\uvec r_1, \uvec r_2)
\end{equation}
