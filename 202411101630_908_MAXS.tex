...
\begin{tabular}{|c|c|c|c|}
\hline
\textbf{Name} & \textbf{Integral equations (SI quantities)} & \textbf{Differential equations (SI quantities)} & \textbf{Differential equations (Gaussian quantities)} \\
...
\hline
Gauss's law & 
$\oiint_{\partial \Omega} \mathbf{D} \cdot d\mathbf{S} = \iiint_{\Omega} \rho_f \, dV$ & 
$\nabla \cdot \mathbf{D} = \rho_f$ & 
$\nabla \cdot \mathbf{D} = 4\pi \rho_f$ \\
\hline
Ampère–Maxwell law & 
$\oint_{\partial \Sigma} \mathbf{H} \cdot d\mathbf{\ell} = \iint_{\Sigma} \mathbf{J_f} \cdot d\mathbf{S} + \frac{d}{dt} \iint_{\Sigma} \mathbf{D} \cdot d\mathbf{S}$ & 
