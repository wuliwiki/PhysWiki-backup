...
考虑域$\mathbb{F}$，$\opn{ch}\mathbb{F}=p$．对于任意$\alpha, \beta\in\overline{\mathbb{F}}$和$k\in\mathbb{Z}^+$，都有$(\alpha-\beta)^{p^k}=\alpha^{p^k}-\beta^{p^k}$，其中$\overline{\mathbb{F}}$是$\mathbb{F}$的代数闭包．
