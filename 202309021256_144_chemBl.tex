...
\end{aligned}
$$
原则上，我们已经解决了化学平衡问题：化学平衡时系统Gibbs能取极值。
...
因此，对于一个化学反应，其实只有一个自由度，我们称之为化学反应进度 $\dd \xi$。系统中各个物质的物质的量变化$\dd n_i$都由$\dd \xi$确定：$\dd n_i = \nu_i \dd \xi$。其中$\nu_i$是化学计量数，即化学方程式中物质前的数字，生成物记为正、反应物记为负。
...
在化学学科，一般将$\dd \xi$ "除"到左边，从而定义反应的摩尔Gibbs变$\Delta_r G_M$：
