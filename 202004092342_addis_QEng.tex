...
要讨论势能的概念， 我们首先需要确保这个力场是一个保守场， 即只有上式的结果只与初末位置有关而与路径无关时才可能存在一个势能函数． 以后我们会看到电场可以分为两类： 由净电荷产生的电场是无旋的， 即保守场， 而由变化磁场产生的电场是有旋的， 即非保守场．

这个问题有两种解决方法， 第一是要求净电荷分布不随时间变化， 且电流保持恒定\footnote{注意有电流就意味着有电荷在移动， 所以我们强调的是 “净” 电荷保持静止}， 这类问题称为\textbf{静电学（electrostatics）}．

第二种方法是， 在非静电学的情况下， 我们将电场中的保守场， 即净电荷产生的电场分离出来定义电势能． 例如电路中的电荷的电势能电压\upref{Voltag}就是通过这种方法定义的， 一般来说电路不满足静电学的条件．

 但在另一些情况下（例如电路中）， 

广义来说（例如在电路中\upref{Voltag}）， 我们可以电场中的无旋部分分离出来定义电势能（或电势）

而满足这一条件的最简单情况就是， 我们把这类问题叫做 % 链接未完成
所以我们接下来只讨论这种情况．
...
\begin{example}{匀强电场}
令空间中处处存在匀强电场 $\bvec E = E_x \uvec x + E_y \uvec y + E_z \uvec z$， 以原点为零势点 $\bvec r_0$， 求点电荷 $q$ 在空间中任意一点 $\bvec r$ 的电势能．
