% 电场的高斯定律
% keys 高斯定律|高斯定理|麦克斯韦方程组|库仑定律|闭合曲面
...
在静电学条件下， 即空间中净电荷不随时间变化，且电流恒定不变时， 高斯定律和库伦定律\upref{ClbFrc}是等价的． 然而在非静电学条件下， 高斯定律依然成立而库伦定律却不成立\footnote{我们在电动力学简介\upref{EM0}中已经讨论过： 若一个静止的电荷在原地快速抖动一下， 电磁场会以光速把这个扰动向周围传播， 所以远处的电荷并不能立即感受到电场的变化． 这显然超出了库伦定律描述的范围．}． 所以高斯定律是更普适的定理， 库仑定律可以看作是高斯定律在静电学条件下的推论．
