...
\begin{equation}
\begin{aligned}
i\mathcal{M}(p_1p_2\rightarrow p_3p_4) &= -i\lambda + (-i\lambda)^2 \int \frac{\dd[4]{k}}{(2\pi)^4} \frac{i}{k^2-m^2+i\epsilon} \frac{i}{(k+p_1+p_2)^2-m^2}\\
