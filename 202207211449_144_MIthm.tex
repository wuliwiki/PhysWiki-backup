...
\end{figure}
选择质心所在垂直轴作为转动轴．已知圆柱体的转动惯量计算公式为$I=\frac{1}{2}mr^2$，计算内半径为r，外半径为R的均匀空心圆柱的转动惯量．

设密度为$\rho$，则圆柱转动惯量为$I=\frac{1}{2}(\rho \pi r^2) r^2=\frac{1}{2}\rho \pi r^4$．

根据可加性定理，设半径为r实心圆柱的转动惯量为$I_A$, 空心圆柱的转动惯量为$I_B$，那么半径为R实心圆柱的转动惯量为$I_{A+B}=I_A+I_B$．

所以$I_B=I_{A+B}-I_A=\frac{1}{2}\rho \pi (R^4-r^4)=\frac{1}{2}\rho \pi (R^2+r^2)(R^2-r^2)=\frac{1}{2}m'(R^2+r^2)$，$m'=\rho \pi (R^2-r^2)$即为该空心圆柱的质量．
\end{example}