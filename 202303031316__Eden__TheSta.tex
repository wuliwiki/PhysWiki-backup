...
考虑整个多体系统的能级，此时系统的量子态被定义为 $N$ 粒子的张量积（的对称化），而这个大的量子态能够按照系统哈密顿量的本征值划分为多个能级，这个大的量子态的能量是其中各个粒子的能量之和。假设每个大的量子态被粒子占据的概率仍正比于 $e^{-\beta \psilon}$（这是正则系综的一个基本假设，能够被证明）。 因此我们能够在经典意义下粗略地写出它的