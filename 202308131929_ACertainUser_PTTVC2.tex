...
\end{figure}
从更有物理意义的角度而言，根据状态量与路径无关的性质\upref{StaPro}，我们知道状态量的变化是与过程无关的。也就是说，只要始末态的压强、温度一定，相变前后的状态量变化就一定相同。因此，我们可以大胆放心地写出二者间的差值：
$$
\begin{aligned}
...
\end{aligned}~
$$
这个差值还意味着，等温等压条件下系统完全相变前后，系统内能的变化量。在一些国内教材的符号规范中，$\Delta^g_l$的上标$g$代表相变后的末相气相，下标$l$代表相变前的初始相液相。相变前后，热力学量的这种变化是由于物质在不同相中的本质性差异。
