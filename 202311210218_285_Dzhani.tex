...
现在，还是考虑\autoref{fig_Dzhani_12} 的模型。在刚体坐标系中，如果某一时刻刚体的角动量在$x$方向附近，那就意味着此时角动量在\autoref{fig_Dzhani_7} 第一行左起第一幅图的能量椭球与角动量球的交线上——因为椭球的$x$主轴是最短主轴。如\autoref{fig_Dzhani_12} 可见，此时二者的交线总是在$x$轴附近，因此角动量的变化幅度不会很大。
