...
\item Hacking, Ian（1983年）。《19世纪决定论概念的裂痕》（19th-century Cracks in the Concept of Determinism）。发表于 *Journal of the History of Ideas*，第44卷第3期，第455–475页。doi:10.2307/2709176。JSTOR 2709176。
\item Tchebichef, P.（1846年）。《概率理论一则一般命题的初等证明》（Démonstration élémentaire d'une proposition générale de la théorie des probabilités）。发表于 *Journal für die reine und angewandte Mathematik*（法文），1846年第33期，第259–267页。doi:10.1515/crll.1846.33.259。S2CID 120850863。
\item Seneta 2013。
\item Yuri Prohorov。“大数法则”。发表于 *数学百科全书*（Encyclopedia of Mathematics），EMS Press。
\end{enumerate}
