...
\item “高斯平均值定理”（Gauss's Mean-Value Theorem），见 Wolfram Alpha 网站
\item Pompeiu 1905
...
* Ahlfors, Lars（1979），《复分析》（第 3 版），McGraw Hill，ISBN 978-0-07-000657-7
* Pompeiu, D.（1905），《论复变函数的连续性》（PDF），图卢兹科学院年报，第二系列，第 7 卷第 3 期，265–315 页
* Titchmarsh, E. C.（1939），《函数论》（第 2 版），牛津大学出版社
* Hörmander, Lars（1966），《多复变函数分析导论》，Van Nostrand
* Hörmander, Lars（1983），《线性偏微分算子的分析 I》，Springer，ISBN 3-540-12104-8
* Doran, Chris；Lasenby, Anthony（2003），《物理学中的几何代数》，剑桥大学出版社，ISBN 978-0-521-71595-9

---

### 外部链接

* “Cauchy integral”，《数学百科全书》，EMS 出版社，2001（1994年初版）
* Eric W. Weisstein: “Cauchy Integral Formula”，MathWorld

---

如需将其中任何参考文献展开详细介绍，也可以继续告诉我。
