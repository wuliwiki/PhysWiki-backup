...
\item 10.12 例子 (a) $\omega=y\dd{x}+x\dd{y}$ 那么 $\int_\gamma \omega = \int_0^1 [\gamma_1(t)\gamma'_2(t)+\gamma_2(t)\gamma'_1(t)]\dd{t} = \gamma_1(1)\gamma_2(1)-\gamma_1(0)\gamma_2(0)$ 对闭合曲线为零． (b)  $1$-形式的积分时常叫做\textbf{线积分}．
