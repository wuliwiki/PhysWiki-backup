...
给定两个流形间的映射 $f:M\to N$，如果对于\textbf{任意}点 $p\in M$，存在一个 $M$ 的图 $(U, \varphi)$ 和一个 $N$ 的图 $(V, \phi)$，使得 $p\in U$，$\varphi(P)\subseteq V$，且 $\phi\circ f\circ\varphi^{-1}$ 是一个欧几里得空间之间的光滑映射，那么称 $f$ 是流形间的\textbf{光滑映射（smooth function）}．
\end{definition}
