...
\footnote{本文参考了刘智恩的材料科学基础（\autoref{MetDfm_fig7} ）与Callister的Material Science and Engineering An Introduction（\autoref{MetDfm_fig7}  , \autoref{MetDfm_fig8} ）. 部分文本、图片来自网络。本文适用于CC-BY-SA。}
