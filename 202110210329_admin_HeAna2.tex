...
\psi_{l_1,l_2}^{L, M}
\end{equation}
所有其他的 $(l_1,l_2)$ 分波在 $r_2\to\infty$ 波函数都消失． 这样就可以把这个态记为 $\ket{E,L,M; l_1,l_2,k_2}$． 分号用于提醒后面的量子数只是无穷远处的边界条件． 如果把这些态用 CG 系数线性组合一下， 就可以得到 $\ket{E; m_1,m_2,l_1,l_2,k_2}$， 注意此时除了能量， 剩下的量子数都是在 $r_2\to+\infty$ 处实现的．
