...
\href{https://www.caam.rice.edu/software/ARPACK/}{Arpack} 最初是一个 Fortran 语言编写的， 用于求解大型本征方程的程序库． 其主要算法是 Arnoldi- 下面是它的一些特性：
\begin{itemize}
\item 矩阵可以表示为密矩阵\upref{MatSto}， CSC 矩阵\upref{SprMat}． 也可以不需要提供矩阵本身而是提供矩阵—矢量乘法． 也就是你只需要提供一个函数 \verb|v = F(u)| 给 Arpack 即可， 其中 \verb|v| 就是矩阵乘以 \verb|u| 的结果．
