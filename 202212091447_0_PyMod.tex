...
元组：\verb|time.struct_time| 元组共有9个元素：（年：\verb|tm_year|，月：\verb|tm_mon|，日：\verb|tm_mday|，时：\verb|tm_hour|，分：\verb|tm_min|，秒：\verb|tm_sec|， 周几（1 就是周 1）：\verb|tm_wday|，一年中第几天：\verb|tm_yday|，夏令时）
