...
5. 一音叉置于反射面 $S$ 和观察者 $R$ 之间, 音叉的频率为 $v_0$。现在 $R$ 静止, 而音叉以速度 $v_1$ 向反射面 $S$ 运动, 则 $R$ 处接收到的拍频 $\underline{\hspace{2cm}}$。 $\Delta v = \underline{\hspace{2cm}}$。设题设已知。

6. 同一媒质中的两波源 $A$, $B$, 相距为 $x_B - x_A = 10m$, 它们的振幅均为 $15$ 厘米, 频率都是 $50$Hz, 相位差为 $\pi$, 波速为 $400ms^{-1}$。$t = 0$ 时, $A$ 处质点的位移为 $15$ 厘米。若以 $A$ 点为坐标原点, 则 $A$ 处质点由波动方程(即波函数)为 $\underline{\hspace{2cm}}$, $B$ 处质点的波动方程为 $\underline{\hspace{2cm}}$。$A$, $B$ 连线上的干涉静止点的各点的位置为 $\underline{\hspace{2cm}}$。