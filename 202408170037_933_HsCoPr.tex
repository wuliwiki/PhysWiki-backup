...
其中：$A$是所有平面四边形构成的集合，$P(x)$是命题“$x$是矩形。”，$Q(x)$是命题“x的对角线长度相等。”，$B$是$x$的所有内角构成的集合，$R(y)$是命题“$y$是直角。”
\begin{itemize}
\item 
\item 否定与原本命题的真伪相反，否定时“任意”会变成“存在”，并根据条件命题的否定是“$P\land\lnot Q$”可得后面的结论。事实上，由于矩形
