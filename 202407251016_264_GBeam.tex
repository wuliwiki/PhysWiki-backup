...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/0b631152a0a6ba13.png}
\caption{0阶高斯光的光强分布} \label{fig_GBeam_7}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/26c2e601424eac6e.png}
\caption{0阶高斯光的相位分布} \label{fig_GBeam_8}
\end{figure}
