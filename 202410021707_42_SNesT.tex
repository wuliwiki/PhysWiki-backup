...
在 $\{x_n\}$ 中选取这样的点 $x_{n_1}$ 作为半径为1的闭球 $B_1$ 的中心，使得一切 $n\geq n_1$，$d(x_n,x_{x_1})<1/2$（根据柯西序列\autoref{def_cauchy_3}）。然后在 $\{x_n\}$ 中选取 $x_{n_2}$ 作为半径为1/2的闭球 $B_2$ 的中心，使得 $n_2>n_1$，且对一切 $n\geq n_2$，$d(x_n,x_{x_2})<1/2^2$。
