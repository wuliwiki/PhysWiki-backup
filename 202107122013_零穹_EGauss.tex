...
当$\bvec r\in V$ 时，由于同样的理由，被积函数仅在 $\bvec r'=\bvec r$处可能不为0，即
\begin{equation}
\int\rho(\bvec r')\bvec\nabla_{\bvec r}\vdot\frac{\bvec r-\bvec r'}{\abs{\bvec r-\bvec r'}^3}\dd[3]{r'}=\lim_{\bvec r'\rightarrow \bvec r}\int\rho(\bvec r)\bvec\nabla_{\bvec r}\vdot\frac{\bvec r-\bvec r'}{\abs{\bvec r-\bvec r'}^3}\dd[3]{r'}
\end{equation}
由散度的定义式计算．
\begin{equation}
\begin{aligned}
