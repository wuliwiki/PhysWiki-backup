...
\begin{equation}
\begin{aligned}
\mathcal{L} = \frac{1}{2}Z_\phi (\partial_\mu\phi)^2 - \frac{1}{2} Z_\phi m_0^2 \phi^2 - \frac{Z_\phi^4\lambda_0}{4!} \phi^4
\end{aligned}
\end{equation}
为了方便自能的计算，要求拉氏量中的参数 $m$ 等于粒子的物理质量 $m_\text{ph}$，
令 $Z_m = Z_\phi m_0^2/m^2$，这样就可以将 $Z_\phi m_0^2$ 用 $Z_m m^2$ 替代。
