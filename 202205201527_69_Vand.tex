...
从范德瓦尔斯等温线可以总结处的特点是：气液相变，有\textbf{临界点}，并且可以通过临界点的测量得到 $a,b$．图中的红色曲线正是\textbf{临界温度} $T_c$ 下的等温线．所谓临界温度，指的是在这一温度以上时，不再存在 $ADB$ 的气液共存态，事实上在临界温度以上，气相和液相的区别消失．
\subsection{范德瓦尔斯气体的稳定性，临界点的计算}
热力学系统的熵判据\upref{equcri}告诉我们，系统的平衡稳定条件是
\begin{equation}
