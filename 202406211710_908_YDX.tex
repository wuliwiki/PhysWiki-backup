...
\begin{align}
\frac{d}{dt}\bm{e}_r &= \dot{\bm{e}}_r = \dot{\theta} \bm{e}_\theta \\\\
\frac{d}{dt}\\bm{e}_\\theta &= \\dot{\\bm{e}}_\\theta = -\\dot{\\theta} \bm{e}_r \\\\
\frac{d}{dt}\\dot{\\bm{e}}_r &= \\ddot{\\bm{e}}_r = \\ddot{\\theta} \\bm{e}_\\theta - \\dot{\\theta} \\dot{\\bm{e}}_r \\\\
\frac{d}{dt}\\dot{\\bm{e}}_\\theta &= \\ddot{\\bm{e}}_\\theta = -\\ddot{\theta} \\bm{e}_r - \\dot{\\theta}^2 \\bm{e}_\\theta ~
\end{align}

使用这些符号，$\bm{P}(t)$ 变成以下形式：

\begin{equation}
\bm{P}(t) = R\bm{e}_r + Z(t)\hat{k}~
\end{equation}

其中在粒子仅在半径为$r$ 的圆柱体表面上移动的情况下为常数。

一般情况下，轨迹$\bm{P}(t)$ 不被约束在圆柱上，因此半径$r$ 随时间变化，圆柱极坐标中的粒子轨迹变为：

\begin{equation}
\bm{P}(t) = R(t)\bm{e}_r + Z(t)\hat{k}~
\end{equation}
