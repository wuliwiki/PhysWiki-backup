...
\subsection{透射深度}
Landau-Ginzburg理论解释了超导电流的参数依赖问题，在伦敦方程中，计算得到的超导唯象解释——伦敦方程 \autoref{sub_edy34_1}~\upref{edy34}，其中的投射深度包含参数$n_s$，即超导电子密度，在Landau-Ginzburg理论中，根据$n_s = |\psi|^2 = -\alpha/\beta$，得到投射深度为
\begin{aligned}
\lamb
\end{aligned}
\subsection{临界电流}
