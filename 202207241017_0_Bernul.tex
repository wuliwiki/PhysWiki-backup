...
根据不可压缩的假设，流入水管的水量等于流出水管的水量，$A_1v_1\Delta t=A_2v_2\Delta t=V$，即$m1=m2$． 这个过程中这段液体的机械能改变了多少呢？ 机械能包括动能和重力势能． 显然中间深蓝色的部分的机械能保持不变， 所以可以等效视为 1 处的一小截液体移动到了 2 处．
...
\end{equation}
所以 $A_1,A_2$ 间的液体在时间 $\Delta t$ 内机械能增量为 $\Delta E = E_2 - E
