...
对于一个双曲线，其两个焦点为 $F_1$ 和 $F_2$。对于双曲线上的任意一点 $P$，若从 $F_1$ 发出一条光线射向 $P$，在 $P$ 发生镜面反射，则反射光线的延长线将经过 $F_2$。也就是说，直线 $PF_1$ 与 $PF_2$ 关于切线 $l$ 对称，即：
\begin{equation}
...
双曲线的反射性质与椭圆类似，但也有本质不同。椭圆反射性质中，从一个焦点出发的光线经反射后实际到达另一个焦点；而在双曲线中，从一个焦点出发的光线，经反射后，反射线的延长线穿过另一个焦点。这种性质在某些通信设备、雷达设计中尤其重要，比如需要将来自一个方向的信号转向另一指定方向时。
