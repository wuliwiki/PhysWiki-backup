...
与双曲线不同，抛物线并没有渐近线，以\autoref{eq_Para3_3} 为例，设抛物线上的点 $P (x, \sqrt{2px})$ ，设直线 $L: y = ax + b$，当$x$趋于无穷时，考虑点到直线的距离，有：
\begin{equation}
\begin{split}
\lim_{x \to \infty} d(P, L)
&= \lim_{x \to +\infty} \frac{|ax - \sqrt{2px} + b|}{\sqrt{a^2 + 1}}\\
&=\frac{1}{\sqrt{a^2 + 1}}\lim_{x \to +\infty} |\sqrt{x}(a\sqrt{x} - \sqrt{2p}) + b|
~.
\end{split}
\end{equation}


$\sqrt{2px} \sim x^{1/2}$，$ax \sim x$，因此上式中 $|ax - \sqrt{2px} + b| \to \infty$，从而距离不趋近于 0。
