...
\item \verb|wuli.wiki/history/| 打开某词条后， 提供历史版本的 list， 功能和编辑器中的 “历史版本” 窗口类似（该窗口的新要求见下文）． 点击一个历史版本可以浏览网页（即时用 PhysWikiScan 编译）， 勾选两个历史版本可以点击 “对比” 查看二者区别． 该界面同样需要 “只显示每次编辑的最后版本” 按钮（见下文）．
