...
\subsection{另见}
* 自动微分 —— 在数值计算中伴随求导数的一种方法，这是一种大量使用链式法则来计算精确数值导数的计算方法。
* 求导法则 —— 计算函数导数的规则
* 换元积分法 —— 积分计算中的一种技巧
* 莱布尼茨积分法则 —— 积分号下求导的公式
* 乘积法则 —— 两个函数乘积的导数公式
* 商法则 —— 两个函数比值的导数公式
* 三重乘积法则 —— 三个变量相对导数之间的关系
\subsection{参考文献}
1. George F. Simmons，《Calculus with Analytic Geometry》（1985），第 93 页。
...
3. Rodríguez, Omar Hernández; López Fernández, Jorge M. (2010). "A Semiotic Reflection on the Didactics of the Chain Rule". *The Mathematics Enthusiast*. 7 (2): 321–332. doi:10.54870/1551-3440.1191. S2CID 29739148. 2019-08-04 检索。
4. Apostol, Tom (1974). *Mathematical analysis* (第2版). Addison Wesley. 定理 5.5。
