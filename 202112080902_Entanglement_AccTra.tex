...
圆盘绕圆轨道一周所用的时间为$\frac{2 \pi}{\bvec \omega}$ ，$A$ 点走过的路径长为$2 \pi (\bvec R + \bvec r)$ ，所以圆盘边缘的点转动的线速度为 $\frac{2 \pi (R+r)}{\frac{2 \pi}{\bvec \omega}}$ ，所以圆盘边缘上任意点对圆心 $A$ 点的加速度 $\bvec a_{S'}$ 为
\begin{equation}
