...
当（大量）电荷定向运动起来，就会产生\textsl{电流}。电流可以由两种方式衡量，分别是电流强度\upref{I}与电流密度\upref{Idens} ，他们之间的关系如同质量与密度。
...
\hline
电流密度：“单位时间单位面积通过的电荷量” $\bvec j$ & $$I = \oint \bvec j \cdot \dd {\bvec S}~$$ $$\bvec j= \dv{I}{S_\perp} \hat n~$$ \\
\hline
\end{tabular}
\end{table}
