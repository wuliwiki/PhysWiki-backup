...
\begin{equation}
\leftgroup{
&A = \mathcal{N}(k^2 + b^2)\sin(2bl) + 2\I kb \cos(2bl)\\
&B = \mathcal{N}(k^2 - b^2)\sin(2bl)\exp(-2\I kl)\\
&C = \I \mathcal{N}k (k + b) \exp[-\I (k+b)l]\\
&D = \I \mathcal{N}k(b-k) \exp[-\I (k-b)l]\\
&F = 2\I\mathcal{N} kb \exp(-2\I kl)
}\end{equation}
其中归一化系数为
\begin{equation}
