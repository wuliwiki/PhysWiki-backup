...
\autoref{ODEb1_the1} 证明思路提示：我们已经知道，\autoref{ODEb1_eq2} 的每个解由$n$个初值唯一确定．在初值点$x_0$，给定chu'zhi'tiao'jian$y_1(x_0), y_2(x_0), \cdots, y_n(x_0)$，如果$c_1y_1(x)+\cdots+c_ny_n(x)$满足全部$n$个初值条件，那么
\begin{equation}
\leftgroup{
c_1y_1(x_0)+\cdots+c_ny_n(x_0)
}
\end{equation}
