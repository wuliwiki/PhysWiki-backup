...
这里 $S=\left(\frac{\partial E}{\partial T}\right)_V$，除此以外熵还有统计物理的定义．如果这个全微分刚好对应系统的一个可逆过程，那么我们可以看出 $\delta W$ 就是 $-p\dd V$，由热力学第一定律，就有 $\delta Q=T\dd S$，这给出了熵的另一个定义．

对于不可逆的热力学过程，有 $\delta W>-p\dd V$，$\delta Q<$
