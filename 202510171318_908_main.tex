...
\entry{丢番图（综述）}{DPHT}
\entry{丘成桐（综述）}{QCT}
\entry{阿基米德（综述）}{Archim}
\entry{欧几里得（综述）}{Euclid}
\entry{埃米·诺特（综述）}{AMnt}
\entry{阿瑟·凯利（综述）}{Cayley}
\entry{埃利·嘉当（综述）}{Cartan}
\entry{乔治·布尔（综述）}{George}
\entry{乔治·格林（综述）}{QZgl}
\entry{索菲斯·李（综述）}{SFSL}
\entry{欧多克索斯（综述）}{ODK}
\entry{毕达哥拉斯（综述）}{Pythag}
\entry{亨利·庞加莱（综述）}{HLPJL}
\entry{拉扎尔·卡诺（综述）}{Lazare}
\entry{约翰·伯努利（综述）}{YHBNL}
\entry{威廉·哈密顿（综述）}{WLHMD}
\entry{卡尔·威尔施特拉斯}{Karl}
\entry{伊本·海什木（综述）}{YBH}
\entry{雅克·阿达马（综述）}{YKadm}
\entry{艾萨克·巴罗（综述）}{ASKbl}
\entry{詹姆士·金斯（综述）}{James}
\entry{哥德巴赫猜想（综述）}{GDBHCX}
\entry{阿尔-花拉子米（综述）}{HLZM}
\entry{海因茨·霍普夫（综述）}{HYCH}
\entry{雅各布·伯努利（综述）}{YGBbnl}
\entry{丹尼尔·伯努利（综述）}{BNL}
\entry{库尔特·哥德尔（综述）}{KRT} 
\entry{约瑟夫·傅里叶（综述）}{YSf}
\entry{斯特凡·巴拿赫（综述）}{STFbnh}
\entry{伯恩哈德·黎曼（综述）}{BEHDLM}
\entry{恩斯特·策梅洛（综述）}{Zerme}
\entry{尼尔斯·阿贝尔（综述）}{NRSAB}
\entry{约翰·冯诺依曼（综述）}{Neuman}
\entry{大卫·希尔伯特（综述）}{David}
\entry{安德鲁·怀尔斯（综述）}{Andrew}
\entry{弗朗索瓦·韦达（综述）}{WD}
\entry{布莱斯·帕斯卡（综述）}{BLSpsk}
\entry{乔治·斯托克斯（综述）}{QZstks}
\entry{詹姆斯·格雷果里（综述）}{ZMs}
\entry{亚伯拉罕·棣莫弗（综述）}{YBLH}
\entry{皮埃尔·德·费马（综述）}{Pierre}
\entry{格奥尔格·康托尔（综述）}{Canto}
\entry{戈特洛布·弗雷格（综述）}{Gottlo}
\entry{约翰·福布斯·纳什（综述）}{JFNJY}
\entry{西梅翁·德尼·泊松（综述）}{BSDN}
\entry{乔治·比德尔·艾里（综述）}{AL}
\entry{埃瓦里斯特·伽罗瓦（综述）}{AWLS}
\entry{卡尔·魏尔施特拉斯（综述）}{KRTS}
\entry{帕夫努季·切比雪夫（综述）}{PFNJ}
\entry{伯恩哈德·波尔查诺（综述）}{Bolzan}
\entry{约翰·查尔斯·菲尔兹（综述）}{Charle}
\entry{奥古斯丁-路易·柯西（综述）}{August}
\entry{亚历山大·格罗滕迪克（综述）}{AlGr}
\entry{克里斯蒂安·哥德巴赫（综述）}{Goldba}
\entry{斯坦尼斯瓦夫·乌拉姆（综述）}{Ulam}
\entry{斯里尼瓦瑟·拉马努金（综述）}{LMLJ}
\entry{皮埃尔-西蒙·拉普拉斯（综述）}{LPLS}
\entry{阿德里安-马里·勒让德（综述）}{adla}
\entry{亚历克西·克洛德·克莱罗（综述）}{Alexis}
\entry{约翰·彼得·古斯塔夫·勒热纳·狄利克雷（综述）}{YBGL}
...
\entry{汉斯·贝特（综述）}{Hans}
\entry{约翰·巴丁（综述）}{Yhbd}
\entry{尼尔斯·玻尔（综述）}{NRSbr}
\entry{尤金·维格纳（综述）}{YJwgn}
\entry{利奥·西拉德（综述）}{Szilar}
\entry{乔治·伽莫夫（综述）}{QZjmf}
\entry{斯蒂芬·霍金（综述）}{HJ}
\entry{赫尔曼·外尔（综述）}{WR}
\entry{艾萨克·牛顿（综述）}{Newton}
\entry{恩里科·费米（综述）}{ELK}
\entry{爱德华·泰勒（综述）}{ADHTL}
\entry{马克斯·玻恩（综述）}{BE}
\entry{罗伯特·胡克（综述）}{HK}
\entry{詹姆斯·焦耳（综述）}{JR}
\entry{伊西多·拉比（综述）}{YXDlb}
\entry{爱德华·康登（综述）}{ADHkd}
\entry{约翰·沃利斯（综述）}{YHALS}
\entry{勒内·笛卡尔（综述）}{DKE}
\entry{保罗·狄拉克（综述）}{DLK1}
\entry{莉泽·迈特纳（综述）}{LZm}
\entry{约翰·蓝道尔（综述）}{YHldr}
\entry{阿诺德·索末菲（综述）}{ANOSf}
\entry{维尔纳·海森堡（综述）}{Heisen}
\entry{路易·德布罗意（综述）}{Brogli}
\entry{沃尔夫冈·泡利（综述）}{Pauli2}
\entry{迈克尔·法拉第（综述）}{FLD}
\entry{鲁道夫·佩尔斯（综述）}{LDF}
\entry{莱昂哈德·欧拉（综述）}{OL1}
\entry{格奥尔格·欧姆（综述）}{GOM}
\entry{伽利略·伽利莱（综述）}{JLL}
\entry{菲利普·莱纳德（综述）}{FLPL}
\entry{古斯塔夫·赫兹（综述）}{GSTFhz}
\entry{马克·奥利芬特（综述）}{MKalft}
\entry{詹姆斯·弗兰克（综述）}{ZMSflk}
\entry{约翰·考克饶夫（综述）}{YHkrf}
\entry{奥利弗·亥维赛（综述）}{ALFkws}
\entry{罗伯特·奥本海默（综述）}{ABHM}
\entry{欧内斯特·劳伦斯（综述）}{ONST}
\entry{弗雷德里克·塞茨（综述）}{Seitz}
\entry{詹姆斯·查德威克（综述）}{ZMcdw}
...
\entry{钱德拉塞卡拉·拉曼（综述）}{QDLlm}
\entry{赫尔曼·冯·亥姆霍兹（综述）}{HEMfhm}
\entry{戈特弗里德·莱布尼茨（综述）}{LBNC}
\entry{乔赛亚·威拉德·吉布斯（综述）}{QSY}
\entry{萨特延德拉·纳特·玻色（综述）}{BOSE}
\entry{卡尔·弗里德里希·高斯（综述）}{KRGS}
\entry{詹姆斯·克拉克·麦克斯韦（综述）}{Clerk}
\entry{苏布拉马尼扬·钱德拉塞卡（综述）}{Sbl}
% \entry{角动量简介}{CM2}
...
\entry{尼古拉·特斯拉（综述）}{Tesla}
\entry{威廉·爱德华·韦伯（综述）}{Eduard}
