...
要注意的是，上述推导是以无穷远处为势能零点．若令棒长$L\rightarrow \infty$，将得出任意位置电势无穷大的错误结论．也就是说，在讨论无限长的导体棒问题时以无穷远处为电势零点是不合适的．若以相距无限长导体棒$a$的位置点$A$为电势零点，那么有
\begin{equation}
V =\frac{\lambda }{2 \pi \epsilon_{0}}\ln{}{\frac{a}{d}}
\end{equation}
