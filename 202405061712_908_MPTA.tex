...
\hline
\enref位置 \upref{CM} & $\bvec r_c =\frac{\sum (m_i \bvec r_i)}{M} $\\
\hline
\enref速度 \upref{SysMom} & $\bvec v_c = \dv{\bvec r_c}{t}=\frac{\sum (m_i \dv{\bvec r_i}{t})}{M}=\frac{\sum (m_i \bvec v_i)}{M} $\\
\hline
\enref加速度 \upref{PLaw}& $\bvec a_c = \dv{\bvec v_c}{t}=\frac{\sum (m_i \bvec a_i)}{M} $\\
\hline
