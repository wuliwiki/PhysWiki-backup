...
\omega(\Gamma',\Gamma_1';\Gamma,\Gamma_1)ff_1\dd\Gamma\dd\Gamma_1\dd\Gamma'\dd\Gamma_1'
 \end{equation}
 观察上式，$f\dd \Gamma$ 的单位为 $m^{-3}$，而总的单位为 $m^{-3}t^{-1}$，所以 $\omega(\Gamma',\Gamma_1';\Gamma,\Gamma_1)\dd\Gamma'\dd\Gamma_1'$ 单位为 $m^{-3}t^{-1}m^{3}m^{3}=m^3t^{-1}$．这表明下式具有面积的量纲
 \begin{equation}
 \dd \sigma=\frac{\omega(\Gamma',\Gamma_1';\Gamma,\Gamma_1)}{\abs{\bvec v-\bvec v'}}\dd\Gamma'\Gamma_1'
 \end{equation}
 其中 $\bvec v-\bvec v'$ 为两粒子相对速度，
