...
\end{equation}
则该土地面积 $S$ 为：
S=S_{\Delta ACD}+S_{\Delta CBD}
对 $\Delta ABC}$和$S_{\Delta CBD$，其海伦公式中的 $s$ 分别为
\begin{equation}
s_{\Delta ABC}=\frac{\overline{AB}+\overline{AC}+\overline{BC}}{2}=90m
,
s_{\Delta CBD}=\frac{\overline{BC}+\overline{BD}+\overline{CD}}{2}=90m
\end{equation}
