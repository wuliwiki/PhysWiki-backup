...
在进一步介绍分圆多项式性质之前，我们需要引入\textbf{Möbius函数}\upref{MbusF}的概念．
...
\addTODO{证明反演公式，然后用它结合\autoref{Cycltm_the1} 推导出Möbius函数表示分圆多项式的推论．}



\begin{lemma}{Möbius反演公式}
...
当$n>1$时，$\sum_{k\mid n}\mu(d)=0$．这是因为求和中非零的
...
\begin{corollary}{Möbius函数表示分圆多项式}
\begin{equation}
