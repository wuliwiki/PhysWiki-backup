...
\subsection{双电子系统}
双电子完全也可以分别使用\autoref{HeAna2_sub1} 和\autoref{HeAna2_sub2} 两种方法． 这是完全一样的． y氦原子和 $H$ 对易的算符只有 $L^2, L_z$， 所以精确的球面波能量本征态记为 $\ket{H,}$
\begin{equation}
\ket{l_1,l_2,L,n_1,k_2} = \frac{1}{r_1r_2}\psi_{l_1,l_2}^{L, 0}(r_1, r_2)\mathcal Y_{l_1,l_2}^{L, 0}(\uvec r_1, \uvec r_2)
\end{equation}
