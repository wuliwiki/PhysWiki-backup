...
中， 若势能函数是线性的， 即 $V(x) = px + q$， 那么方程整理后可变为\autoref{eq_AiryF_13} 的形式， 所以波函数就是\autoref{eq_AiryF_1} 的形式。 详见 “\enref{线性势能的定态薛定谔方程}{LinPot}”。 该势能的一个应用是 WKB 近似\upref{WKB}， WKB 近似是量子力学中解定态薛定谔方程的一种近似方法。
