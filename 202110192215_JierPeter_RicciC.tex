...
\begin{aligned}
2R_{tkij}=&2g^{ar}R^r_{kij}\\
=&g^{ar}(\partial_ig^{ar})(\partial_jg_{ka})+\delta^a_t\partial_i\partial_jg_{ka}+\\
&g^{ar}(\partial_ig^{ar})(\partial_kg_{aj})+\delta^a_t\partial_i\partial_kg_{aj}-\\
&g^{ar}(\partial_ig^{ar})(\partial_ag_{jk})-\delta^a_t\partial_i\partial_ag_{jk}-\\%First line above, expanded
&g^{ar}(\partial_jg^{ar})(\partial_ig_{ka})-\delta^a_t\partial_j\partial_ig_{ka}-\\
&g^{ar}(\partial_jg^{ar})(\partial_kg_{ai})-\delta^a_t\partial_j\partial_kg_{ai}+\\
&g^{ar}(\partial_jg^{ar})(\partial_ag_{ik})+\delta^a_t\partial_j\partial_ag_{ik}+\\%Second line above
...
=&g^{ar}(\partial_ig^{ar})(\partial_jg_{ka})+\partial_i\partial_jg_{kt}+\\
&g^{ar}(\partial_ig^{ar})(\partial_kg_{aj})+\partial_i\partial_kg_{tj}-\\
&g^{ar}(\partial_ig^{ar})(\partial_ag_{jk})-\partial_i\partial_tg_{jk}-\\%First line above, expanded
&g^{ar}(\partial_jg^{ar})(\partial_ig_{ka})-\partial_j\partial_ig_{kt}-\\
&g^{ar}(\partial_jg^{ar})(\partial_kg_{ai})-\partial_j\partial_kg_{ti}+\\
&g^{ar}(\partial_jg^{ar})(\partial_ag_{ik})+\partial_j\partial_tg_{ik}+\\%Second line above
...
=&g^{ar}(\partial_ig^{ar})(\partial_jg_{ka})+\\
&g^{ar}(\partial_ig^{ar})(\partial_kg_{aj})+\partial_i\partial_kg_{tj}-\\
&g^{ar}(\partial_ig^{ar})(\partial_ag_{jk})-\partial_i\partial_tg_{kj}-\\%First line above, expanded
&g^{ar}(\partial_jg^{ar})(\partial_ig_{ka})-\\
&g^{ar}(\partial_jg^{ar})(\partial_kg_{ai})-\partial_j\partial_kg_{ti}+\\
&g^{ar}(\partial_jg^{ar})(\partial_ag_{ik})+\partial_j\partial_tg_{ki}+\\%Second line above
