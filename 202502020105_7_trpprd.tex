...
\left\{
\begin{aligned}
\bvec{a}\times\qty(\bvec{b}_1\times\bvec{c}) ={}& \gamma_1\bvec{b}_1(\bvec{a}\cdot\bvec{c}) - \gamma_1\bvec{c}_1(\bvec{a}\cdot\bvec{b}), \\
\bvec{a}\times\qty(\bvec{b}_2\times\bvec{c}) ={}& \gamma_2\bvec{b}_2(\bvec{a}\cdot\bvec{c}) - \gamma_2\bvec{c}_2(\bvec{a}\cdot\bvec{b}), 
\end{aligned}
\right. ~
\end{equation}
那么
\begin{equation}
\bvec{a}\times\qty((\bvec{b}_1+\bvec{b}_2)\times\bvec{c}) = (\gamma_1\bvec{b}_1+\gamma_2\bvec{b}_2)(\bvec{a}\cdot\bvec{c}) - (\gamma_1\bvec{c}_1+\gamma_2\bvec{c}_2)(\bvec{a}\cdot\bvec{b})
~\end{equation}
