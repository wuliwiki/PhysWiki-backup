...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/8322d5348fc3d320.png}
\caption{ 关于 LIGO 与 Virgo 干涉仪首次引力波观测的数据} \label{fig_Gras_5}
\end{figure}
...
\begin{itemize}
\item LIGO 科学合作组织
\item AstroGravS：天体物理引力波源档案
\item 视频（时长 04:36）——《探测引力波》，作者 Dennis Overbye，发表于《纽约时报》（2016 年 2 月 11 日）。
\item 视频（时长 71:29）——新闻发布会宣布发现：“LIGO 探测到引力波”，美国国家科学基金会（2016 年 2 月 11 日）。
\item 引力波天文学
\end{itemize}
