...
(d\rightarrow 4)&= -i\frac{e^2}{(4\pi)^2}  \int_0^1 \dd x \left[\frac{2}{\epsilon}+\log\left(\frac{\mu^2}{(1-x)m^2+x m_\gamma^2 - x(1-x)p^2}\right)\right]\cdot \left[(4-\epsilon)m -(2-\epsilon)x\not p\right]
\end{aligned}
\end{equation}
