...
$\mathfrak{gl}(n,\mathbb C)$由$n$阶复数矩阵构成，$\mathfrak u(n)$则由$n$阶反厄米矩阵构成。因此显然$\mathfrak{gl}(n,\mathbb C)\supset \mathfrak u(n)$。现设任意$A\in \mathfrak gl(n,\mathbb C)$，并有$A=B+\I C$。
