...
历史  
柯西–黎曼方程首次出现在让·勒·朗·达朗贝尔（Jean le Rond d'Alembert）的研究中。[1] 后来，莱昂哈德·欧拉（Leonhard Euler）将这一系统与解析函数联系起来。[2] 随后，柯西（Cauchy）使用这些方程构建了他的函数理论。[3] 黎曼（Riemann）关于函数理论的博士论文于1851年发表。[4]