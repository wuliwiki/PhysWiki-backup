...
\subsection{电磁学}
1. 高斯单位制中以厘米、克、秒分别作为长度、质量、时间的单位．求国际单位制与高斯单位制下电场强度的换算关系．已知国际单位制中 $1/(4 \pi \varepsilon_{0})=9 \times 10^{9} {N \cdot m^{2}/C^{2}}$ 求精细结构常数 $\alpha$ 的数值．已知高斯单位制下 $\alpha=\frac{e^{2}}{\overline{\pi c}}$