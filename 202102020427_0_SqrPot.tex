...
\end{equation}
又根据概率流\upref{PrbJ}守恒得 $\abs{A}^2 = \abs{B}^2 + \abs{E}^2$， 所以我们令边界条件为
\begin{equation}
A = \frac{1}{\sqrt{2\pi}}
\end{equation}
当 $E > V_0$ 时， 系数解为
...
其中
\begin{equation}
\mathcal{N} = \frac{[(k^2 + b^2)\sin(2bl) - 2\I kb \cos(2bl)]\exp(-\I kl)}{\sqrt{\pi}\sqrt{2(k^2-b^2)^2\sin^2(2bl) + 8k^2b^2}}
\end{equation}
...
\begin{equation}
\mathcal{N} = \frac{1}{\sqrt{\pi}\sqrt{2(k^2+\kappa^2)^2\sinh^2(2\kappa l) + 8k^2\kappa^2 \cosh^2(2\kappa l)}}
\end{equation}
