...
\subsection{历史}
约瑟夫·路易·拉格朗日在1760 年首次引入了曲面积分的概念，并在 1811 年出版的《解析力学》第二版中以更一般的形式再次提出。拉格朗日将曲面积分运用于流体力学研究中【13】。他在1762 年发现了散度定理【14】。

卡尔·弗里德里希·高斯（Carl Friedrich Gauss）在 **1813 年** 研究椭球体的引力吸引问题时，也使用了曲面积分，并证明了散度定理的若干特殊情况【15】【13】。他在 **1833 年** 和 **1839 年** 又证明了更多特殊情形【16】。

然而，首次对该定理进行一般性证明的人是 **米哈伊尔·奥斯特罗格拉德斯基（Mikhail Ostrogradsky）**，他在 **1826 年** 对热流问题进行研究时给出了完整的推导【17】。此外，**乔治·格林（George Green）** 在 **1828 年** 的论文《*数学分析在电磁理论中的应用*》（*An Essay on the Application of Mathematical Analysis to the Theories of Electricity and Magnetism*）中【18】【16】，**西缅·德尼·泊松（Siméon Denis Poisson）** 在 **1824 年** 关于弹性的论文中，以及 **弗雷德里克·萨鲁斯（Frédéric Sarrus）** 在 **1828 年** 关于浮体的研究中【19】【16】，都分别给出了该定理的特殊情况。
