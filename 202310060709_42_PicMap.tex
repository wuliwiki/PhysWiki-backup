...
设 $U$ 是 $\mathbb R^{n+1}$ 的一区域，在其上定义了一向量场 $v:U\rightarrow\mathbb TU$\footnote{在 $U\in\mathbb R^{n+1}$ 上定义了向量场相当于在 $\mathbb R^n$ 中一区域定义了依赖于时间 $t\in\mathbb R$ 的向量场。前者表述的空间称为后者的扩张空间（\autoref{sub_PSaPF_1}~\upref{PSaPF}）。}，
\end{definition}