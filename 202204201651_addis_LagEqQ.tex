...
\begin{equation}
Q_x = F_1 \pdv{x_1}{x} + F_2 \pdv{x_2}{x} = -\alpha s_1\dot x_1^2 \cdot \frac{1}{2} -\alpha s_2\dot x_2^2 \cdot \frac{-1}{2} = \frac{\alpha}{2}(s_1\dot x_1^2 - s_2 \dot x_2^2)
\end{equation}
同理得
\begin{equation}
Q_X = -\alpha(s_1 \dot x_1^2 + s_2\dot x_2^2)
\end{equation}
两个广义力中的 $x_1,x_2$ 可以进一步写成 $x, X$ 的函数， 具体略． 求得含摩擦力的运动方程为
\begin{equation}
