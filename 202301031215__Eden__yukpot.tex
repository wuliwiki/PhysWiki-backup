...
我们先计算两体散射过程 $\ket{{\bvec p},s,+;{\bvec k},r,+}\rightarrow \ket{{\bvec p}',s',+;{\bvec k}',r',+}$ 的费曼矩阵元忽略高圈图的贡献，我们只保留其树图的贡献。在这里 $+$ 代表费米子，$-$ 代表反费米子。要注意 $\ket{{\bvec p}',s',+;{\bvec k}',r',+}$ 对应的左矢是 $\bra{\bvec p',s',+;\bvec k',r',+}=\bra 0 a_{\bvec k'}^{r'} a_{\bvec p'}^{s'}$。
\begin{equation}
\begin{aligned}
\notag i\mathcal{M}&=
