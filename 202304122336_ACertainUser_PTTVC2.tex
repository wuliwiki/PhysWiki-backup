...
进一步地，根据状态量与路径无关的性质\upref{StaPro}，我们可以定义相应的差值：
$$
\begin{aligned}
...
\caption{请添加图片描述} \label{fig_PTTVC2_2}
\end{figure}
从更有物理意义的角度而言，这个差值意味着，等温等压条件下系统发生相变时，系统的内能就必然增加（减少）这么多的量。在国内教材的符号规范中，$\Delta^g_l$的上标$g$代表相变后的末相气相，下标$l$代表相变前的初始相液相。
