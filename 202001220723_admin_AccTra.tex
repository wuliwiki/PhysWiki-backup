...
我们在 $S$ 系中证明以下的黑体字母都表示矩阵或者矢量的坐标． 令 $S$ 系中的坐标为 $(x, y, z)\Tr$， $S'$ 系中的坐标为 $(x', y', z')$， 且坐标变换可以用一个旋转矩阵 $\mat R(t)$ 和一个平移矢量 $\bvec d(t)$ 表示为
\begin{equation}
\pmat{x\\y\\z} = \mat R(t) \pmat{x'\\y'\\z'} + \pmat{d_x'\\d_y'\\d_z'}
\end{equation}
