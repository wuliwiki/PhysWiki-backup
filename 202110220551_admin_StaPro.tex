...
系统关于时间的变化可以看作状态空间中一点划过一条轨迹， 表示为矢量函数 $\bvec x(t)$． 若一个物理量 $Q$ 只和状态空间的位置有关， 即可以表示为已知状态量的函数， 那么它就也是状态量， 若它和状态空间中的运动过程有关， 它就是过程量． 典型的状态量例如系统的能量， 动量， 温度， 体积， 压强等； 典型的过程量如做功， 冲量， 传热等．
