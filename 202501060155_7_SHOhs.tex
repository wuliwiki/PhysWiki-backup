...
\begin{equation}
\frac{\dd}{\dd t}\qty(\frac{\dd}{\dd t}s) = -ks ~, 
\end{equation}
其中$k$是一个任意的正数，$s$是用来表示简谐振子运动状态的参量，$\frac{\dd}{\dd t}$表示“关于时间求导”。对于弹簧振子，参量$s$就用物块的位移$x$，于是$\frac{\dd}{\dd t}x$就是物块的速度，而$\frac{\dd}{\dd t}\qty(\frac{\dd}{\dd t}x)$就是物块的加速度。对于单摆，尽管
