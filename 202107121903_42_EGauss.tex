...
\end{equation}
注意， $\bvec\nabla$ 是作用于 $\bvec r$ 的，为此我们记 $\bvec\nabla=\bvec\nabla_{\bvec r}$ 以明确．并且有 $\div (\bvec A-\bvec C)=\div \bvec A\qquad (\bvec C \text{为常矢量})$，所以
\begin{equation}
\int\div\frac{\rho(\bvec r')}{\abs{\bvec r-\bvec r'}^2}\uvec R\dd[3]{r'}=\int\div\frac{\rho(\bvec r')\abs{\bvec r-\bvec r'}}{\abs{\bvec r-\bvec r'}^3}\dd[3]{r'}
\end{equation}
