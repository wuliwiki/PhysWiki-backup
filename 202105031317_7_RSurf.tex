% 三维空间中的曲面
% keys 曲面|光滑曲面|正则曲面|surface|regular surface|smooth surface|局部坐标系|parametrization
...
换一种说法，映射$f$把道路映射为道路，而我们在\textbf{切空间（欧几里得空间）}\upref{tgSpaE}词条里强调过，道路就是切向量，因此这个道路到道路的映射就被称为$f$的微分，j
