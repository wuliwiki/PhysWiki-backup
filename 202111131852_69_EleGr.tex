...
设区域 $V$ 为以 $(0,0,0)$ 为圆心，$a$ 为半径的球，可以构造 Dirichlet 格林函数：
\begin{equation}
G_D(\bvec r,\bvec r')=\frac{1}{|\bvec r-\bvec r'|}-\frac{a/r'}{|\bvec r-(a^2/r'^2)\bvec r'|}
\end{equation}

容易知道 $\nabla'^2G_D(\bvec r,\bvec r')=-4\pi\delta(\bvec r-\bvec r')$．再考虑该函数在边界上的取值．$\bvec r',(a^2/r'^2)\bvec r'$ 同向，对从原点指向球的任意向量 $\bvec r'$，设它和 $\bvec r'$ 的夹角为 $\theta$，那么
\begin{equation}
