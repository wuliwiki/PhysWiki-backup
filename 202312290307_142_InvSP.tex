...
任选 $V$ 的基底 $(e_1,\cdots,e_n)$，即得 $A$ 对应的算子 $\mathcal{A}$ 具有关系式\autoref{eq_InvSP_2} 。而这意味着由基底 $(e_1,\cdots,e_m)$ 和 $(e_{m+1},\cdots,e_n)$ 张成的空间 $U=\langle e_1,\cdots,e_m\rangle$ 和 $W=\langle e_{m+1},\cdots,e_n\rangle$ 是算子 $\mathcal{A}$ 的不变子空间，而由基底 $(e_1,\cdots,e_n)$ 的线性无关性可知，$V=U\oplus W$。
