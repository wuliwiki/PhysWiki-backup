...
\begin{equation}
\nabla_{\bvec r}\vdot\frac{\bvec r-\bvec r'}{\abs{\bvec r-\bvec r'}^3}=\frac{\oint\frac{\bvec r-\bvec r'}{\abs{\bvec r-\bvec r'}^3} \vdot\dd{\bvec s }}{\Delta V}=\frac{\oint\frac{\cos\langle\bvec r-\bvec r',\bvec s\rangle}{\abs{\bvec r-\bvec r'}^2} \dd{s }}{\Delta V}=\oint\dd{\Omega}=4\pi
\end{equation}
由散度的定义
\begin{equation}
