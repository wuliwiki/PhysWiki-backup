...
我们知道，Gibbs变还体现了系统做非体积功的能力 \upref{Td2Law}。系统发生$1 \Si{mol}$反应\footnote{实际上这么表述是不严谨的，因为$1 \Si{mol}$反应期间，系统的$J$qi}，能做的非最大体积功是，
$$w = - \Delta_r G_M~,$$
...
那么，
$$E = E^* - \frac{RT}{Nq} \ln J ~.$$
可见，电池电动势与物质种类、活度积等有关，史称能斯特Nernst方程。能斯特方程能部分解释电池电压随电量降低而降低的原因。
\end{example}
