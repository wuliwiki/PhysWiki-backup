...
\end{equation}
带入\autoref{eq_TIPT2_1} 得
\begin{equation}
E_m^0\braket{\psi_m^0}{\psi_n^2} + \mel{\psi_m^0}{H^1}{\psi_n^1} = E_n^0\braket{\psi_m^0}{\psi_n^2} + E_n^1\braket{\psi_m^0}{\psi_n^1} + \delta_{m,n}E_n^2~.
\end{equation}
