...
\begin{equation}
\begin{aligned}
v'=\Lambda_{L} v \Lambda_{R} &=\left(1-\frac{i}{2} \theta_{i} \sigma^{i}-\frac{1}{2} \phi_{i} \sigma^{i}\right)\left(V^{0}-V^{i} \sigma^{i}\right)\left(1+\frac{i}{2} \theta_{i} \sigma^{i}-\frac{1}{2} \phi_{i} \sigma^{i}\right) \\
