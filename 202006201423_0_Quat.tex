...
注意， 虽然四元数的加法显然满足交换律， 但由于一般来说向量的叉积不可交换， 因此四元数乘法一般不具有交换律． 只有 $\bvec{a}$ 平行于 $\bvec{b}$ （包括其中之一为 $\bvec 0$）的时候， 才会有 $\bvec{a}\times\bvec{b}= \bvec{0} =\bvec{b}\times\bvec{a}$．
...
\begin{exercise}{}
证明若将单位矢量看作四元数（实部为零）， 证明 $\uvec{a}^2=-1，\uvec{a}^3=-\uvec{a}$
\end{exercise}
