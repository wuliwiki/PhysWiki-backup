...
\subsection{证明}
\subsubsection{两角和}
如图？， 令 $OB = 1$， 那么 $\sin(\alpha+\beta) = BD = AC + BE$， $\cos(\alpha+\beta) = OC = OD + EA$． 而 $AC = OA \sin\alpha$， $OA = \cos\beta$； $BE = AB\cos\alpha$， $AB = \sin\beta$， 即得 $\sin(\alpha+\beta) = \sin\alpha\cos\beta + \cos\alpha\sin\beta$． 注意当 $\alpha$ 或 $\beta$ 取其他任意值时， 重新画图同样可以证明该关系．
