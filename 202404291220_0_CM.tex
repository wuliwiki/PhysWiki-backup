...
\subsection{质心的定义}
\textbf{质心（center of mass）}通俗来讲可以理解为质量的中心， 是系统中位置矢量\upref{Disp}关于质量的加权平均值。 我们先看几个例子。 注意本文主要是讨论质心的\textbf{定义}， 至于为什么要这么定义， 以及质心和物体受力平衡之间的联系则留到以后（\autoref{ex_CM_1} 给出了一个初步的思考）。
