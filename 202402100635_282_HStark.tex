...
\end{equation}
\begin{equation}
\pm30 \Rightarrow \qty(\sqrt{14},\pm 2\sqrt{7},2 \sqrt{5},\pm\sqrt{7},1)~.
\end{equation}
\begin{equation}
\mp 15 \Rightarrow \qty(-\frac{\sqrt{\frac{7}{2}}}{2},\mp\frac{\sqrt{7}}{4},\frac{\sqrt{5}}{4},\pm\frac{\sqrt{7}}{2},1)~.
\end{equation}
\begin{equation}
