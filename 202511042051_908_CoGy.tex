...
\subsection{参考文献}
\begin{enumerate}
\item 希勒，卡尔（Karl Hille）编（2016 年 10 月 13 日）：“哈勃揭示可观测宇宙中的星系数量是先前估计的十倍”（\emph{Hubble Reveals Observable Universe Contains 10 Times More Galaxies Than Previously Thought}）。NASA。取自 2016 年 10 月 17 日。  

\item 赫瑟林顿，诺里斯·S.（Norriss S. Hetherington，2014）。《宇宙学百科全书（Routledge 重刊版）：现代宇宙学的历史、哲学与科学基础》（\emph{Encyclopedia of Cosmology (Routledge Revivals): Historical, Philosophical, and Scientific Foundations of Modern Cosmology}）。Routledge 出版社，第 116 页。ISBN 978-1-317-67766-6。  

\item 吕米内，让-皮埃尔（Jean-Pierre Luminet，2008）。《包裹的宇宙》（\emph{The Wraparound Universe}）。CRC Press，第 170 页。ISBN 978-1-4398-6496-8。  

\item “导论：宇宙学——空间”（\emph{Introduction: Cosmology – space}），《新科学人》（\emph{New Scientist}），2006 年 9 月 4 日。存档于 2015 年 7 月 3 日。  

\item “Cosmology”，《牛津词典》（\emph{Oxford Dictionaries}）。  

\item 奥弗贝，丹尼斯（Dennis Overbye，2019 年 2 月 25 日）：“黑暗力量是否扰乱了宇宙？——轴子？幻影能量？天体物理学家试图修补宇宙的漏洞，并在此过程中重写宇宙史”（\emph{Have Dark Forces Been Messing With the Cosmos? – Axions? Phantom energy? Astrophysicists scramble to patch a hole in the universe, rewriting cosmic history in the process}）。《纽约时报》（\emph{The New York Times}）。取自 2019 年 2 月 26 日。  

\item 斯珀格尔，大卫·N.（David N. Spergel，2014 秋季）：“今日宇宙学”（\emph{Cosmology Today}）。《达达罗斯》（\emph{Daedalus}），143 (4): 125–133。doi:10.1162/DAED\_a\_00312。S2CID 57568214。  

\item 普朗克合作组（Planck Collaboration，2016 年 10 月 1 日）：“普朗克 2015 结果. XIII. 宇宙学参数”（\emph{Planck 2015 results. XIII. Cosmological parameters}）。《天文学与天体物理学》（\emph{Astronomy & Astrophysics}），594 (13)。PDF 第 31 页表 4。arXiv:1502.01589。doi:10.1051/0004-6361/201525830。  

\item 狄德罗（Denis Diderot，2015 年 4 月 1 日）：“人类知识体系的详细解释”（\emph{Detailed Explanation of the System of Human Knowledge}）。《狄德罗与达朗贝尔百科全书——协作翻译计划》（\emph{Encyclopedia of Diderot & d'Alembert – Collaborative Translation Project}）。取自 2015 年 4 月 1 日。  

\item 《马可·奥勒留沉思录》第八卷第 52 节（\emph{The Thoughts of Marcus Aurelius Antoninus viii.52}）。  

\item 爱因斯坦，阿尔伯特（Albert Einstein，1952）：“关于广义相对论的宇宙学考量”（\emph{Cosmological considerations on the general theory of relativity}）。收录于《相对论原理》（\emph{The Principle of Relativity}）。Dover 出版社，第 175–188 页。  

\item 多德尔森，斯科特（Scott Dodelson，2003 年 3 月 30 日）。《现代宇宙学》（\emph{Modern Cosmology}）。Elsevier 出版社。ISBN 978-0-08-051197-9。  

\item 法尔克，丹（Dan Falk，2009 年 3 月 18 日）：“书评：《我们发现宇宙的那一天》（Marcia Bartusiak 著）”（\emph{Review: The Day We Found the Universe}）。《新科学人》（\emph{New Scientist}），201 (2700): 45。doi:10.1016/S0262-4079(09)60809-5。  

\item 哈勃，E. P.（E. P. Hubble，1926 年 12 月 1 日）：“河外星云”（\emph{Extragalactic nebulae}）。《天体物理学杂志》（\emph{The Astrophysical Journal}），64: 321。  

\item 马丁，G.（G. Martin，1883）：“G. DELSAULX——论平面波衍射的一个性质”（\emph{Sur une propriété de la diffraction des ondes planes}），《布鲁塞尔科学学会年报》（\emph{Annales de la Société scientifique de Bruxelles}，1882）。《理论与应用物理学杂志》（\emph{Journal de Physique Théorique et Appliquée}，法文），2 (1): 175。doi:10.1051/jphystap:018830020017501。  

\item 哈勃，埃德温（Edwin Hubble，1929 年 3 月 15 日）：“河外星云的距离与径向速度关系”（\emph{A Relation Between Distance and Radial Velocity Among Extra-Galactic Nebulae}）。《美国国家科学院院刊》（\emph{PNAS}），15 (3): 168–173。  

\item 彭齐亚斯，A. A.；威尔逊，R. W.（1965 年 7 月 1 日）：“在 4080 Mc/s 下的额外天线温度测量”（\emph{A Measurement of Excess Antenna Temperature at 4080 Mc/s}）。《天体物理学杂志》（\emph{The Astrophysical Journal}），142: 419–421。  
