...
\issueDraft
\end{issues}
\footnote{本文内容与图片了参考自刘智恩的《材料科学基础》
% （\autoref{MetInt_fig12} ）
以及Calister的 Material Science and Engineering An Introduction．
% （\autoref{MetInt_fig3} \autoref{MetInt_fig4} \autoref{MetInt_fig6} \autoref{MetInt_fig7} \autoref{MetInt_fig9} \autoref{MetInt_fig11} \autoref{MetInt_fig16} ）．
其余部分文本、图片来自网络．}
