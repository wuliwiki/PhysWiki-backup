...
反设这不是单射，即至少存在两个包含$N$的子群$A,B$使得$f(A)=f(B)$。对于任意$a\in A$，存在$b\in B$使得$f(a)=f(b)$，则$f(ab^{-1})=e'$，所以$ab^{-1}\in N\subseteq B$，则$a\in B, A\subseteq B$。反之，对于任意$b'\in B$，存在$a'\in A$使得$f(a'b'^{-1})=e'$，则$a'b'^{-1}\subseteq A$，则$$
\end{enumerate}
