...
其中允许能级$E_n$有著名的玻尔公式：
\begin{equation}
E_{n} =-\left[\frac {m_e}{2\hbar^{2}} \left(\frac {e^ {2}}{4\pi _0}\right)^ {2}\right]  \frac {1}{n^ {2}}  =  \frac {E_ {1}}{n^ {2}}, \ \  n=1,2,3, \cdots 
\end{equation}
...
试着用精细结构常数表达出玻尔能量公式：
\begin{equation}
E_n=-\left[\frac {m_e}{2\hbar^{2}} \left(\frac {e^ {2}}{4\pi e_0}\right)^ {2}\right]  \frac {1}{n^2}=\frac{mc^2}{2n^2}\left(\frac {e^{2}}{4\pi e_0}\right)^2
\end{equation}
...
\begin{align}
-\frac{e^2}{4\pi\epsilon_0}\left\langle \frac{1}{r}\right\rangle&=-\left[\frac {m_e}{\hbar^{2}} \left(\frac {e^ {2}}{4\pi e0}\right)^ {2}\right]  \frac {1}{n^ {2}}\\
