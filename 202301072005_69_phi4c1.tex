...
\begin{gathered}
\lim _{t \rightarrow \pm \infty}
\left\langle\alpha\left|\phi_0(x)\right| \beta\right\rangle=
\lim _{t \rightarrow \pm \infty} \sqrt{Z_\phi^{\overline{\mathrm{MS}}}}\left\langle\alpha\left|\phi^{\overline{\mathrm{MS}}}(x)\right| \beta\right\rangle
\end{gathered}
\end{equation}
