...
\begin{equation}
\begin{aligned}
F_1(q^2)&=\frac{e^2}{(4\pi)^{d/2}}\int\dd x\dd y\dd z\delta(x+y+z-1)\left[\frac{\Gamma(2-d/2)}{\Delta^{2-d/2}}\frac{(2-\epsilon)^2}{2}\right.\\
&\quad\quad\left.+\frac{\Gamma(3-d/2)}{\Delta^{3-d/2}}
\right]
\end{aligned}
\end{equation}
