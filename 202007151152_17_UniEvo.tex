...
\begin{table}[ht]
\centering
\caption{宇宙大事记（问号表示理论尚未给出合理解释）\footnote{翻译自Daniel Baumann，TASI Lectures on Ination, arXiv:0907.5424，1.2 节，Table1}}\label{UniEvo_tab1}
\begin{tabular}{|r|r|r|}
\hline
 & 时间 & 能量 \\
\hline
...
\caption{宇宙尺度及成分表\footnote{引自 Daniel Baumann，TASI Lectures on Ination, arXiv:0907.5424，1.2 节，Figure2}} \label{UniEvo_fig1}
\end{figure}
