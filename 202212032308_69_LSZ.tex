...
\begin{align}
\notag\tilde \phi(p^\mu)\ket{\Omega}=&|\Omega\rangle \langle \Omega|\tilde \phi(p^\mu)\ket{\Omega} + \sum_{\lambda}\int \frac{\dd[3] \bvec p}{(2\pi)^3}\frac{1}{2E_{\bvec p}(\lambda)}|\lambda_{\bvec p}\rangle \langle \lambda_{\bvec p}|\tilde \phi(p^\mu)\ket{\Omega}\\ \notag\overset{p^2\approx m^2}{=}&(2\pi)^4 \delta^4(p)\ket{\Omega}\bra{\Omega}\phi(0)\ket{\Omega}
+
\int \frac{\dd[3]{\bvec k}}{(2\pi)^3}\frac{1}{2 E_{\bvec k}} \ket{\bvec k}\bra{\bvec k}\tilde \phi(p^\mu)\ket{\Omega}\\
\label{eq_47}=&\eta(2\pi)^4\delta^4(p)\ket{\Omega}+2\pi \sqrt{Z} \delta(p^2-m^2)\theta(p^0) \ket{\bvec p}
\end{align}
...
\begin{align}
\notag\int \dd[4]{x}F(x)g(t-T)e^{ilx}&=\int \dd t \dd[3]{x} e^{il^0t - i\bvec l\cdot \bvec x}\int \frac{\dd[3]{\bvec p}}{(2\pi)^3}f(\bvec p)e^{-i\omega_{\bvec p}t+i\bvec p\cdot \bvec x}\int \frac{\dd \nu}{2\pi}\tilde g(\nu) e^{-i\nu(t-T)}\\
\notag&=\int \frac{\dd[3]\bvec p}{(2\pi)^3}\frac{\dd \nu}{2\pi} f(\bvec p)\tilde g(\nu) (2\pi)^3 \delta(\bvec p-\bvec l) 2\pi \delta(l^0-\omega_{\bvec p}-\nu)e^{i\nu T}\\
\label{eq_48}&=f(\bvec l) \tilde g(l^0-\omega_{\bvec l})e^{i(l^0-\omega_{\bvec l})T}
\end{align}
