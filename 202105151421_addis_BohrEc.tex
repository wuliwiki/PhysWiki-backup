...
下面来验证\autoref{BohrEc_eq5}， \autoref{BohrEc_eq2} 符合量子化条件\autoref{BohrEc_eq3}． 把\autoref{CenFrc_eq10}~\upref{CenFrc} 和\autoref{BohrEc_eq4}  代入\autoref{BohrEc_eq3} 得
