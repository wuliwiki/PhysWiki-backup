...
\begin{equation}
f_\alpha(k) = \frac{1}{2\pi}\int_{-l}^{l} \E^{\I kx}\dd{x} = \frac{\sin(l k)}{\pi k} = \frac{l}{\pi} \sinc(l \Delta k)
\end{equation}
使用\autoref{sinc_eq2}~\upref{sinc}容易证明\autoref{Delta_def1} 中的
\begin{equation}
\lim_{l\to+\infty} I_l(k) = \delta(k)
\end{equation}
证毕．
\end{example}
