...
\entry{Bohr-Sommerfeld 氢原子模型}{BohrEc}
...
\entry{C++ 中矩阵类的实现方式}{CppMat}
\entry{SLISC 库简介}{SLISC}
\entry{SLISC 的矢量和矩阵}{SliMat}
\entry{SLISC 容器的基本运算}{SliAri}
% \entry{SLISC 的稀疏容器}{}
\entry{SLISC 容器的切割}{SliCut}
