...
\item 
由前文讨论可知，$f(H)$必然是$G_2$的子群，因此$f^{-1}f(H)$必然是包含$N$的子群。所以$f$确实建立了包含$N$的$G_1$\textbf{子群集合}与$f(H)$构成的\textbf{子群集合}之间的映射。在该集合意义上，$f$是满射（$f^{-1}f(H)\supseteq H$），所以接下来我们只需要证明这是单射即可。
\end{enumerate}
