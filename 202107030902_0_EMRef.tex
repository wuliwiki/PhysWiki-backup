...
电流在导线周围产生的磁场（见\autoref{AmpLaw_ex1}~\upref{AmpLaw}）使粒子受到垂直于导线洛伦兹力\upref{Lorenz} $F = qvB$． 而在 $S'$ 系中， 导线同样产生相同的磁场，而粒子的速度却是 $v - u$， 所以洛伦兹力为 $F = q(v-u)B$． 这说明在不同参考系中粒子受的电磁力是不同的．
