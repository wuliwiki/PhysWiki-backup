...
\begin{itemize}
\item 要编辑百科词条可从网站首页的链接进入（必须处于登录状态）． 如果不想注册， 可以使用测试网址 \href{http://wuli.wiki/editor-test}{wuli.wiki/editor-test}， 测试账号为 \verb|test1| 到 \verb|test100|， 密码 6 个 8． 注意测试账号的文件会被定期删除， 可以自行使用下载按钮备份
