...
\subsection{标准}
\begin{itemize}
\item 参考\href{https://gcc.gnu.org/onlinedocs/gcc/Standards.html}{这里}．
\item 目前（2022-11-23）， \verb|g++| 的默认标准是 \verb|-std=gnu++17| 这是 \verb|-std=c++17| 加上 GNU 的一些拓展．
\item 其他的选项如 \verb|-ansi, -std=c++98 或 -std=c++03|， \verb|123|
\item 如果要严格符合标准， 用 \verb|-pedantic| 给出警告，或者 \verb|-pedantic-errors| 给出错误．
\end{itemize}
