...
设任意向量$\bvec y=b^j\bvec e_j$，左根$\bvec x=a^i\bvec e_i$满足$f(a^i\bvec e_i,b^j\bvec e_j)=b^ja^if(\bvec e_i,\bvec e_j)=0$，则必有$a^if(\bvec e_i,\bvec  e_j)=\bvec x^T A=(A^Tx)^T=0$。
