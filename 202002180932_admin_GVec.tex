...
从概念上来说几何矢量本身可以单独存在而不需要借助任何坐标系或坐标来描述． 例如在房梁上悬挂一支箭， 它有长度， 有方向， 就是一个矢量， 不需要任何参照物或者坐标系． 下面要介绍的许多概念（加法， 数乘， 线性组合， 线性无关等）都不需要任何坐标的概念， 请读者注意区分我们什么时候在讨论矢量本身什么时候在讨论它的坐标． 为什么要做这样的区分呢？ 因为以后我们在学习矢量空间时会发现广义的矢量几乎可以是任何东西（多项式， 函数等等）， 它们同样也可以具有坐标的概念， 和我们下面要讨论的矢量有许多相似的性质．
