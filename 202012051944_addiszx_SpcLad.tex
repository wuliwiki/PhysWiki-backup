...
目前最强的材料碳纳米管有 $p = 6.2\times 10^{10} \Si{Pa}$， 密度使用 $\rho = 1.34\times 10^{3} \Si{kg/m^3}$． 同步轨道半径为 $4.2164\times 10^7 \Si{m}$． 地球质量 $M = 5.972 \times 10^{24} \Si{kg}$．

代入上式得 $F = 2.85 F_0$ ！！！！ 竟然有这么好的事情． 碳纳米管的大规模生产完全可以开启新的航天时代．
