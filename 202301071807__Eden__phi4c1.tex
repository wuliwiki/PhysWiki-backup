...
(d\rightarrow 4)&= -i\lambda \frac{m^2}{2(4\pi)^2} \frac{1}{\epsilon(\epsilon-1)} \left(\frac{4\pi\mu^{2}}{m^2}\right)^{\epsilon}\Gamma(1+\epsilon),\quad \epsilon=(4-d)/2\\
&=\frac{i\lambda m^2}{32\pi^2}\left(\frac{1}{\epsilon}+1-\gamma+\log\left(\frac{4\pi\mu^2}{m^2}\right) \right)
\end{aligned}
\end{equation}
