...
\begin{definition}{复杂指标}
给定指标集合$\Gamma$，使得函数集合$\{x^i\}_{i\in\Gamma}$构成了流形上的坐标集合．

设$I$是$\Gamma$的有序子集，即其元素是$\Gamma$的元素，不重复，但有顺序之分．如果$I$显式表示为$I=(i_1, i_2, \cdots)_{i_k\in\Gamma}$
\end{definition}
