...
对数符号的写法与已有的所有写法都不太像，需要习惯一下。在高中阶段，为了使运算能够对$c\in\mathbb{R}$成立，要求$a\in\mathbb (0,1)\cup(1,+\infty)$。\footnote{这里的要求和指数函数的要求一样。如果打开限制，其实高中阶段中的某些特殊值也是成立的，但在高中阶段不考虑。}
