...
\begin{theorem}{}
设 $V_1,V_2,V_3$ 是域 $\mathbb F$ 上有限维矢量空间．则有同构映射
\begin{equation}
\psi_1:(V_1\otimes V_2)\otimes V_3\rightarrow V_1\otimes(V_2\otimes V_3) \quad  \psi_2:V_1\otimes V_2\rightarrow V_2\otimes V_1
\end{equation}
使得
\end{theorem}