...
在稳定、低速、弱场近似下，$T_{00}=\rho$，而$h_{00}=-2\Phi$\footnote{见\textbf{引力的弱场近似}\upref{WeakG}最后的讨论．}．而度量张量为$g_{\mu\nu}=\eta_{\mu\nu}+h_{\mu\nu}$．
