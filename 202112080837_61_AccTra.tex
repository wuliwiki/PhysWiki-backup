...
圆盘绕大圆轨道一周所用的时间为$\frac{2 \pi}{\omega}$ ，$A$ 点走过的路径长为$2 \pi (R+r)$ ，所以圆盘转动的线速度为 $\frac{2 \pi (R+r)}{\frac{2 \pi}{\omega}}$ ，所以圆盘边缘上任意点对圆心 $A$ 点的加速度 $a$ 为
% \begin{equation}
% \bvec a_{S'} = \frac{(\frac{2 \pi (R+r)}{\frac{2 \pi}{\omega}})^2}{r} = \frac{(\omega R)^2}{r}
% \end{equation}
