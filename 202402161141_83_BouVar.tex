...
\begin{align}
\left|f(x)-f(a)\right|+\left|f(b)-f(x)\right| &\leq V(f;a,b) \
\Rightarrow\ \left|f(x)-f(a)\right| &\leq V(f;a,b) \
\left|f(x)\right|=\left|f(a)+f(x)-f(a)\right| &\leq\left|f(a)\right|+\left|f(x)-f(a)\right| \
&\leq\left|f(a)\right|+\left|V(f;a,b)\right| < \infty \
\Rightarrow\ f\ \ \text{在}\ [a,b]\ \text{上有界。}
\end{align}
\end{enumerate}
\end{example}
\begin{theorem}{}
