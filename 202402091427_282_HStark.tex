...
\end{equation}
\begin{equation}
\pm\frac{3}{Z} \Rightarrow \frac{1}{\sqrt{2}}(\ket{2,0,0}\pm\ket{2,1,0})~.
\end{equation}
\begin{equation}
\ket{2,1,\pm 1}~.
\end{equation}
...
\end{equation}
\begin{equation}
\pm\frac{9}{Z} \Rightarrow \frac{1}{\sqrt{3}}\ket{3,0,0} \pm \frac{1}{\sqrt{2}}\ket{3,1,0} + \frac{1}{\sqrt{6}}\ket{3,2,0}~.
\end{equation}
\begin{equation}
...
\end{itemize}
\begin{equation}
\ket{3,1,\pm1},\ket{3,2,\pm1},\ket{3,3,\pm1} \Rightarrow
-\frac{3\sqrt{3}}{Z}\pmat{0 & 1\\1 & 0}~.
\end{equation}
\begin{equation}
\pm\frac{3\sqrt{3}}{Z} \Rightarrow \frac{1}{\sqrt 2}(\ket{3,0,1}\pm\ket{3,1,1})~.
\end{equation}
