...
MathJax 本身不支持 physics 宏包， 我们进行了一定的改进． Physics 宏包的文档见\href{http://mirrors.ibiblio.org/CTAN/macros/latex/contrib/physics/physics.pdf}{这里}， 目前仅支持 Physics 宏包的以下命令．
