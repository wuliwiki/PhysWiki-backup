...
现在我们来看$\psi$在$U(\Lambda)$下是如何变幻的
\begin{equation}
U \psi(x) U^{-1} = U \int \frac{d^3p}{(2\pi)^3} \frac{1}{\sqrt{2 E_{\mathbf p}}} \sum_s (a_{\mathbf p}^s u^s(p) e^{-ipx}+b_{\mathbf p}^{s\dagger}v^s(p)e^{ipx})
\end{equation}
