...
\bra{\delta_{\bvec r_1}}\braket{C_{l_2,m_2}(k_2)}{\Psi(\bvec r_1, \bvec r_2)} = \frac{1}{r_1} \sum_{l_1, m_1} \psi_{l_1,m_1}(r_1) \cdot Y_{l_1, m_1}(\uvec r_1)
\end{equation}
\begin{equation}
...
\begin{equation}
\bra{\delta_{\bvec r_1}}\braket*{\psi_{\bvec k_2}^{(-)}}{\Psi} = \frac{1}{k_2}\sum_{l_2,m_2} \I^{-l_2} \E^{\I\sigma_{l_2}} \bra{\delta_{\bvec r_1}}\braket{C_{l_2,m_2}(k_2)}{\Psi(\bvec r_1, \bvec r_2)} \cdot Y_{l_2,m_2}(\uvec k_2)
\end{equation}
所以
