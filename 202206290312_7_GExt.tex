...
注意，保$\mathbb{F}$域自同\textbf{态}必须把元素映射到它关于$\mathbb{F}$的共轭（\autoref{NomEx_def1}~\upref{NomEx}）上，故同构也是．

$\mathbb{K}/\mathbb{F}$正规，故任取$\overline{\mathbb{F}}$的保$\mathbb{K}$自同构$\sigma$，都有$\sigma\mathbb{K}=\mathbb{K}$．于是$\opn{Gal}(\mathbb{K}/\mathbb{F})$的元素正是$\overline{\mathbb{F}}$的全体保$\mathbb{F}$自同构．
