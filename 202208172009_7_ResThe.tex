...
设$\Gamma_1$为实数轴上从$0$到$\rho$的路径，$\Gamma_2$为从$\rho$到$\I \rho$的\textbf{四分之一}圆弧路径，$\Gamma_3$为虚数轴上从$\I\rho$到$0$的路径．由于$f(z)$在整个复平面上都没有极点，因此据\autoref{ResThe_the3} ，
\begin{equation}
\int^\infty_{-\infty} f(x) \dd x=\sum_{i=1, 2, 3}\int_{\Gamma_i} f(z) \dd z
\end{equation}
