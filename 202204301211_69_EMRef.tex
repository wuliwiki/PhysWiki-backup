...
\subsubsection{具体计算}
在 $S$ 中，根据高斯定理\autoref{EGauss_ex1}~\upref{EGauss}，一个无限长直导线会产生径向方向的电场，其大小与距离直导线的距离 $r_0$ 成反比，即 $E_z=\lambda/(2\pi\epsilon_0r_0)$．由于 $S$ 参考系中直导线上的电荷静止，不会产生磁场，所以 $B_y=0$．
\begin{equation}
E_{z} = \frac{1}{2\pi\epsilon_0 r_0} \lambda
\qquad
B_{y} = 0
\end{equation}
在 $S'$ 中， 由尺缩效应，线电荷密度变为 $\lambda' = \gamma_u \lambda$， 电流为 $I' = \gamma_u \lambda u$， 电磁场分别为
\begin{equation}
