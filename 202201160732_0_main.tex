...
\entry{洛必达法则}{LHopiR}
\entry{泰勒公式}{Tayl}
%\entry{有限增量定理}{FinInc}  \entry{幂级数与解析函数} \entry{隐函数定理} \entry{微分同胚} \entry{莫尔斯引理} \entry{驻点与极值}{StExt} \entry{条件极值} \entry{拐点}{InflPt} \entry{凸函数}{ConvFu}
