...
\begin{equation}
\begin{aligned}
&S_{\Delta ABC}=\sqrt{s_{\Delta ABC}(s_{\Delta ABC}-a)(s_{\Delta ABC}-b)(s_{\Delta ABC}-c)}=
\\
&S_{\Delta BCD}=\sqrt{s_{\Delta BCD}(s_{\Delta BCD}-a)(s_{\Delta BCD}-b)(s_{\Delta BCD}-c)}
\end{aligned}
\end{equation}
