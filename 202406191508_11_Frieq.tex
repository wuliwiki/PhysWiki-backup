...
\begin{equation}\dot{\rho}+3\frac{\dot{a}}{a}\rho=0\quad\Longrightarrow\quad\frac1{a^3}\frac d{dt}\left(\rho a^3\right)=0\quad\Longrightarrow\quad\frac d{dt}\left(\rho a^3\right)=0 ~,\end{equation}
显然，此时$\rho\propto 1/a^3$，这是只考虑三维体积膨胀效应的结果。

所谓辐射主导则指宇宙的成分集合可视作光子，此时$p=\rho/3$，代入\autoref{eq_Frieq_1} 后可解得：
\begin{equation}\dot{\rho}+\frac{\dot{a}}{a}\rho=0\quad\Longrightarrow\quad\frac1{a^3}\frac d{dt}\left(\rho a^3\right)=0\quad\Longrightarrow\quad\frac d{dt}\left(\rho a^3\right)=0 ~,\end{equation}
