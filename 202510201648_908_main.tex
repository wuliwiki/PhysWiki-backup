...
\entry{利奥·西拉德（综述）}{Szilar}
\entry{乔治·伽莫夫（George Gamow）（综述）}{QZjmf}
\entry{斯蒂芬·霍金（综述）}{HJ}
\entry{赫尔曼·外尔（综述）}{WR}
\entry{艾萨克·牛顿（综述）}{Newton}
...
\entry{弗雷德里克·塞茨（综述）}{Seitz}
\entry{詹姆斯·查德威克（James Chadwick）（综述）}{ZMcdw}
\entry{约翰内斯·开普勒（综述）}{KPL1}
\entry{帕斯夸尔·约尔丹（综述）}{YRD}
\entry{安德烈-马里·安培（综述）}{AP}
\entry{让·勒朗·达朗贝尔（综述）}{BR}
\entry{亨德里克·卡西米尔（综述）}{KXMR}
\entry{路德维希·玻尔兹曼（综述）}{BRZM}
\entry{克里斯蒂安·惠更斯（综述）}{HGS}
\entry{古斯塔夫·基尔霍夫（综述）}{JRHF}
\entry{加布里埃尔·李普曼（综述）}{LPM}
