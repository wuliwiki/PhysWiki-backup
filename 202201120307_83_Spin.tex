...
接下来由本征旋量可得：
\begin{equation}
c_+^{(y)}=\left(\chi_+^{(y)}\right)\chi=\frac{1}{3}\frac{1}{\sqrt{2}}\pmat{1\quad -\I}\pmat{1-2\I\\2}=\frac{1-4\I}{3\sqrt{2}}\Rightarrow |c_+^{(y)}|^2=\frac{17}{18}
\end{equation}
因此可能值$+\hbar/2$的概率为$17/18$．接下来类似地我们继续计算可能值$-\hbar/2$的概率为$1/18$：
\begin{equation}
c_-^{(y)}=\left(\chi_-^{(y)}\right)\chi=\frac{1}{3}\frac{1}{\sqrt{2}}\pmat{1\quad \I}\pmat{1-2\I\\2}=\frac{1}{3\sqrt{2}}\Rightarrow |c_+^{(y)}|^2=\frac{1}{18}
\end{equation}
$S_x$的期待值为：
\begin{equation}
\langle S_x \rangle =\frac{17}{18}\frac{\hbar}{2}+\frac{1}{18}\left(-\frac{\hbar}{2}\right)=\frac{4\hbar}{9}
\end{equation}
\end{example}
