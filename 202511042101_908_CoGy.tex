...
\item 卡尔·本杰明·博耶（Carl Benjamin Boyer，1968）。《数学史》（\emph{A History of Mathematics}）。Wiley 出版社。ISBN 0471543977，第 54 页。  

\item 亚里士多德（Aristotle，1914）。福斯特（E. S. Forster）与多布森（J. F. Dobson）编，《论世界》（\emph{De Mundo}）。牛津大学出版社，第 393a 页。  

\item “他用以创造灵魂的成分及其制作方式如下：在那不可分、永远不变的存在与可分、在物质领域生成的存在之间，他混合出第三种中间形式的存在，源自前两者。同样地，他在‘同一’（the Same）与‘差异’（the Different）之间，也制成中介的混合体。然后，他将这三种混合物混合为一，迫使难以混合的‘差异’服从于‘同一’。当他将‘同一’与‘差异’混合入‘存在’，并由此三者构成单一的混合体之后，他又将整体重新分割成任务所需的部分，每一部分仍保持‘同一’、‘差异’与‘存在’的混合性质。”——柏拉图《蒂迈欧篇》（\emph{Timaeus}）35a–b，唐纳德·J·泽尔（Donald J. Zeyl）译。  

\item 柏拉图，《蒂迈欧篇》（\emph{Timaeus}），36c。  
\item 柏拉图，《蒂迈欧篇》（\emph{Timaeus}），36d。  
\item 柏拉图，《蒂迈欧篇》（\emph{Timaeus}），39d。  

\item 雅维茨，伊多（Ido Yavetz，1998 年 2 月）：“论欧多克索斯的同心球体”（\emph{On the Homocentric Spheres of Eudoxus}）。《精确科学史档案》（\emph{Archive for History of Exact Sciences}），52 (3): 222–225。doi:10.1007/s004070050017。  

\item 克劳，迈克尔（Michael Crowe，2001）。《从古代到哥白尼革命的世界理论》（\emph{Theories of the World from Antiquity to the Copernican Revolution}）。纽约州迈诺拉：Dover 出版社，第 23 页。ISBN 0-486-41444-2。  

\item 伊斯特林，H.（H. Easterling，1961）。《论〈论天〉中的同心球体》（\emph{Homocentric Spheres in De Caelo}）。《弗罗涅西斯》（\emph{Phronesis}），6 (2): 138–141。doi:10.1163/156852861x00161。  

\item 劳埃德，G. E. R.（G. E. R. Lloyd，1968）。《柏拉图的批评者：亚里士多德思想的成长与结构》（\emph{The Critic of Plato. Aristotle: The Growth and Structure of His Thought}）。剑桥大学出版社。ISBN 978-0-521-09456-6。  

\item 赫希菲尔德，艾伦·W.（Alan W. Hirshfeld，2004）。《阿里斯塔克斯的三角形》（\emph{The Triangles of Aristarchus}）。《数学教师》（\emph{The Mathematics Teacher}），97 (4): 228–231。doi:10.5951/MT.97.4.0228。  
