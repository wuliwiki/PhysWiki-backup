...
\subsection{推导}
我们先使用\autoref{CurCor_eq8}~\upref{CurCor} 重新推导球坐标系中的三个单位矢量． 球坐标系中， 位置矢量可以表示为
\begin{equation}
...
归一化得三个单位矢量为（\autoref{SphCar_eq3}~\upref{SphCar}）
...
\addTODO{以上推导应该移动到 “正交曲线坐标系” 中作为例子}

对比\autoref{SphNab_eq9} 与\autoref{SphNab_eq10}， 有
