...
\item 1: sys_write - write to a file descriptor
\item 2: sys_open - open a file
\item 3: sys_close - close a file descriptor
\item 60: sys_exit - exit the process
\item 231: sys_exit_group - exit all threads in a process
\end{itemize}
