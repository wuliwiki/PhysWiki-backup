...
\begin{equation}
\bra{\delta_{\bvec r_1}}\braket*{\psi_{\bvec k_2}^{(-)}}{\Psi} = \frac{1}{k_2}\sum_{l_2,m_2} \I^{-l_2} \E^{\I\sigma_{l_2}} \bra{\delta_{\bvec r_1}}\braket{C_{l_2,m_2}(k_2)}{\Psi} \cdot Y_{l_2,m_2}(\uvec k_2)
\end{equation}
所以
\begin{equation}\label{HeAnal_eq11}
\begin{aligned}
P(\bvec k_2) &= \int_0^{r_{1,max}} \abs{\bra{\delta_{\bvec r_1}}\braket*{\psi_{\bvec k_2}^{(-)}}{\Psi}}^2 \dd[3]{r_1}\\
&= \sum_{l_1,m_1} \int_0^{r_{1,max}} \abs{\sum_{l_2,m_2} \frac{\I^{-l_2}}{k_2} \E^{-\I \sigma_{l_2} Y_{l_2,m_2}(\uvec k_2)}\psi_{l_1,m_1}(r_1)}^2 \dd{r_1}
\end{aligned}
\end{equation}
．
