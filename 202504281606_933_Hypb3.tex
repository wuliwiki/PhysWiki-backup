...
已知切线斜率为$k_1=\displaystyle\frac{b^2}{a^2}\frac{x_0}{y_0}$，而渐近线斜率为$k_2=\displaystyle\frac{b^2}{a^2}$，显然有$k_1>0,k_2>0$，为了比较二者的大小，将二者作比得到
\begin{equation}
\begin{split}
\frac{k_1}{k_2}&=\displaystyle\frac{\frac{b^2}{a^2}\frac{x_0}{y_0}}{\displaystyle\frac{b^2}{a^2}}\\
&=
\end{split}~.
\end{equation}
