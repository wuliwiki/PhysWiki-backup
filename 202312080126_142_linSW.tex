...
由于这个映射是双线性的，根据张量积的万有性质（TODO）可以得到一个唯一
\begin{equation}
\begin{aligned}
...
\textbf{证明：}
如果 $f \otimes_1 g = \iota(f \otimes_2 g) = 0$，这意味着对任意 $v \in V, v' \in V'$，$f(v) \otimes_1 g(v') = (f \otimes_1 g)(v \otimes v') = 0$，即 $f(v)$ 或者 $g(v')$ 等于 $0$，此时
