...
\subsection{物理意义}
$z$ 方向的电场不会改变电子 $z$ 方向的角动量， 所以 $L_z$ 守恒\upref{QMcons}， $\Delta m$ 为 0． 另外， 虽然我们的计算中并未使用光子的概念（详见量子电动力学）， 但 $\Delta l = 0, \pm 1$ 暗示了\textbf{光子的自旋自旋角动量\upref{Spin}}为 $l=1$， 而事实的确如此．
