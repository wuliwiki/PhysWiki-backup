...
由外测度的单调性，可得
\begin{equation}
\opn{m^*}(\bigcup_{i=0}^k A_i)\leq\opn{m^*}(\bigcup_{i=0}^\infty A_i)=\opn{m^*}A
\end{equation}
...
由于各$\bigcup_{i=1}^k E_i$都是可测的，有
\begin{equation}
\opn{m^*}(\bigcup_{i=0}^k A_i)=\sum_{i=0}^k\opn{m^*}A_i
\end{equation}

由外测度的次可加性，得
\begin{equation}
\sum_{i=0}^\infty\opn{m^*}A_i\geq \opn{m^*}\bigcup_{i=0}^\infty A_i
\end{equation}
