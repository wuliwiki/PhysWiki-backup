...
\end{theorem}
\textbf{proof.}\footnote{参考邓少强祝福，朱富海《抽象代数》}

设$G$是无限循环群，建立$\mathbb Z\rightarrow G$的同态映射，使得对于任意$n\in \mathbb Z$，都有$f(n)=a^n$。根据群同态基本定理\autoref{exe_Group2_1}~\upref{Group2}，我们有$\mathbb Z/\opn{ker}f\cong G$