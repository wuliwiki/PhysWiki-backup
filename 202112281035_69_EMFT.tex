...
&=\gamma[\delta_{ij}+(\gamma-1) v_iv_j/v^2]E_j+\frac{\gamma v_j}{c}\frac{\gamma v_i}{c} \gamma\beta_i (-E_j)+\gamma\beta_j [\delta_{ik}\\
&\ \ \ +(\gamma-1)v_i v_k/v^2]\epsilon_{jkl}B_l\\
&=\gamma E_i+(\gamma^2-\gamma)\frac{v_iv_jE_j}{v^2}-\gamma^2\beta_i\beta_jE_j
\end{aligned} 
\end{equation}
