...
根据这个定义可以得到一个简单的性质：
作平面上与准线平行的直线$L$，若$L$与准线在jiao

过抛物线对称轴上一点，作一条与准线平行的直线 $L$，若这一点处于开口方向且位于焦点以外，那么对于抛物线上的任意一点 $P$，其到焦点的距离 $r$ 与到直线 $L$ 的距离之和是一个定值。
...
如 \autoref{fig_Para3_1} 所示，作一条垂直于准线与 $L$ 的线段 $AB$，并使其通过点 $P$。由于 $PA$ 表示点 $P$ 到准线的距离，而抛物线的定义说明 $PA = r$，因此 $r + PB = AB$。线段 $AB$ 是固定的，所以 $r + PB$ 不随点 $P$ 的变化而改变，恒为定值。
