...
设$f(x)=\sum_{i=0}^n c_ix^i$，则$\opn{deg}f=n$，则$n$也是$f$的根的数目．设这些根为$a_1, a_2, a_3, \cdots, a_n$，其中$a_1=a$．

向量组$\{1, a_1, a_2, a_3, \cdots, a_n\}$张成域$\mathbb{F}$上的线性空间$\mathbb{F}(a)$．由\textbf{韦达定理}\autoref{VietaF_eq1}~\upref{VietaF}，这个向量组线性相关，因此基向量组应该是它的一个真子集．
