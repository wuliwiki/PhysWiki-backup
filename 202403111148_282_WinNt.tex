...
\item 高级条件。这些条件可以在搜索结果中从下拉选项中用鼠标设置，但其等效于直接在搜索框输入相应的命令，如 \verb`搜索词 size:>1GB` 在搜索结果中选择空文件。 如果有多个选项，用空格隔开：\verb`搜索词 size:<30KB datemodified:this week`。要指定拓展名，如 \verb`kind:png`。 \verb`datemodified:` 的其他用法如 \verb`today`，yesterday,thisweek,lastweek,datemodified:<03/10/2023,03/01/2023..03/10/2023`
\end{itemize}
