...
\caption{有限长直导体棒中垂线上的电势} \label{QEng_fig2}
\end{figure}
...
\begin{equation}
\begin{aligned}
V &=\frac{\lambda }{4 \pi \epsilon_{0}}\int_{0}^{L} \frac{\mathrm{d} x}{\sqrt{x^{2}+b^{2}}}\\
&=-\frac{\lambda }{4 \pi \epsilon_{0}}\ln_{}{(x+\sqrt{(x^2+b^2)}}
\end{aligned}
\end{equation}
