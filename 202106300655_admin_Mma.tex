...
\subsection{变量}
\begin{itemize}
\item \verb|Head[...]| 可用于判断一个对象的类型， 如 \verb|Head[1]| 是 \verb|Integer|， \verb|Head[Pi]| 是 \verb|Symbol|， \verb|Head[1/5]| 是 \verb|Rational|， \verb|Head[0.2]| 是 \verb|Real|， \verb|Head[I]| 是 \verb|Complex\verb| （Real 和 Complex 用于浮点运算，有误差）， \verb|Sin[1]|  是 \verb|Sin|， \verb|Head[2 Pi/3]| 是 \verb|Times|．
