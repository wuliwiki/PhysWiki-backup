...
&=-\frac{Va^2}{4\pi}(\int_{0}^{\pi/2}\dd \theta' \int_{0}^{2\pi}\sin\theta' \dd \phi'(\frac{\partial }{\partial n'}\frac{1}{|\bvec r-\bvec r'|})+\int_{\pi/2}^{\pi}\dd \theta' \int_{0}^{2\pi}\sin\theta' \dd \phi'(\nabla'\frac{1}{|\bvec r-\bvec r'|}))
\end{aligned}
\end{equation}
