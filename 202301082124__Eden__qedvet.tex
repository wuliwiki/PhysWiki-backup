...
\end{aligned}
\end{equation}
其中 $\Delta =(1-z)^2m^2+zm_\gamma^2 - xyq^2$。$m_\gamma$ 为引入的光子质量项（存在红外发散）。因此由重整化条件得
\begin{equation}
\begin{aligned}
\delta_1 = Z_1-1 &= -\frac{e^2}{(4\pi)^{d/2}}\int\dd x\dd y\dd z\delta(x+y+z-1)\left[\frac{\Gamma(2-d/2)}{\Delta_0^{2-d/2}}\frac{(2-\epsilon)^2}{2}\right.\\
