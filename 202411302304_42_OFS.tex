...
\end{aligned}~
\end{equation}
这恰好就是定义在区间 $[-\infty,\infty]$ 上的函数 $F_x(z)=\frac{1}{2\pi}\ev{e^{\I z x},f}e^{\I z x}$ 的积分
...
&=\int_{-\infty}^\infty\frac{1}{2\pi}\ev{e^{\I z x},f(x)}e^{\I z x}\dd z\\
&=\frac{1}{2\pi}\int_{-\infty}^\infty\mathcal F(z)e^{\I z x}\dd z\\
\end{aligned}~
\end{equation}
其中
\begin{equation}
\mathcal F(z)=\ev{e^{\I z x},f(x)}=\int_{-\infty}^\infty f(x)e^{-\I zx}\dd x.~
\end{equation}
