...
\autoref{MWEq2_eq1} 右边第一个部分和第三个部分是同类项，而第二个部分和它们都无关．第一个部分对应$\partial_0\bvec{B}$，第三个部分对应$\nabla\times\bvec{E}$，第二个部分对应$\nabla\dot\bvec{B}$，由此易得，\autoref{MWEq2_eq3} 和\autoref{MWEq2_eq4} 可以统一用一个式子来表达：
\begin{equation}
\dd F = 0
\end{equation}
