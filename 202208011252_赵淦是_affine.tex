...
由垂径定理， $\displaystyle{P'Q'=2P'B=2\sqrt{1-OB^2}=\sqrt{2}}$h

则 $\displaystyle{S_{\text{四边形}OP'T'Q'}=\sqrt{2}\cdot\frac{\sqrt{2}}{2}=1}$

由性质2， $\displaystyle{S_{\text{}OPTQ}=1\cdot \sqrt{6}\cdot\sqrt{2}=2\sqrt{3}}$ 
\end{example}
