...
\item \textbf{Zone} ：DNS zones need an SOA。 a 'zone' is an area of control over namespace, A zone can include a single domain name, one domain and many subdomains, or many domain names. In some cases, 'zone' is essentially equivalent with 'domain,' \textsl{but} this is not always true.
\end{itemize}
