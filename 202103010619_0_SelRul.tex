...
\begin{equation}
\begin{aligned}
&\mel{\psi_{n,l,m}}{\bvec{\mathcal E}\vdot\bvec r}{\psi_{n',l',m'}} = \bvec{\mathcal E}\vdot\mel{\psi_{n,l,m}}{\bvec r}{\psi_{n',l',m'}}\\
&= \sqrt{\frac{2\pi}{3}} E_x \int R_{n,l}(r) r R_{n',l'}(r) r^2 \dd{r} \cdot \qty(\mel{Y_{l,m}}{Y_{1,-1}}{Y_{l',m'}} - \mel{Y_{l,m}}{Y_{1,1}}{Y_{l',m'}})\\
&+ \I\sqrt{\frac{2\pi}{3}} E_y \int R_{n,l}(r) r R_{n',l'}(r) r^2 \dd{r} \cdot \qty(\mel{Y_{l,m}}{Y_{1,-1}}{Y_{l',m'}} + \mel{Y_{l,m}}{Y_{1,1}}{Y_{l',m'}})\\
&+ \sqrt{\frac{4\pi}{3}} E_z \int R_{n,l}(r) r R_{n',l'}(r) r^2 \dd{r} \cdot \mel{Y_{l,m}}{Y_{1,0}}{Y_{l',m'}}
\end{aligned}
\end{equation}
所以求解跃迁矩阵元的角向部分积分就变为求解三个球谐函数之积的积分（\autoref{SphCup_eq1}~\upref{SphCup}）
