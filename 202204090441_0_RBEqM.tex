...
\pentry{刚体的平面运动方程\upref{RBEM}， 惯性张量\upref{ITensr}， 刚体的瞬时转轴、角速度的矢量相加\upref{InsAx}， 叉乘的矩阵形式\upref{CrosMt}}
...
\end{equation}
而角速度和速度之间有 $\bvec v = \bvec \omega \cross (\mat R \bvec r)$（\autoref{CMVD_eq5}~\upref{CMVD}）． 我们可以把叉乘用矩阵乘法表示\upref{CrosMt}为
