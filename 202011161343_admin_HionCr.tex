...
\begin{equation}
\dv{E}{\omega} = \dv{\sigma}{\omega}(\omega) s(\omega)
\end{equation}
其中 $\dv*{\sigma}{\omega}$ 为单位频率的散射截面． 如果再对立体角微分得
\begin{equation}
\pdv{E}{\omega}{\Omega} = \pdv{\sigma}{\omega}{\Omega}(\omega) s(\omega)
\end{equation}
...
\begin{equation}
E = \int \pdv{\sigma}{\omega}{\Omega}(\omega) s(\omega) \dd{\frac{k^2}{2m}}\dd{\Omega}
\end{equation}
\begin{equation}
E = \int P_{j\to i}(\bvec k) k^2\dd{\Omega}\dd{k}
\end{equation}
对比得
\begin{equation}
\pdv{\sigma}{\omega}{\Omega}(\omega) = \frac{km P_{j\to i}(\bvec k)}{s(\omega)}
\end{equation}
