...
\subsection{几何理解}
若把\autoref{FSExp_eq1} 中的 $x$ 改成时间 $t$， 那么 $f(t)$ 可以看作是复平面上一个点随时间的运动方程． 而根据欧拉公式， \autoref{FSExp_eq1} 中的每一项， 则是一个矢量以某个固定的频率的匀速圆周运动． 由于复数的加法相当于复平面上矢量的相加， 那么 $f(t)$ 所代表的运动就是把所有这些
