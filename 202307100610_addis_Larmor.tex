...
\addTODO{写或者引用一个经典电磁学版本的拉莫尔进动。 使用\autoref{ex_AMLaw_2}~\upref{AMLaw} 的结论。

\autoref{eq_AMLaw_2}~\upref{AMLaw} $\Omega = \frac{mgr_0}{I\omega}$。

\autoref{eq_MagMom_2}~\upref{MagMom} $\bvec \tau = \bvec \mu \times \bvec B$。
