...
\begin{equation}
\begin{aligned}
	g_{\mu\nu} i \Pi^{\mu\nu}(p) / \mu^{4-D} &= 4 \int \frac{\dd[d]{k}}{(2\pi)^d} \frac{(2-D)(l^2+p\cdot l) + 4Dm^2}{[l^2-m^2+i0^+][(p+l)^2-m^2+i 0^+]}\\
	&=4(-ie)^2 \int \frac{\dd[D]l}{(2\pi)^D} \frac{(2-D)}{(p+l)^2-m^2+i 0^+} 
	+
	4(-ie)^2 \int \frac{\dd[4]l}{(2\pi)^4}
	\frac{(2-D)p\cdot l+2 m^2}{[l^2-m^2+i0^+][(p+l)^2-m^2+i 0^+]}\\
	&=4(-ie)^2 \int \frac{\dd[D]l}{(2\pi)^D} \frac{(2-D)}{(l+p)^2-m^2+i 0^+} +  \frac{(D-2)/2}{(l+p)^2-m^2+i 0^+}-\frac{(D-2)/2}{l^2-m^2+i 0^+}
	\\
	&\quad\quad + 
	\frac{(D-2)/2\cdot p^2+2 m^2}{[l^2-m^2+i0^+][(p+l)^2-m^2+i 0^+]}
	\\
	&=(-ie)^2 \int \frac{\dd[D]l}{(2\pi)^D} \frac{4(2-D)}{l^2-m^2+i 0^+} + 
	(-ie)^2 \int \frac{\dd[D]l}{(2\pi)^D}
	\frac{2(D-2)\cdot p^2 + 8 m^2}{[l^2-m^2+i0^+][(p+l)^2-m^2+i 0^+]}\\
	g_{\mu\nu}i\Pi^{\mu\nu}(p)&=4(2-D) I_1 + (2(D-2)p^2+8m^2)I_2
\end{aligned}
\end{equation}
