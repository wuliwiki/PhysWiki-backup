...
\entry{最小二乘法数值拟合（任意函数）}{CurFit}
\entry{最小二乘法数值拟合（多项式）}{LSpoly}
...
\entry{中国科学院 2018 年考研普通物理}{CAS17}
