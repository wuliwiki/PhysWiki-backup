...
\hat e_\phi$ 和 $\bvec A^N(\bvec x)=\frac{\mu_0 e_M}{4\pi } \frac{1-\cos\theta}{r\sin\theta} \hat e_\phi$，这种构造磁矢势的方式被称为 Wu-Yang 单极子，Wu-Yang 利用这种思想提出了用纤维丛\upref{Fibre}去研究磁单极子问题背后的几何和拓扑性质。注意到 $\bvec A^N,\bvec A^S$ 在赤道处的指向都是沿切向方向的，可以构造一个赤道上的标量函数 $\phi$ shi d