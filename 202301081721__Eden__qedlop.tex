...
\begin{equation}
\begin{aligned}
\Pi(q^2)=-e^2 d(d-1)q^2 \frac{i}{(4\pi)^2}\left[\frac{2}{3\epsilon}+\int_0^1 \dd x\ 2x(1-x)\cdot\log\left(\frac{\mu^2}{\Delta}\right)\right]
\end{aligned}
\end{equation}
...
&=d(d-1)q^2 \frac{i}{(4\pi)^2}\left[\frac{2}{3\epsilon}+\int_0^1 \dd x\ 2x(1-x)\cdot\log\left(\frac{\mu^2}{\Delta}\right)\right]
\end{aligned}
\end{equation}
