...
请注意，$\bvec E$各分量的初相位可以不同，并且之间没有直接的约束关系．\autoref{VcPlWv_eq3} 没有很好地反映这一点．
...
$\tilde {\bvec E_0}$表明$\tilde {\bvec E_0}$是一个复矢量，即各分量都是一个复数．$\tilde {\bvec E_0}$包括了初相位信息，写为分量形式即为$
\tilde {\bvec E_0} = 
\begin{pmatrix}
