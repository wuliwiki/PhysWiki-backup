...
\hline
$\alpha$ & $0$ &$\displaystyle {T\over4}$& $\displaystyle {T\over2}$ & $\displaystyle {3\over4}T$ & $\displaystyle T$\\
\hline
$\sin \alpha$ & $0$&$1$&$0$&$-1$&$0$ \\
\hline
$x=\displaystyle{\alpha-\varphi\over \omega}$&$-{\varphi\over \omega}$&${\pi\over \omega}-\varphi$&${\alpha-\varphi\over \omega}$&${\alpha-\varphi\over \omega}$&${\alpha-\varphi\over \omega}$\\
\hline
$f(x)$ & $b$&$b+A$&$b$&$b-A$&$b$ \\
\hline
\end{tabular}
