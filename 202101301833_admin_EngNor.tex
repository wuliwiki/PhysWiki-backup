...
\begin{equation}
\begin{aligned}
\psi_{E,e}(x) &= \frac{1}{\sqrt{2}}[\psi_{E,1}(x) + \psi_{E,2}(x)] = \sqrt{\frac{m}{\pi k}}\E^{\I kx}\cos(kx)\\
\psi_{E,o}(x) &= \frac{1}{\sqrt{2}}[\psi_{E,1}(x) - \psi_{E,2}(x)] = \sqrt{\frac{m}{\pi k}}\E^{\I kx}\sin(kx)
\end{aligned}
\end{equation}
