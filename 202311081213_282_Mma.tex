...
\item \verb|list1 = {4, 2, 3, 1};
list2 = {a, b, c, d};  (* This could be any list of objects. *)

(* This gets the permutation that will sort list1. *)
ordering = Ordering[list1];

(* Now we apply this permutation to both lists. *)
sortedList1 = list1[[ordering]];
sortedList2 = list2[[ordering]];|
