...
&= d \cdot \int_0^1\dd x [2(d-1)x(1-x)q^2] \cdot \tilde{\mu}^{4-d}\frac{i}{(4\pi)^{d/2}}\frac{\Gamma(2-d/2)}{\Delta^{1-d/2}}\\
(d\rightarrow 4)&=2d(d-1)q^2 \frac{i}{(4\pi)^2}\int_0^1 \dd x\ x(1-x)\cdot\left[ \frac{1}{\epsilon} \right]
\end{aligned}
\end{equation}
