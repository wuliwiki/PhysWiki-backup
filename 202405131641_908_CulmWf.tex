...
\footnote{参考资料： \cite{Bransden}， Wikipedia， 据说 \cite{Merzbacher} 也有。 另一个是 “F Morales et al 2016 J. Phys. B: At. Mol. Opt. Phys. 49 245001” 的附录。}本文使用\enref{原子单位制}{AU}。 \textbf{库仑波函数（Coulomb wave function）}是\enref{类氢原子}{HWF} 的散射态\upref{SchEq}波函数。
