...
\end{enumerate}
\begin{example}{}
CGS单位制指定长度、质量和时间为基本量类，并选 $\boldsymbol{cm},\boldsymbol{g},\longleftarrow{s}$ 为基本单位．为定义速度 $\tilde{\boldsymbol{v}}$ （导出量类）的单位，考虑质点做匀速直线运动这一现象类\upref{PHEC}（它包括质点以各种不同速度做匀速直线运动这一现象）
\end{example}