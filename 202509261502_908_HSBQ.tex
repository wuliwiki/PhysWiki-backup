...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/ee8c83aac78d7ea1.png}
\caption{} \label{fig_HSBQ_1}
\end{figure}
如果$a, b, c$是整数（在环$\mathbb{Z}$ 中），则可以得到离散海森堡群$H_{3}(\mathbb{Z})$。这是一个非阿贝尔的幂零群。它有两个生成元：
$$
x = \begin{pmatrix}
1 & 1 & 0 \\
0 & 1 & 0 \\
