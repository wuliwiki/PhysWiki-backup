...
\begin{definition}{装备 Hilbert 空间}
 装备 Hilbert 空间包含一可分 Hilbert 空间$\mathcal{H}$与一稠密子空间$Φ⊂\mathcal{H}$, 满足如下条件: $Φ$上有一更强的拓扑$τ_Φ$, 使得$(Φ,τ_Φ)$成为一核空间, 而且有$Φ_0=\mathcal{H}$, 且自然的包含映射$Φ\hookrightarrow\mathcal{H}$在此拓扑下连续.
\end{definition}
