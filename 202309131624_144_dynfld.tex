...
\subsubsection{电磁场能量的初步表达}
\begin{table}[ht]
\centering
\caption{电磁场能量的初步表达}\label{tab_dynfld4}
\begin{tabular}{|c|c|c|}
\hline
 & 电场 & 磁场 \\
\hline
源-势 & $$ U = \frac{1}{2}\sum q_i \varphi_i = \frac{1}{2} \int \rho \varphi \dd V~$$ 
& $$U = \frac{1}{2} \int \bvec A \cdot \bvec j \dd V~$$ \\
\hline
场 & $$U=\frac{\epsilon_0}{2} \int E^2 \dd V~$$ $$u = \frac{\epsilon_0}{2} E^2~$$
& $$U=\frac{1}{2\mu_0} \int B^2 \dd V~$$ $$u=\frac{1}{2\mu_0} B^2~$$\\
\hline
\end{tabular}
\end{table}
