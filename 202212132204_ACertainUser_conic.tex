...
\hline
椭圆 Ellipse & \begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/conic_1.pdf}
\caption{请添加图片描述} \label{conic_fig1}
\end{figure} & $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$ & $\sqrt{a^2-b^2}$, $b^2+c^2=a^2$ & $\sqrt{1-\frac{b^2}{a^2}} < 1$ & $\frac{b^2}{a}$ & $\frac{b^2}{\sqrt{a^2-b^2}}$ &  \\
\hline
