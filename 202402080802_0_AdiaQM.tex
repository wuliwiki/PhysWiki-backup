...
更一般地，若我们只考虑 $\mat H_0$ 的某个能量为 $E_0$ 的简并子空间的演化，
...
当 $\mat H^0$ 非简并时， 直接使用本文开头的结论即可。 当 $\mat H^0$ 简并时， 上面已经得出， 在绝热近似下， 不同子空间的演化独立进行。 而\autoref{eq_AdiaQM_15} 在每个子空间内部则可化简为\autoref{eq_AdiaQM_14} 的形式！ 这样问题就迎刃而解了。
