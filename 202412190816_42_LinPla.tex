...
其中 
\begin{aligned}
x_B=(x_1,\cdots,x_m)^T,x_N=(x_{m+1},\cdots,x_n)^T,\lambda=(\lambda_1,\cdots,\lambda_{n-m}),b=(c_1,\cdots,c_n)^T.
\end{aligned}
...
\begin{definition}{典则形式，可行基，}
\autoref{eq_LinPla_4} 称为\autoref{eq_LinPla_2} 的\textbf{典则形式}。
\end{definition}
