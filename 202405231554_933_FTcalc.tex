...
$S_n = \sum_{i=1}^n f\left( \frac{i}{n} \right) \Delta x = \sum_{i=1}^n \frac{i}{n} \cdot \frac{1}{n} = \sum_{i=1}^n \frac{i}{n^2}$
...
因此，黎曼和为：
\[ S_n = \frac{1}{n^2} \cdot \frac{n(n+1)}{2} = \frac{n(n+1)}{2n^2} = \frac{n+1}{2n} \]

### 步骤 5: 取极限
当 $ n \to \infty $ 时，黎曼和的极限就是积分的值：
\[ \lim_{n \to \infty} S_n = \lim_{n \to \infty} \frac{n+1}{2n} = \lim_{n \to \infty} \frac{n}{2n} + \lim_{n \to \infty} \frac{1}{2n} = \frac{1}{2} + 0 = \frac{1}{2} \]

### 结论
因此，函数 $ f(x) = x $ 在区间 $[0, 1]$ 上的黎曼积分是：
