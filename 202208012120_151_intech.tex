...
$\displaystyle{\int x^n e^{ax}\cos bx\,\mathbb{d}x=x^n e^{ax}\frac{{a\cos bx+b\sin bx}}{a^2+b^2}-\frac{n}{a^2+b^2}\left(a\int x^{n-1}e^{ax}\cos bx\,\mathbb{d}x+b\int x^{n-1}e^{ax}\sin bx\,\mathbb{d}x\right)+C}$
$\displaystyle{\int x^n e^{ax}\sin bx\,\mathbb{d}x=x^n e^{ax}\frac{{a\sin bx-b\cos bx}}{a^2+b^2}-\frac{n}{a^2+b^2}\left(a\int x^{n-1}e^{ax}\sin bx\,\mathbb{d}x-b\int x^{n-1}e^{ax}\cos bx\,\mathbb{d}x\right)+C}$ 
\end{corollary}