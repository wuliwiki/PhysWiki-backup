...
一个李代数 \({\mathfrak {g}}\) 是幂零的，如果它的下中央系列
\[
...
\]
在有限步骤后变为零。等价地，如果存在一有限理想列
\[
0 = {\mathfrak {a}}_0 \subseteq {\mathfrak {a}}_1 \subseteq \cdots \subseteq {\mathfrak {a}}_r = {\mathfrak {g}},~
\]
使得 \({\mathfrak {a}}_j / {\mathfrak {a}}_{j-1}\) 在商代数 \({\mathfrak {g}} / {\mathfrak {a}}_{j-1}\) 中是中央的，那么 \({\mathfrak {g}}\) 是幂零的。根据恩格尔定理，一个李代数在任意域上是幂零的，当且仅当对于李代数中的每个元素 \(u \in {\mathfrak {g}}\)，其伴随内射
\[
\operatorname{ad}(u): {\mathfrak {g}} \to {\mathfrak {g}}, \quad \operatorname{ad}(u)v = [u, v]~
\]
是幂零的。

更一般地，一个李代数 \({\mathfrak {g}}\) 被称为可解的，如果它的导出系列
\[
...
\]
在有限步骤后变为零。等价地，\({\mathfrak {g}}\) 是可解的，如果存在一有限李子代数列
\[
0 = {\mathfrak {m}}_0 \subseteq {\mathfrak {m}}_1 \subseteq \cdots \subseteq {\mathfrak {m}}_r = {\mathfrak {g}},~
\]
使得 \({\mathfrak {m}}_{j-1}\) 是 \({\mathfrak {m}}_j\) 中的理想，并且 \({\mathfrak {m}}_j / {\mathfrak {m}}_{j-1}\) 对每个 \(j\) 是交换的。

每个有限维的李代数在域上都有一个唯一的最大可解理想，称为其根理想。根据李代数的对应关系，幂零（或可解）李群对应于幂零（或可解）李代数。