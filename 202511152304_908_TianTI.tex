...
\end{figure}
国际天文学联合会（IAU）对行星与矮行星的定义要求：凡绕太阳运行的天文天体，必须经历圆化过程而达到近似球形的形状，这一状态称为流体静力平衡。无论是像火星这样的较小类地行星，还是像木星这样的气体巨行星，都呈现出类似的类球形态。

任何绕太阳运行但尚未达到流体静力平衡的天然天体，均被 IAU 分类为小型太阳系天体（SSSB）。这些天体具有各种非球形形状，是由于落入的尘埃和岩石随机堆积而成的块状结构；其质量不足以产生足够的内部热量来完成圆化过程。一些小型太阳系天体只是由许多相对较小的岩块在引力作用下松散聚集而成，但并未真正熔结为单一的整体岩体。一些体积较大的小型天体则接近球形，但仍未达到流体静力平衡。小型太阳系天体 4 号灶神星（Vesta）质量足够大，至少经历了部分的行星分化。

像太阳这样的恒星由于引力作用于其等离子体（这是一种可自由流动的流体），也呈现出类球形。持续的恒星核聚变产生的能量远大于恒星形成早期所释放的初始热量。
\subsection{按位置分类}
下表根据天体的位置或结构列出了各种天体与天文对象的通用类别。
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/0d06d183342d6f43.png}
\caption{} \label{fig_TianTI_2}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/0ab522478755974f.png}
\caption{} \label{fig_TianTI_3}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=14.25cm]{./figures/b16fe784ee18e686.png}
\caption{} \label{fig_TianTI_4}
\end{figure}
\subsection{另见}
\begin{itemize}
\item 光源列表  
...
\subsection{参考文献}
\begin{enumerate}
\item Task Group on Astronomical Designations from IAU Commission 5（2008 年 4 月）。Naming Astronomical Objects。International Astronomical Union（IAU）。2010 年 8 月 2 日归档。访问于 2010 年 7 月 4 日。
\item The Early Universe。NASA。
\item Narlikar, Jayant V.（1996）。Elements of Cosmology。Universities Press。ISBN 81-7371-043-0。
\item Smolin, Lee（1998）。The life of the cosmos。Oxford University Press US。第 35 页。ISBN 0-19-512664-5。
\item Buta, Ronald James; Corwin, Harold G.; Odewahn, Stephen C.（2007）。The de Vaucouleurs atlas of galaxies。Cambridge University Press。第 301 页。ISBN 978-0-521-82048-6。
\item Hartung, Ernst Johannes（1984 年 10 月 18 日）。Astronomical Objects for Southern Telescopes。CUP Archive。ISBN 0521318874。访问于 2017 年 2 月 13 日。
\item Elmegreen, Bruce G.（2010 年 1 月）。The nature and nurture of star clusters。收录于 Star clusters: basic galactic building blocks throughout time and space，Proceedings of the International Astronomical Union，IAU Symposium，卷 266，3–13 页。arXiv:0910.4638。Bibcode:2010IAUS..266....3E。doi:10.1017/S1743921309990809。
\item Hansen, Carl J.; Kawaler, Steven D.; Trimble, Virginia（2004）。Stellar interiors: physical principles, structure, and evolution。Astronomy and astrophysics library（第 2 版）。Springer。第 86 页。ISBN 0-387-20089-4。
\end{enumerate}
\subsection{外部链接}
\begin{itemize}
\item SkyChart，Sky & Telescope，存档于美国国会图书馆网络档案（归档日期：2005 年 6 月 13 日）
\item 适用于地球上每个地点的每月星空图。存档于 Wayback Machine（归档日期：2007 年 9 月 13 日）。
\end{itemize}