...
\begin{equation}
x_1-x_0=-\frac{\displaystyle{x_0\over a}+{y_0\over b}}{2a}~.
\end{equation}
...
\begin{split}
S&=ah\\
&=\left|-\frac{\displaystyle{x_0\over a}+{y_0\over b}}{2a}\right|\sqrt{1+{b^2\over a^2}}\cdot\frac{\left|\displaystyle \displaystyle{x_0\over a}-{y_0\over b}\right|}{b\displaystyle\sqrt{{b^2\over a^2}+1}}\\
