...
\caption{\autoref{GrpPrd_the1} 的示意图．群$G$和$K$被表示为两条相互垂直的虚线，$G\times K$就是它们生成的平面．$H$和$J$被表示为两条线段，$H\times J$就是作图中间那个方形区域．右图用垂直的虚线把$G$区分成若干区域，就是$G/H$的元素} \label{GrpPrd_fig1}
\end{figure}
