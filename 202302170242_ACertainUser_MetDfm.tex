...
\subsection{弹性变形机制}
原子间依靠原子间作用力（或者说，键\footnote{根据强度与具体机制等，键可以再细化为化学键（金属键、共价键、离子键）与分子间作用力等}）连接在一起。原子间作用力的具体机制非常复杂，但简化的来说，可以认为原子间作用力是一种电荷交互作用，包括电子间的排斥力与原子核对电子的吸引力。
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MetDfm_5.pdf}
\caption{请添加图片描述} \label{MetDfm_fig5}
\end{figure}

这对吸引力与排斥力保持了一种微妙的平衡，使得原子在不受外力的作用下保持一定的平衡间距。
\begin{figure}[ht]
\centering
