...
\item 同时，由于极化电偶的产生，还产生了极化电流 $\bvec j_p = \pdv{\bvec P}{t}$ \upref{PolCur}。 %似乎这个词条没有说明极化电流的来历

\item 磁化、极化电流产生了额外的磁场。因此磁性介质的存在改变了磁场的分布。\upref{PolCur} $\bvec B = \bvec B_0 + \bvec B'$, $\curl {\bvec B} = \mu_0 (\bvec j_f + \bvec j_s + \bvec j_p) + \mu_0\epsilon_0 \pdv{\bvec E}{t} = \mu_0 \bvec j_f + \mu_0 \curl \bvec M + \mu_0 \pdv{\bvec P}{t} + \mu_0 \epsilon_0 \pdv{\bvec E}{t}$
