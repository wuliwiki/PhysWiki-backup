...
\begin{aligned}
    ...
    &=d\cdot \int_0^1\dd x\left[\int\frac{\dd[d]{k}}{(2\pi)^d}\frac{2-d}{l^2-D}+\int \frac{\dd[d]{k}}{(2\pi)^d}\frac{2m^2-(2-d)2x(1-x)q^2}{(l^2-D)^2}\right]
\end{aligned}
\end{equation}
我们发现，计算结果中似乎出现了二次发散，但其实不然，贡献二次发散极点的 $\Gamma(1-d/2)$ 函数恰好被 $2-d$ 因子消去了极点。我们最终得到
\begin{equation}
\begin{aligned}
I=d\cdot\int_0^1\dd x \left[\right]
\end{aligned}
\end{equation}
