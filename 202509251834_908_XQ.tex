...
\subsection{参见}
\begin{itemize}
\item 哈密顿力学 (*Hamiltonian mechanics*)
* 梅塔辛群 (*Metaplectic group*)
* 正交群 (*Orthogonal group*)
* 参数模群 (*Paramodular group*)
* 射影酉群 (*Projective unitary group*)
* 经典李群的表示 (*Representations of classical Lie groups*)
* 辛流形、辛矩阵、辛向量空间、辛表示
