...
为讨论方便我们讨论 $T_2 > T_1$ （$\omega_2 < \omega_1$） 的情况， 若某个点 $t_0$ 处两标记重合， 那么再经过大约 $T_i/\Delta T$ 个周期后， 标记会再次重合． 所以两个波包的距离为 $(T_i/\Delta T)\cdot T_i = T_i^2/\Delta T$， 拍的频率为 $2\pi \Delta T/T_i^2$．
