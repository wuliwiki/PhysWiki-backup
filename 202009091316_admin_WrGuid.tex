...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm]{./figures/WrGuid_3.png}
\caption{由 “牛顿—莱布尼兹公式” 为目标生成的} \label{WrGuid_fig3}
\end{figure}

\item 1我们重视百科的自洽性， 所以几乎所有词条都需指定其他一些词条作为预备知识（\autoref{WrGuid_fig1} ）． 预备知识相当于 “必备知识”， 如果其中的内容不掌握， 读者阅读词条内容就会遇到较大的困难（例如从来没见过的术语，公式或定理）．
