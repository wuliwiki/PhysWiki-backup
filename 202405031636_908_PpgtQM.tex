...
\end{equation}
根据\enref{高斯积分}{GsInt}\autoref{eq_GsInt_5}~\upref{GsInt} ，或者如果你对高斯积分向复数的拓展有疑虑的话，根据\textbf{留数定理}\upref{ResThe}\autoref{ex_ResThe_3}~\upref{ResThe}，知$\int \E^{-\I b^2}\dd b = \sqrt{\frac{\pi}{\I}} = \sqrt{\frac{\pi}{2}}(1-\I)$。代入\autoref{eq_PpgtQM_6} 得
