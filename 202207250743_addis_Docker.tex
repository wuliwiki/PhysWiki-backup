...
\begin{itemize}
\item ubuntu x86/64 安装参考 https://docs.docker.com/install/linux/docker-ce/ubuntu/
```
...
```
\item 测试安装成功， 用 `sudo docker run hello-world`
\end{itemize}
...
\item 三个安装包依次是 containerd.io, docker-ce-cli, docker-ce, 用 `dpkg -i xxx.deb` 安装即可
\end{itemize}
