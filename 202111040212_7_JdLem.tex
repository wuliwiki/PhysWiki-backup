...
将问题拓展到复数域上，对任意$z\in\mathbb{C}$有
\begin{equation}
\sinc z = \frac{\sin z}{z} \quad  (z \ne 0)
\end{equation}

可见这个函数是没有奇点的．因此，如果令$C(R)$是以原点为圆心、$R$为半径、逆时针为积分方向的曲线，那么根据\textbf{留数定理}\upref{ResThe}，我们应有：
\begin{equation}
\int_{C(R)}\sinc z\dd z+\int_{-R}^R\sinc x\dd x=0
\end{equation}
