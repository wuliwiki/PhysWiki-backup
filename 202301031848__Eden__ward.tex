...
\begin{equation}
\begin{aligned}
F_i&=k_\mu\cdot \bar u(p')\cdots (-ie\gamma_{\mu_{i+1}})\frac{i}{\not p+\not k+\not q_1+\cdots+\not q_i-m}
(-ie\gamma_\mu)
...
\end{equation}
经过上面的分析，我们已经初步证明了 Ward 等式的一般形式。现在考虑费米子链的两端是在壳的费米子外线的情况，
\begin{equation}
\begin{aligned}
F_i = k_\mu \cdot \bar u(p')\cdots (-ie\gamma_\mu)\cdots u(p)
\end{aligned}
\end{equation}
