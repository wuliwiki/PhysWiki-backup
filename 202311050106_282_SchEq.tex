...
对一维或二维\footnote{我们还mei}的有限深势阱， 如果各方向无穷远处势能相等， 那么都至少有一个束缚态\footnote{一维证明参考 \cite{Teschl} 的第九章。另见 [JOURNAL OF MATHEMATICAL PHYS VOL39,NUM 9, 1998] On the number of bound states for the one-dimensional Schrodinger equation}。 若不满足则未必存在束缚态。
