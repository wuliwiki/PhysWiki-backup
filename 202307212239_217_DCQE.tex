...
={}&i\hbar(\frac{d}{dt}\langle\xi|)\ket\eta\rangle+i\hbar\langle\xi|(\frac{d}{dt}\ket\eta\rangle) \notag \\
={}&-\langle\xi|H\ket\eta\rangle+\langle\xi|H\ket\eta\rangle \notag \\
={}&0.
\end{align}
而$\ket\phi_L\rangle$和$\ket\phi_R\rangle$两个态初始时就是正交的，于是得
\begin{equation}
