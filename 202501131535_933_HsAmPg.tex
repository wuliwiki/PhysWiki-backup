...
\subsection{错位相减法}
与\autoref{eq_HsAmPg_7} 类似，许多常见的求和情况，可以利用拆项的方法，变成可以与下一项相抵消的方式，然后得到结果，这种方法被称为\textbf{错位相减法（telescoping method）}。
...
如\autoref{ex_HsAmPg_2} 所示，这种方法可以将一个求和过程化简为一个简单的结果，一般的特征是这个求和过程的每一项是分母是与n有关乘积的分式。
