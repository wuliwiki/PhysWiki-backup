...
解： 首先平衡位置必定在三角形 $P_1, P_2, P_3$ 内， 否则仅分析力的方向就不可能平衡． 令绳结到三点的单位矢量分别为 $\uvec r_1, \uvec r_2, \uvec r_3$， 那么
\begin{equation}
...
然后根据 $\theta_{12}$ 过 $P_1, P_2$ 作一条弧线， 半径为（\autoref{SphTri_eq1}~\upref{SphTri}）
\begin{equation}
