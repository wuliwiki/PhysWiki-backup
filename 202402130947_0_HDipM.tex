...
function d_z = hydrogen_dipole_z(Z,n1,l1,m1,n2,l2,m2,r_max)
...
以下函数需要 parallel toolbox， 如果没有， 把 \verb`parfor` 改成 \verb`for` 即可。
% 已验证：氢原子 |1,0,0> polarizability = -4.5
...
function [d_z, n_l] = hydrogen_dipole_z_mat(Z, m, n_max, r_max)
if nargin == 0
% === params ===
Z = 1;
m = 0;
...
parfor i = 1:Nlist
    ...
    d_val(i) = hydrogen_dipole_z(Z,n1,l1,m,n2,l2,m,r_max);
end
