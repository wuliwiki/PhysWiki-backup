...
\subsection{参考文献}
\begin{itemize}
\item Aldaz, J. M.; Barza, S.; Fujii, M.; Moslehian, M. S.（2015），《算子柯西–施瓦茨不等式及其反向不等式的进展》（*Advances in Operator Cauchy—Schwarz inequalities and their reverses*），*泛函分析年刊*（Annals of Functional Analysis），第6卷第3期：275–295，doi:10.15352/afa/06-3-20，S2CID 122631202。

\item Bunyakovsky, Viktor（1859），《关于有限差分积分的一些不等式》（*Sur quelques inegalités concernant les intégrales aux différences finies*）（PDF），*圣彼得堡科学院汇刊*（Mem. Acad. Sci. St. Petersbourg），第7卷第1期，第6页，原文PDF于2022-10-09归档。

\item Cauchy, A.-L.（1821），《关于符号 > 或 < 的使用及多数量平均值所得公式》（*Sur les formules qui résultent de l'emploie du signe et sur > ou <, et sur les moyennes entre plusieurs quantités*），《分析课程》（*Cours d'Analyse*），第一部分：代数分析，1821年；全集第二辑，卷三，第373-377页。
\item Dragomir, S. S.（2003），《关于柯西–布尼亚科夫斯基–施瓦茨型离散不等式的综述》（*A survey on Cauchy–Bunyakovsky–Schwarz type discrete inequalities*），*纯与应用数学不等式杂志*（Journal of Inequalities in Pure and Applied Mathematics），第4卷第3期：142页，原文已于2008-07-20归档。
\item Grinshpan, A. Z.（2005），《一般不等式、推论及应用》（*General inequalities, consequences, and applications*），*应用数学进展*（Advances in Applied Mathematics），第34卷第1期：71–100，doi:10.1016/j.aam.2004.05.001。
\item Halmos, Paul R.（1982年11月8日）。《希尔伯特空间问题集》（*A Hilbert Space Problem Book*）。*研究生数学教程*（Graduate Texts in Mathematics），第19卷（第2版）。纽约：施普林格出版社。ISBN 978-0-387-90685-0。OCLC 8169781。
\item Kadison, R. V.（1952），《广义施瓦茨不等式与算子代数的代数不变量》（*A generalized Schwarz inequality and algebraic invariants for operator algebras*），*数学年刊*（Annals of Mathematics），第56卷第3期：494–503，doi:10.2307/1969657，JSTOR 1969657。
\item Lohwater, Arthur（1982），《不等式导论》（*Introduction to Inequalities*），在线PDF电子书。
\item Paulsen, V.（2003），《完全有界映射与算子代数》（*Completely Bounded Maps and Operator Algebras*），剑桥大学出版社。
\item Schwarz, H. A.（1888），《关于变分法中的一个极小面积问题》（*Über ein Flächen kleinsten Flächeninhalts betreffendes Problem der Variationsrechnung*）（PDF），*芬兰科学学会学报*（Acta Societatis Scientiarum Fennicae），第15卷：318页，原文PDF于2022-10-09归档。
\item Solomentsev, E. D.（2001）\[1994]，《柯西不等式》（*Cauchy inequality*），*数学百科全书*（Encyclopedia of Mathematics），EMS出版社。
\item Steele, J. M.（2004），《柯西–施瓦茨大师课》（*The Cauchy–Schwarz Master Class*），剑桥大学出版社，ISBN 0-521-54677-X。
\end{itemize}
\subsection{外部链接}
\begin{itemize}
