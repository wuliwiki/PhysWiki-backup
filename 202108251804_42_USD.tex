...
\end{equation}
其中 $\hat{\boldsymbol{Q}},\hat{\boldsymbol{Q'}}$ 分别表示 $\tilde{\boldsymbol{Q}}$ 在旧、新两制中的单位．这一比值\autoref{USD_eq8} 称为 $\tilde{\boldsymbol{Q}}$ 的\textbf{量纲}(dimension)，记作 $\mathem{dim}\tilde{\boldsymbol{Q}}$ ，即
\begin{equation}
\mathem{dim}\tilde{\boldsymbol{Q}}=
\end{equation}
