...
当然，这里对于不等式的构造会有一定的要求，所以下面会提供一些常用的不等式关系，一起服用，效果极佳。

\begin{itemize}
\item \begin{align*}
&\sin x < x < \tan x, \quad x \in \left(0, \frac{\pi}{2}\right) \\[10pt]
&\sin x \leq x, \quad x \in (0, +\infty) \\[10pt]
&\arctan x \leq x \leq \arcsin x, \quad x \in [0, 1] \\[10pt]
&e^x \geq x + 1 \\[10pt]
&x - 1 \geq \ln x, \quad x \in (0, +\infty) \\[10pt]
&\frac{1}{1 + x} \leq \ln\left(1 + \frac{1}{x}\right) \leq \frac{1}{x}, \quad x \in (0, +\infty) \\[10pt]
