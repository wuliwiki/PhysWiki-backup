...
&=\int^{+\infty}_{-\infty} \qty[\sqrt{\frac{1}{3}}\psi^{*}_{0}(x)e^{\frac{i}{\hbar}E_{0}t}+\sqrt{\frac{2}{3}}\psi^{*}_{1}(x)e^{\frac{i}{\hbar}E_{1}t}]\qty[\sqrt{\frac{1}{3}}\frac{1}{\alpha}\qty[\sqrt{\frac{1}{2}}\psi_{1}](x)e^{-\frac{i}{\hbar}E_{0}t}+\sqrt{\frac{2}{3}}\psi_{1}(x)e^{-\frac{i}{\hbar}E_{1}t}]\dd{x}
\end{aligned}
\end{equation}
