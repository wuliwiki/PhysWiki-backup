...
当然了，von Neumann测量仍然没有回答为什么量子态会坍缩这个问题，而是把问题从量子系统本身丢到了测量仪器乃至于观测者上。但是无论怎样，这样的测量模型仍然给了后续研究者以很大启发，比如上世纪80年代提出的弱测量技术便是在von Neumann测量的基础上得以提出，在弱测量中，我们可以在不扰动被观测量子态的情况下获得关于它的信息。