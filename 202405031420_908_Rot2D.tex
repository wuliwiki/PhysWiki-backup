...
我们之前学过的 “\enref{平面旋转变换}{Rot2DT}” 属于线性变换\upref{LinMap}，以下用矩阵 $\mat R_2$ 表示。虽然我们可以直接把\autoref{eq_Rot2DT_1}~\upref{Rot2DT} 到\autoref{eq_Rot2DT_4}~\upref{Rot2DT} 写成矩阵乘以列矢量的形式， 得到
\begin{equation}
\pmat{x'\\ y'} =
\begin{pmatrix}
\cos\theta & - \sin\theta\\
