...
\begin{equation}
\mathbb{E}=\{\alpha\in\mathbb{K}\mid \sigma\alpha = \alpha, \sigma\text{是域}\overline{\mathbb{F}}\text{的任意保}\mathbb{F}\text{自同构}\}
\end{equation}
则$\mathbb{E}/\mathbb{F}$是纯不可分扩张，$\mathbb{K}/\mathbb{E}$是可分扩张．
\end{theorem}
