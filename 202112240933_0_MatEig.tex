...
\begin{theorem}{}
对方阵 $\mat A$， 两个不同的本征值 $\lambda_i, \lambda_j$ 所对应的本征矢 $\bvec v_i, \bvec v_j$ 线性无关．
\end{theorem}
证明： 可以用反证法， 若本征矢线性相关， 则 $\bvec v_j = C \bvec v_i$， 带入 $$ 得 $\mat A \bvec v_j = \lambda_j \bvec v_j$

可见， 对于一般 $N$ 维方阵， 若特征多项式存在重根， 则未必有 $N$ 个线性无关的本征矢．
