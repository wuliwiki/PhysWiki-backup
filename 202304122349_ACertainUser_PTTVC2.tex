...
根据状态量与路径无关的性质\upref{StaPro}，我们可以进一步地定义等温等压的两种相态下，热力学量的差值：
$$
\begin{aligned}
...
\end{figure}
从更有物理意义的角度而言，这个差值还意味着，等温等压条件下系统相变前后，系统内能的变化量。在国内教材的符号规范中，$\Delta^g_l$的上标$g$代表相变后的末相气相，下标$l$代表相变前的初始相液相。
