...
\end{figure}
皮埃尔·德·费马（Pierre de Fermat，法语：[pjɛʁ də fɛʁma]；1601年8月17日 – 1665年1月12日）是法国数学家，他因早期的研究成果而被认为是微积分学的奠基人之一，其中包括他使用的“等值法”（adequality）。特别地，他因发现了一种原始的方法，用于求解曲线的最大和最小纵坐标，这一方法与当时未知的微分学相类似。此外，他还对数论进行了深入研究，并在解析几何、概率论和光学方面作出了重要贡献。他最著名的贡献包括光传播的费马原理和费马大定理，后者是他在一份《丢番图算术》副本的空白页上所写的一条注释中提出的。他还是法国图卢兹议会的律师。
\subsection{传记}
