...
定义
\begin{equation}
\lim\limits_{n\to\infty} \sup\{a_i\}_{i=n}^\infty = \substack{\overline{\lim}}{n\to\infty} a_n
\end{equation}
为 $\{a_n\}$ 的\textbf{上极限（upper limit）}．

类似地，定义
\begin{equation}
\lim\limits_{n\to\infty} \inf\{a_i\}_{i=n}^\infty = \substack{\underline{\lim}}{n\to\infty} a_n
\end{equation}
