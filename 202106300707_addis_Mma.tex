...
\subsection{变量}
\begin{itemize}
\item \verb|Head[...]| 可用于判断一个对象的类型， 如 \verb|Head[1]| 是 \verb|Integer|， \verb|Head[Pi]| 是 \verb|Symbol|， \verb|Head[1/5]| 是 \verb|Rational|， \verb|Head[0.2]| 是 \verb|Real|， \verb|Head[I]| 是 \verb|Complex\verb| （\verb|Real| 和 \verb|Complex| 用于浮点运算，有误差）， \verb|Sin[1]|  是 \verb|Sin|， \verb|Head[2 Pi/3]| 是 \verb|Times|．
\item \verb|?变量| 显示某个变量的定义
\item \verb|Clear[变量名]| 清除某个变量的定义．
\item 数组（矩阵） \verb|data = {a, 2, c, d}|， \verb|T = {{1, 2}, {3, 4}}|， 高维数组同理．
