...
\item \verb|/.| 是 \verb|ReplaceAll[]| 的简写形式． 例如 \verb|{x, x^2, y, z} /. x -> 1| 的结果是 \verb|{1,1,y,z}|， 又例如 \verb|{x, x^2, y, z} /. {x -> 2, y -> 1}|
...
\item \verb|DSolve[{y''[x] + b y'[x] == 0, y[0] == 0, y'[0] == 1}, y[x], x]| 解常微分方程． 也可以省略初始条件获得通解．
