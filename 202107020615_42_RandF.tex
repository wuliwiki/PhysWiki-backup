...
\begin{aligned}
\ev{v}&=A\int_{0}^{v_{m}} v\sin[2](\frac{\pi v}{v_{m}})\dd v=\frac{A}{2}\int_0^{v_m}v\qty[1-\cos\qty(\frac{2\pi v}{v_{m}})]=A\qty[\sin(\frac{\pi v}{v_{m}})\frac{v_{m}^2}{\pi^2}-\cos (\frac{\pi v}{v_{m}})\frac{v_{m}v}{\pi}]\Bigg|_{0}^{v_{m}}\\
