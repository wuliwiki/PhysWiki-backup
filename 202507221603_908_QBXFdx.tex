...
$$
$$
T_n(x) = \frac{1}{\binom{n - \frac{1}{2}}{n}} P_n^{(-\frac{1}{2}, -\frac{1}{2})}(x) = \frac{2^{2n}}{\binom{2n}{n}} P_n^{(-\frac{1}{2}, -\frac{1}{2})}(x)~
$$
对于第二类切比雪夫多项式 $U_n(x)$：
$$
U_n(x) = C_n^{(1)}(x)~
$$
$$
U_n(x) = \frac{n+1}{\binom{n + \frac{1}{2}}{n}} P_n^{(\frac{1}{2}, \frac{1}{2})}(x) = \frac{2^{2n + 1}}{\binom{2n + 2}{n + 1}} P_n^{(\frac{1}{2}, \frac{1}{2})}(x)~
$$
...
$$
特别地，当 $\alpha = \frac{1}{2}$ 时，它们之间的关系为：
$$
