...
通常我们说 “波” 时， 它几乎可以是任意形状的， 例如一个波包\upref{WvPck}， 或者从一点向各个方向传播的球面波． 但我们先来讨论一种最简单的波动， 叫做\textbf{简谐波（sinusoidal wave）}， 在任意时刻， 它在传播方向的波形是一个正弦函数， 范围是无穷大． 简谐波也叫\textbf{平面波（plane wave）}， 本书对这两个词不加区分． 叫平面波是因为三维平面波的等相位面（见下文）都是平面， 但其他维度习惯上也可以使用这个词， 这在量子力学中较常见\footnote{见几乎任意一本常见量子力学入门教材．}．
