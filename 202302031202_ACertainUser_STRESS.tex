...
\caption{请添加图片描述} \label{STRESS_fig8}
\end{figure}
如果你对数学具有足够的热枕与敏感度，那么还有另一种简洁的方式说明应力平衡定律：如\autoref{STRESS_fig8} 所示，我们在物体中任选取一个区域。我们知道物体内部的受力包括应力（表面力）与体力，由于这个区域受力平衡，所以这个区域受的总表面力等于总体力。
$$\oint \bvec \sigma \cdot \dd \bvec A + \int \bvec f \dd V = 0$$
运用散度定理\upref{Divgnc}
