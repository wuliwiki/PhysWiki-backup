...
为什么我们可以这么求质心呢，首先需要知道的一点是在匀强重力场下质心和重心是重合的．现在假设$m_1$ 和 $m_2$是一根杠铃的两端，若我们给杠铃的重心一个竖直向上的，大小等于$m_1g+m_2g$力那么杠铃便会保持平衡．
但如果这个力没有作用在重心上，而是稍微偏离重心呢？那么由于力矩的作用，杠铃就会发生旋转．因此假设重心离质点1的距离为$l_1$，离质点1的距离为$l_2$，根据杠杆原理便有$m_1l_1=m_2l_2$
