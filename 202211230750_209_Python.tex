...
\begin{itemize}
\item 易于学习：Python有相对较少的关键字，结构简单，和一个明确定义的语法，学习起来更加简单．
\item 易于阅读：Python代码定义的更清晰．
\item 易于维护：Python的成功在于它的源代码是相当容易维护的．
\item 可嵌入: 你可以将Python嵌入到C/C++程序，让你的程序的用户获得"脚本化"的能力．
\item 广泛的标准库：Python的最大的优势之一是丰富的库，且跨平台，在 UNIX，Windows 和 Mac 兼容很好．
