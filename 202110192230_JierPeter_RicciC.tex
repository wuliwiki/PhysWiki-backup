...
\begin{aligned}
2R^r_{kij}=&\partial_i(g^{ar}\partial_jg_{ak}+g^{ar}\partial_kg_{aj}-g^{ar}\partial_ag_{jk})-\\
&\partial_j(g^{ar}\partial_ig_{ak}+g^{ar}\partial_kg_{ai}-g^{ar}\partial_ag_{ik})+\\
&g^{as}(\partial_jg_{ak}+\partial_kg_{aj}-\partial_ag_{jk})g^{br}(\partial_ig_{sb}+\partial_sg_{bi}-\partial_bg_{is})-\\
&g^{as}(\partial_ig_{ak}+\partial_kg_{ai}-\partial_ag_{ik})g^{br}(\partial_jg_{sb}+\partial_sg_{bj}-\partial_bg_{js})\\
=&(\partial_ig^{ar})(\partial_jg_{ak})+g^{ar}\partial_i\partial_jg_{ak}+\\
...
&(\partial_jg^{ar})(\partial_ig_{ak})-g^{ar}\partial_j\partial_ig_{ak}-\\
...
&g^{as}g^{br}(\partial_jg_{ak}+\partial_kg_{aj}-\partial_ag_{jk})(\partial_ig_{sb}+\partial_sg_{bi}-\partial_bg_{is})-\\
&g^{as}g^{br}(\partial_ig_{ak}+\partial_kg_{ai}-\partial_ag_{ik})(\partial_jg_{sb}+\partial_sg_{bj}-\partial_bg_{js})
\end{aligned}
\end{equation}
...
=&g_{rt}(\partial_ig^{ar})(\partial_jg_{ak})+\delta^a_t\partial_i\partial_jg_{ak}+\\
...
&g_{rt}(\partial_jg^{ar})(\partial_ig_{ak})-\delta^a_t\partial_j\partial_ig_{ak}-\\
...
&g^{as}\delta^b_t(\partial_jg_{ak}+\partial_kg_{aj}-\partial_ag_{jk})(\partial_ig_{sb}+\partial_sg_{bi}-\partial_bg_{is})-\\
&g^{as}\delta^b_t(\partial_ig_{ak}+\partial_kg_{ai}-\partial_ag_{ik})(\partial_jg_{sb}+\partial_sg_{bj}-\partial_bg_{js})\\
=&g_{rt}(\partial_ig^{ar})(\partial_jg_{ak})+\partial_i\partial_jg_{kt}+\\
...
&g_{rt}(\partial_jg^{ar})(\partial_ig_{ak})-\partial_j\partial_ig_{kt}-\\
...
&g^{as}(\partial_jg_{ak}+\partial_kg_{aj}-\partial_ag_{jk})(\partial_ig_{st}+\partial_sg_{ti}-\partial_tg_{is})-\\
&g^{as}(\partial_ig_{ak}+\partial_kg_{ai}-\partial_ag_{ik})(\partial_jg_{st}+\partial_sg_{tj}-\partial_tg_{js})\\
=&g_{rt}(\partial_ig^{ar})(\partial_jg_{ak})+\\
&g_{rt}(\partial_ig^{ar})(\partial_kg_{aj})+\partial_i\partial_kg_{tj}-\\
&g_{rt}(\partial_ig^{ar})(\partial_ag_{jk})-\partial_i\partial_tg_{kj}-\\%First line above, expanded
&g_{rt}(\partial_jg^{ar})(\partial_ig_{ak})-\\
&g_{rt}(\partial_jg^{ar})(\partial_kg_{ai})-\partial_j\partial_kg_{ti}+\\
...
\begin{aligned}
2R_{tkij}=&2g_{rt}R^r_{kij}\\
=&-g^{ar}(\partial_ig_{rt})(\partial_jg_{ak})\\
...
&+g^{ar}(\partial_jg_{rt})(\partial_ig_{ak})\\
