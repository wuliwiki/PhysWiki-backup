...
\end{aligned}
\end{equation}
在非相对论极限下，$|p'-p|\ll |p+k|$，因此我们可以忽略第二项. Use $\bar v^s(p') v^r(p)=-2m \delta_{rs}$, the result is the same as $e^-e^-\rightarrow e^- e^-$, we can obtain an attractive Yukawa potential 
\[
