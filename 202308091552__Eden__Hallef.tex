...
\footnote{电阻率的定义见\autoref{eq_Resist_7}~\upref{Resist}。} 的定义 $R=\rho L / S=\rho L /(dw)$（$d$ 为材料的厚度， $w$ 为垂直于电流方向的宽度，如\autoref{fig_Hallef_1} 所示。），那么代入 \autoref{eq_Hallef_2} 可以得到
\begin{equation}
\frac{\rho L}{w} = \frac{B}{dnq} = \frac{V}{I}
\end{equation}
