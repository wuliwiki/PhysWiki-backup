...
理想气体是热力学中一个理想化的模型（可以类比自由落体\upref{ConstA}， 简谐振子等\upref{SHO}）， 用于探索密闭容器中一定量气体的压强， 体积和温度之间的关系． 该模型假设密闭容器中有一定量由原子或分子构成的气体（以下统称为分子）， 假设气体非常稀薄， 分子之间几乎不发生相互作用（例如碰撞）， 且与容器壁之间的碰撞是完全弹性的且在瞬间完成的， 且符合镜面反射定律． 假设每个分子所受重力忽略不计．
