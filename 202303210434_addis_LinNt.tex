...
\item 大括号可以展开， 例如 \verb|touch 路径/{文件1,文件2}| 相当于 \verb|touch 路径/文件1 路径/文件2| 也可以用两点如 \verb|touch 路径/文件{1..100}| 可以生成 100 个文件。 如果有多个大括号就做 “张量积”， 例如 \verb|{a,b}/{1,2}| 展开为 \verb|a1 a2 b1 b2|。
\end{itemize}
...
\item 从远程传到本地： \verb|rsync -azvh 用户名@域名或IP:/路径/* 本地路径/|
