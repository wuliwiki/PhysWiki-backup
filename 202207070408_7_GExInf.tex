...
任取$\mathbb{K}/\mathbb{M}$的中间域$\mathbb{M}$，使得$\mathbb{M}/\mathbb{F}$是有限扩张．考虑$\mathcal{M}$的定义，以及“有限可分扩张都是单扩张”（\autoref{PrmtEl_cor2}~\upref{PrmtEl}），可知存在$\alpha$使得$\mathbb{M}=\mathbb{F}(\alpha)$．因此，如果$\sigma\in\opn{Gal}(\mathbb)$
