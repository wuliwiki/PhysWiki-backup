...
如果 $f: V^{\times k} \to \mathbb{F}$ 是一个多线性型（多线性函数），我们称它为\textbf{反对称多线性型}；全体反对称 $k$-形式的集合记做 ${\large \wedge}^k V$。
...
向量空间上的一个微分算子是一个线性映射 $\dd{} : {\large \wedge}^k V \to {\large \wedge}^{k + 1} V$，满足
\begin{itemize}
