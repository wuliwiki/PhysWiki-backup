...
\footnote{参考 \cite{Brandsen} Chap. 3.5 One-electron atoms in parabolic coordinates.}本文使用原子单位制\upref{AU}． shi'y
...
\dv{\xi} \qty(\xi \dv{f}{\xi}) + \qty(\frac{m E \xi}{2} - \frac{m^2}{4\xi} + \nu_1) f = 0
\end{equation}
\begin{equation}
