...
全微分绕闭合回路积分为$0$
\begin{equation}
0=\oint_L \dd{(x^{\prime}\cdot \bvec R)x^{\prime}}=\oint_L (x^{\prime}\cdot\bvec R)\dd l^{\prime}+\oint_l (\dd l^{\prime}\cdot \bvec R)x^{\prime}=\dfrac1 2\oint_L (x^{\prime}\times\dd l^{\prime})\times \bvec R \label{edy33_eq8}
\end{equation}
故而
\begin{equation}
