...
\end{equation}
 ...
 对于碰撞 $\Gamma,\Gamma_1\rightarrow\Gamma',\Gamma_1'$，其中，$$ 气体单位时间在每单位体积内的这种碰撞总数，可以写成每单位体积中的分子数 $f\dd\Gamma$ 与这其中的任一分子经受该类型碰撞的概率的乘积．这一概率总是正比于单位体积中 $\Gamma_1$ 处的分子数 $f_1\dd \Gamma_1$，并且正比于碰撞后两个分子 $\Gamma$ 值的所在的区间 $\dd\Gamma'$ 和 $\dd \Gamma_1'$
