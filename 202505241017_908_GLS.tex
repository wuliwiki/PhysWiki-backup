...
2. T. D. Lee, Kerson Huang, C. N. Yang（1957年6月15日）.《硬球玻色体系的本征值与本征函数及其低温性质》（*Eigenvalues and Eigenfunctions of a Bose System of Hard Spheres and Its Low-Temperature Properties*），《物理评论》（*Physical Review*），106 (6): 1135–1145。Bibcode: 1957PhRv..106.1135L。doi: [10.1103/PhysRev.106.1135](https://doi.org/10.1103/PhysRev.106.1135)。ISSN: 0031-899X。

3. Elliott H. Lieb, Werner Liniger（1963年5月15日）.《相互作用玻色气体的精确分析：I. 通解与基态》（*Exact Analysis of an Interacting Bose Gas. I. The General Solution and the Ground State*），《物理评论》（*Physical Review*），130 (4): 1605–1616。Bibcode: 1963PhRv..130.1605L。doi: [10.1103/PhysRev.130.1605](https://doi.org/10.1103/PhysRev.130.1605)。ISSN: 0031-899X。

4. Jakub Kopyciński, Maciej Łebek, Maciej Marciniak, Rafał Ołdziejewski, Wojciech Górecki, Krzysztof Pawłowski（2022年1月14日）.《一维气体中超越格罗斯–皮塔耶夫斯基方程的研究：准粒子与孤子》（*Beyond Gross-Pitaevskii equation for 1D gas: quasiparticles and solitons*），*SciPost Physics*，12 (1): 023。arXiv:2106.15289。Bibcode: 2022ScPP...12...23K。doi: [10.21468/SciPostPhys.12.1.023](https://doi.org/10.21468/SciPostPhys.12.1.023)。ISSN: 2542-4653。S2CID: 235670023。
