...
\item \verb`jl_method_instance_t *mfunc = jl_lookup_generic_(jl_value_t *F, jl_value_t **args, uint32_t nargs, uint32_t callsite, size_t world);` 根据函数对象，入参，以及调用该函数处的指针，world_age 共同决定
\end{itemize}
