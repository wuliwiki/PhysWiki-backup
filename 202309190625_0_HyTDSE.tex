...
\begin{equation}
\begin{aligned}
&\quad\mel{rY_{l,m}}{\cos\theta\pdv{r}}{rY_{l',m}}\\
&= \mel{rY_{l,m}}{\cos\theta}{\frac{1}{r}\dv{\psi_{l',m}}{r}Y_{l',m}}
-\mel{rY_{l,m}}{\frac{1}{r}\cos\theta}{rY_{l',m}}\\
&= \mel{\frac{\psi_{l',m}}{r^2}}{\dv{r}}{\psi_{l',m}}\mel{Y_{l,m}}{\cos\theta}{Y_{l',m}}
-\mel{r}{\frac{1}{r}}{r}\mel{Y_{l,m}}{\cos\theta}{Y_{l',m}}~.
\end{aligned}
\end{equation}
