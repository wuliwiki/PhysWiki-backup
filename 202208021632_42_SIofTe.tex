...
\begin{equation}
\begin{aligned}
A^2&=\frac{1}{(p!)^2}\sum_{\sigma,\pi\in S_p}\epsilon_\sigma\epsilon_\pi f_\sigma\circ f_\pi=\frac{1}{(p!)^2}\sum_{\sigma\in S_p}\epsilon_\sigma\epsilon_\pi f_\sigma\circ f_\pi\\
&=\frac{1}{(p!)^2}\sum_{\sigma,\pi\in S_p}\epsilon_{\sigma\pi} f_{\sigma\pi}\\
&=\frac{1}{(p!)^2}
\end{aligned}
\end{equation}
