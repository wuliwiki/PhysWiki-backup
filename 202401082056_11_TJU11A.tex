...
\item $e^{\mathcal i\alpha \sigma_y}=\sum\limits^{\infty}_{k=0}\frac{(\mathcal i \alpha \sigma_y)^{2k}}{2k!}+\sum\limits^{\infty}_{k=0}\frac{(\mathcal i \alpha \sigma_y)^{2k+1}}{(2k+1)!}=\sum\limits^{\infty}_{k=0}\frac{- (\alpha )^{2k}}{2k!}+\sum\limits^{\infty}_{k=0}\frac{(\mathcal i \alpha \sigma_y)^{2k}}{(2k+1)!}$
\end{enumerate}
\subsection{ }
\subsection{ }
\subsection{ }
