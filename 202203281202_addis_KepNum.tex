...
\caption{在同一位置以同 $45^\circ$ 仰角和不同初速度发射的质点的轨道， 动画见\href{https://wuli.wiki/apps/Kepler.html}{这里}． 速度最大的轨道为双曲线， 其他轨道为椭圆．} \label{KepNum_fig2}
\end{figure}
...
这里给出另一组参数， 计算以 $45^\circ$ 仰角， 模拟不同初速度发射的情况， 替换到以上代码中即可．
