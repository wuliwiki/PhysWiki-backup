...
在$t=t_a$时，场源向相距R的场点发出一个速度为c的信号；在$t=t_b$时，场点才收到场源的信号．因此，场点在$t=t_b$时刻得知的信息只是$t_a$时刻场源的信息．此例子中，$\Delta t= t_b-t_a = R/c = |R|$．

广而论之，t时刻场点得到的场源信息都是$\Delta t = R/c$前、或$(t-\Delta t = t-R/c)$时刻的场源信息，因此可以定义推迟时刻$t_r=t-R/c$
