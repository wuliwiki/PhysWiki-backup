...
\end{figure}
那么自然而然的，合振动的振幅取决于两个位移矢量合成后的模长，当两个位移矢量同向，也就是波源在该位置的相位差为$2n\pi(n\in \mathbb{N}_0)$时，合振动振幅最大，我们把质点所在位置称之为振动加强点；当位移矢量反向，即相位差为$(2n+1)\pi$时，合振动振幅最小，此时位置则是振动减弱点。
...
中学物理常引入“振动步调”的概念来描述波源的振动相位。振动步调即振动位移，那么“振动步调一致”即波源的振动位移方程相同，$\phi_1-\phi_2=0$。当相位差为$2n\pi$，也就是振动加强时，波程差$r_1-r_2=n\lambda$，当振动减弱，也就是相位差为$(2n+1)\pi$时，有$r_1-r_2=(2n+1)\lambda/2$。
