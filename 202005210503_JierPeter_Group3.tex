...
\begin{theorem}{Burnside引理}\label{Group3_the3}
设群$G$作用在集合$X$上．对于给定的$g\in G$，记$X^g=\{x\in X|g\cdot x=x\}$，$O_x$是$x\in X$的轨道，那么$|\{O_x|x\in X\}|=\frac{1}{|G|}\sum_{g\in G}|X^g|$．就是说，$X$上轨道的数目，等于$\frac{1}{|G|}\sum_{g\in G}|X^g|$．
\end{theorem}
