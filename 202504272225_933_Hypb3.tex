...
在开方时，为了保证正负两种可能性，方程中自然出现了 $\pm$ 符号。这就得到了\autoref{eq_Hypb3_16}。当然，在学习了\enref{泰勒展开}{Taylor}后，可以给出更严谨些的证明：
...
\begin{split}
y &= \frac{bx}{a} -\frac{bx}{a} \cdot\frac{a^2}{2x^2}+\frac{bx}{a}\order{{x^2}}\\
& = \frac ba x - \frac{ab}{2x} + \order{\frac{1}{x^3}}~.
\end{split}
\end{equation}
