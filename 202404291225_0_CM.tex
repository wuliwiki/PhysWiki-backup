...
\subsection{质心的定义}
\textbf{质心（center of mass）}通俗来讲可以理解为一个系统的质量中心， 是系统中\textbf{位置矢量\upref{Disp}关于质量的加权平均值}。 我们先看几个例子。 注意本文主要是讨论质心的\textbf{定义}， 至于为什么要这么定义， 以及质心和物体受力平衡之间的联系则留到以后（\autoref{ex_CM_1} 给出了一个初步的思考）。
...
\begin{exercise}{}
证明两质点的质心必定在其连线上， 即 $\bvec r_1 - \bvec r_c$ 和 $\bvec r_2 - \bvec r_c$ 共线。且证明% 共线如何证明？ “几何矢量” 中有提吗？
\end{exercise}
