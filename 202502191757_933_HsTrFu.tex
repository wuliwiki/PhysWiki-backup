...
诱导公式
由于圆的对称性，。以及三角函数的定义可以明显的察觉到当两个角所对应的点P是关于X轴或Y轴或原点对称的时候，他们的横坐标纵坐标以及坐标的壁纸可能存在相等的情况或者相反的情况，这时可以轻易的得到这些角之间三角函数的关系。。这使得三角函数在第234象限角的情况与第一象限角的情况只是相差了一个符号所以最重要的还是锐角情况下三角函数的值。由于这些关系可以快速地将其他象限角的情况快速映射到锐角第一象限角情况
