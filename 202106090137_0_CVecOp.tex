...
\pentry{正交曲线坐标系\upref{CurCor}， 矢量的导数 求导法则\upref{DerV}， 全微分\upref{TDiff}， 正交曲线坐标系中的重积分\upref{CrIntN}， 旋度\upref{Curl}， 拉普拉斯算符\upref{Laplac}}

\footnote{参考 \cite{GriffE} 附录．}我们以三维正交曲线坐标系为例讨论． 该坐标系中， 位置矢量\upref{Disp} $\bvec r$ 是三个坐标 $u, v, w$ 的（矢量）函数． 那么位置矢量的全微分\upref{TDiff}为
