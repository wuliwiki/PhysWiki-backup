...
$$K_{A0} = K_{A} + K_{B}$$
即
\begin{equation}\label{TwoCld_eq4}
v_{Ax0}^2 = v_{Ax}^2 + v_{Ay}^2 + v_{Bx}^2 + v_{By}^2
\end{equation}

要证明 
\begin{equation}
\bvec p_A \perp \bvec p_B
\end{equation}
只需证明 
\begin{equation}
\bvec p_A \cdot \bvec p_B = 0
\end{equation}
只需证明 
\begin{equation}
v_{Ax}v_{Bx}+v_{Ay}v_{By}=0
\end{equation}
代入\autoref{TwoCld_eq2} ，所以只需证明
\begin{equation}\label{TwoCld_eq6}
v_{Ax}v_{Bx}-v_{Ay}^2=0
\end{equation}

将\autoref{TwoCld_eq3} 代入\autoref{TwoCld_eq4} ，得
\begin{equation}
2v_{Ax}v_{Bx} = v_{Ay}^2 + v_{By}^2
\end{equation}
代入\autoref{TwoCld_eq2} ，得
\begin{equation}\label{TwoCld_eq5}
2v_{Ax}v_{Bx} = 2v_{Ay}^2
\end{equation}
对比\autoref{TwoCld_eq5} 与\autoref{TwoCld_eq6} ，即可证明．
\end{example}
