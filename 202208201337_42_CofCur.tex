...
\begin{equation}
\lim_{\Delta s\rightarrow0}\frac{\abs{\overline{P_1P_2}}}{\Delta s^{n+1}}\neq0,\quad \lim_{\Delta s\rightarrow0}\frac{\abs{\overline{P_1P_2}}}{\Delta s^{n+2}}=0
\end{equation}
...
\end{equation}
则 $\overline{P_1P_2}$ 是 $m+1$ 阶无穷小，根据\autoref{CofCur_def1} ，$\Gamma_1,\Gamma_2$ 在 $P_0$ 点有 $n$ 阶切触．
