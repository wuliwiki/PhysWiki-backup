...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/dbcf88e9d21acc51.png}
\caption{代表点与研究的代表点密度随时间变化} \label{fig_LiouTh_1}
\end{figure}
...
下面考虑证明刘维尔定理：
设相空间的某处体元 $\dd \Omega$ 内有一些相点，有相点密度 $\widetilde \rho(q_i, p_i, t)$。考虑这些相点随时间变化