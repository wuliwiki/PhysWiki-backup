...
\end{theorem}
\textbf{证明（存在唯一和对起始点的连续性）：}由\autoref{the_PicMap_2}~\upref{PicMap}，对任一点 $z_0=(t_0,x_0)$，都有要求的点 $z_0$ 的领域 $M$（对应 $\abs{z-z_0}\leq b'$）存在，使得 $\forall z\in M$ ，皮卡映射（\autoref{def_PicMap_1}~\upref{PicMap}）
