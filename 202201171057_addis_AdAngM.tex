...
\pentry{角动量（量子力学）\upref{QOrbAM}}

回顾 $N$ 粒子经典体系总，每个粒子对于 $O$ 点的总角动量为每一粒子对于 $O$ 的角动量矢量 $\bvec L_i=\bvec r_i\cross\bvec p_i$ 之和， 且若系统受到的外力矩为零， 角动量守恒\upref{AMLaw}． 现在我们来讨论在量子力学中如何把两个粒子的角动量相加．
