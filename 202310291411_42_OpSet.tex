...
\end{equation}
 当且仅当 
 \begin{equation}\label{eq_OpSet_6}
...
\end{equation}
 当且仅当 
 \begin{equation}\label{eq_OpSet_7}
 (z\in X\cap Z)\lor (z\in Y\cap Z)=1~.
 \end{equation}
由\autoref{the_OpSet_3} 和\autoref{def_OpSet_5} ，\autoref{eq_OpSet_2} ,\autoref{eq_OpSet_6} 和\autoref{eq_OpSet_5} ,\autoref{eq_OpSet_7} 等式左边可写为
\begin{equation}
\begin{aligned}
...
\begin{equation}
\begin{aligned}
(z\in X\land z\in Y)\lor z\in Z,\quad\Leftrightarrow\quad(z\in X\lor z\in Y)\land (z\in Y\lor z\in Z),\\
z\in (X\cup Y)\lor z\in Z&=(z\in X\lor z\in Y)\land z\in Z,\\
(z\in X\cap Z)\lor (z\in Y\cap Z)&=(z\in X\land z\in Y)\lor (z\in Y\land z\in Z)~.
\end{aligned}
\end{equation}

由\autoref{the_OpSet_4} ，
