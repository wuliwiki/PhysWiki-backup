...
\subsubsection{一些符号}
\autoref{eq_test_4} \autoref{eq_test_5} \autoref{eq_test_6} \autoref{eq_test_7} 参考 \href{https://docs.julialang.org/en/v1/manual/unicode-input/}{Julia 符号表}和 \href{https://oeis.org/wiki/List_of_LaTeX_mathematical_symbols}{LaTeX 符号表}， 以及 \href{http://www.onemathematicalcat.org/MathJaxDocumentation/TeXSyntax.htm}{MathJax 符号表}。
...
\begin{equation}\label{eq_test_7}
