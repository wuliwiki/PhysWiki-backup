...
\end{enumerate}
\subsection{(10 分)}设量子体系某个表象的基矢量为 $|k\rangle$，$(k = 1, 2, \dots)$，它具有正交归一性和完备性。若系的任意一个量子态可表示为 $|\psi\rangle = \sum a_k |k\rangle$，则 $a_k = \langle k|\psi\rangle$。

\subsection{(10 分)}在一维散射问题中，反射系数为 $r$，透射系数为 $t$，则 $r + t = 1$。
