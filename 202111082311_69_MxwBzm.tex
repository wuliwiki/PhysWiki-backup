...
注意上式中第一第二行 $F$ 之所以能对 $v^2$ 作偏微分，是因为 $F$ 本身就是 $v^2$ 的函数，与 $\bvec v$ 的方向无关．也就是说，这一步用了各向同性假设．

同理，我们可以得到以下等式

\begin{equation}
\frac{\partial \ln F(v_x^2+v_y^2+v_z^2)}{\partial v^2}=\frac{\partial \ln g(v_x^2)}{\partial v_x^2}=\frac{\partial \ln g(v_y^2)}{\partial v_y^2}=\frac{\partial \ln g(v_z^2)}{\partial v_z^2}
\end{equation}
