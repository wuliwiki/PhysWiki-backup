...
下面的问题就是如何在单位圆中构造包含角$\alpha$的直角三角形。在直角三角形中，$\displaystyle\sin\theta = \frac{\text{对边}}{\text{斜边}}$，一个能把已知条件都利用上的直角三角形就是由$P$点向$x$轴作垂线得到的三角形，在这个三角形中，圆$O$的半径是斜边，而$v$的纵坐标
...
我们取单位圆上一点 $P(u,v)$，令 $OP$ 与 $x$ 轴夹角为 ，则
