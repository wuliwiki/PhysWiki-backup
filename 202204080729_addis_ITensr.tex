...
\subsection{坐标平移变换}
若刚体原来的惯性张量（关于原点）为 $I$， 质心为 $\bvec r_c = (x_{1,c}, x_{2,c}, x_{3,c})$， 把它平移 $\bvec r_0 = (x_{1,0}, x_{2,0}, x_{3,0})$ 后令新的惯性张量（关于原点）为 $\mat I'$， 则
\begin{equation}
...
\end{equation}
若把 $\bvec r_k$ 替换为 $\bvec r_k + \bvec r_0$， $x_{ik}$ 替换为 $x_{ik} + x_{i0}$， 再利用质心的定义， 就可以得到 $I'_{ij}$．
