% 曲率张量场
% keys 里奇曲率|曲率|测地线|广义相对论|引力|爱因斯坦场方程|relativity|gravity|Einstein Field Equation|geodesic|curvature|differential geometry|manifold|流形|联络|connection|黎曼曲率|Riemann curvature|黎曼张量|Riemann tensor|Ricci曲率|Ricci张量|Ricci curvature
