...
如果$[\mathbb{K}:\mathbb{F}]=1$，即$\mathbb{K}=\mathbb{F}$，则按\autoref{PlyRtS_eq9} 知$\opn{Gal}(f:\mathbb{F})/V_4=\{e\}$，即\textbf{得证}$\opn{Gal}(f:\mathbb{F})=V_4$．

如果$[\mathbb{K}:\mathbb{F}]=6$，则$\abs{\opn{Gal}(f:\mathbb{F})}=24$，即$\opn{Gal}(f:\mathbb{F})=S_4$．

如果$[\mathbb{K}:\mathbb{F}]=12$，则$\abs{\opn{Gal}(f:\mathbb{F})$
