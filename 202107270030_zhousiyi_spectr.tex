...
现在我们来看粒子的统计性质．我们来考虑一个二粒子态$a^\dagger_{\mathbf p}a^\dagger_{\mathbf q}| 0 \rangle$．因为$a^\dagger_{\mathbf p}$和$a^\dagger_{\mathbf q}$是对易的，这个态和$a^\dagger_{\mathbf q}a^\dagger_{\mathbf p}| 0 \rangle$．
