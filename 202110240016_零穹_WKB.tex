...
\begin{equation}
V(x)=V(a)+V'(a)(x-a)=E+g(x-a)
\end{equation}
 其中，$g=V'(a)<0$．于是在 $a$ 点附近的薛定谔方程为
 \begin{equation}\label{WKB_eq16}
 \dv[2]{u}{x}-\frac{2mg}{\hbar^2}(x-a)u=0
 \end{equation}
令
\begin{equation}
\xi=\qty(\frac{2mg}{\hbar^2})^{\frac{1}{3}}(x-a)
\end{equation}
则\autoref{WKB_eq16} 式变为
\begin{equation}\label{WKB_eq17}
\dv[2]{u}{\xi}-\xi u=0
\end{equation}
这是艾里函数\upref{AiryF}满足的微分方程\autoref{AiryF_eq2}~\upref{AiryF}．
在经典允许区($\xi<0$)中，\autoref{WKB_eq17} 的解为
