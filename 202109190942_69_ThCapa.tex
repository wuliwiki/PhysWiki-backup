...
\begin{equation}
\delta Q=[C_V\dd T+L_V\left(\frac{\partial V}{\partial T}\right)_p]\dd T+L_V\left(\frac{\partial V}{\partial p}\right)_T\dd p
=C_V \dd T+L_V \dd V 
\end{equation}

在实验上我们无法之间测量系统的内能．我们能测的物理量有 $p,V,T,C_p,C_V$．
