...
\begin{equation}
\begin{aligned}
\curl \bvec A =& \frac{1}{\sqrt{2}c\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{\eta}\qty(\sqrt{2}\sinh\xi\sin\eta
A_\phi) - \pdv{\phi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta)]\uvec \xi\\
&+ \frac{1}{\sqrt{2}c^2\sinh\xi\sin\eta\sqrt{\sinh^2\xi+\sin^2\eta}}\qty[\pdv{\phi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi) - \pdv{\xi}\qty(\sqrt{2}c\sinh\xi\sin\eta
A_\phi)]\uvec \eta
 \\
&+\frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\qty[\pdv{\xi}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\eta) - \pdv{\eta}\qty(c\sqrt{\sinh^2\xi+\sin^2\eta}A_\xi)]\uvec \phi
\end{aligned}
\end{equation}
\begin{equation}
\laplacian s = \frac{1}{c^2\qty(\sinh^2\xi+\sin^2\eta)}\qty(\pdv[2]{s}{\xi}\ + \pdv[2]{s}{\eta} )+ \pdv[2]{s}{z}
