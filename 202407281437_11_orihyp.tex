...
\begin{equation}
\begin{aligned}
i_X(\omega\wedge\eta)&=i_X(\omega_1\wedge...\wedge\omega_k\wedge\eta_1\wedge...\wedge\eta_l)\\
&=\sum_{i=1}^k(-1)^{i-1}\omega^{i}(X)\omega^1\wedge...\wedge\hat\omega^i\wedge...\wedge\omega^k\\
&+(-1)^k\sum_{i=1}^l(-1)^{i-1}\eta^{i}(X)\eta^1\wedge...\wedge\hat\eta^i\wedge...\wedge\eta^l~.
\end{aligned}
\end{equation}
