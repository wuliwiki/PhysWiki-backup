...
\begin{equation}
\begin{aligned}
\rho(\mu)(v_1 \wedge \cdots \wedge v_n) &= \sum_{\sigma \in S_n} \text{sgn}(\sigma) \rho(\mu)(v_{\sigma(1)} \otimes \dots \otimes v_{\sigma(n)}) \\
&= \sum_{\sigma \in S_n} \text{sgn}(\sigma) \text{sgn}(\mu) (v_{\mu(\sigma(1))} \otimes \dots \otimes v_{\mu(\sigma(n))}) \\
&= \sum_{\sigma \in S_n} \text{sgn}(\mu \sigma) (v_{\mu \sigma(1)} \otimes \dots \otimes v_{\mu \sigma(n)}) \\
