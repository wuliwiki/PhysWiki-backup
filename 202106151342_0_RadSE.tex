...
\end{equation}
当势能 $V(\bvec r)$ 处处为零时， 这就变成了球坐标系中的亥姆霍兹方程\upref{SphHHz}． 以下考虑球对称势能 $V(\bvec r) = V(r)$， 即势能只与到原点的距离有关． 此时波函数在球坐标系中可记为
\begin{equation}
\Psi(\bvec r) = \frac{1}{r}\sum_{n,l,m} \psi_{n,l}(r) Y_{l,m}(\uvec r)
\end{equation}
其中 $\psi_{l,m}(r)$ 称为\textbf{约化径向波函数（scaled radial wave function）}， 满足径向薛定谔方程
