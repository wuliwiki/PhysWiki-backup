...
在发电厂中，有一种高大耸立的冷却装置，称作“冷却塔”\autoref{fig_Hypb3_3} 。乍看之下像是一个圆台，但仔细观察会发现，其外形更接近一个中间收紧、两端张开的沙漏，而且轮廓并非由直线构成，而是略带弯曲的曲线。该结构可以通过一条特定的曲线绕轴旋转生成，其设计并非出于美观考虑，而是源于精巧的工程构想：它不仅能有效抵御强风、节省材料，还能提高散热效率。这些工程优势，正是建立在这种曲线所具备的数学性质之上。


\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/9d8f8fdb10436630.png}
\caption{冷却塔} \label{fig_Hypb3_3}
\end{figure}

在数学中，这类曲线早已有深入研究。它由两条彼此对称、互不相交的分支组成，尽管共享同一个坐标原点，但各自沿相反方向无限延伸，永不相遇。这种曲线被称为“双曲线”。

许多读者最早接触“双曲线”一词，往往是在初中学习反比例函数时。那时常听到一句话：“反比例函数的图像是双曲线。”彼时对双曲线的理解可能还很朴素和模糊，仅仅觉得图像是“两根”曲线，因此得名“双曲线”，至于更深层的几何结构和性质，课堂上往往并未展开，学生自然也无从深入探究。

既然反比例函数的图像是双曲线，读者也许还记得，双曲线具有一个重要的几何特性：它拥有两条\textbf{渐近线（asymptotes）}。尽管在高中阶段对这一概念的讲解相对有限，但在双曲线中，渐近线具有核心地位。双曲线的两个分支会无限接近各自的渐近线，却永远不会与之相交。

本文在介绍双曲线的过程中，也将进一步分析双曲线与渐近线之间的关系，从而拓展对这一曲线的理解视角。
