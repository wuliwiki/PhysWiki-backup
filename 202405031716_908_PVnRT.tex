...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Ideal_gas}{相关页面}。}\textbf{理想气体（ideal gas）}是热力学中一个理想化的模型， 可以类比\enref{自由落体\upref{ConstA}， 简谐振子等\upref{SHO}。 该模型描述静止的密闭容器中一定量气体的压强， 体积和温度之间的关系。 该模型假设：
\begin{enumerate}
