...
\right.
\end{equation}
在无外界影响的情况下，$\dot{\bvec r_c}=0$（这是因为系统的动量守恒）．系统的势能为 $V(r)$．因此拉格朗日量为 $L=T(\dot{\bvec r})-V(r)$．两个物体一定在同一个平面内作运动，设 $\bvec r$ 在该平面内转过的角度为 $\phi$，设 $|\bvec r|=\rho$．我们取广义坐标 $\rho,\phi$．那么 $T=\frac{1}{2}\mu \dot{\bvec r}^2=\frac{1}{2}\mu \dot \rho^2+\frac{1}{2}\mu \dot\rho^2\dot\phi^2$．体系的拉格朗日量和哈密顿量为
\begin{equation}
\begin{aligned}
&L=\frac{1}{2}\mu \dot \rho^2+\frac{1}{2}\mu \dot\rho^2\dot\phi^2-V(\rho)\\
&H=T+V=\frac{1}{2}\mu \dot \rho^2+\frac{1}{2}\mu \dot\rho^2\dot\phi^2+V(\rho)
\end{aligned}
\end{equation}
因此可以列出拉格朗日方程：
\begin{equation}
\frac{\dd }{\dd t}\frac{\partial L}{\partial \dot\rho}=\frac{\partial L}{\partial \rho}\Rightarrow 
\end{equation}