...
为表示简洁，用“$_{;a}$”表示$\partial_a$，即$\partial^iR_{ij}=R_{ij;i}$。那么第二 Bianchi 恒等式表示为：
\begin{equation}
...
\begin{equation}
\begin{aligned}
g^{bk}g^{aj}R_{abcd;e}+R_{abec;d}+R_{abde;c}&=0\\
&=g^{bk}(R^j{}_{bcd;e}+R^j{}_{bec;d}+R^j{}_{bde;c})\\
&=~.
\end{aligned}
\end{equation}
