...
\item $\varphi$ 称为\textbf{初相（initial phase）}，的进一步原因在于，称它即函数在在 $x=0$ 处相位 $\omega x+\varphi$ 为的相位，初相就是在 $0$ 处的相位。
