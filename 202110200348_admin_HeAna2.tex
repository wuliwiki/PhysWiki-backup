...
\end{equation}
根据边界条件\autoref{CulmWf_eq4}~\upref{CulmWf}， $C(\bvec k)$ 本身也自带一个不收敛的相位 $-\eta \ln 2kr$， 而电场的傅里叶变换 $\tilde f(-\omega)$ 和 $\E^{-\I E t}$ 相位恒定， 所以对某个方向 $\uvec k$， 有
\begin{equation}
\pdv{E} c(\uvec k k(E)) = \pdv{E} \mel{C(\bvec k)}{z}{i}
\end{equation}
