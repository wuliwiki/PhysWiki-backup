...
\begin{enumerate}
    ...
    \item 对于非$0$元素，乘法$\times$存在\textbf{单位元}，记为$1$，常称为“幺元”\footnote{这是有争议的。有的数学家从形式上定义，不要求环有幺元，而把有幺元的特别称呼为“幺环”；但是有的数学家认为，我们很少研究不含幺元的环，所以不如直接定义环必须有幺元，简化讨论。本书使用后一种传统，但是有时也会为了强调而使用“幺环”的术语，也就是说我们会将“环”和“幺环”视作等价的术语来使用。}。
    \end{itemize}
...
不至于混淆时，为方便计，可用集合符号$R$代指环$(R, +, \times)$，称为“环$R$”。
\end{definition}
...
\begin{enumerate}
    ...
    \item 乘法$\times$具有\textbf{结合性}。
    \item 乘法在$\mathbb{F}^*$上存在单位元，记为$1$，常称为“幺元”。
    \item 对于任意$\mathbb{F}^*$中元素$a$，存在其乘法逆元$a^{-1}$，使得$a\times a^{-1}=1$。
    \end{itemize}
...
不至于混淆时，为方便计，可用集合符号$\mathbb{F}$代指域$(\mathbb{F}, +, \times)$，称为“域$\mathbb{F}$”。
\end{definition}
