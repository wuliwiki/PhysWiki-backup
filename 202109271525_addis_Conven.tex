...
\subsubsection{通用规范}
\begin{itemize}
\item 数域用双线字母表示， 实数 $\mathbb R$、 复数 $\mathbb C$、 有理数 $\mathbb Q$， 自然数 $\mathbb N$．
\item 根据 ISO \href{https://en.wikipedia.org/wiki/ISO/IEC_80000}{国际标准}， \textbf{自然数}定义为非负整数． \textbf{非零自然数}定义为正整数．
