...
\end{equation}
即系统总角动量（矢量） $\bvec L$ 对时间的变化率等于所有外力矩的矢量和（合外力矩） $\bvec \tau$．角动量定理可以类比动量定理\upref{PLaw}， 其中角动量与动量对应， 力矩与力对应．

角动量定理可以类比动量定理\upref{PLaw}． 当角动量始终沿着同一方向时（例如刚体的绕轴转动\upref{RigRot}）
