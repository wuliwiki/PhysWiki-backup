...
\item linux 暂时不支持 \verb|apt| 安装， 安装方法参考\href{https://kaustubh13.medium.com/how-to-install-cling-on-linux-or-wsl-8125798ed9b9}{这里}．
\item 推荐直接 \href{https://root.cern/download/cling/}{download binary}
\item 解压： \verb|bzip2 -d ???.bz2|， \verb|tar -xvf ???.tar|．
\item 解压以后， 可以直接进入到 \verb|bin| 文件夹运行 \verb|./cling| 看看是否成功． 如果成功， 可以添加一个软链 \verb|sudo ln -s cling /usr/bin/|．
