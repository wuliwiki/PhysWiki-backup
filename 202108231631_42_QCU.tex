...
\autoref{QCU_eq8} 是由测量公理得出的，结合\autoref{QCU_the2} ，我们得到下面的定理．
\begin{theorem}{}
$\boldsymbol{Q}$ 与任选单位无关．即任意 $\hat{\boldsymbol{Q}},\hat{\boldsymbol{Q'}}\in\tilde{\boldsymbol{Q}}$，对$\boldsymbol{Q}$ 的测量结果记为 
\end{theorem}
同样的，我们可以得到下面的定理.
