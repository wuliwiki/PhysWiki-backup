...
有了测量公理，便可讨论 $\widetilde{\boldsymbol{Q_1}}$ 和 $\wid{\boldsymbol{Q_2}}$ 的关系．由商的定义\autoref{QCU_eq4} ，可知 $\hat{\boldsymbol{Q_1}}$ 测量 $\boldsymbol{Q_2}$ 得数为 $\frac{\boldsymbol{Q_2}}{\boldsymbol{Q_1}}$ 