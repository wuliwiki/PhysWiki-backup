...
有了引理的支持，证明过程就比较容易了。设 $P$ 是双曲线上的任意一点\footnote{以下假设在$F_1$一侧，不影响证明。}，$l$ 是过 $P$ 的切线，在 $l$ 上任取另一点 $P'$（$P'\neq P$），连接 $PF_1$、$PF_2$ 以及 $P'F_1$、$P'F_2$。由于 $P'$ 在双曲线外部，而 $F_1,F_2$ 位于双曲线内部，因此线段 $P'F_1,P'F_2$ 必定与双曲线两支分别交于某一点，记为 $Q,R$，且满足：
