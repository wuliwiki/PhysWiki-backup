...
现在证明，$\mathcal L(V_1^*,V_2^*;\mathbb F)$ 就是 $V_1,V_2$ 的张量积．设 $U$ 是域 $\mathbb F$ 上任一线性空间，
...
由空间张量基的定义（\autoref{TPofSp_def1} ），\textbf{证得} $\mathcal L(V_1^*,V_2^*,\mathbb F)$ 就是 $V_1,V_2$ 的张量积．
