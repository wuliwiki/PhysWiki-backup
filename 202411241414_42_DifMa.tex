...
\begin{equation}
\begin{aligned}
f(x_i+h)&=f(x_i)+f'(x_i)h+\frac{1}{2}f''(x_0)h^2+\frac{1}{6}f'''(x_0)h^3,\\
f(x_i)&=f(x_i-h)+f'(x_i-h)h+\frac{1}{2}f''(x_0-h)h^2+\frac{1}{6}f'''(x_0-h)h^3.
\end{aligned}~
\end{equation}
因此
\begin{equation}
f(x_i+h)-f(x_i-h)=h(f'(x_i)+f'(x_i-h))+\frac{1}{2}h^2(f''(x_0)+f''(x_0-h))~
\end{equation}
