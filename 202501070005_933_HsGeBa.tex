...
d = 2r~.
\end{equation}
此时，所对圆心角为平角，即$180^\circ$，所对弧称为\textbf{半圆（semi circle）}。

对于圆上任意不重合的三点 $A,B,C$，有以下概念：
\begin{itemize}
\item 顶点位于圆上，两边与圆相交的角称作\textbf{圆周角（inscribed angle）}。设顶点为$C$，则圆周角$\angle ACB$所夹圆弧$\overset{\frown}{AB}$称作其对应的弧，同弧对应的圆心角是圆周角的两倍。
\end{itemize}
