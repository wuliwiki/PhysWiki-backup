...
在高中阶段，常见的恒等式包括\enref{三角恒等式}{HsAnTf}、\enref{组合恒等式}{combin}以及代数运算中的恒等式，包括二项式定理和等幂和差公式。
\begin{theorem}{二项式定理}
\begin{equation}
...
两个表达式$a$与$b$的幂次均为$n$，则它们的和与差具有如下关系：
\begin{equation}
...
：两个常见的特例为$a^2-b^2=(a+b)(a-b)$
立方和、差：$a^3\pm b^3=(a\pm b)(a^2\mp ab+b)$
