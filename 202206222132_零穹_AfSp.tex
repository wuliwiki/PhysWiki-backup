...
\end{equation}
若 $\dot p,\dot q$ 在此坐标系中的坐标分别为 $x_1,\cdots,x_n$ 和 $y_1,\cdots,y_n$ ，那么矢量 $\vec{pq}$ 在此基底之下的坐标为 $y_1-x_1,\cdots,y_n-x_n$．对任意矢量 $a=\sum_{i=1}^n a_ie_i$ ，点 $\dot p+a$ 的坐标是 $x_1+a_1,\cdots,x_n+a_n$．
\end{theorem} 