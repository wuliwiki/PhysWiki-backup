...
\begin{corollary}{}
设椭圆 $\displaystyle{\frac{x^2}{a^2}+\frac{y^2}{b^2}}$，直线 \(l\) 交椭圆于点 \(A\) 和\,\(B\)，点 \(P(x_0,y_0)\) 为线段 \(AB\) 的中点，求直线斜率
\begin{figure}[ht]
\centering
...
\textbf{解：}作变换 $\displaystyle{x'=\frac{x}{a},y'=\frac{y}{b}}$ ，则椭圆化为单位圆 \(C:x'^2+y'^2=1\)，且 $\displaystyle{P'\left(\frac{x_0}{a},\frac{y_0}{b}\right)}$
...
而 \(k_{A'B'}\cdot k_{OP'}=-1\) ，得 $\displaystyle{k_{A'B'}=-\frac{bx_0}{ay_0}}$

由上述性质， $\displaystyle{k_l=\frac{b}{a}\cdot k_{A'B'}=-\frac{b^2x_0}{a^2y_0}}$
\end{corollary}
\begin{corollary}{}
设椭圆   $\displaystyle{\Gamma:\frac{x^2}{a^2}+\frac{y^2}{b^2}=1(a>b>0)}$，直线 \(l\) 切椭圆于点 \(P(x_0,y_0)\)，求直线斜率 

\textbf{解：}作变换 $\displaystyle{x'=\frac{x}{a},y'=\frac{y}{b}}$ ，则椭圆化为单位圆 \(C:x'^2+y'^2=1\)，$\displaystyle{P'\left(\frac{x_0}{a},\frac{y_0}{b}\right)}$ 

故  $\displaystyle{k_{OP'}=\frac{ay_0}{bx_0}}$ 

在圆中，由切线定理， \(OP'\bot l'\) 

而  \(k_{l'}\cdot k_{OP'}=-1\) ，得 $\displaystyle{k_{l'}=-\frac{bx_0}{ay_0}}$ 
...
\begin{corollary}{}
设椭圆 $\displaystyle{\Gamma:\frac{x^2}{a^2}+\frac{y^2}{b^2}=1(a>b>0)}$， \(A\) 、\(B\) 和 \(M\) 为椭圆上的点，点 \(A\) 和 \(B\) 关于原点对称，求证： \(k_{MA}\cdot k_{MB}\) 为一定值
​
\begin{figure}[ht]
\centering
...
\textbf{证明：}作变换 $\displaystyle{x'=\frac{x}{a},y'=\frac{y}{b}}$ ，则椭圆化为单位圆 \(C:x'^2+y'^2=1\)
...
\begin{corollary}{}
设椭圆 $\displaystyle{\Gamma:\frac{x^2}{a^2}+\frac{y^2}{b^2}=1(a>b>0)}$， \(A\) 和 \(B\) 为椭圆上的点，点 \(M\) 为 \(AB\) 的中点，求证： \(k_{AB}\cdot k_{OM}\) 为一定值
...
设椭圆 $\displaystyle{\Gamma\frac{x^2}{a^2}+\frac{y^2}{b^2}=1(a>b>0)}$， \(A\) 和 \(B\) 为椭圆上的点，直线 \(AB\) 交 \(x\) 轴于点 \(P(x_0,0)\) ，在 \(x\) 轴上求一点 \(G\) ，使 \(x\) 轴平分 \(\angle AGB\) 
