...
对于一般的情况，考虑线性映射 $H: V \otimes V' \to W \otimes W'$，取 $v \in V, v' \in V'$，当且仅当 $H(v \otimes v') \in W \otimes W'$ 正好是形如 $w \otimes w'$，我们就能找到
\begin{equation}
h(v) = w, h'(v') = w'~
\end{equation}
使得 $H = h \otimes h'$。
...
\end{equation}
由于 $e_i \otimes e_j + e_{i + 1} \otimes e_{j + 1}$ 不可能写成 $w \otimes w'$ 的形式，
