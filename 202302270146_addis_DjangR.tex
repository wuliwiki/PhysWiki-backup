...
\item django 基于 \textbf{MVT （Model-View-Template）} 的\textbf{设计模式（design pattern）}。 \textbf{Model}： 整个应用的数据结构和数据库。 \textbf{View}： 渲染用户界面（HTML/CSS/Javascript）。 \textbf{Template}: HTML 模板， 用一些特殊语法指定如何加载动态内容。
