...
\begin{equation}
\phi(\mathbf{x})=\int \frac{d^{3} p}{(2 \pi)^{3}} \frac{1}{\sqrt{2 E_{\vec \mathbf{p}}}}\left(a_{\vec \mathbf{p}} e^{i \mathbf{p} \cdot \mathbf{x}}+a_{\mathbf{p}}^{\dagger} e^{-i \mathbf{p} \cdot \mathbf{x}}\right)~,
\end{equation}
