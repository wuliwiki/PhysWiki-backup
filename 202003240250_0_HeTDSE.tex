...
\item 90eV xuv 的 direct （n=1）电离后电子的末动能为 2.4037146 a.u.（65.408405eV）， 末动量为 2.1925850a.u.

\item 90eV xuv 的 shakeup （n=2）电离后电子末动能为 0.9037146 a.u. （24.591326eV）， 末动量为 1.3444066a.u.

\item 90eV xuv 的 shakeup （n=3）电离后电子末动能为 0.62593682 a.u. （17.032608eV）， 末动量为 1.1188716a.u.
\end{itemize}
