...
\begin{aligned}
f(t)&=t-1+(f(0)+1)\E^{-\frac{1}{2}}\cos(\frac{\sqrt{3}}{2}t)\\&
+(f'(0)+\frac{1}{2}f(0)-\frac{1}{2})\E^{-\frac{1}{2}}\sin(\frac{\sqrt{3}}{2}t)
\end{aligned}
\end{equation}
