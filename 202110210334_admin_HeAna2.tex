...
\end{equation}
所有其他的 $(l_1,l_2)$ 分波在 $r_2\to\infty$ 波函数都消失． 这样就可以把这个态记为 $\ket{L,M; l_1,l_2, n_1, k_2}$． 分号用于提醒后面的量子数只是无穷远处的边界条件， 这个态仍然只是 $E,L,M$ 的本征态． 如果把这些态用 CG 系数线性组合一下， 就可以得到 $\ket{l_1, m_1, l_2,m_2,n_1,k_2}$， 注意此时除了能量， 剩下的量子数都是在 $r_2\to+\infty$ 处 well define．
