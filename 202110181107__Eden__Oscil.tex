...
\end{equation}
其中 $[V]_{\alpha\beta}$ 是对称矩阵．体系的动能 $T=\frac{1}{2}m_i\dot{x}_i(\bvec q)^2=\frac{1}{2}T_{\alpha\beta} \dot{q}_\alpha \dot{q}_\beta$，其中 $[T]_{\alpha\beta}$ 为对称矩阵，且正定（无论怎样取 $\dot{q}_\alpha$，$T_{\alpha\beta} \dot{q}_\alpha \dot{q}_\beta$ 的值都 $\ge0$）．
...
拉格朗日方程为
\begin{equation}
T_{\alpha\beta}\ddot{q}_beta+V_{\alpha\beta}
\end{equation}