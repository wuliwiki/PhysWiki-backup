...
如果只考虑双粒子的自旋\upref{Spin}态矢量空间， 同样由于概率原因我们要求全同粒子同样在该空间的态矢满足交换对称。

单电子自旋为 $1/2$， 自旋态在 2 维空间， 两个基底通常记为 $\uparrow$ 和 $\downarrow$， 分别代表自旋 $z$ 分量 $m_s=\pm 1/2$。 而双电子的自旋态是该空间和自己的张量积， 是 $2\times2 = 4$ 维的， 四个正交归一基底自然地可以取张量积 $\uparrow\uparrow, \uparrow\downarrow, \downarrow\uparrow, \downarrow\downarrow$ 。 但中间两个既不是对称也不是反对称的， 所以我们可以将他们稍作线性变换， 得到 4 个具有交换对称性的正交归一基底
