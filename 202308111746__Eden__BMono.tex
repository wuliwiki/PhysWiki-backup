...
由于 Wu-Yang 单极子所构造的磁矢势没有奇异的狄拉克弦，所以我们可以对北半球和南半球分别利用 stokes 定理求出磁通量。磁场在闭球面上的磁通量为 $\mu_0 e_M$（根据\autoref{eq_BMono_2} ）可以被表示为沿赤道的两个磁矢势的线积分之差：
...
，可以构造一个赤道上的标量函数 $\phi$ 使得赤道上的两种取值可以通过规范变换相联系： $\bvec A^N = \bvec A^S + \nabla\phi$ 。
