...
令 $f_1(t), f_2(x)$ 的频率分别为 $\omega_1, \omega_2$， 周期为 $T_1, T_2$， 它们都相差很小． 令 $\Delta \omega = \omega_2 - \omega_1$， $\Delta T = T_2 - T_1$， 那么我们要求 $\Delta \omega/\omega_i \ll 1$， $\Delta T/T_i \ll 1$ （$i = 1,2$）．

为讨论方便我们讨论 $T_2 > T_1$ （$\omega_2 < \omega_1$） 的情况， 若某个点 $t_0$ 处两标记重合， 那么再经过大约 $T_i/\Delta T$ 个周期后， 标记会再次重合． 所以拍频的频率是基本频率 $\omega_i$ 的 % 所以两个波包的距离为 $(T_i/\Delta T)\cdot T_i = T_i^2/\Delta T$， 拍的频率为 $2\pi \Delta T/T_i^2$．
