...
\]
我们始终有：\(\alpha + \beta \leq \alpha \oplus \beta\)
以及
\[
...
如果 \(\alpha < \omega^\gamma\) 且 \(\beta < \omega^\gamma\)，那么：
\[
\alpha \oplus \beta < \omega^\gamma
\]
  

如果 \(\alpha < \omega^{\omega^\gamma}\) 且 \(\beta < \omega^{\omega^\gamma}\)，那么：
\[
\alpha \otimes \beta < \omega^{\omega^\gamma}
\]
  

---

**自然和和自然积在右侧参数上并非连续的**，例如：
\[
\lim_{n < \omega} (\alpha \oplus n) = \alpha + \omega
\]
而不是：
\[
\alpha \oplus \omega
...
同样：
\[
\lim_{n < \omega} (\alpha \otimes n) = \alpha \cdot \omega
\]
而不是：
\[
\alpha \otimes \omega
