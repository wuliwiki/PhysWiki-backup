...
\end{equation}
其中 $E_1=(e_1,\cdots,e_n)$ 是 $\mathbb R^n$ 的基， $E_2=(e'_1,\cdots,e'_n)$ 是 $\mathbb R^m$ 的基，$X=(x_1,\cdots,x_n)^T$ 是矢量 $E_1X\in\mathbb R^n$ 在基 $E_1$ 下的坐标，$\bar A$ 为za。设 $f$ 是 $\mathbb R^m$ 上的线性连续泛函，则由共轭算子定义，
\begin{equation}
A^*f=fA.~
\end{equation}
因此
\begin{equation}
A^*f(E_1X)=(fA)(E_1X)=f(E_2 AX)=f(E_2)AX.~
\end{equation}
