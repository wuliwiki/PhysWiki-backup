...
在各参考系中计算波长，就要计算对应参考系中同一时间下两波峰的空间距离．对于$K_1$，同一时间意味着$t_1=t_2$；对于$K_2$，同一时间意味着$t_1-vt_1=t_2-v(t_2+\lambda)$，
...
在$K_2$中，“同一时间”条件为$t_1-vt_1\cos{\theta}=t_2-v(t_2+\lambda)\cos{\theta}$．由此可计算得，$\lambda'=\lambda\sqrt{\sin^2{\theta}+\frac{\cos^2\theta}{1-v^2}=$
