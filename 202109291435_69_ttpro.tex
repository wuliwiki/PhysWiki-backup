...
最后一个等号可以由焓的方程\upref{MWRel}\autoref{MWRel_eq3} 推出．对理想气体来说，等压膨胀系数 $\alpha=\frac{1}{T}$，焦汤系数为　$0$，气体没有降温．这个结果并不出人意料，因为理想气体\upref{Igas}的分子间没有互相作用力，内能只是温度的函数，在绝热条件下内能没有发生变化．