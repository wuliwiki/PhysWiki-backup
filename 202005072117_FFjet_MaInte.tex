...
\end{equation}
这里， aJ=l、就是通过以闭合回路abed 为边界的任意曲面的总磁化电流，所以
式(8-59) 表明磁化强度对闭合问路的线积分等j 通过问路所包旧的血积内的
总磁化电流式(8-59 ) 虽是从均匀磁化介质及长方形闭合回路的简单特例导
出的，但却是在任何情况下都普遍适用的关系式
