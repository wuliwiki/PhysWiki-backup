...
\item $\forall x\in[-{3\pi\over4}+2k\pi,{\pi\over4}+2k\pi],\sin x\leq\cos x$，$\forall x\in[{\pi\over4}+2k\pi,{5\pi\over4}+2k\pi],\sin x\geq\cos x$，$k\in\mathbb{Z}$
\end{itemize}

还有一种常见的情况，选取$g(x)$为$f(x)$的某条切线，此时，切点往往成为取等的临界条件。
