...
由动量定理 $\bvec I = \bvec F \Delta t = \Delta \bvec p$ 的矢量性，如果在某一方向 $\hat{e}$ 上系统受到的合外力 $F_{e} = \bvec F \cdot \hat{e}$ 为零，则系统在这方向上有 $\Delta p_{e} = \Delta \bvec p \cdot \hat{e} = (\bvec F \cdot \hat{e}) \Delta t = 0$，所以系统在这方向上动量守恒。
