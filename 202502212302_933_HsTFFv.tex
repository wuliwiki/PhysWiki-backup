...
值得注意的是，三角函数的零点和奇异点（即定义域中无法取到的点）与其周期性、对称性存在紧密联系。而这些特殊点也都出现在终边与坐标轴重合的情况下，而这些位置恰好不是象限角（$0^\circ, 90^\circ, 180^\circ, 270^\circ$）所限定的范围，而是更一般的形式，如 $k\pi$ 或 $\frac{\pi}{2} + k\pi$，这使得它们在三角函数的研究中具有核心地位。后续在讨论周期性和对称性时，这些点将再次发挥重要作用。
