...
\begin{equation}
\parallel \Psi \parallel^2 = \langle\hat{1}\rangle=\int d^{3}x \Psi^{*}(\boldsymbol{x}, t) 1 \Psi(\boldsymbol{x}, t)=1~.
\end{equation}
...
\end{equation}
在 Griffiths 的量子力学概论中\cite{GriffQ}，多次用到 \autoref{eq_Ehrenf_2}。
\end{example}
