...
\item ${\rm B}$和${\Gamma}$分别表示第一类欧拉积分${\rm B(x,y)}$（Beta函数）和第二类欧拉积分${\Gamma (z)}$（Gamma函数），以及由此积分导出的概率分布：Beta分布${\rm B(\alpha,\beta)}$和Gamma分布$\Gamma (\alpha,\beta)$。
\end{itemize}
