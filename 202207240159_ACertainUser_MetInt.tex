...
\subsubsection{相界}
相界是一种更复杂的微结构，需要你对相对概念有所理解．不过简言之，相可以被如下定义：
\begin{definition}{相（材料科学）}
材料中结构、性质、成分相同或相近的一部分被称为一相；各相间有明显的边界．
\end{definition}

\begin{example}{图中水有几个相？}
\begin{figure}[ht]
\centering
\includegraphics[width=5cm]{./figures/MetInt_14.png}
\caption{请添加图片描述} \label{MetInt_fig14}
\end{figure}
\end{example}
