...
\subsubsection{简谐振动 $g(t)= \E^{-\I\omega t}$ 乘以方形脉冲（从 $t=t_1$ 到 $t=t_2$）}
%未完成： 应该直接讨论三角函数的情况
与上面的推导类似，结果为
\begin{equation}
...
\subsubsection{简谐振动 $g(t)= \cos(\omega t)$ 乘以方形脉冲（从 $t=t_1$ 到 $t=t_2$）}
...
\end{equation}
作为一个近似， 如果 $\abs{\omega - \omega_{ij}} \ll \omega + \omega_{ij}$ 那么有
