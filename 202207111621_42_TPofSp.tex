...
\end{equation}
那么对任意 $v=\sum_\limits{i}v_ie_i\in V_1$，有
\begin{equation}
f_1(v)=\sum_{i}v_if_1(e_i)=\sum_{i}v_i\alpha_i=\sum_{i}v_if(e_i)=f(v)
\end{equation}
即 $f_1=f$．

\textbf{证毕！}
\begin{lemma}{}
设 $V_1,V_2$ 分别是 $n$ 维和 $m$ 维的矢量空间， $\{\mu_i\}$，$\{\nu_i\}$ 分别是 $V_1^*,v_2^*$ 的基，那么
\begin{equation}
\mu_i\otimes\nu_j,\quad i=1,\cdots,n,\quad j=1,\cdots,m
\end{equation}
 是 $\mathcal{V_1,V_2,\mathbb F}$ 的一组基．
\end{lemma}
\begin{theorem}{}
