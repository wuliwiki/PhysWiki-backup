...
如果只考虑双粒子的自旋态空间， 全通粒子同样要求在该空间的状态满足交换对称． 以最常见的电子态为例， 单电子自旋态是一个二维空间， 两个基底通常取 $\uparrow$ 和 $\downarrow$， 分别代表 $\ket{s=1/2,m_s=\pm 1/2}$． 而双粒子的自旋态是该空间和自己的张量积， 是 4 维的， 基底可以取 $\uparrow\uparrow, \uparrow\downarrow, \downarrow\uparrow, \downarrow\downarrow$ 四种． 但第二和第三种既不是交换对称也不是反对称的． 所以我们可以将四个基底改为
\begin{equation}
...
当我们考虑两个粒子的总状态时， 我们可以把空间视为双粒子波函数空间和双粒子自旋态空间的张量积空间． 量子力学假设玻色子和费米子分别在该空间中具有交换对称或反对称．
