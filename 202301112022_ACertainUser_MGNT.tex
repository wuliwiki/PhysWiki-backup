...
\item 磁化电流、极化电流产生了额外的磁场。磁性介质的存在改变了磁场的分布。极化电流\upref{PolCur} $\bvec B = \bvec B_0 + \bvec B'$, $\curl {\bvec B} = \mu_0 (\bvec j_f + \bvec j_M + \bvec j_p) + \mu_0\epsilon_0 \pdv{\bvec E}{t} = \mu_0 \bvec j_f + \mu_0 \curl \bvec M + \mu_0 \pdv{\bvec P}{t} + \mu_0 \epsilon_0 \pdv{\bvec E}{t}$

\item 为了简化极化电荷的影响，引入“磁场强度”矢量：$\bvec H = \frac{\bvec B}{\mu_0} - \bvec M$,并有电位移矢量的高斯定律 $\curl \bvec H = \bvec j_f + \pdv{\bvec D}{t}$
