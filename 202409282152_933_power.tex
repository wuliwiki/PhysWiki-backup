...
如果将第一象限以$x=1,y=x,y=1$三条线分成六个区域。这三条线的交点是$(1,1)$，由于不论$a$取何值，$1^a=1$，因而幂函数一定会过点$(1,1)$。如果将$x=1,y=x$之间大于$1$的部分记作区域$\Roman{1}$，则可顺时针得到$\Roman{1},\Roman{2},\Roman{3},\Roman{4},\Roman{5},\Roman{6}$一共六个区域
