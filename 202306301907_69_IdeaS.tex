...
设某理想气体由 $N $ 个原子组成，体积为 $V$，能量为 $U$，现在，我们利用玻尔兹曼熵公式计算它的熵（可以加上一个常量）。假设 $N $ 为定值，但是 $U $ 和 $V $ 可以变化。我们要求的量是 $S(U,V)$。为了计算熵，我们利用玻尔兹曼公式\footnote{具体的内容参考熵的微观定义与玻尔兹曼公式\upref{entro2}。}
