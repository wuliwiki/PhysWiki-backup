...
考虑由 $N$ 个\textbf{全同\footnote{需要考虑全同粒子假设，$\Omega=\Omega_{M.B.}/N!$。}、近独立\upref{depsys}\footnote{近独立的意思是，系统的总能量近似等于所有单粒子能量的总和，即忽略粒子相互作用势。这是一个极粗糙的近似，但我们可以以此简化计算得到系统可能的一些性质。}}的玻色子组成的系统。根据玻色分布，处在能级 $\epsilon_l$ 上的粒子数为
\begin{equation}
