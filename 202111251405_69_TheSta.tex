...
\begin{equation}
\begin{aligned}
\dd E&=\sum_l a_l\dd \epsilon_l+\sum_l\epsilon_l\dd a_l
\\
&=\delta W+\delta Q+\mu\dd N=Y\dd y+\delta Q+\mu \dd N
\end{aligned}
\end{equation}
由此可以推出热量的传递：
\begin{equation}\label{TheSta_eq2}
\begin{aligned}
\delta Q&=\dd E-Y\dd y-\mu \dd N
\\&=-N\dd{\qty(\frac{\partial \ln Z_1}{\partial \beta})}+\frac{N}{\beta}\frac{\partial \ln Z_1}{\partial y}\dd y-\mu \dd N
\end{aligned}
\end{equation}
...
\begin{aligned}
\beta \delta Q&=-N\beta\dd{\qty(\frac{\partial \ln Z_1}{\partial \beta})}+N\frac{\partial \ln Z_1}{\partial y}\dd y-\beta\mu\dd N\\
