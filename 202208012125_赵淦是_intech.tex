...
令 $\displaystyle{I_n=\int x^n e^{ax}\cos bx\,\mathrm{d}x},J=\int x^n e^{ax}\sin bx\,\mathrm{d}x$
$\displaystyle{\int x^n e^{ax}\cos bx\,\mathrm{d}x=x^n e^{ax}\frac{{a\cos bx+b\sin bx}}{a^2+b^2}-\frac{n}{a^2+b^2}\left(a\int x^{n-1}e^{ax}\cos bx\,\mathrm{d}x+b\int x^{n-1}e^{ax}\sin bx\,\mathrm{d}x\right)+C}$

$\displaystyle{\int x^n e^{ax}\sin bx\,\mathrm{d}x=x^n e^{ax}\frac{{a\sin bx-b\cos bx}}{a^2+b^2}-\frac{n}{a^2+b^2}\left(a\int x^{n-1}e^{ax}\sin bx\,\mathrm{d}x-b\int x^{n-1}e^{ax}\cos bx\,\mathrm{d}x\right)+C}$ 
\end{corollary}
