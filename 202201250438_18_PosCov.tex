...
\end{theorem}
\textbf{证明.} 证明非常简单. 在后一种情形, $c_n{a_n}/{a_{n+1}}-c_{n+1} \leq0$等价于$a_{n+1}/a_n\geq c_{n}/c_{n+1}$, 所以由乘性比较原理, 立刻得到级数$\sum_{n=1}^\infty a_n$发散. 在前一种情形, 由$c_n{a_n}/{a_{n+1}}-c_{n+1}\geq k$知道$c_na_n-c_{n+1}a_{n+1}\geq \kappa a_{n+1}>0$, 所以序列$\{c_na_n\}$是单调递减的, 从而有极限. 于是望远镜级数
$$
