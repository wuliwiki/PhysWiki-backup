...
\item 数值计算的基态能量： -2.9037244 a.u. （-79.014366 eV）

\item 氦离子基态能量： -2 a.u. （-27.2eV） 第一激发态 -0.5 a.u.(-13.6eV)

\item direct 单电离 threshold： 0.9037244 a.u. （24.591594eV）

\item shakeup 电离 threshold： 

\item 90eV 的 xuv 光子能量为 3.3074390 a.u.

\item direct 电离后电子的末动能为 2.4037146 a.u.（65.408405eV）， 末动量为 2.1925850a.u.

\item shakeup （n=1）电离后电子末动能为 0.9037146 a.u. （24.591326eV）， 末动量为 1.3444066a.u.
\end{itemize}
