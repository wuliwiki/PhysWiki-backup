...
让我们进一步分析过热液体 $AJ$ 和过冷气体 $NB$ 的性质．虽然它们处于平衡稳定条件，但如果加以扰动，它们将迅速演变为气液共存态，落到 $ADB$ 水平线上．这是为什么呢？让我们研究这两个系统的某个热力学势，以吉布斯自由能\upref{GibbsG}（即化学势）作为判据进行分析．利用 $\dd \mu=-S\dd T+V\dd P=V\dd P$ 得到等温线上对应的化学势变化曲线．如图
...
此外，我们发现当系统处于 $JDN$ 曲线上时，$\mu$-$P$ 曲线的二阶导大于 $0$，即
\begin{equation}
...
现在考察 $JA$ 和 $BN$，其 $\mu$-$P$ 曲线的二阶导小于 $0$，
