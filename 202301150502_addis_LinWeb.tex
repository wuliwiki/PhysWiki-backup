...
\begin{itemize}
\item 另外参考一个\href{https://www.digitalocean.com/community/tutorials/how-to-forward-ports-through-a-linux-gateway-with-iptables}{具体教程}， 讲解如何设置网关的 port forwarding 可以让外网访问内网的 nginx 服务器。
\end{itemize}
