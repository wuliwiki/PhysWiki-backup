...
考虑方程
\begin{equation}
10\qty(\frac{\dd y}{\dd x})^2+5x\frac{\dd y}{\dd x}+x^2=y
\end{equation}
令$p=\dd y/\dd x$，两边对$x$求导，则原方程化为
\begin{equation}
20p\frac{\dd p}{\dd x}+5p+5x\frac{\dd p}{\dd x}+2x=p
\end{equation}
整理得
\begin{equation}\label{ODEa4_eq4}
20p\frac{\dd p}{\dd x}+5x\frac{\dd p}{\dd x}+4p+2x=0
\end{equation}
\end{example}
...
% % $\frac{X}{Y}=\frac{Y-1}{2}$
% 此处$X, Y$是原方程前两个的系数，$X/Y=AC/AD=BC/BD=(Y-q)/2$
