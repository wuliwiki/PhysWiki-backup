...
\hline
$A$→$O$ & 位移向右，减小；回复力及加速度向左，减小；振子速度向左，增大；振子动能增大，弹簧的势能减小 \\
\hline
$O$ & 位移、回复力及加速度为零；振子速度向左，达最大值，动能达最大值，弹簧的势能为零 \\
\hline
$O$→$A'$ & 位移向左，增大；回复力及加速度向右，增大；振子速度向左，减小；振子动能减小，弹簧的势能增大 \\
\hline
$A'$ & 位移向左，达最大值；回复力及加速度向右，达最小值；振子动能为零，弹簧的势能达最大值 \\
\hline
$A'$→$O$ & 位移向左，减小；回复力及加速度向右，减小； \\
\hline
* & * \\
\hline
\end{tabular}
