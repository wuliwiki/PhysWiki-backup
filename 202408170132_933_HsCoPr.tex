...
这些命题中都有一个共同的特点——需要在陈述中表达所述事物的“全体”的含义，这时使用的量词称为\textbf{全称量词}（universal quantifier），记作$\forall$，可以读作“任意”、“所有”、“每一个”等\footnote{在自然语言中，“每一”和“全体”强调的重点不同，前者强调每一个个体，后者强调整体，但在逻辑中不区分二者。}。形如“集合$M$中所有的元素$x$，都满足性质$P(x)$”的命题称为\textbf{全称量词命题}或称“性质$P(x)$\textbf{恒成立}（universal proposition）”，记作：
