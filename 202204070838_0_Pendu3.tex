...
&= \frac{1}{2}(m_1l_1^2 + m_2r_2^2 + I_1)\omega_1^2 + \frac{1}{2}(m_2l_2^2 + I_2)\omega_2^2 + m_2r_1l_2\cos(\theta_1+\alpha-\theta_2)\omega_1\omega_2
\end{aligned}
\end{equation}
...
\end{equation}
\begin{equation}
\pdv{V}{\theta_1} = m_1gl_1\sin\theta_1 + m_2gr_1\sin(\theta_1+\alpha)
\end{equation}
