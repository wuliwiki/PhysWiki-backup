...
\end{equation}
\begin{equation}
\laplacian s = \frac{1}{\sqrt{2}c^3\sinh\xi\sin\eta\qty(\sinh^2\xi+\sin^2\eta)}\qty(\pdv{\xi}\qty(\sqrt{2}c\sinh\xi\sin\eta\pdv{s}{\xi}) + \pdv{\eta}\qty(\sqrt{2}c\sinh\xi\sin\eta\pdv{s}{\eta})  )+ \pdv{\phi}
\end{equation}
