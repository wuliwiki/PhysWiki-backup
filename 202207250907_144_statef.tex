...
\subsection{"状态公理"}
%好像没有正式的表述？感觉这么叫挺合适的（
系统的各热力学参量间并不是互相独立的．事实上，如果系统不处于外场\footnote{例如处于重力场下的大气，压强会随高度的变化而变化，情况肯定会有所不同，}之中、系统中的物质种类已知，那么少数几个宏观的热力学参量就能完整地刻画一个\textbf{热力学平衡系统}．
...
对于一定量的物质（可以是气体、液体或固体），我们可以把内能 $E$ 写成 $T$ 和 $P$ 的函数 $E(T,P)$，因此可以写出 $E$ 的全微分形式：
\begin{equation}
