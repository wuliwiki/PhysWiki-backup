...
\begin{equation}
V & = & \iint \frac{\sigma r \mathrm{d} \varphi \mathrm{d} r}{4 \pi \varepsilon_{0} \sqrt{r^{2}+z^{2}}} \\ 
& = & \frac{\sigma}{4 \pi \varepsilon_{0}} \int_{0}^{2 \pi} \mathrm{d} \varphi \int_{0}^{R} \frac{r \mathrm{d} r}{\sqrt{r^{2}+z^{2}}}\\ 
& = & \frac{\sigma}{2 \varepsilon_{0}}\left(\sqrt{R^{2}+z^{2}}-z\right)
\end{equation}
