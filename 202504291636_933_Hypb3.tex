...
通过一个焦点且垂直于实轴的弦称为\textbf{通径（Latus Rectum）}。

\begin{example}{求：双曲线通径的长度}
...
\begin{example}{证明：对双曲线$\displaystyle\frac{x^2}{a^2} - \frac{y^2}{b^2} = 1$上任意一点$P(x_0,y_0)$，设右焦点为 $F(c,0)$ 则当$|PF|$最小时，$P$为右支端点。}

显然，若$P$在左支上，则取$P$关于$y$轴对称的点$P'$，一定有$|P'F|<|PF|$，故$P$一定在右支上。
根据两点距离公式有：
\begin{equation}
...
\end{equation}
由于$d\geq0$，取$d^2$有，带入\autoref{eq_Hypb3_24} 和\autoref{eq_Hypb3_12} 有：
