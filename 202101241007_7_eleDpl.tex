...
&=-\frac{1}{4\pi\epsilon_0}\pmat{(p_x\frac{x^2+y^2+z^2-3x^2}{(x^2+y^2+z^3)^{5/2}}+p_y\frac{x^2+y^2+z^2-3y^2}{(x^2+y^2+z^3)^{5/2}}+p_z\frac{x^2+y^2+z^2-3z^2}{(x^2+y^2+z^3)^{5/2}})}
\end{aligned}
\end{equation}
