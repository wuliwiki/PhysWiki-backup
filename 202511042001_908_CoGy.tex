...
\hline
卡佩拉模型（Capella's model）& 马提安努斯·卡佩拉（Martianus Capella，约公元 420 年）& 地心与日心混合模型（Geocentric and Heliocentric） \quad 地球静止于宇宙中心，月亮、太阳、三颗行星及恒星环绕其运行，而水星与金星则绕太阳公转。\cite{ref45}\\
\hline
阿耶波多模型（Aryabhatan model） \quad 阿耶波多（Aryabhata，公元 499 年） \quad 地心或日心模型（Geocentric or Heliocentric） \quad 地球自转，行星以椭圆轨道绕地球或太阳运行；由于行星轨道的位置既以地球又以太阳为参照，模型究竟是地心还是日心尚不确定。\\
\hline
《古兰经》宇宙学（Quranic cosmology） \quad 《古兰经》（Quran，公元 610–632 年） \quad 平面地球观（Flat-earth） \quad 宇宙由叠层的平面结构构成，其中包括七重天（seven levels of heaven），在部分诠释中还包含七层地（seven levels of earth），其中最下层为地狱（hell）。\\
\hline
中世纪宇宙（Medieval universe） \quad 中世纪哲学家（公元 500–1200 年） \quad 时间上有限（Finite in time） \quad 基督教学者约翰·菲罗波诺斯（John Philoponus）提出宇宙在时间上是有限的并具有起点，从而反对古希腊“无限过去”的概念。早期穆斯林哲学家阿尔·肯迪（Al-Kindi）、犹太哲学家萨阿迪亚·高恩（Saadia Gaon）以及穆斯林神学家阿尔·加扎利（Al-Ghazali）进一步发展了支持有限宇宙的逻辑论证。\\
\hline
非平行多元宇宙（Non-Parallel Multiverse） \quad 《博伽梵往世书》（\emph{Bhagvata Purana}，公元 800–1000 年） \quad 多元宇宙，非平行结构（Multiverse, Non-Parallel） \quad 无数宇宙的存在可与现代多元宇宙理论相比较，但这些宇宙并非平行——每个宇宙皆独立不同，每一具个体灵魂（\emph{jīva-ātma}，有身之魂）在任一时刻仅存在于一个宇宙之中。所有宇宙均由同一物质生成，因此它们遵循平行的时间循环——同时显现与隐没。\cite{ref46}\\
\hline
多宇宙宇宙学（Multiversal cosmology） \quad 法赫尔·丁·拉齐（Fakhr al-Din al-Razi，1149–1209） \quad 多元宇宙、多世界（Multiverse, multiple worlds and universes） \quad 在已知世界之外存在无限外层空间，真主（God）拥有能力使真空中充满无数个宇宙。\\
\hline
* & * & * & * \\
\hline
* & * & * & * \\
