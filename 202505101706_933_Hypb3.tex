...
\begin{equation}
h=\frac{|\displaystyle{b\over a}x_0-y_0|}{\displaystyle\sqrt{{b^2\over a^2}+1}}=\frac{|\displaystyle bx_0-ay_0|}{a\displaystyle\sqrt{{b^2\over a^2}+1}}~.
\end{equation}
...
\begin{split}
S&=ah\\
&=|x_1-x_0|\sqrt{1+{b^2\over a^2}}\cdot\frac{|\displaystyle bx_0-ay_0|}{a\displaystyle\sqrt{{b^2\over a^2}+1}}~.
\end{split}
\end{equation}
