...
\end{equation}
其中 $\uvec r$ 表示一个单位矢量\upref{GVec}， 指向球坐标中的点 $(1, \theta, \phi)$， $l, m$ 为整数， $l \geqslant 0$， $-l \leqslant m \leqslant -l$． $A_{l,m}$ 是归一化系数， 使得 $\abs{Y_{l, m} (\uvec r)}^2$ 在单位球面上的面积分等于 1 （\autoref{SphHar_eq8}）．
