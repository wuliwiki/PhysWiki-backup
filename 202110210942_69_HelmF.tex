...
亥姆霍兹自由能，简称自由能，常用 $A$ 或 $F$ 表示（本文将用 $F$ 表示）．自由能是一个热力学态函数，\textbf{对于一个恒温的封闭热力学系统，自由能的增量总是小于（不可逆过程）或等于（可逆过程）外界对系统做功的量}．我们称它为\textbf{最大功原理}．

由热力学第一定律\upref{Th1Law}，对于系统的任意一个过程，都有 $T\dd S\ge \delta Q=\dd U-\delta W$．在等温过程中，$T\dd S=\dd (TS)$，所以 $\delta W\ge \dd (U-TS)$．对照最大功原理，我们可以有如下定义．
