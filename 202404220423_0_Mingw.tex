...
\item \verb|pacman -S base-devel|，包含 \verb` binutils bison-3.8.2-5  diffstat-1.65-1  diffutils-3.10-1  dos2unix-7.5.1-1  flex-2.6.4-3
              m4-1.4.19-2  make-4.4.1-1  patch-2.7.6-2  pkgconf-2.1.0-1  texinfo-7.1-2  texinfo-tex-7.1-2
