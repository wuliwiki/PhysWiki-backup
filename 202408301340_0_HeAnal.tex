...
\begin{itemize}
\item \textbf{parahelium}: singlet spin ($l_s=0$), 对称波函数， 存在 1s 基态（我们使用的）。 \textbf{orthohelium}: triplet spin ($l_s=1$), 反对称波函数， 不存在 1s 基态， 但其他束缚态的能量相对较低。 GPT 说标准情况下 ortho 大约是 para 的三倍？
