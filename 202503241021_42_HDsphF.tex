...
就有
\begin{equation}
\frac{1}{R}r^{-N+2}\frac{\partial }{\partial r}\qty(r^{N}\frac{\partial u}{\partial r})=-\Nabla^{2}_{S^N}u=\lambda_N
\end{equation}
将\autoref{eq_HDsphF_3} 写成变量分离的形式：
\begin{equation}
r^{-N+2}\frac{\partial }{\partial r}\qty(r^{N}\frac{\partial u}{\partial r})=-\Nabla^{2}_{S^N}u=\lambda_N.~
\end{equation}
其中 $\lambda_N$ 是分离常数。
