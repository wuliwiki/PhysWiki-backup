...
\begin{equation}
\begin{aligned}
\boldsymbol{B}&=\oint{\mathrm{d}\boldsymbol{B_\parallel}}\\=\oint\mathrm{d}B\cos{\alpha}=\frac{\mu_0}{4\pi}\frac{I\mathrm{d}r}{R^2}\cos\alpha
\end{aligned}
\end{equation}
而
\begin{equation}
\mathrm{d}B_\parallel=\mathrm{d}B\cos{\alpha}=\frac{\mu_0}{4\pi}\frac{I\mathrm{d}r}{R^2}\cos\alpha
\end{equation}
\end{example}
