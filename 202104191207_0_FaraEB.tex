...
\varepsilon  =  -\dv{Φ}{t} =  -\Phi\dv{t} ∫ \bvec B \vd\int t \dd{\bvec a} =  - ∫ \dv{\bvec B}{t\int \vdot \dd{\bvec a}
\end{equation} 
这里的 $\bvec a$ 表示面积， 积分的曲面是以线圈为边界的任意曲面． 另一方面，感生电动势是由感生电场产生的． 
\begin{equation}\label{FaraEB_eq2}
\varepsilon  = ∮ \bvec E \oint vdot \dd{\bvec r}
\end{equation}
...
对比上面两式，得
\begin{equation}
\oint \bvec E \vdot \dd{\bvec r}  =  - ∫ \p\int v{\bvec B}{t} \vdot \dd{\bvec a} 
\end{equation} 
