...
另一个流行的 IDE 是 JetBrain 推出的 \href{https://www.jetbrains.com/clion/}{CLion}。 CLion 是一个跨平台的 IDE，也就是在 Windows，Mac，Linux 上都能使用。  CLion 功能较多较完善，学生可以免费使用，但对其他用户收费。 我们推荐 CLion。

另外也有一些免费的 IDE 如 Eclipse，NetBeans，Code::Blocks，Qt Creator 等。 事实上不同的 IDE 在基本功能上使用起来大同小异。
