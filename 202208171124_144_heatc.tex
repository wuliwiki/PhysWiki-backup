...
\begin{figure}[ht]
\centering
\includegraphics[width=1cm]{./figures/heatc_2.png}
\caption{请添加图片描述} \label{heatc_fig2}
\end{figure}
\end{example}

\begin{example}{限定源扩散}
一维杆 $0\le x\le +\infty$，初始温度为$T_0$，左端与恒温热源$T_s$接触，求杆各处温度随时间的变化．

解微分方程，得
\begin{equation}
T(x,t)=T_0+(T_s-T_0)\left(1-erf\left(\frac{x}{2\sqrt{Dt}}\right)\right)
\end{equation}
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/heatc_1.png}
\caption{限定源扩散，\href{https://www.geogebra.org/m/bd2pb74r}{一个可动的例子}（站外链接）} \label{heatc_fig1}
\end{figure}
\end{example}
