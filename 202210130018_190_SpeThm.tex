...
倘若$\exists A\in \mathcal{F}$使得$|A|=\lfloor\frac{n}{2} \rfloor=k$，则$\forall x\in [n]\backslash A,y\in A,\hat{A}\triangleq A\cup\{x\}\notin \mathcal{F}$,由于$N_{\mathcal{C}}=1$，这里$\mathcal{C}$取作包含$\hat{A}$和$B\triangleq \hat{A}\backslash\{y\}$的极大链，我们有$B\in \mathcal{F}$
$\square$
