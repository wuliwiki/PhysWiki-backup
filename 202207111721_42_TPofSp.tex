...
\end{theorem}
\textbf{证明：}由\autoref{TPofSp_cor1} ，映射 $\sigma:V_1\otimes V_2\rightarrow\mathcal L(V_1^*,V_2^*;\mathbb F)$ 是  $\mathcal L(V_1^*,V_2^*;\mathbb F)$ 中的矢量．而由 \autoref{TPofSp_lem1} ，若 $\{\mu_i\},\{\mu_i\}$ 分别是 $V_1,V_2$ 的基
\begin{equation}
\sigma()
\end{equation}
