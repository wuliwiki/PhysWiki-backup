...
任取$\alpha\in\mathbb{K}$．取$\mathbb{F}(\alpha)$的若干保$\mathbb{F}$单同态$\varphi_1, \cdots, \varphi_n:\mathbb{F}\to\overline{\mathbb{F}}$，其中$\varphi_1$是恒等映射．由\autoref{FldExp_the5}~\upref{FldExp}，可将每个$\varphi_i$开拓为$\overline{\mathbb{F}}$的保$\mathbb{F}$自同构$\phi_i$．
