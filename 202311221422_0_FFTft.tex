...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/e6c21da4cdca9131.png}
\caption{输出} \label{fig_FFTft_1}
\end{figure}
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/18aee60e41043d4d.png}
\caption{输出} \label{fig_FFTft_2}
\end{figure}
