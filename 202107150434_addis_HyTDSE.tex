...
\begin{equation}
V'(\bvec r) = \sum_{l,m} f_{l,m}(r) Y_{l,m}(\uvec r)
\end{equation}
那么 coupling 矩阵元为（\autoref{SphHar_eq5}~\upref{SphHar}）
\begin{equation}\label{HyTDSE_eq5}
\begin{aligned}
&\mel{Y_{l'',m''}}{V'(\bvec r)}{Y_{l',m'}} = \sum_{l,m} f_{l,m}(r) \mel{Y_{l'',m''}}{Y_{l,m}}{Y_{l',m'}}\\
&= \sum_{l,m} f_{l,m}(r) (-1)^{m''}\sqrt{\frac{(2l''+1)(2l+1)(2l'+1)}{4\pi}} \pmat{l''& l& l'\\ 0 & 0 & 0}\pmat{l'' & l & l'\\  -m'' & m & m'}
\end{aligned}
\end{equation}
注意矩阵元取决于 $r$．
