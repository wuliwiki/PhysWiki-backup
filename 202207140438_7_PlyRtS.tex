...
\autoref{PlyRtS_lem1} 中的四种情况正对应\autoref{PlyRtS_the3} 中的四种情况．
...
\subsubsection{讨论$\opn{Gal}(\mathbb{E}:\mathbb{K})$的性质}
...
所以如果$[\mathbb{K}:\mathbb{F}]=1$，即$\mathbb{K}=\mathbb{F}$，则按\autoref{PlyRtS_eq9} 知$\opn{Gal}(f:\mathbb{F})/V_4=\{e\}$，即\textbf{得证}$\opn{Gal}(f:\mathbb{F})=V_4$．
