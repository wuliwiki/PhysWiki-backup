...
我们同样可以在这个线性空间中定义内积$(g_\alpha,g_\beta)=\delta_{\alpha,\beta}$
...
$$x g_\alpha^{-1}=R(g_\alpha)x=\displaystyle\sum_\nu x_\nu (g_\nu g_\alpha^{-1})$$

这样定义后有：

$$R(g_\alpha)R(g_\beta)x=R(g_\alpha)x g_\beta^{-1}=x g_\beta^{-1} g_\alpha^{-1} =R(g_\alpha g_\beta)x$$
