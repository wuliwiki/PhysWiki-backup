...
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/a1508d6892fb4c90.png}
\caption{步骤 $7$} \label{fig_mmsab_31}
\end{figure}
接下来继续搜索，该递归访问根节点的下一子节点，继承 $\alpha$、$\beta$ 信息：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/0a8341a79ba04e1e.png}
\caption{步骤 $8$} \label{fig_mmsab_32}
\end{figure}
继续递归，访问到其第一个子节点，这是叶子节点，不继承信息并自更新 $\alpha$、$\beta$ 信息（因为在 Max 层所以更新 $\alpha$ 信息）：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/89c245c1873d4590.png}
\caption{步骤 $9$} \label{fig_mmsab_33}
\end{figure}
回溯，在 Min 层所以更新 $\beta$ 信息为各子节点的所有 $\alpha$、$\beta$ 值的最小值：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/e40908c2e1e80ec0.png}
\caption{步骤 $10$} \label{fig_mmsab_34}
\end{figure}
此时发现这节点的 $\alpha \ge \beta$，这说明他不会对父节点贡献一个更优的信息了。剪枝，不再进行后面的搜索：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/1b6c7473a1272bce.png}
\caption{步骤 $11$} \label{fig_mmsab_36}
\end{figure}
$\alpha-\beta$ 剪枝对应于遍历这当前节点的所有子节点的循环被跳出（\verb`break` 掉），所以不继续搜索这节点的子树：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/2542f9bc2a4db6c5.png}
\caption{步骤 $12$} \label{fig_mmsab_35}
\end{figure}
回溯，因为剪枝了所以不传递信息，剪枝掉的节点的信息不会对其父节点产生贡献，所以可以不考虑传递信息的问题：
\begin{figure}[ht]
\centering
\includegraphics[width=14cm]{./figures/fb33c40772a7ed33.png}
\caption{步骤 $13$} \label{fig_mmsab_37}
\end{figure}
