...
\addTODO{把量子力学简介里面的图复制过来（不要引用）}
\begin{figure}[ht]
\centering
\includegraphics[width=7.5cm]{./figures/197f3970f51a81a9.pdf}
\caption{无限深势阱的一些波函数能量本征态，每个能量 $E_i$ 叫做一个能级，共有无穷多个能级，将这些本征态叠加就能获得任何波函数例如波包。} \label{fig_ISW_1}
\end{figure}

\subsection{束缚态的意义}
复习一下 “量子力学的基本原理（科普）\upref{QM0}” 和 “量子力学的基本原理（量子力学）\upref{QMPrcp}”
