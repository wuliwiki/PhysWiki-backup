...
如果想完全利用 16 字节， 见 GCC 编译器的 \verb|__float128| 类型（\href{https://gcc.gnu.org/onlinedocs/gcc-8.1.0/libquadmath.pdf}{文档}）． 相当于 FORTRAN 的 \verb|QUAD real|． 有 112 bit 小数， 15 bit 指数和 1 bit 正负号（\autoref{FltCpp_fig1} ）．
