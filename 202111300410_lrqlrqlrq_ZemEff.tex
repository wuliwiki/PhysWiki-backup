...
\begin{equation}
\langle \mathbf{L+2S}\rangle =\left\langle \mathbf{J}+\frac{\mathbf{S\cdot J}}{J^2}\mathbf{J}\right\rangle=\left[1+\frac{j(j+1)-l(l+1)+3/4}{f2j(j+1)}\right]\langle\mathbf{J}\rangle
\end{equation}
