...
当考虑矢量 $\vec \mu = (a(x, t, u), b(x, t, u), c(x, t, u))|_{P_0}$，则微分方程恰好表示法向量 $\vec n$ 与 $\vec \mu$ 在 $P_0$ 点处互相垂直，从而在曲面 $u = u(x, t)$ 上以 $\vec \mu$ 为切矢量且与曲线 $\Gamma$ 相交，交点是 $(\tau, 0, \varphi(\tau))$ 的曲线fang
