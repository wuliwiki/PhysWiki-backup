...
\autoref{ResThe_lem1} 的证明很简单，将$f(z)$泰勒展开以后再除以$z$即可．

利用\autoref{ResThe_lem1} ，我们可以快速计算出很多常见函数的留数．

\begin{example}{}
求$\frac{1}{z(z-1)}$在$z=1$处的留数．

由于$\frac{1}{z}$在$z=1$处解析，因此根据\autoref{ResThe_lem1} 可知，
\begin{equation}
\opn{Rez}_1\frac{1}{z(z-1)}=\frac{1}{0-1}=-1
\end{equation}
\end{example}
