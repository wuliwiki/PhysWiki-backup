...
\end{equation}
而柯西—黎曼条件\upref{CauRie}恰好规定了这两个矢量场的旋度为零， 所以如果 $f(z)$ 在考虑的区域上解析， \autoref{AnaInt_eq1} 中的线积分结果只和起点和终点有关， 与路径无关（所有的路径必须在解析的区域内）． 于是可以得到类似于牛顿—莱布尼兹公式\upref{NLeib}， 令 $\bvec f_R, \bvec f_I$ 的势函数
\begin{equation}
