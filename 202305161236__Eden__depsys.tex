...
\begin{theorem}{}
近独立子系中，子系的分布函数可以由 $\bar a_\lambda \propto \omega_\lambda e^{-\alpha n_\lambda-\beta\epsilon_\lambda}$ 给出，$\epsilon_\lambda$ 为子系的能级大小，$n_\lambda$ 为子系的粒子占据数。
\end{theorem}


$\beta,\alpha$ 参数可以由系统的温度参数以及子系得化学势确定\footnote{玻尔兹曼分布（统计力学）\upref{MBsta}。}。这里要强调的是，这一公式不仅可以适用于经典理想气体，还可以推广到具有不同能级的玻色系统或费米系统中，但这时我们需要以另一种视角去看待系统和子系的能级。
