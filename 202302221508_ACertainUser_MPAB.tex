...
\hline
角动量定理 \upref{AMLaw1} & $\bvec \tau = \dv{\bvec L}{t}$ & $\bvec L = \bvec r \times \bvec p$ 质点角动量是质点动量与位矢的叉乘 & $\bvec \tau = \sum \bvec \tau_i $是质点所受力矩和；$\bvec \tau_i= \bvec r \times \bvec F_i$ 力矩是力与位矢的叉乘；& 力矩和为零时，质点角动量守恒\\
\hline
