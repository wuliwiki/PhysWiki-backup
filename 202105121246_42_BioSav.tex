...
\end{figure}
如\autoref{BioSav_fig2}，电流环半径为$r$ ， 以电流环圆心为原点，垂直与环面的轴线为$x$轴，在轴线上任取一点$P$，其dao与电流元$I\mathrm{d}\boldsymbol{r}$的连线与环面夹角为$\alpha$,则电流元$I\mathrm{d}\boldsymbol{r}$在$P$点的磁场为
\begin{equation}
...
&=\frac{\mu_0Ir^2}{2(a^2+r^2)^{\frac{3}{2}}}
\end{aligned}
\end{equation}
而
\begin{equation}
