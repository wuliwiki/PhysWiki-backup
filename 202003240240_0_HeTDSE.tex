...
\item 氦离子基态能量： -2 a.u. （-27.2eV） 第一激发态 -0.5 a.u.(-13.6eV) 第二激发态 -2/9=-0.22...a.u.（-6.0469747eV）

\item direct 单电离 threshold： 0.9037244 a.u. （24.591594eV）

\item shakeup （n=2）单电离 threshold： 2.4037244 a.u. （-65.408673eV）

\item shakeup （n=3）单电离 threshold： 
