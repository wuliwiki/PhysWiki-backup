...
\begin{aligned}
E&=\int \dd[3]{\bvec x}\frac{\epsilon_0}{2} \left(\frac{e}{4\pi\epsilon_0 |\bvec x|^2}\right)^2=\frac{1}{2(4\pi)^2\epsilon_0}\int_0^\infty 4\pi r^2\dd r \frac{1}{r^4}\\
&=\frac{1}{8\pi\epsilon_0} \int_0^\infty \frac{1}{r^2}\dd r
\end{aligned}
\end{equation}
发散的积分区域是 $r\rightarrow 0$ 处．如果我们取一个积分下限的截断，从 $1/\Lambda$ 积分到 $\infty$，我们将得到
\begin{equation}
E=\frac{1}{8\pi\epsilon_0}\int_{1/\Lambda}^{\infty} \frac{1}{r^2}\dd r=\frac{1}{8\pi\epsilon_0}\Lambda
\end{equation}
结果关于 $\Lambda$ 是线性发散的．如果\textbf{假设}经典电磁学的公式
