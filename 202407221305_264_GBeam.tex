...
如下图，假设衍射光中的一束光在$z_1$平面在$r_1$出以$theta_1$角度入射，在$z_2$平面以$r_2,\theta_2$出射。
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/3ab969bd13c685de.png}
\caption{图片来自A.E. Siegman, Lasers (Oxford University Press, Oxford, U. K.), Chapt. 20. 对参数的定义不同，所以图中的标注会有些许区别} \label{fig_GBeam_6}
\end{figure}
