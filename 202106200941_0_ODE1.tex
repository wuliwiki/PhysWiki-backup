...
上式右端第一式对应常系数齐次线性方程\autoref{ODE1_eq3} 的通解，第二项则是常系数非齐次线性方程\autoref{ODE1_eq4} 的一个特解（在通解\autoref{ODE1_eq12} 中取 $C=0$便得 ）．由此可知，一阶常系数非齐次线性方程的通解等于对应的齐次方程的通解与非齐次方程的一个特解之和．
\subsection{一般情况}
