...
由于能量密度正比于电场强度的平方，因此电场能量\textbf{不满足}叠加原理．从能量角度上看，这真是因为往已有电场中再加入电荷时，需要额外的外力做功已克服电场力，这部分外力功就被转换为相互作用能．

这里有一个巧妙的\textsl{陷阱}（具体参见\cite{GriffE}）．当我们在计算离散电荷的电势能\upref{QEng}时，我们事实上忽略了点电荷的固有能：因为不幸的是，点电荷的“固有能”是发散的．在将其推广至连续电荷分布时，这个问题得到了解决．
