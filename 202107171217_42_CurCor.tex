...
\begin{equation}
\begin{aligned}
&\dd s^2=\dd x^2+\dd y^2+\dd z^2=\qty(\pd{\varphi_1}{u}\dd u+\pd{\varphi_1}{v}\dd v+\pd{\varphi_1}{w}\dd w)^2+\\ 
&\qty(\pd{\psi_1}{q_1}\dd q_1+\pd{\psi_1}{v}\dd v+\pd{\psi_1}{w}\dd w)^2+\qty(\pd{\omega_1}{u}\dd u+\pd{\omega_1}{v}\dd v+\pd{\omega_1}{w}\dd w)^2
\end{aligned}
\end{equation}
