...
\partial_\mu T^\mu{}_\nu=0~.
\end{equation}
其中 $T^0{}_0$ 对应着哈密顿量密度，或者说电磁场的能量密度；$T^0{}_i$ 对应着电磁场的动量密度。我们已经推导过电磁场的能量密度为 $\mathcal H=\frac{1}{8\pi}(\bvec E^2+\bvec B^2)$ \upref{EBS}，也推导过电磁场的动量密度为\enref{$\mathcal P=\frac{1}{4\pi} \bvec E\times \bvec B$ }{EBP}。下面可以通过推导 \autoref{eq_EMtens_1} 验证这些结论。
