...
人教版初中教材中给出的“方程”定义是：“含有未知数的等式称作方程（equation）。”而未知数则一般指“方程的求解目标”。这看上去是一种循环定义，同时也会造成对某些问题的理解困难。因此，下面会先将一些基础

只在某些特定的变量取值下成立的等式称作\textbf{条件方程（conditional equations）}，也就是通常从小学就接触的“方程”，
