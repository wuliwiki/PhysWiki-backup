...
现要证明
\begin{equation}
\rangle\overline{f_1},\cdots,\overline{f_n}\langle=U^*
\end{equation}

事实上，显然 $\rangle\overline{f_1},\cdots,\overline{f_n}\langle \in U^*$．齐次，设 $\tilde f$ 是 $U^*$ 的任一矢量，$(\bvec e_1,\cdots,\bvec e_r)$ 的基底，而 $(\bvec e_1,\cdots,\bvec e_r;\bvec e_{r+1},\cdots,\bvec e_n)$ 是它在 $V$ 中的扩展基底．对这样的线性函数 $f\in V^*$，其中 
\begin{equation}
