...
\item \href{https://en.wikipedia.org/wiki/LR_parser}{LR parser}， \href{https://en.wikipedia.org/wiki/LALR_parser}{LALR parser}， \href{https://en.wikipedia.org/wiki/Recursive_descent_parser}{Recursive Descent parser} （G++ 和 Clang 都用是手写的 Recursive Descent）， \href{https://en.wikipedia.org/wiki/GLR_parser}{GLR parser}
\item C/C++ parser 的一个\href{https://stackoverflow.com/questions/6319086/are-gcc-and-clang-parsers-really-handwritten}{Stack Overflow 问题}．
