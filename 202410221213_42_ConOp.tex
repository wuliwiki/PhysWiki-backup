...
设 $A:\mathbb R^n\rightarrow\mathbb R^m$ 是线性算子，则 
\begin{equation}
A(E_1 X)=E_2 AX.~
\end{equation}
其中 $E_1=(e_1,\cdots,e_n)$ 是 $\mathbb R^n$ 的基， $E_2=(e'_1,\cdots,e'_n)$ 是 $\mathbb R^m$ 的基，$X=(x_1,\cdots,x_n)^T$ 是矢量 $E_1X\in\mathbb R^n$ 在基 $E_1$ 下的坐标。设 $f$ 是 $\mathbb R^m$ 上的线性连续泛函，则
\begin{equation}
(fA)(E_1X)=f(E_2AX)=f(E_2)AX.~
\end{equation}
