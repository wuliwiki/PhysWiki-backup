...
\mat M=\pmat{-1&1\\0&0}~.
\end{equation}
可以验证，$\mat M\bvec e_x=-\bvec e_x,\mat M \bvec e_y=\bvec e_y$。因此这确实是一个保持向量在y方向的分量不变，x轴分量反向的轴反射。任意向量的模长不因轴反射而改变，因此任何图像的形状在反射后不变。如果我们想进一步把“反射”的概念拓展到高维，只需要满足两个性质：依然保距，且兼容轴变换。
