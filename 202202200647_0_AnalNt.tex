...
\item 有向仿射 $k$-单形 $\sigma = [\bvec p_0,\bvec p_1,\dots,\bvec p_k]$ 是用 $Q^k$ 作参数域， 由仿射映射 $\sigma(\alpha_1\bvec e_1+\dots+\alpha_k\bvec e_k) = \bvec p_0 + \sum_{i=1}^k \alpha_i(\bvec p_i-\bvec p_0)$． 给出的 $R^n$ 中的 $k$-曲面． 注意……
\end{itemize}
