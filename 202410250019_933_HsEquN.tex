...
\end{equation}
其中，$\sqrt{a^2+b^2\over2}$称为平方平均数，它的特点是越大的值影响越大，或者说给予较大的值更高的权重。通常用在一些$0$附近的数上，来反映波动程度。${2\over\displaystyle{1\over a}$称为调和平均数，通常用来计算等量变化时的速率或比率，比如一段路一半以$60km/s$的速度运动，另一半以$30km/s$的速度运动，那么平均速度是$\frac{2}{\frac{1}{60} + \frac{1}{30}} = 40 \, $km/h



事实上，上面的四种平均数都可以扩展至多个数，对于一列数$a_1,a_2,\cdots,a_n$，称
\begin{equation}
\begin{array}{c} 
...
\item $H$——\textbf{调和平均数（Harmonic mean，或调和均值）}，其实是$\displaystyle \frac{n}{H} = \frac{1}{a_1} + \frac{1}{a_2} + \cdots + \frac{1}{a_n}$
\end{itemize}
