...
\begin{aligned}
\ev{v}&=A\int_{0}^{v_{m}} v\sin[2](\frac{\pi v}{v_{m}})\dd v=\frac{A}{2}\int_0^{v_m}v\qty[1-\cos\qty(\frac{2\pi v}{v_{m}})]\\
&=\frac{A}{2}\qty{\frac{v^2}{2}-\qty[\sin(\frac{2\pi v}{v_{m}})\cdot\frac{v}{\qty(\frac{2\pi}{v_m})}+\cos(\frac{2\pi v}{v_{m}})\frac{1}{\qty(\frac{2\pi}{v_m})^2}\Bigg|_{0}^{v_{m}}\\
&=A(\frac{v_{m}^2}{\pi}-0)=\frac{2v_{m}}{\pi}
\end{aligned}
\end{equation}
...
\begin{aligned}
\ev{v^2}&=A\int_{0}^{v_{m}} v^2\sin[2](\frac{\pi v}{v_{m}})\dd v\\
&=A\qty{\sin(\frac{\pi v}{v_{m}})\frac{2v}{(\frac{\pi }{v_{m}})^2}-\cos(\frac{\pi v}{v_{m}})\qty[\frac{v^2}{\frac{\pi}{v_{m}}}-\frac{2}{(\frac{\pi}{v_{m}})^3}]}\Bigg|_0^{v_{m}}\\
