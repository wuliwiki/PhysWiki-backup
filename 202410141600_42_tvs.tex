...
令 $U=E\backslash F$，则由加法的连续性，存在零邻域 $W_1,W_2$，使得 $W_1-W_2\subset U$，取 $W=W_1\cap W_2$，则存在零邻域 $W$，使得 $W-W\subset U$。设 $y\in [W]$，则点 $y$ 的每一邻域，特别是 $y+W$，都有属于 $W$ 的点 $z$，从而 $z-y\in W$，即 $y\in W-W\subset U$，因此 $[W]\in U$
