...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/a58f93605d652a54.pdf}
\caption{$\abs{\mel{k_z}{z}{1,0,0}}$， 实线、虚线：平面波近似， 点： 无近似（代码： \verb|plot_hydrogen_trans_dipole.m|）} \label{fig_HyIon2_3}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/a540cf946ddeffb6.pdf}
\caption{} \label{fig_HyIon2_1}
\end{figure}
...
legend({'plane wave approximation', ...
    'plane wave approximation analytical', 'Coulomb plane wave'});
grid on;
