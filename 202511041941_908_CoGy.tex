...
\hline
巴比伦宇宙学（Babylonian cosmology） \quad 巴比伦文献（\emph{Babylonian literature}，约公元前 2300–500 年） \quad 浮于无限“混沌之水”上的平面地球（Flat Earth floating in infinite "waters of chaos"） \quad 地球与天穹共同构成一个位于无限“混沌之水”（waters of chaos）中的整体；地球为平面且呈圆形，其上方覆盖着坚固的穹顶（即“天穹” \emph{firmament}），以阻隔外部的“混沌之海”。\\
\hline
埃利亚学派宇宙学（Eleatic cosmology） \quad 巴门尼德（Parmenides，约公元前 515 年） \quad 有限且球形（Finite and spherical in extent） \quad 宇宙是不变的、均匀的、完美的、必然的、超越时间的，既非生成也非消逝；虚空（Void）不存在。多样性与变化皆源于感官经验所导致的认知无知（epistemic ignorance）。时间与空间的界限皆为任意设定，且相对于巴门尼德式的整体（Parmenidean whole）而言是相对的。
```
