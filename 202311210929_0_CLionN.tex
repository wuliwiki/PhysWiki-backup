...
\item  启动用 \verb`sh /opt/clion-*/bin/clion.sh`， 可以在 bashrc 中设置 alias, 需要桌面快捷方式在 \verb`Tools -> Create Desktop Entry` 设置
\end{itemize}
...
\item ， 可以用 MobaXterm 远程 GUI。 运行用 \verb`/snap/clion/203/bin/clion.sh`， 可以在 bashrc 中设置 alias
