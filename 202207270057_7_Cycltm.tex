...
任取$\Phi_n$的一根$\varepsilon_i$，则由\autoref{Cycltm_def2} 的互素条件可知，$\varepsilon_i$的全体幂包含了全体$n$次单位根．于是，任取$f$的一根$\alpha$和$g$的一根$\beta$，总存在正整数$k$使得$\beta=\alpha^k$，且$k$与$n$互素（因为$\beta$是本原单位根）．遍历$f$和$g$的所有根，挑出其中使得$k$最小的情况，设该情况为“取$f$的根$\alpha_0$和$g$的根$\beta_0$，则$\beta_0=\alpha_0^k$”．由于$\alpha_0\neq \beta_0$，知$k>1$．
