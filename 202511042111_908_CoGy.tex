...
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/752f320041723ce2.png}
\caption{除前景中那几颗拥有衍射光芒、明亮且易于辨认的恒星外，复合照片中的每一个光点都是一整个独立的星系，其中一些星系的年龄高达 132 亿年；据估计，可观测宇宙中包含超过 2 万亿个星系。[1] ——摘自哈勃极深场（Hubble eXtreme Deep Field）。} \label{fig_CoGy_3}
\end{figure}
...
\subsection{参考文献}
\begin{enumerate}
\item 希勒，卡尔（Karl Hille）编（2016 年 10 月 13 日）：“哈勃揭示可观测宇宙中的星系数量是先前估计的十倍”（Hubble Reveals Observable Universe Contains 10 Times More Galaxies Than Previously Thought）。NASA。取自 2016 年 10 月 17 日。  
\item 赫瑟林顿，诺里斯·S.（Norriss S. Hetherington，2014）。《宇宙学百科全书（Routledge 重刊版）：现代宇宙学的历史、哲学与科学基础》（Encyclopedia of Cosmology Routledge Revivals: Historical, Philosophical, and Scientific Foundations of Modern Cosmology）。Routledge 出版社，第 116 页。ISBN 978-1317-67766-6。  
\item 吕米内，让-皮埃尔（Jean-Pierre Luminet，2008）。《包裹的宇宙》（The Wraparound Universe）。CRC Press，第 170 页。ISBN 978-1-4398-6496-8。  
\item “导论：宇宙学——空间”（Introduction: Cosmology – space），《新科学人》（New Scientist），2006 年 9 月 4 日。存档于 2015 年 7 月 3 日。  
\item “Cosmology”，《牛津词典》（Oxford Dictionaries）。  
\item 奥弗贝，丹尼斯（Dennis Overbye，2019 年 2 月 25 日）：“黑暗力量是否扰乱了宇宙？——轴子？幻影能量？天体物理学家试图修补宇宙的漏洞，并在此过程中重写宇宙史”（Have Dark Forces Been Messing With the Cosmos? – Axions? Phantom energy? Astrophysicists scramble to patch a hole in the universe, rewriting cosmic history in the process）。《纽约时报》（The New York Times）。取自 2019 年 2 月 26 日。  
\item 斯珀格尔，大卫·N.（David N. Spergel，2014 秋季）：“今日宇宙学”（Cosmology Today）。《达达罗斯》（Daedalus），143 (4): 125–133。doi:10.1162/DAED\_a\_00312。S2CID 57568214。  
\item 普朗克合作组（Planck Collaboration，2016 年 10 月 1 日）：“普朗克 2015 结果. XIII. 宇宙学参数”（Planck 2015 results. XIII. Cosmological parameters）。《天文学与天体物理学》（Astronomy & Astrophysics），594 (13)。PDF 第 31 页表 4。arXiv:1502.01589。doi:10.1051/0004-6361/201525830。  
\item 狄德罗（Denis Diderot，2015 年 4 月 1 日）：“人类知识体系的详细解释”（Detailed Explanation of the System of Human Knowledge）。《狄德罗与达朗贝尔百科全书——协作翻译计划》（Encyclopedia of Diderot & d'Alembert – Collaborative Translation Project）。取自 2015 年 4 月 1 日。  
\item 《马可·奥勒留沉思录》第八卷第 52 节（The Thoughts of Marcus Aurelius Antoninus viii.52）。  
\item 爱因斯坦，阿尔伯特（Albert Einstein，1952）：“关于广义相对论的宇宙学考量”（Cosmological considerations on the general theory of relativity）。收录于《相对论原理》（The Principle of Relativity）。Dover 出版社，第 175–188 页。  
\item 多德尔森，斯科特（Scott Dodelson，2003 年 3 月 30 日）。《现代宇宙学》（Modern Cosmology）。Elsevier 出版社。ISBN 978-0-08-051197-9。 
\item 法尔克，丹（Dan Falk，2009 年 3 月 18 日）：“书评：《我们发现宇宙的那一天》（Marcia Bartusiak 著）”（Review: The Day We Found the Universe）。《新科学人》（New Scientist），201 (2700): 45。doi:10.1016/S0262-4079(09)60809-5。  
\item 哈勃，E. P.（E. P. Hubble，1926 年 12 月 1 日）：“河外星云”（Extragalactic nebulae）。《天体物理学杂志》（The Astrophysical Journal），64: 321。  
\item 马丁，G.（G. Martin，1883）：“G. DELSAULX——论平面波衍射的一个性质”（Sur une propriété de la diffraction des ondes planes），《布鲁塞尔科学学会年报》（Annales de la Société scientifique de Bruxelles，1882）。《理论与应用物理学杂志》（Journal de Physique Théorique et Appliquée，法文），2 (1): 175。doi:10.1051/jphystap:018830020017501。  
\item 哈勃，埃德温（Edwin Hubble，1929 年 3 月 15 日）：“河外星云的距离与径向速度关系”（A Relation Between Distance and Radial Velocity Among Extra-Galactic Nebulae）。《美国国家科学院院刊》（PNAS），15 (3): 168–173。  
\item 彭齐亚斯，A. A.；威尔逊，R. W.（1965 年 7 月 1 日）：“在 4080 Mc/s 下的额外天线温度测量”（A Measurement of Excess Antenna Temperature at 4080 Mc/s）。《天体物理学杂志》（The Astrophysical Journal），142: 419–421。  
\item 博格斯，N. W. 等（1992 年 10 月 1 日）：“COBE 任务——发射两年后的设计与性能”（The COBE mission – Its design and performance two years after launch）。《天体物理学杂志》（The Astrophysical Journal），397: 420–429。  
\item 帕克，巴里·R.（Barry R. Parker，1993）。《大爆炸的辩护：突破与障碍》（The Vindication of the Big Bang: Breakthroughs and Barriers）。纽约：Plenum Press。ISBN 0-306-44469-0。  
\item “计算机图形学成就奖”（Computer Graphics Achievement Award）。ACM SIGGRAPH 2018 奖项，SIGGRAPH '18。加拿大不列颠哥伦比亚省温哥华：计算机协会（ACM），2018 年 8 月 12 日，第 1 页。doi:10.1145/3225151.3232529。  
\item 美国科学促进会（American Association for the Advancement of Science，2007 年 6 月 15 日）：“NETWATCH：植物学的时光机”（NETWATCH: Botany's Wayback Machine）。《科学》（Science），316 (5831): 1547。  
\item 帕拉菲茨，D.；约尔特，J.；埃利亚斯多蒂尔，Á.（2009 年 5 月 1 日）：“使用北欧光学望远镜监测的五个 SDSS 双类星体的光学结果”（Results of optical monitoring of 5 SDSS double QSOs with the Nordic Optical Telescope）。《天文学与天体物理学》（Astronomy & Astrophysics），499 (2): 395–408。
\item 据报道，阿兰·古思（Alan Guth）在 Edge 基金会的一次访谈中曾作出此论述（Edge Foundation interview）。出处：EDGE，网页存档于 2016 年 4 月 11 日。  
\item 桑普尔，伊恩（Ian Sample，2014 年 6 月 4 日）：“因分析存在缺陷的指控，引力波的发现化为尘埃”（Gravitational waves turn to dust after claims of flawed analysis）。《卫报》（The Guardian）。  
\item 考恩，罗恩（Ron Cowen，2015 年 1 月 30 日）：“引力波发现正式被否认”（Gravitational waves discovery now officially dead）。《自然》（Nature）。doi:10.1038/nature.2015.16830。S2CID 124938210。  
\item 奥弗贝，丹尼斯（Dennis Overbye，2014 年 12 月 1 日）：“新图像细化了对早期宇宙的认识”（New Images Refine View of Infant Universe）。《纽约时报》（The New York Times）。取自 2014 年 12 月 2 日。  
\item Leonard & McClure 2004，第 32–33 页。  
\item 克劳奇，C. L.（C. L. Crouch，2010 年 2 月 8 日）：“《创世纪》1:26–27 作为人类神圣血统的陈述”（Genesis 1:26–7 As a statement of humanity's divine parentage）。《神学研究杂志》（The Journal of Theological Studies），61 (1): 1–15。doi:10.1093/jts/flp185。  
\item “BICEP2 2014 结果发布”（BICEP2 2014 Results Release）。美国国家科学基金会（National Science Foundation），2014 年 3 月 17 日。取自 2014 年 3 月 18 日。  
\item “出版物——宇宙计划”（Publications – Cosmos）。欧洲空间局（ESA）网站：www.cosmos.esa.int。取自 2018 年 8 月 19 日。  
\item 查尔斯·卡恩（Charles Kahn，1994）。《阿那克西曼德与希腊宇宙学的起源》（Anaximander and the Origins of Greek Cosmology）。印第安纳波利斯：哈克特出版社（Hackett Publishing）。  
\item 亚里士多德，《论天》（On the Heavens），卷二，第 13 章。  
\item 阿那克西曼德的宇宙模型大部分出自伪普鲁塔克（pseudo-Plutarch，《Placita Philosophorum》II, 20–28）：“〔太阳〕是一个比地球大二十八倍的圆，其外形类似充满火焰的战车轮，在某些地方开有一个‘口’，火焰便从那里透出，就像笛孔一般。[……] 太阳与地球等大，但它呼吸并运行的圆圈比整个地球大二十七倍。[……] 日食发生在火焰透出口被关闭之时。[……] 〔月亮〕是一个比整个地球大十九倍的圆，内部也充满火焰，如同太阳一般。”
\item 卡尔·本杰明·博耶（Carl Benjamin Boyer，1968）。《数学史》（A History of Mathematics）。Wiley 出版社。ISBN 0471543977，第 54 页。  
\item 亚里士多德（Aristotle，1914）。福斯特（E. S. Forster）与多布森（J. F. Dobson）编，《论世界》（De Mundo）。牛津大学出版社，第 393a 页。  
\item “他用以创造灵魂的成分及其制作方式如下：在那不可分、永远不变的存在与可分、在物质领域生成的存在之间，他混合出第三种中间形式的存在，源自前两者。同样地，他在‘同一’（the Same）与‘差异’（the Different）之间，也制成中介的混合体。然后，他将这三种混合物混合为一，迫使难以混合的‘差异’服从于‘同一’。当他将‘同一’与‘差异’混合入‘存在’，并由此三者构成单一的混合体之后，他又将整体重新分割成任务所需的部分，每一部分仍保持‘同一’、‘差异’与‘存在’的混合性质。”——柏拉图《蒂迈欧篇》（Timaeus）35a–b，唐纳德·J·泽尔（Donald J. Zeyl）译。  
\item 柏拉图，《蒂迈欧篇》（Timaeus），36c。  
\item 柏拉图，《蒂迈欧篇》（Timaeus），36d。  
\item 柏拉图，《蒂迈欧篇》（Timaeus），39d。  
\item 雅维茨，伊多（Ido Yavetz，1998 年 2 月）：“论欧多克索斯的同心球体”（On the Homocentric Spheres of Eudoxus）。《精确科学史档案》（Archive for History of Exact Sciences），52 (3): 222–225。doi:10.1007/s004070050017。  
\item 克劳，迈克尔（Michael Crowe，2001）。《从古代到哥白尼革命的世界理论》（Theories of the World from Antiquity to the Copernican Revolution）。纽约州迈诺拉：Dover 出版社，第 23 页。ISBN 0-486-41444-2。  
\item 伊斯特林，H.（H. Easterling，1961）。《论〈论天〉中的同心球体》（Homocentric Spheres in De Caelo）。《弗罗涅西斯》（Phronesis），6 (2): 138–141。doi:10.1163/156852861x00161。  
\item 劳埃德，G. E. R.（G. E. R. Lloyd，1968）。《柏拉图的批评者：亚里士多德思想的成长与结构》（The Critic of Plato. Aristotle: The Growth and Structure of His Thought）。剑桥大学出版社。ISBN 978-0-521-09456-6。  
\item 赫希菲尔德，艾伦·W.（Alan W. Hirshfeld，2004）。《阿里斯塔克斯的三角形》（The Triangles of Aristarchus）。《数学教师》（The Mathematics Teacher），97 (4): 228–231。doi:10.5951/MT.97.4.0228。  
\item 布鲁斯·S·伊斯特伍德（Bruce S. Eastwood，2007）。《秩序诸天：加洛林文艺复兴时期的罗马天文学与宇宙学》（Ordering the Heavens: Roman Astronomy and Cosmology in the Carolingian Renaissance）。莱顿：Brill 出版社，第 238–239 页。  
\item 米拉贝罗，马克（Mark Mirabello，2016 年 9 月 15 日）。《来世旅行者指南：关于死亡、临终与彼岸的传统与信仰》（A Traveler’s Guide to the Afterlife: Traditions and Beliefs on Death, Dying, and What Lies Beyond）。Simon and Schuster 出版社，第 23 页。ISBN 978-1-62055-598-9。  
\item 吉尔伯特，威廉（William Gilbert，1893）。《论磁体》（De Magnete），第六卷第三章。P. Fleury Mottelay 英译本（影印版）。纽约：Dover 出版社。ISBN 0-486-26761-X。
\end{enumerate}
\subsection{资料来源}
\begin{itemize}
\item 布拉格，梅尔文（Melvyn Bragg，2023）。《宇宙的形状》（The Universe’s Shape）。BBC 网站（bbc.co.uk），英国广播公司（BBC）。取自 2023 年 5 月 23 日。梅尔文·布拉格探讨了宇宙的形状、大小与拓扑结构，并审视了其膨胀的相关理论：如果宇宙本身已经是无限的，它还能“变得更大”吗？并且，它真的是唯一的吗？  
\item 《宇宙之旅：科学宇宙学的历史》（Cosmic Journey: A History of Scientific Cosmology）。美国物理学会（American Institute of Physics），history.aip.org，2023 年。取自 2023 年 5 月 23 日。该资料讲述了宇宙学的发现史——从古希腊天文学一直到太空望远镜时代。  
\item 多德尔森，斯科特；施密特，法比安（Scott Dodelson; Fabian Schmidt，2020）。《现代宇宙学（第二版）》（Modern Cosmology, 2nd Edition）。Academic Press 出版社。ISBN 978-0128159484。  
全文下载：多德尔森，斯科特；施密特，法比安（2020）。《斯科特·多德尔森与法比安·施密特〈现代宇宙学〉（2021）》PDF（Scott Dodelson – Fabian Schmidt – Modern Cosmology (2021) PDF）。scribd.com，Academic Press。取自 2023 年 5 月 23 日。  
\item 查尔斯·卡恩（Charles Kahn，1994）。《阿那克西曼德与希腊宇宙学的起源》（Anaximander and the Origins of Greek Cosmology）。印第安纳波利斯：Hackett 出版社。  
\item 《创世计划：起源的探索。任务总结》（Genesis, Search for Origins. End of mission wrap up）。美国国家航空航天局（NASA）喷气推进实验室（JPL），加州理工学院。2017 年 12 月。取自 2023 年 5 月 23 日。大约 46 亿年前，太阳星云演化为现今的太阳系。为了在化学上模拟这一转化过程，我们理想上希望能够获得原始星云的样本，以作为基准来追踪变化。  
\item 莱昂纳德，斯科特·A；麦克卢尔，迈克尔（Scott A. Leonard; Michael McClure，2004）。《神话与知识》（Myth and Knowing）。麦格劳-希尔出版社（McGraw-Hill）。ISBN 978-0-7674-1957-4。  
\item 莱斯，戴维（David Lyth，1993 年 12 月 12 日）。《宇宙学导论》（Introduction to Cosmology）。arXiv:astro-ph/9312022。  
这些讲义是宇宙学的入门笔记，特别强调大尺度结构、宇宙微波背景各向异性与暴胀理论。内容源自 1993 年在意大利的国际理论物理中心（ICTP, Trieste）举办的高能物理与宇宙学暑期学校，共 60 页，附 5 幅图。  
\item “NASA/IPAC 河外星系数据库”（NASA/IPAC Extragalactic Database, NED）。ned.ipac.caltech.edu，美国国家航空航天局（NASA）。2023 年。取自 2023 年 5 月 23 日。  
（2023 年 4 月发布版本更新摘要。）  
\item “NASA/IPAC 河外星系数据库”（NASA/IPAC Extragalactic Database, NED）。ned.ipac.caltech.edu，美国国家航空航天局（NASA）。2020 年。取自 2023 年 5 月 23 日。  
（NED-D：红移无关的河外距离主列表。）  
\item 索菲亚中心（Sophia Centre）。威尔士三一圣大卫大学（University of Wales Trinity Saint David）“文化中的宇宙学研究中心”（The Sophia Centre for the Study of Cosmology in Culture）。  
\end{itemize}
\subsubsection{外部链接}
\begin{itemize}
\item 赖特，爱德华·L.（Edward L. Wright，2013 年 5 月 24 日）。《宇宙学常见问题》（Frequently Asked Questions in Cosmology）。洛杉矶：加州大学洛杉矶分校（UCLA）天文学与天体物理学系。原始内容存档于 2019 年 12 月 10 日。取自 2020 年 1 月 19 日。
\end{itemize}
