...
针对水杯的杯口，的那种压扁的圆，参考\enref{函数的变换}{FunTra} 中介绍的变换方法来研究从单位圆变化得到的曲线。具体地，考虑将单位圆在 $x$ 轴和 $y$ 轴方向分别拉伸 $p$ 倍和 $q$ 倍（其中 $p, q$ 为任意正数）。可
...
由变换可知，曲线在 $x$ 轴上的交点为 $(p, 0), (-p, 0)$，在 $y$ 轴上的交点为 $(0, q), (0, -q)$，它们限制了图像在两个方向上的最大范围。参考圆中“直径”的概念，这四个交点确定了图像的两条对称轴，长度分别为 $2p$ 和 $2q$。
