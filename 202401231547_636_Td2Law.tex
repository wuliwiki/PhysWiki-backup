...
考虑有一高温热源 $\theta_1$ 与低温热源 $\theta_2$，两个热机 $A$、$B$ 工作其间，分别从高温热源 $\theta_1$ 吸收 $Q_1$ 与 $Q_1'$ 的热量、向低温热源 $\theta_2$ 放出 $Q_2$ 与 $Q_2'$ 的热量。
\begin{figure}[ht]
\centering
\includegraphics[width=6cm]{./figures/a7bea06d85184ab9.png}
\caption{热机 $A$ 与 $B$} \label{fig_Td2Law_6}
\end{figure}
