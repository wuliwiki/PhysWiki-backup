...
\end{equation}
\begin{equation}
\psi_{l_1,m_1}(r_1) = \int \sqrt{\frac{2}{\pi}}F_{l_2}(\eta_2, k_2 r_2)\psi_{l_1, l_2}^{m_1, m_2}(r_1, r_2)\dd{r_2}
\end{equation}
所以
\begin{equation}
\begin{aligned}
P(k_2) &= \int \abs{\bra{\delta(\bvec r'_1 - \bvec r_1)}\braket{C_{l_2,m_2}(\bvec r_2)}{\Psi(\bvec r_1, \bvec r_2)}}^2 \dd[3]{r_1}\\
&= \sum_{l_1,m_1} \int \abs{\psi_{l_1,m_1}(r_1)}^2 \dd{r_1}
\end{aligned}
\end{equation}
