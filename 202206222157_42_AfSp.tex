...
\begin{theorem}{}
设 $\{\dot o;e_1,\cdots,e_n\},\{\dot o';e'_1,\cdots,e'_n\}$ 是仿射空间 $\mathbb A$ 中的两个坐标系. $\dot p,\dot o$ 在前一坐标系下的坐标分别为 $x_1,\cdots,x_n$ 和$b_1,\cdots,b_n$．则 $\dot p$ 在后一坐标系下的坐标为  
\end{theorem}
设 $\{\dot o;e_1,\cdots,e_n\},\{\dot o';e'_1,\cdots,e'_n\}$ 是仿射空间 $\mathbb A$ 中的两个坐标系，已知 $\dot p$ 在前一坐标系下坐标为 $x_1,\cdots,x_n$ ，