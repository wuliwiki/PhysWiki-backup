...
表示集合 (X) 上所有 **Kuratowski 闭包算子** 的全体，
而
[
\mathrm{Atp}(X)
]
表示由某拓扑中所有集合的补集组成的所有族的全体，即满足 [T1]–[T3] 公理的所有族的集合，
则存在一个映射
[
{\mathfrak{S}}:\mathrm{Cls}*{\text{K}}(X)\to \mathrm{Atp}(X),
\quad
\mathbf{c} \mapsto {\mathfrak{S}}[\mathbf{c}],
]
它是一个双射，其逆映射由如下对应给出：
[
