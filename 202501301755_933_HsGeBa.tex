...
\textbf{角度（degree measure）}：角的大小可以用\textbf{度数（degrees）}表示，例如 $30^\circ, 45^\circ, 90^\circ$。一个\textbf{平角（straight angle）}的度数为 $180^\circ$，而\textbf{周角（full angle）}的度数为 $360^\circ$。
