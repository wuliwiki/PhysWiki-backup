...
若在\autoref{eq_Lagrng_1} 右边加上\enref{}{}广义力\upref{LagEqQ}， 则它将与牛顿三定律\upref{HSPM03}完全等效。 使用拉格朗日方程对比用牛顿定律的优势在于， 第一，只需写出拉格朗日量，就可由简单求导得到完整的动力学微分方程而无需进行受力分析。第二，方程的形式不随广义坐标的选取而改变。第三，无需解方程即可以得到一些守恒量。
