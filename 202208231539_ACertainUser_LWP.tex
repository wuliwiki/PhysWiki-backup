...
那么，要如何确定场源与场点推迟时间呢？$t=t_b$时刻，场点计算\textsl{他所知道的场源}$\bvec r'(t=t_a)$与自己的距离 $\bvec R = \bvec r'(t=t_a) - \bvec r$，并且除以信号的速度c，那么场点就知道自己关于场源的信息来自$\Delta t = R/c$前．

因此，$c\Delta t = R$，即推迟时刻被方程$c(t-t_r) = |\bvec r'(t_r) - \bvec r'|$隐性定义．此例中，$t_r=t_a$．
