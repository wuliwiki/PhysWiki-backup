...
\begin{example}{}
某一维势阱中有两个互不作用的全同粒子， 我们只考虑束缚态， 单个粒子在该势阱中可能有 3 个正交归一的束缚态 $\psi_i(x)$ （$i=1,2,3$）， 它们可以看作是 3 维希尔伯特空间 $\mathcal V$ 中的基底．
...
对 $i\ne j$ 的基底， 我们可以稍作幺正变换， 例如由 $\psi_1(x_1)\psi_2(x_2)$ 和 $\psi_2(x_1)\psi_1(x_2)$ 张成的子空间中， 把基底取为 $\psi_i(x_1) \psi_j(x_2) + \psi_j(x_1) \psi_i(x_2)$， 反对称基底为
\end{example}
