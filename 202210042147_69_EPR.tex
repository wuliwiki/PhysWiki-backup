...
注意我们除了能对电子 A 测量 $S_z$，还能测量 $S_x,S_y$．那么根据定域实在论，似乎对于 B 电子而言 $S_x,S_y,S_z$ 都是物理实在．这就造成了矛盾．电子三个方向自旋算符是两两不对易的．因此 EPR 佯谬最终导出一个结论：正统量子力学的波函数无法给出关于物理实在的完整描述．换句话说，正统量子力学是不完备的．除非我们推翻定域论或实在论这看似非常合理的假设．爱因斯坦和玻尔曾经围绕 EPR 佯谬展开辩论，辩论的焦点在论文中定域论和实在论的合理性． 当然，根据现代观点以及人们对量子力学的诠释，定域论未必是合理的．
\subsection{定域隐变量原理}
EPR 论文的最后，Einstein 给出了一个
