...
\pentry{质心\ 质心系\upref{CM}， 自由度\upref{DoF}， 动量定理\upref{PLaw}}

我们现在考虑两个仅受相互作用的质点 $A$ 和 $B$， 它们的质量分别为 $m_A$ 和 $m_B$． 由于不受系统外力， 在任何惯性系中它们的质心都会做匀速直线运动（\autoref{PLaw_eq2}~\upref{PLaw}）． 所以系统的质心参考系是一个惯性系， 以下我们选取质心参考系， 系统的质心将一直处于原点．
