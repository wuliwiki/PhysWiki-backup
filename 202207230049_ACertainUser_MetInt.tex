...
\subsection{缺陷}
如果金属中的原子都完全按这种理想的方式整整齐齐地排列，那材料科学也未免太无趣了（材料科学的书至少会薄半本！但同时，我们能用材料科学做的事也会少很多！）．如果我们稍微看的远一点，就会看到金属晶体中存在许多原子偏离了理想排列的区域．实际上，由于各种因素的影响，真实的金属晶体往往存在偏离理想结构的区域，称为缺陷．根据缺陷的空间尺度，缺陷一般被分为点缺陷、线缺陷与面缺陷．

% 金属中的缺陷占比虽然不多，但却对材料的性能起到了决定性影响．“缺陷”这个词往往让人以为缺陷对于材料性质都是不利的，但事实并非如此．有些缺陷对于材料（某一方面的性质）可以起到积极作用．

\begin{definition}{缺陷}
由于各种因素的影响，实际金属中原子偏离理想排列而出现的不完整区域
\end{definition}
