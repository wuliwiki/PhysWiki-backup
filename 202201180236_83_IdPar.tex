...
\item \textbf{两个全同的粒子：}
\begin{align}
\langle x_1^2\rangle = \frac{1}{2}\left[\int x_1|\psi_A(x_1)|^2dx_1\int |\psi_B(x_2)|^2dx_2\\
+\int x_1|\psi_B(x_1)|^2dx_1\int |\psi_A(x_2)|^2dx_2\\ 
\pm\int x_1^2\psi_A(x_1)\psi_B(x_2)^*dx_1\int \psi_B(x_1)\psi_A(x_2)^*dx_2\\
\pm\int x_1^2\psi_B(x_1)\psi_A(x_2)^*dx_1\int \psi_A(x_1)\psi_B(x_2)^*dx_2=\frac{1}{2}\right]
\end{align}
