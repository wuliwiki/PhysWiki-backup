...
由方程\autoref{IntGen_eq3} 或\autoref{IntGen_eq4} 对 $x$ 求导，直到 $n-1$ 阶，再用 $x=x_0$ 及初始条件\autoref{IntGen_eq5} 代入，就得到 $n$ 个方程。由这 $n$ 个方程，就可以确定出对应初始条件\autoref{IntGen_eq5} 的一般积分的任意常数 $C_1,\cdots,C_n$。
