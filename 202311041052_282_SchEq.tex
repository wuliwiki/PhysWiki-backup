...
对一维或二维的有限深势阱， 如果各方向无穷远处势能为零， 那么都至少有一个束缚态\footnote{一维证明参考 \cite{Teschl} 的第九章。}。 若不满足则未必存在束缚态。
\addTODO{这个定理是错的？见下文的反例，但为什么存在文献呢？找到一篇【JOURNAL OF MATHEMATICAL PHYS VOL39,NUM 9, 1998】}
