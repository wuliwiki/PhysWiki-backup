...
附注：对多项式更广泛的讨论，可以参考小时百科《代数学进阶》部分的内容，尤其是环论开始的部分。这里推荐几例值得作为拓展阅读的文章：\enref{爱森斯坦判别式}{EsstCr}（\textbf{整环}\upref{Domain}上判定多项式不可约的条件），\textbf{唯一析因环}\upref{UFD}（满足因式分解唯一性的环，比如本文涉及的整数环），\textbf{欧几里得环}\upref{EuRing}，\textbf{多项式环}\upref{RPlynm}。
