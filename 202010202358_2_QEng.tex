...
设带电直导线长为$L$，线电荷密度为$\lambda$，导线水平放置．以导体棒中点为坐标原点，建立$xOy$坐标系，如下图所示．

\begin{figure}[ht]
\centering
\includegraphics[width=10cm]{./figures/QEng_2.png}
\caption{有限长直导体棒的电势} \label{QEng_fig2}
\end{figure}

对导线上的某一电荷微元，有$\dd q=\lambda \lambda \dd x$，该电荷微元到导线某一侧的任一点$P$的距离为$r=\sqrt{(a-x)^2+b^2}$，那么该电荷微元对导线某一侧的任一点$P$贡献的电势为
\begin{equation}
