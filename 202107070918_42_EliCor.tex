...
我们先来求三个正交曲线坐标系的拉梅系数 $\Big|\pdv{\bvec{r}}{q_i}\Big|\;(i=1,2,3)$，其中 $q_i$ 为坐标系的3个坐标．由\autoref{EliCor_eq1} ，得椭圆柱坐标系中得拉梅系数
\begin{equation}
H_\xi=H_\eta=r\sqrt{\sinh^\xi+\sin^2\eta} \quad H_\eta= \quad H_z=1
\end{equation}
