...
\end{align}
其中 $J_{A\rightarrow B}$ 为物理量流度，当 $q=m$ 时，$J$ 就代表质量流；$q=\bar v$ 时，$J$ 就代表动量流．由于分子从 $A$ 越过界面到 $B$ 后会与“本地”分子碰撞，在一个弛豫时间内被同化，我们可以想象\textbf{当弛豫时间越短，同化得就越快}，这将对传递过程产生影响．我们将运用“平均自由程”进行分析，为此需要热力学假设：
...
不妨设粒子越过 $z_0$ 后在 $\alpha \bar \lambda$ 的路径中被同化，
