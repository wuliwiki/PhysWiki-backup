...
\begin{pmatrix}
  ...
  2& 0\\
 1 &-3
\end{pmatrix}\t$\opn{Im}$es \begin{pmatrix}
 2 &-1
...
记$\opn{ker}f=\{\boldsymbol x\in V|f(\boldsymbol x)=\boldsymbol 0\}$，称作线性映射$f$的核（$\opn{ker}$nel）。记$\opn{Im}f=\{f(\boldsymbol x)|\boldsymbol x\in V\}$，称作线性映射$f$的象（$\opn{Im}$age）
\end{definition}
\begin{exercise}{}
...
\mathrm{d$\opn{Im}$}V=\mathrm{d$\opn{Im}$}\,$\opn{ker}$f+\mathrm {d$\opn{Im}$}\,$\opn{Im}$f~,
\end{lemma}
