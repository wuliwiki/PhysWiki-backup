...
\end{equation}
在$S_z$表象下计算$\overline{S_x}$得：

\begin{equation}
\begin{aligned}
 \bra{a}\mathrm e^{\mathrm i S_z\phi}S_x\mathrm e^{-\mathrm i S_z\phi}\ket{a}&=\frac{1}{2}\mathrm e^{\mathrm i S_z\phi}()\mathrm e^{-\mathrm i S_z\phi}\\
\end{aligned}
\end{equation}
