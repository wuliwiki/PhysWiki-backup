...
\footnote{参考 Wikipedia \href{https://en.wikipedia.org/wiki/Gamma_function}{相关页面}．}$\Gamma$ 函数\textbf{（gamma function）}可以看成是阶乘在实数或复数域的拓展． 我们先讨论 $x$ 取实数的情况． 使用定积分的方法可以定义 $(-1, \infty)$ 范围的阶乘
