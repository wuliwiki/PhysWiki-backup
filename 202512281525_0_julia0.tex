...
\item typed ir 中常见的 \verb`Base` 模块的 \verb`Core.IntrinsicFunction` 类函数有 \verb`add_int, sub_int, or_int, not_int, xor_int, mul_float, lt_float, sle_int`
\item \verb`Core.Intrinsics.checked_smul_int`
