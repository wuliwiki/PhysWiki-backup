...
\begin{itemize}
\item \verb`INSERT INTO 表格名 (列1, 列2, 列3, ...) VALUES (value1, value2, value3, ...);` 插入行， 如果每列都插入， 那么 \verb`(列1, 列2,...)` 可以省略
\item 对所有列， \verb`INSERT INTO 表格名 VALUES (value1, value2, value3, ...);`
...
\item \verb`UPDATE 表格名 SET 列1 = value1, 列2 = value2, ... WHERE condition;`
