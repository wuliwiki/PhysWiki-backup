...
\begin{example}{}
在没有引力的太空中， 两个面团角动量分别为 $\bvec L_1$ 和 $\bvec L_2$， 与转轴方向相同． 他们的质心在同一直线上相向运动然后相撞并融为一体． 把他们看成一个系统， 总角动量为 $\bvec L = \bvec L_1 + \bvec L_2$． 由于不受任何外力（矩）， 根据角动量守恒， 相撞后总角动量仍然为 $\bvec L$， 面团的转轴沿 $\bvec L$ 的方向．
\end{example}
